...
export default createE2EConfig([
  ...
  { file: 'fields__collections__Blocks', shards: 1 },
  { file: 'fields__collections__Blocks#config.blockreferences.ts', shards: 1 },
  ...
  { file: 'fields__collections__Date', shards: 1 },
  ...
  { file: 'fields__collections__Relationship', shards: 1 },
  ...
  { file: 'lexical__collections__Lexical__e2e__main', shards: 1 },
  { file: 'lexical__collections__Lexical__e2e__blocks', shards: 1 },
  { file: 'lexical__collections__Lexical__e2e__blocks#config.blockreferences.ts', shards: 1 },
  { file: 'lexical__collections__RichText', shards: 1 },
  { file: 'query-presets', shards: 1 },
  { file: 'form-state', shards: 1 },
  { file: 'live-preview', shards: 1 },
  { file: 'localization', shards: 1 },
  ...
  { file: 'plugin-multi-tenant', shards: 1 },
  ...
  { file: 'trash', shards: 1 },
  { file: 'versions', shards: 1 },
  { file: 'uploads', shards: 1 },
])
