...
const UnpublishMany = (props) => {
    ...
    const handleUnpublish = (0, react_1.useCallback)(() => {
        setSubmitted(true);
        api_1.requests.patch(`${serverURL}${api}/${slug}${getQueryParams({ _status: { not_equals: 'draft' } })}`, {
            body: JSON.stringify({
                _status: 'draft',
            }),
            headers: {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(modal_1.Modal, { slug: modalSlug, className: baseClass },
            react_1.default.createElement(Minimal_1.default, { className: `${baseClass}__template` },
                ...
                react_1.default.createElement("p", null, t('aboutToUnpublishSelection', { label: (0, getTranslation_1.getTranslation)(plural, i18n) })),
                ...
                react_1.default.createElement(Button_1.default, { onClick: submitted ? undefined : handleUnpublish, id: "confirm-unpublish" }, submitted ? t('unpublishing') : t('general:confirm'))))));
};
exports.default = UnpublishMany;
