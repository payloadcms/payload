...
const JSONField = (props) => {
    ...
    return (react_1.default.createElement("div", { className: classes, style: {
        ...
        react_1.default.createElement(CodeEditor_1.CodeEditor, { options: editorOptions, defaultLanguage: "json", value: stringValue, onChange: handleChange, readOnly: readOnly }),
