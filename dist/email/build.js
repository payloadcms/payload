...
const ensureConfigHasFrom = (emailConfig) => {
    if (!(emailConfig === null || emailConfig === void 0 ? void 0 : emailConfig.fromName) || !(emailConfig === null || emailConfig === void 0 ? void 0 : emailConfig.fromAddress)) {
...
const handleMockAccount = async (emailConfig, logger) => {
    ...
    try {
        ...
        if (emailConfig === null || emailConfig === void 0 ? void 0 : emailConfig.logMockCredentials) {
