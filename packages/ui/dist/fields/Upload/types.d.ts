...
type PopulateDocsDeprecated = (ids: (number | string)[], items: never, collectionSlug?: string) => Promise<null | PaginatedDocs>;
type PopulateDocsNew = (items: ValueWithRelation[], ids: never, collectionSlug: never) => Promise<null | ValueAsDataWithRelation[]>;
