...
import { TableColumnsProvider, useTableColumns } from '../../elements/TableColumns/index.js'
...
const ListWithContext: React.FC<ListViewClientProps> = (props) => {
  const {
    AfterList,
    AfterListTable,
    beforeActions,
  ...
  const { Table: TableFromContext } = useTableColumns()
  const {
    data,
