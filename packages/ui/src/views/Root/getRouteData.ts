...
import { AccountView } from '../Account/RenderAccount.js'
import { BrowseByFolder } from '../BrowseByFolder/BrowseByFolderView.js'
...
const oneSegmentViews: OneSegmentViews = {
  ...
  login: LoginView as React.FC<AdminViewServerProps>,
  logout: LogoutView,
    ...
    case 2: {
      if (`/${segmentOne}` === config.admin.routes.reset) {
        ...
        if (
          ...
          ViewToRender = {
            Component: CollectionFolderView as React.FC<AdminViewServerProps>,
          }
    ...
    default:
      if (segmentTwo === 'verify') {
        ...
        if (segmentThree === 'trash' && typeof segmentFour === 'string') {
          ...
          ViewToRender = {
            Component: TrashView as React.FC<AdminViewServerProps>,
          }
