...
import type { ViewToRender } from './RenderDocument.js'

import { APIView as DefaultAPIView } from '../API/index.js'
import { DefaultEditView as EditView } from '../Edit/index.js'
        ...
        switch (segment3) {
          ...
          case 'create': {
            if ('create' in docPermissions && docPermissions.create) {
              View = getCustomDocumentViewByKey(views, 'default') || EditView
            } else {
