...
> = (props) => {
  const {
    ...
    selectProps: {
      customProps: { draggableProps, onDocumentDrawerOpen, onDocumentOpen } = {},
    } = {},
  } = props
  ...
  return (
    <div className={baseClass}>
      ...
      {relationTo && hasReadPermission && allowOpenInNewTab !== false && (
        <Fragment>
          <button
          ...
          >
            ...
            <NewTabIcon className={`${baseClass}__icon`} />
          </button>
        </Fragment>
      )}
    </div>
