...
- [Source code](https://github.com/payloadcms/payload/tree/3.x/packages/plugin-search)
- [Documentation](https://payloadcms.com/docs/plugins/search)
- [Documentation source](https://github.com/payloadcms/payload/tree/3.x/docs/plugins/search.mdx)
