    ...
    <div className={baseClass}>
      <div className={`${baseClass}__blocks-grid`}>
        <button
          ...
          onClick={() => addFieldRow({ data: { block1Title: 'Block 1: Prefilled Title', blockType: 'block-1' }, path: 'customBlocks', rowIndex: nextIndex })}
          type="button"
        >
          Add Block 1
        </button>
        ...
        <button
          className={`${baseClass}__block-button`}
          onClick={() => addFieldRow({ data: { block2Title: 'Block 2: Prefilled Title', blockType: 'block-2' }, path: 'customBlocks', rowIndex: nextIndex })}
          type="button"
        >
          Add Block 2
        </button>
      ...
      <div>
        <button
          ...
          onClick={() => replaceFieldRow({ data: { block1Title: 'REPLACED BLOCK', blockType: 'block-1' }, path: 'customBlocks', rowIndex: nextIndex - 1 })}
          type="button"
        >
          Replace Block
          {' '}
