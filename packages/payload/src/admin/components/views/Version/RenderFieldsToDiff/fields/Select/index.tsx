...
const getOptionsToRender = (value: string, options: SelectField['options'], hasMany: boolean): (OptionObject | string)[] | OptionObject | string => {
...
const getTranslatedOptions = (options: (OptionObject | string)[] | OptionObject | string, i18n: Ii18n): string => {
