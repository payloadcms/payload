...
export { acquireMigrationLock } from './database/migrations/acquireMigrationLock.js'
export type { AcquireLockResult } from './database/migrations/acquireMigrationLock.js'
...
export { migrationsLockGlobal } from './database/migrations/migrationsLockGlobal.js'
...
export { releaseMigrationLock } from './database/migrations/releaseMigrationLock.js'
