...
describe('getSafeRedirect', () => {
  ...
  ])('should use the fallback when a path contains a control character: %s', (query) => {
  ...
  it('should preserve a parsed redirect target without re-decoding its query values', () => {
