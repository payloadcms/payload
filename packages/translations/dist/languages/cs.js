export const csTranslations = {
    ...
    error: {
        ...
        documentNotFound: 'Dokument s ID {{id}} nebyl nalezen. Mohlo být smazáno nebo nikdy neexistovalo, nebo k němu nemáte přístup.',
        ...
        insufficientClipboardPermissions: 'Přístup ke schránce byl odepřen. Zkontrolujte oprávnění ke schránce.',
    ...
    folder: {
        ...
        folders: 'Složky',
        folderTypeDescription: 'Vyberte, který typ dokumentů ze sbírky by měl být dovolen v této složce.',
    ...
    general: {
        ...
        successfullyReindexed: 'Úspěšně reindexováno {{count}} z {{total}} dokumentů z {{collections}} a přeskočeno {{skips}} konceptů.',
        takeOver: 'Převzít',
