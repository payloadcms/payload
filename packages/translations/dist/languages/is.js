export const isTranslations = {
    authentication: {
        ...
        youAreInactive: 'Þú hefur ekki verið virkur í smá stund og verður fljótlega skráður út sjálfkrafa til öryggis. Viltu halda innskráningu?',
        youAreReceivingResetPassword: 'Þú færð þetta vegna þess að þú (eða einhver annar) hefur beðið um að endurstilla lykilorðið fyrir reikninginn þinn. Vinsamlegast smelltu á eftirfarandi hlekk eða límdu þetta í vafrann þinn til að ljúka ferlinu:',
    ...
    error: {
        ...
        insufficientClipboardPermissions: 'Aðgangur að klemmuspjaldi hafnað. Vinsamlegast athugaðu klemmuspjaldsheimildir þínar.',
    ...
    folder: {
        ...
        moveItemsToFolderConfirmation: 'Þú ert að fara að færa <1>{{count}} {{label}}</1> í <2>{{toFolder}}</2>. Ertu viss?',
        moveItemsToRootConfirmation: 'Þú ert að fara að færa <1>{{count}} {{label}}</1> í rótarmöppuna. Ertu viss?',
        moveItemToFolderConfirmation: 'Þú ert að fara að færa <1>{{title}}</1> í <2>{{toFolder}}</2>. Ertu viss?',
        moveItemToRootConfirmation: 'Þú ert að fara að færa <1>{{title}}</1> í rótarmöppuna. Ertu viss?',
    ...
    general: {
        ...
        aboutToPermanentlyDelete: 'Þú ert að fara að eyða {{label}} <1>{{title}}</1> varanlega. Ertu viss?',
        aboutToPermanentlyDeleteTrash: 'Þú ert að fara að eyða <0>{{count}}</0> <1>{{label}}</1> varanlega úr ruslinu. Ertu viss?',
        aboutToRestore: 'Þú ert að fara að endurheimta {{label}} <1>{{title}}</1>. Ertu viss?',
        aboutToRestoreAsDraft: 'Þú ert að fara að endurheimta {{label}} <1>{{title}}</1> sem drög. Ertu viss?',
        ...
        resetPreferencesDescription: 'Þetta mun endurstilla allar stillingarnar þínar í sjálfgefnar stillingar.',
        ...
        successfullyReindexed: 'Tókst að endurvísa {{count}} af {{total}} skjölum úr {{collections}} og {{skips}} drög voru sleppt.',
        takeOver: 'Taka yfir',
    ...
    upload: {
        ...
        focalPointDescription: 'Dragðu brennipunktinn beint á forskoðunina eða stilltu gildin hér að neðan.',
        height: 'Hæð',
    ...
    validation: {
        ...
        longerThanMin: 'Þetta gildi verður að vera lengra en lágmarkslengdin sem er {{minLength}} stafir.',
        ...
        shorterThanMax: 'Þetta gildi verður að vera styttra en hámarkslengdin sem er {{maxLength}} stafir.',
        timezoneRequired: 'Tímabelti er nauðsynlegt.',
        trueOrFalse: 'Þetta svæði getur aðeins verið jafnt og satt eða ósatt.',
        username: 'Vinsamlegast settu inn gilt notandanafn. Getur innihaldið bókstafi, tölur, bandstrik, punkta og undirstrik.',
