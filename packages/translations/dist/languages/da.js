export const daTranslations = {
    ...
    error: {
        ...
        documentNotFound: 'Dokumentet med ID {{id}} kunne ikke findes. Det kan være slettet eller har aldrig eksisteret, eller du har muligvis ikke adgang til det.',
        ...
        insufficientClipboardPermissions: 'Adgang til udklipsholder nægtet. Kontroller dine udklipsholderrettigheder.',
    ...
    folder: {
        ...
        folders: 'Mapper',
        folderTypeDescription: 'Vælg hvilken type samling af dokumenter der bør være tilladt i denne mappe.',
    ...
    general: {
        ...
        successfullyReindexed: '{{count}} ud af {{total}} dokumenter fra {{collections}} blev succesfuldt genindekseret, og {{skips}} kladder blev sprunget over.',
        takeOver: 'Overtag',
        thisLanguage: 'Dansk',
        time: 'Tid',
        timezone: 'Tidszone',
