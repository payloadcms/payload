export const nbTranslations = {
    ...
    error: {
        ...
        documentNotFound: 'Dokumentet med ID {{id}} kunne ikke bli funnet. Det kan ha blitt slettet eller aldri eksistert, eller du har kanskje ikke tilgang til det.',
        ...
        insufficientClipboardPermissions: 'Tilgang til utklippstavlen ble nektet. Sjekk utklippstavle-tillatelsene dine.',
    ...
    folder: {
        ...
        moveItemToRootConfirmation: 'Du er i ferd med å flytte <1>{{title}}</1> til rotmappen. Er du sikker?',
    ...
    general: {
        ...
        aboutToRestoreAsDraft: 'Du er i ferd med å gjenopprette {{label}} <1>{{title}}</1> som et utkast. Er du sikker?',
        ...
        aboutToTrash: 'Du er i ferd med å flytte {{label}} <1>{{title}}</1> til søppelkurven. Er du sikker?',
        ...
        successfullyReindexed: 'Vellykket reindeksering av {{count}} av totalt {{total}} dokumenter fra {{collections}}, og {{skips}} utkast ble hoppet over.',
        takeOver: 'Ta over',
        thisLanguage: 'Norsk',
        time: 'Tid',
        timezone: 'Tidssone',
    ...
    version: {
        ...
        aboutToRestore: 'Du er i ferd med å gjenopprette {{label}} dokumentet til tilstanden det var i på {{versionDate}}.',
