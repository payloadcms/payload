export const zhTwTranslations = {
    ...
    folder: {
        ...
        moveFolder: '移動資料夾',
        moveItemsToFolderConfirmation: '您即將移動 <1>{{count}} 個 {{label}}</1> 到 <2>{{toFolder}}</2>。確定要繼續？',
    ...
    general: {
        ...
        aboutToPermanentlyDeleteTrash: '您即將從垃圾桶中永久刪除 <0>{{count}}</0> 個 <1>{{label}}</1>。確定要繼續？',
        ...
        successfullyReindexed: '已成功重新索引 {{count}} 個來自 {{collections}} 的 {{total}} 個文件，並跳過了 {{skips}} 個草稿。',
        takeOver: '接手編輯',
        thisLanguage: '中文（繁體）',
        time: '時間',
        timezone: '時區',
