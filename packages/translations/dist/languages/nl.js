export const nlTranslations = {
    ...
    error: {
        ...
        documentNotFound: 'Het document met ID {{id}} kon niet worden gevonden. Het kan zijn verwijderd of heeft nooit bestaan, of u heeft mogelijk geen toegang tot het.',
        ...
        insufficientClipboardPermissions: 'Toegang tot het klembord geweigerd. Controleer je klembordmachtigingen.',
    ...
    folder: {
        ...
        folderName: 'Mapnaam',
        folders: 'Mappen',
        folderTypeDescription: 'Selecteer welk type verzameldocumenten toegestaan zou moeten zijn in deze map.',
    ...
    general: {
        ...
        successfullyReindexed: 'Succesvol {{count}} van {{total}} documenten uit {{collections}} opnieuw geïndexeerd, en {{skips}} concepten werden overgeslagen.',
        takeOver: 'Overnemen',
