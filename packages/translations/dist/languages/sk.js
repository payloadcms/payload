export const skTranslations = {
    ...
    error: {
        ...
        documentNotFound: 'Dokument s ID {{id}} sa nepodarilo nájsť. Možno bol vymazaný, nikdy neexistoval, alebo k nemu nemáte prístup.',
        ...
        insufficientClipboardPermissions: 'Prístup do schránky bol zamietnutý. Skontrolujte svoje oprávnenia pre schránku.',
        ...
        restoringTitle: 'Pri obnovovaní {{title}} sa vyskytla chyba. Skontrolujte prosím svoje pripojenie a skúste to znova.',
    ...
    folder: {
        ...
        folders: 'Priečinky',
        folderTypeDescription: 'Vyberte, ktorý typ dokumentov z kolekcie by mal byť povolený v tejto zložke.',
    ...
    general: {
        ...
        aboutToPermanentlyDelete: 'Chystáte sa natrvalo vymazať {{label}} <1>{{title}}</1>. Ste si istý?',
        aboutToPermanentlyDeleteTrash: 'Chystáte sa natrvalo odstrániť <0>{{count}}</0> <1>{{label}}</1> z koša. Ste si istý?',
        aboutToRestore: 'Chystáte sa obnoviť {{label}} <1>{{title}}</1>. Ste si istý?',
        aboutToRestoreAsDraft: 'Chystáte sa obnoviť {{label}} <1>{{title}}</1> ako koncept. Ste si istý?',
        ...
        successfullyReindexed: 'Úspešne bolo preindexovaných {{count}} z {{total}} dokumentov z kolekcie {{collections}}, a {{skips}} konceptov bolo preskočených.',
        takeOver: 'Prevziať',
