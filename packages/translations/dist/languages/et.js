export const etTranslations = {
    ...
    error: {
        ...
        documentNotFound: 'Dokumenti ID-ga {{id}} ei leitud. Võimalik, et see on kustutatud või pole seda kunagi olnud, või ei pruugi teil sellele juurdepääsu olla.',
        ...
        insufficientClipboardPermissions: 'Lõikelaua juurdepääs keelatud. Palun kontrollige oma lõikelaua õigusi.',
    ...
    general: {
        ...
        successfullyReindexed: 'Õnnestus ümberindekseerida {{count}} dokumenti {{total}}-st kollektsioonist {{collections}} ja {{skips}} mustandeid jäeti vahele.',
        takeOver: 'Võta üle',
        thisLanguage: 'Eesti',
        time: 'Aeg',
        timezone: 'Ajavöönd',
