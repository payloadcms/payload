...
export type SupportedLanguages<
  TDefaultTranslations = DefaultTranslationsObject,
> = {
 ...
 */
export type DefaultTranslationKeysUnSanitized =
  NestedKeysUnSanitized<DefaultTranslationsObject>;
...
export type ClientTranslationKeys<
  TExtraProps = (typeof clientTranslationKeys)[number],
> = TExtraProps;
