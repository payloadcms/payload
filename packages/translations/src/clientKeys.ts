...
export const clientTranslationKeys = createClientTranslationKeys([
  ...
  'general:by',
  'general:cancel',
  'general:chooseTemplate',
  'general:createFromTemplate',
  ...
  'general:row',
  'general:rows',
  'general:insertFromTemplate',
  'general:replaceFromTemplate',
  'general:save',
  'general:saveAsTemplate',
  'general:saveBlockAsTemplate',
  'general:saveChanges',
  'general:saveFieldAsTemplate',
  ...
  'general:templateOutOfDate',
  'general:templateSaved',
