...
export const clientTranslationKeys = createClientTranslationKeys([
  ...
  'dashboard:pinDocument',
  'dashboard:unpinDocument',
  'dashboard:updatedBy',
  'dashboard:saveError',
  'dashboard:loadError',
  'dashboard:uploadDropzone',
  ...
  'general:edit',
  'general:alignHeaderAndControls',
  'general:editViewWidth',
  'general:editViewWidthFull',
  'general:editAll',
  'general:editing',
  ...
  'general:timezone',
  'general:theme',
  'general:typeSizeDefault',
  'general:typeSizeLarge',
  'general:typeSizes',
  'general:typeSizeSmall',
  'general:toggle',
