...
export const clientTranslationKeys = createClientTranslationKeys([
  ...
  'branching:branch',
  'branching:branchDescription',
  'branching:branchedFrom',
  'branching:branches',
  'branching:branchName',
  'branching:branchSettings',
  'branching:branchClosed',
  'branching:branchHistory',
  'branching:historyPageOf',
  'branching:andMoreChanges',
  'branching:changedDocuments',
  'branching:cancelSchedule',
  'branching:changesTo',
  'branching:closeBranchAfterMerge',
  'branching:closeBranchHelpOff',
  'branching:closeBranchHelpOn',
  'branching:confirmDiscardAll',
  'branching:confirmDiscardSelected',
  'branching:currentChanges',
  'branching:createAndSwitch',
  'branching:createNewBranch',
  'branching:defaultBranch',
  'branching:discardAll',
  'branching:discardChanges',
  'branching:discardedCount',
  'branching:discarding',
  'branching:discardSelected',
  'branching:manage',
  'branching:manageBranches',
  'branching:merge',
  'branching:mergeAllChanges',
  'branching:mergeAllCount',
  'branching:mergeBranchInto',
  'branching:mergeChanges',
  'branching:mergeComplete',
  'branching:mergedByCount',
  'branching:mergedCount',
  'branching:mergedOfTotal',
  'branching:mergedOn',
  'branching:mergeHistory',
  'branching:mergeInterrupted',
  'branching:mergeNow',
  'branching:mergeOnlySelected',
  'branching:mergeScheduledFor',
  'branching:mergeSelectedOfTotal',
  'branching:mergeStarting',
  'branching:merging',
  'branching:mergingProgress',
  'branching:noChangesYet',
  'branching:operation_create',
  'branching:operation_delete',
  'branching:operation_update',
  'branching:reviewingChangedDocuments',
  'branching:scheduleAnotherMerge',
  'branching:scheduleCancelled',
  'branching:scheduleCount',
  'branching:scheduledMerges',
  'branching:scheduledToMerge',
  'branching:scheduledToMergeOn',
  'branching:scheduleHasNothingLeft',
  'branching:scheduleWillApplyAll',
  'branching:scheduleWillApplySelected',
  'branching:scheduleMerge',
  'branching:scheduleMergeHelp',
  'branching:scheduling',
  'branching:searchBranches',
  'branching:selectBranch',
  'branching:status_closed',
  'branching:status_merged',
  'branching:status_merging',
  'branching:status_open',
