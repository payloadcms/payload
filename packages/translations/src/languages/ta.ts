...
export const taTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: 'மேலும் {{count}} மாற்றங்கள்',
    branch: 'கிளை',
    branchClosed:
      'இந்தக் கிளை மூடப்பட்டுள்ளது. என்ன ஒன்றிணைக்கப்பட்டது என்பதற்கான பதிவாக இது வைக்கப்படுகிறது.',
    branchDescription: 'கிளையின் விளக்கம்',
    branchedFrom: 'கிளைக்கப்பட்ட மூலம்',
    branches: 'கிளைகள்',
    branchHistory: 'கிளை வரலாறு',
    branchMerging: 'ஒன்றிணைக்கிறது',
    branchName: 'கிளையின் பெயர்',
    branchSettings: 'கிளை அமைப்புகள்',
    cancelSchedule: 'இணைப்பை ரத்துசெய்',
    changedDocuments: 'மாற்றப்பட்ட ஆவணங்கள்',
    changesTo: '{{summary}} இல் மாற்றங்கள்',
    closeBranchAfterMerge: 'ஒன்றிணைத்த பிறகு இந்தக் கிளையை மூடு',
    closeBranchHelpOff:
      'கிளை திறந்திருக்கும், எனவே நீங்கள் அதில் தொடர்ந்து பணியாற்றி பின்னர் மீண்டும் ஒன்றிணைக்கலாம்.',
    closeBranchHelpOn: 'கிளை படிக்க மட்டுமே ஆகிவிடும், மீண்டும் ஒன்றிணைக்க முடியாது.',
    confirmDiscardAll:
      'இந்தக் கிளையில் மாற்றப்பட்ட {{count}} ஆவணங்களும் main-ல் இருந்த நிலைக்குத் திரும்பும். இதைச் செயல்தவிர்க்க முடியாது.',
    confirmDiscardSelected:
      'மாற்றப்பட்ட {{count}} ஆவணங்கள் main-ல் இருந்த நிலைக்குத் திரும்பும். இதைச் செயல்தவிர்க்க முடியாது.',
    createAndSwitch: 'உருவாக்கி மாறு',
    createNewBranch: 'புதிய கிளையை உருவாக்கு',
    currentChanges: 'தற்போதைய மாற்றங்கள்',
    defaultBranch: 'இயல்புநிலை',
    discardAll: 'அனைத்தையும் நிராகரி ({{count}})',
    discardChanges: 'மாற்றங்களை நிராகரி',
    discardedCount: '{{count}} மாற்றங்கள் நிராகரிக்கப்பட்டன.',
    discarding: 'நிராகரிக்கிறது…',
    discardSelected: 'தேர்ந்தெடுத்தவற்றை நிராகரி ({{count}})',
    historyPageOf: 'பக்கம் {{page}} / {{total}}',
    manage: 'நிர்வகி',
    manageBranches: 'கிளைகளை நிர்வகி…',
    merge: 'ஒன்றிணை',
    mergeAllChanges: 'இந்தக் கிளையின் அனைத்து மாற்றங்களும் பயன்படுத்தப்படும்.',
    mergeAllCount: 'இந்தக் கிளையில் மாற்றப்பட்ட {{count}} ஆவணங்களும் பயன்படுத்தப்படும்.',
    mergeBranchInto: '{{branch}}-ஐ {{target}}-உடன் ஒன்றிணை',
    mergeChanges: 'மாற்றங்களை ஒன்றிணை',
    mergeComplete: 'ஒன்றிணைப்பு முடிந்தது',
    merged: 'ஒன்றிணைக்கப்பட்டது',
    mergedByCount: '{{count}} ஆவணங்கள் – {{user}}',
    mergedCount: '{{count}} மாற்றங்கள் ஒன்றிணைக்கப்பட்டன.',
    mergedOfTotal: '{{total}}-ல் {{current}} ஒன்றிணைக்கப்பட்டது',
    mergedOn: '{{date}}-ல் ஒன்றிணைக்கப்பட்டது',
    mergeHistory: 'ஒன்றிணைப்பு வரலாறு',
    mergeInterrupted:
      'ஒன்றிணைப்பு தடைபட்டது, எதுவும் பயன்படுத்தப்படவில்லை. மீண்டும் முயற்சிக்கவும்.',
    mergeNow: 'இப்போது ஒன்றிணை',
    mergeOnlySelected: 'எந்த மாற்றங்களை ஒன்றிணைக்க வேண்டும் என்பதைத் தேர்ந்தெடுக்கவும்',
    mergeScheduledFor: '{{date}}-க்கு ஒன்றிணைப்பு திட்டமிடப்பட்டது.',
    mergeSelectedOfTotal: 'மாற்றப்பட்ட {{total}} ஆவணங்களில் {{selected}} பயன்படுத்தப்படும்.',
    mergeStarting: 'ஒன்றிணைப்பு தொடங்குகிறது…',
    merging: 'ஒன்றிணைக்கிறது…',
    mergingProgress: '{{total}}-ல் {{current}} ஒன்றிணைக்கப்படுகிறது',
    noChangesYet: 'இந்தக் கிளையில் இன்னும் மாற்றங்கள் இல்லை.',
    operation_create: 'உருவாக்கப்பட்டது',
    operation_delete: 'நீக்கப்பட்டது',
    operation_update: 'புதுப்பிக்கப்பட்டது',
    reviewingChangedDocuments: 'மாற்றப்பட்ட ஆவணங்களை மதிப்பாய்வு செய்தல்',
    scheduleAnotherMerge: 'மற்றொரு ஒன்றிணைப்பை திட்டமிடு',
    scheduleCancelled: 'திட்டமிட்ட ஒன்றிணைப்பு ரத்து செய்யப்பட்டது.',
    scheduleCount: '{{count}} திட்டமிடப்பட்டது',
    scheduledMerges: 'திட்டமிட்ட ஒன்றிணைப்புகள்',
    scheduledToMerge: 'ஒன்றிணைக்க திட்டமிடப்பட்டது',
    scheduledToMergeOn: 'இந்தக் கிளை {{date}}-ல் ஒன்றிணைக்க திட்டமிடப்பட்டுள்ளது.',
    scheduleHasNothingLeft:
      'பயன்படுத்த எதுவும் இல்லை — இந்த மாற்றங்கள் நிராகரிக்கப்பட்டன அல்லது ஏற்கனவே ஒன்றிணைக்கப்பட்டன.',
    scheduleMerge: 'ஒன்றிணைப்பை திட்டமிடு',
    scheduleMergeHelp:
      'நீங்கள் தேர்ந்தெடுத்த நேரத்தில் ஒன்றிணைப்பு இயங்கும், அப்போது உங்கள் அனுமதிகள் மீண்டும் சரிபார்க்கப்படும்.',
    scheduleWillApplyAll: 'நிலுவையில் உள்ள அனைத்தையும் பயன்படுத்தும் ({{count}})',
    scheduleWillApplySelected: 'தேர்ந்தெடுத்த {{count}} மாற்றங்களைப் பயன்படுத்தும்',
    scheduling: 'திட்டமிடுகிறது…',
    searchBranches: 'கிளைகளைத் தேடு',
    selectBranch: 'கிளையைத் தேர்ந்தெடு',
    untouchedDocumentsNote:
      'இந்த கிளையில் நீங்கள் மாற்றம் செய்யாத ஆவணங்கள், அந்த கிளை உருவாக்கப்பட்ட போது எடுத்த ஸ்நாப்ஷாட் அல்ல, main இன் தற்போதைய உள்ளடக்கத்தைக் காட்டுகின்றன.',
  },
  commandPalette: {
    actions: 'செயல்கள்',
  ...
  error: {
    ...
    fileFetchFailed: 'கோப்பைப் பெறுவதில் தோல்வி ஏற்பட்டது.',
    ...
    noFileFoundInClipboard: 'பலகையில் எந்தக் கோப்பும் காணப்படவில்லை.',
    ...
    unableToReadClipboard: 'கிளிப்போர்டிலிருந்து படிக்க முடியவில்லை.',
    ...
    urlNotAllowed: 'வழங்கப்பட்ட URL அனுமதிக்கப்படவில்லை.',
  ...
  general: {
    ...
    deletedAgo: '{{distance}} முன்பு நீக்கப்பட்டது',
  ...
  upload: {
    ...
    fromURL: 'URL-ில் இருந்து கோப்பை பதிவேற்று',
    height: 'உயரம்',
