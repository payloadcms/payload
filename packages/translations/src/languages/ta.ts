...
export const taTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    apiKey: 'API விசை',
    apiKeyGeneratedOnSave: 'நீங்கள் சேமிக்கும் போது ஒரு API key உருவாக்கப்படுகிறது.',
    apiKeyIsHidden:
      'இந்த API விசை ஒருவழி ஹாஷாக சேமிக்கப்பட்டுள்ளது மற்றும் மீண்டும் காட்ட முடியாது. உங்களிடம் இல்லை என்றால் புதியதாக உருவாக்கவும்.',
    ...
    copyAPIKeyNow: 'இந்த API விசையை இப்போது நகலெடுக்கவும். இது மீண்டும் காட்டப்படவில்லை.',
