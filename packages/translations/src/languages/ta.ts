...
export const taTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset:
      'இந்தச் செயல் நீங்கள் இந்த முன்அமைவிலிருந்து பூட்டப்படுவதற்கு வழிவகுக்கும்.',
    attachmentContentInvalid: 'இணைப்பு உள்ளடக்கம் ஒரு சரம் அல்லது பஃபராக இருக்க வேண்டும்',
    attachmentMissingContentAndPath: 'இணைப்பில் உள்ளடக்கம் மற்றும் பாதை இரண்டும் காணப்படவில்லை',
    attachmentMissingFilename: 'இணைப்பில் கோப்புப் பெயர் காணப்படவில்லை',
    authenticationRequiredForExport: 'ஏற்றுமதிகளை உருவாக்க பயனர் அங்கீகாரம் தேவை.',
    autosaving: 'இந்த ஆவணத்தை தானாகச் சேமிக்கும் போது ஒரு பிரச்சனை ஏற்பட்டது.',
    busboyMultipartError: 'பல்பகுதி கோரிக்கையை பகுப்பாய்வு செய்வதில் Busboy பிழை',
    collectionSlugRequired: 'தொகுப்பு slug தேவை',
    contentTypeExpectedJSON: 'Content-Type application/json ஆக எதிர்பார்க்கப்படுகிறது',
    ...
    eitherCollectionOrGlobalRequired: 'தொகுப்பு அல்லது globalSlug ஒன்று அனுப்பப்பட வேண்டும்.',
    emailOrPasswordIncorrect: 'கொடுக்கப்பட்ட மின்னஞ்சல் அல்லது கடவுச்சொல் தவறானது.',
    expectedResponseFromUploadHandler: 'பதிவேற்ற கையாளியிலிருந்து பதில் எதிர்பார்க்கப்படுகிறது.',
    failedToFetchFromURL: 'வழங்கப்பட்ட URL இலிருந்து கோப்பை பெற முடியவில்லை.',
    failedToResetLayout: 'ஒழுங்கமைப்பை மீட்டமைக்க முடியவில்லை.',
    failedToSaveLayout: 'ஏற்கப்படவில்லை அமைப்பு சேமிக்க.',
    fieldMustBeSpecified: 'புலம் குறிப்பிடப்பட வேண்டும்',
    fieldsNotInitialized: 'புலங்கள் துவக்கப்படவில்லை.',
    filenameRequired: 'கோப்புப் பெயர் தேவை.',
    ...
    invalidFilename: 'செல்லுபடியற்ற கோப்புப் பெயர்',
    invalidFileType: 'செல்லுபடியற்ற கோப்பு வகை',
    invalidFileTypeValue: 'செல்லுபடியற்ற கோப்பு வகை: {{value}}',
    invalidFileURL: 'செல்லுபடியற்ற கோப்பு url',
    invalidJSON: 'செல்லுபடியற்ற JSON',
    invalidJSONFormat: 'செல்லுபடியற்ற JSON வடிவம்',
    invalidRequestArgs: 'விண்ணப்பத்தில் தவறான அளவுருக்கள் அனுப்பப்பட்டுள்ளன: {{args}}',
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'இணைப்பு புலங்களை வரிசைகள், தொகுதிகள் அல்லது உலகளாவியவற்றில் சேர்க்க முடியாது.',
    ...
    missingIDOfVersionToRestore: 'மீட்டெடுக்க வேண்டிய பதிப்பின் ID காணப்படவில்லை.',
    missingRequiredData: 'தேவையான தரவு காணப்படவில்லை.',
    noConnectionToDatabase: 'தரவுத்தளத்திற்கு இணைப்பு இல்லாத போது beginTransaction அழைக்கப்பட்டது',
    noFileDataForImport: 'இறக்குமதிக்கு கோப்பு தரவு வழங்கப்படவில்லை',
    noFilesUploaded: 'எந்தக் கோப்புகளும் பதிவேற்றப்படவில்லை.',
    noMatchedField: '"{{label}}" க்கான பொருத்தமான புலம் கிடைக்கவில்லை.',
    noPayloadProvided: 'Payload வழங்கப்படவில்லை',
    ...
    notSupported: 'ஆதரவளிக்கப்படவில்லை',
    noUser: 'பயனர் இல்லை',
    orderableJoinsMustTargetSingleCollection:
      'வரிசைப்படுத்தக்கூடிய இணைப்புகள் ஒரே தொகுப்பை இலக்காகக் கொண்டிருக்க வேண்டும்',
    pastingFromURLNotEnabled: 'இந்த தொகுப்பில் URL இலிருந்து ஒட்டுவது இயக்கப்படவில்லை.',
    ...
    redirectTargetNotAllowed: 'திசைதிருப்பல் இலக்கு அனுமதிக்கப்படவில்லை.',
    relationshipFieldNotFound: 'உறவு புலம் காணப்படவில்லை',
    relationshipNotFound: 'உறவு காணப்படவில்லை',
    requestDataRequired: 'கோரிக்கை தரவு தேவை.',
    requestNotEligibleForFileUpload: 'கோரிக்கை கோப்பு பதிவேற்றத்திற்கு தகுதியற்றது',
    requestURLMissing: 'கோரிக்கை URL காணப்படவில்லை.',
    restoringTitle:
    ...
    tooManyRedirects: 'அதிகமான திசைதிருப்பல்கள்.',
    ...
    unexpectedArrayCollectionSlug: 'எதிர்பாராத collectionSlug வரிசை, parent வழங்கப்பட வேண்டும்',
    unknown: 'அறியப்படாத பிழை ஏற்பட்டுள்ளது.',
    unPublishingDocument: 'இந்த ஆவணத்தை வெளியீட்டிலிருந்து நீக்கும் போது பிழை ஏற்பட்டது.',
    unreachable: 'அணுக முடியாதது',
    unspecific: 'ஒரு பிழை ஏற்பட்டுள்ளது.',
    unverifiedEmail: 'உள்நுழைவதற்கு முன் உங்கள் மின்னஞ்சலைச் சரிபார்க்கவும்.',
    uploadConfigHandlersMissing: '{{collection}} க்கு uploadConfig.handlers இல்லை',
    uploadthingUnknownError: 'uploadthing மூலம் கோப்பை பதிவேற்றுவதில் பிழை: அறியப்படாத பிழை',
    ...
    userRequiredForImport: 'இறக்குமதி செயல்பாடுகளுக்கு பயனர் தேவை',
    validURLRequired: 'சரியான URL சரம் தேவை.',
    valueMustBeUnique: 'மதிப்பு தனித்துவமானதாக இருக்க வேண்டும்.',
    vercelBlobUploadError: 'storage-vercel-blob கிளையண்ட் பதிவேற்ற வழித்தடம் பிழை',
