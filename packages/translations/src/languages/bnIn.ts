...
export const bnInTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    beginCreateFirstUser: 'শুরু করার জন্য আপনার প্রথম ব্যবহারকারী তৈরি করুন।',
  ...
  branching: {
    ...
    untouchedDocumentsNote:
      'এই ব্রাঞ্চে আপনি যেসব Document পরিবর্তন করেননি, সেগুলোতে মূল শাখার (main) বর্তমান কনটেন্ট দেখাবে, ব্রাঞ্চ তৈরির সময়ের কোনো স্ন্যাপশট নয়।',
  },
  commandPalette: {
    actions: 'কর্মসমূহ',
  ...
  error: {
    ...
    noFileFoundInClipboard: 'ক্লিপবোর্ডে কোনো ফাইল পাওয়া যায়নি।',
