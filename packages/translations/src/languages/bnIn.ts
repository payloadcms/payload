...
export const bnInTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'টাইপ শনাক্তকরণের জন্য আপলোড করা ফাইল পড়া যায়নি।',
    couldNotReadFileForValidation: 'যাচাইয়ের জন্য আপলোডকৃত ফাইলটি পড়া যায়নি।',
    crop: 'ক্রপ করুন',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'ফাইলের ধরণ {{mimeType}} (এক্সটেনশন {{extension}} থেকে) অনুমোদিত নয়।',
    focalPoint: 'ফোকাল পয়েন্ট',
    focalPointDescription: 'প্রিভিউতে সরাসরি ফোকাল পয়েন্ট টানুন বা নিচের মানগুলি সামঞ্জস্য করুন।',
    height: 'উচ্চতা',
    invalidMimeType: 'অবৈধ MIME প্রকার: {{mimeType}}.',
    invalidOrCorruptedPDF: 'অবৈধ বা বিকৃত PDF ফাইল।',
    lessInfo: 'কম তথ্য',
    moreInfo: 'আরও তথ্য',
    ...
    restrictedFileType:
      "ফাইলের ধরন '{{mimeType}}' {{fileName}}-এর জন্য অনুমোদিত নয়: সীমিত ফাইলের ধরন শনাক্ত হয়েছে — এই সংগ্রহের জন্য এই যাচাইকরণটি বাদ দিতে 'allowRestrictedFileTypes' মানটি true করুন।",
    ...
    svgHarmfulContent: 'SVG ফাইলটিতে সম্ভাব্য ক্ষতিকারক উপাদান থাকতে পারে।',
    width: 'প্রস্থ',
  },
  validation: {
