...
export const bnInTranslations: DefaultTranslationsObject = {
  ...
  version: {
    ...
    aboutToUnpublishIn: 'আপনি এই দস্তাবেজটি {{locale}} তে অপ্রকাশিত করতে চলেছেন। আপনি কি নিশ্চিত?',
    ...
    revertUnsuccessful:
      'পূর্বের প্রকাশিত ভার্সন পাওয়া যায়নি, তাই পূর্ববর্তীর অবস্থায় ফেরা যাওয়া সম্ভব হয়নি।',
