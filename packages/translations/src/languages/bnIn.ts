...
export const bnInTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'এই কাজটি আপনাকে এই প্রিসেট থেকে লক আউট করবে।',
    attachmentContentInvalid: 'সংযুক্তির বিষয়বস্তু একটি স্ট্রিং অথবা বাফার হতে হবে',
    attachmentMissingContentAndPath: 'সংযুক্তিতে বিষয়বস্তু এবং পাথ উভয়ই অনুপস্থিত',
    attachmentMissingFilename: 'সংযুক্তিতে ফাইলের নাম অনুপস্থিত',
    ...
    busboyMultipartError: 'মাল্টিপার্ট অনুরোধ পার্স করতে Busboy ত্রুটি',
    collectionSlugRequired: 'সংগ্রহ স্লাগ প্রয়োজন',
    contentTypeExpectedJSON: 'Content-Type application/json হওয়া প্রত্যাশিত',
    ...
    eitherCollectionOrGlobalRequired: 'সংগ্রহ বা globalSlug অবশ্যই পাস করতে হবে।',
    ...
    fieldMustBeSpecified: 'ক্ষেত্র অবশ্যই নির্দিষ্ট করতে হবে',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'জয়েন ক্ষেত্রগুলি অ্যারে, ব্লক বা গ্লোবালে যোগ করা যায় না।',
    ...
    missingIDOfVersionToRestore: 'পুনরুদ্ধার করার জন্য সংস্করণের ID অনুপস্থিত।',
    missingRequiredData: 'প্রয়োজনীয় ডেটা নেই।',
    noConnectionToDatabase:
      'ডাটাবেসের সাথে কোনো সংযোগ না থাকা অবস্থায় beginTransaction কল করা হয়েছে',
    ...
    orderableJoinsMustTargetSingleCollection:
      'অর্ডারযোগ্য জয়েনগুলি অবশ্যই একটি একক সংগ্রহকে লক্ষ্য করতে হবে',
    pastingFromURLNotEnabled: 'এই সংগ্রহের জন্য URL থেকে পেস্ট করা সক্ষম করা নেই।',
    ...
    requestNotEligibleForFileUpload: 'অনুরোধটি ফাইল আপলোডের জন্য যোগ্য নয়',
    requestURLMissing: 'অনুরোধ URL অনুপস্থিত।',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug:
      'collectionSlug এর অপ্রত্যাশিত অ্যারে, প্যারেন্ট অবশ্যই প্রদান করতে হবে',
