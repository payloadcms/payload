...
export const bgTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Това действие ще ви блокира от тази предварителна настройка.',
    attachmentContentInvalid: 'Съдържанието на прикачения файл трябва да бъде текст или буфер',
    attachmentMissingContentAndPath: 'Прикаченият файл няма нито съдържание, нито път',
    attachmentMissingFilename: 'Прикаченият файл няма име на файл',
    authenticationRequiredForExport:
      'Изисква се удостоверяване на потребител за създаване на експорти.',
    autosaving: 'Имаше проблем в автоматичното запазване на този документ.',
    busboyMultipartError: 'Busboy грешка при анализ на multipart заявка',
    collectionSlugRequired: 'Изисква се slug на колекцията',
    contentTypeExpectedJSON: 'Content-Type трябва да бъде application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Трябва да бъде предоставена колекция или globalSlug.',
    emailOrPasswordIncorrect: 'Имейлът или паролата не са правилни.',
    expectedResponseFromUploadHandler: 'Очакван отговор от обработчика за качване.',
    failedToFetchFromURL: 'Неуспешно извличане на файла от предоставения URL.',
    failedToResetLayout: 'Неуспешно нулиране на оформлението.',
    failedToSaveLayout: 'Неуспешно запазване на оформлението.',
    fieldMustBeSpecified: 'Полето трябва да бъде указано',
    fieldsNotInitialized: 'Полетата не са инициализирани.',
    filenameRequired: 'Изисква се име на файл.',
    ...
    missingIDOfVersionToRestore: 'Липсва идентификатор на версия за възстановяване.',
    missingRequiredData: 'Липсва задължителна информация.',
    noConnectionToDatabase: 'beginTransaction извикан без връзка с базата данни',
    noFileDataForImport: 'Няма предоставени файлови данни за импортиране',
    noFilesUploaded: 'Никакви файлове не бяха качени.',
    noMatchedField: 'Поле не беше открито за "{{label}}"',
    noPayloadProvided: 'Не е предоставен payload',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Подреждаемите join трябва да са насочени към една колекция',
    pastingFromURLNotEnabled: 'Поставянето от URL не е активирано за тази колекция.',
    ...
    redirectTargetNotAllowed: 'Целта на пренасочването не е разрешена.',
    relationshipFieldNotFound: 'Полето за връзка не е намерено',
    relationshipNotFound: 'Връзката не е намерена',
    requestDataRequired: 'Изискват се данни за заявката.',
    requestNotEligibleForFileUpload: 'Заявката не отговаря на условията за качване на файл',
    requestURLMissing: 'URL на заявката липсва.',
    restoringTitle:
    ...
    tooManyRedirects: 'Твърде много пренасочвания.',
    ...
    unexpectedArrayCollectionSlug:
      'Неочакван масив от collectionSlug, родителят трябва да бъде предоставен',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers липсва за {{collection}}',
    uploadthingUnknownError: 'Грешка при качване на файл с uploadthing: Неизвестна грешка',
    urlNotAllowed: 'Предоставеният URL не е разрешен.',
    ...
    userRequiredForImport: 'Изисква се потребител за операции по импортиране',
    validURLRequired: 'Изисква се валиден URL.',
    valueMustBeUnique: 'Стойността трябва да е уникална',
    vercelBlobUploadError: 'Грешка при качване на storage-vercel-blob клиент',
