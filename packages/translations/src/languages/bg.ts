...
export const bgTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Документи',
    draftsHint: 'Скорошните ви чернови ще се показват тук',
    dropFiles: 'Пуснете файловете за качване',
    editDashboard: 'Редактирай таблото',
    editingDashboard: 'Редактиране на таблото',
    gridView: 'Изглед в мрежа',
    listView: 'Изглед в списък',
    loadError: 'Някои документи не можаха да бъдат заредени. Опреснете страницата.',
    noDrafts: 'Няма скорошни чернови',
    noItems:
      'Няма джаджи на таблото ви. Можете да ги добавите от менюто "Табло", което е разположено в горната лента.',
    noPinned: 'Няма закачени документи',
    noRecents: 'Няма наскоро прегледани документи',
    pinDocument: 'Закачи {{title}}',
    pinned: 'Закачени',
    pinnedHint: 'Закачените документи ще се показват тук',
    recentDrafts: 'Скорошни чернови',
    recentlyViewed: 'Наскоро прегледани',
    recentsHint: 'Прегледаните документи ще се показват тук',
    resetLayout: 'Рестартирай Оформлението',
    saveError: 'Настройката на таблото не можа да бъде запазена. Опитайте отново.',
    searchWidgets: 'Търсене на джаджи...',
    unpinDocument: 'Откачи {{title}}',
    updatedBy: 'Обновено от',
    uploadDropzone: 'Област за качване',
    uploadFiles: 'Качване на файлове',
    uploadHint: 'Плъзнете файлове от компютъра или натиснете бутона по-долу',
    viewMode: 'Изглед на документите',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Подравняване на заглавката и контролите',
    all: 'Всички',
    ...
    editViewWidth: 'Ширина на изгледа за редактиране',
    editViewWidthFull: 'Пълна',
    email: 'Имейл',
