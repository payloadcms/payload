...
export const bgTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Копиране',
    copyWarning:
      'Предстои да копирате данни от {{from}} към {{to}}. Това ще замени всички съществуващи {{to}} данни и ще ви пренасочи да продължите редактирането на този локал. Сигурни ли сте, че искате да продължите?',
    create: 'Създай',
    created: 'Създаден',
