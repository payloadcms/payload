...
export const bgTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    noResultsFound:
      'Спазвайте значенията на оригиналния текст в контекста на Payload. Ето списък с общи термини в Payload, които имат много конкретни значения:\n    - Колекция: Колекция е група от документи, които споделят обща структура и цел. Колекциите се използват за организиране и управление на съдържанието в Payload.\n    - Поле: Полето е конкретна част',
