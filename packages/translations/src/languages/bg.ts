...
export const bgTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'Имейлът беше успешно потвърден. Пренасочваме ви към вход...',
  ...
  branching: {
    andMoreChanges: 'още {{count}} промени',
    branch: 'Клон',
    branchClosed: 'Този клон е затворен. Запазва се като запис на това, което е слял.',
    branchDescription: 'Описание на клона',
    branchedFrom: 'Отклонен от',
    branches: 'Клонове',
    branchHistory: 'История на клона',
    branchMerging: 'Сливане',
    branchName: 'Име на клона',
    branchSettings: 'Настройки на клона',
    cancelSchedule: 'Отмяна на обединяването',
    changedDocuments: 'Променени документи',
    changesTo: 'Промени по {{summary}}',
    closeBranchAfterMerge: 'Затвори този клон след сливането',
    closeBranchHelpOff:
      'Клонът остава отворен, така че можете да продължите да работите по него и да го слеете отново по-късно.',
    closeBranchHelpOn: 'Клонът ще стане само за четене и няма да може да бъде слят отново.',
    confirmDiscardAll:
      'Всички {{count}} променени документа в този клон ще бъдат върнати към състоянието им в main. Това не може да бъде отменено.',
    confirmDiscardSelected:
      '{{count}} променени документа ще бъдат върнати към състоянието им в main. Това не може да бъде отменено.',
    createAndSwitch: 'Създай и премини',
    createNewBranch: 'Създай нов клон',
    currentChanges: 'Текущи промени',
    defaultBranch: 'по подразбиране',
    discardAll: 'Отхвърли всички ({{count}})',
    discardChanges: 'Отхвърли промените',
    discardedCount: 'Отхвърлени промени: {{count}}.',
    discarding: 'Отхвърляне…',
    discardSelected: 'Отхвърли избраните ({{count}})',
    historyPageOf: 'Страница {{page}} от {{total}}',
    manage: 'Управление',
    manageBranches: 'Управление на клонове…',
    merge: 'Сливане',
    mergeAllChanges: 'Ще бъдат приложени всички промени в този клон.',
    mergeAllCount: 'Ще бъдат приложени всички {{count}} променени документа в този клон.',
    mergeBranchInto: 'Сливане на {{branch}} в {{target}}',
    mergeChanges: 'Сливане на промените',
    mergeComplete: 'Сливането е завършено',
    merged: 'Слят',
    mergedByCount: '{{count}} документа от {{user}}',
    mergedCount: 'Слети промени: {{count}}.',
    mergedOfTotal: 'Слети {{current}} от {{total}}',
    mergedOn: 'Слято на {{date}}',
    mergeHistory: 'История на сливанията',
    mergeInterrupted: 'Сливането беше прекъснато и нищо не беше приложено. Опитайте отново.',
    mergeNow: 'Слей сега',
    mergeOnlySelected: 'Изберете кои промени да бъдат слети',
    mergeScheduledFor: 'Сливането е планирано за {{date}}.',
    mergeSelectedOfTotal: 'Ще бъдат приложени {{selected}} от {{total}} променени документа.',
    mergeStarting: 'Стартиране на сливането…',
    merging: 'Сливане…',
    mergingProgress: 'Сливане на {{current}} от {{total}}',
    noChangesYet: 'Все още няма промени в този клон.',
    operation_create: 'Създаден',
    operation_delete: 'Изтрит',
    operation_update: 'Обновен',
    reviewingChangedDocuments: 'Преглед на променените документи',
    scheduleAnotherMerge: 'Планирай друго сливане',
    scheduleCancelled: 'Планираното сливане е отменено.',
    scheduleCount: '{{count}} планирани',
    scheduledMerges: 'Планирани сливания',
    scheduledToMerge: 'Сливането е планирано',
    scheduledToMergeOn: 'Този клон е планиран за сливане на {{date}}.',
    scheduleHasNothingLeft:
      'Няма какво повече да се приложи — тези промени бяха отхвърлени или вече слети.',
    scheduleMerge: 'Планирай сливане',
    scheduleMergeHelp:
      'Сливането се изпълнява в избрания час, а правата ви се проверяват отново тогава.',
    scheduleWillApplyAll: 'Ще приложи всичко чакащо ({{count}})',
    scheduleWillApplySelected: 'Ще приложи {{count}} избрани промени',
    scheduling: 'Планиране…',
    searchBranches: 'Търсене в клонове',
    selectBranch: 'Изберете клон',
    untouchedDocumentsNote:
      'Документите, които не сте променяли в този клон, показват текущото съдържание на main, а не моментна снимка от момента на създаване на клона.',
  },
  commandPalette: {
    actions: 'Действия',
  ...
  error: {
    ...
    fileFetchFailed: 'Неуспешно зареждане на файла.',
    ...
    noFileFoundInClipboard: 'Не е намерен файл в клипборда.',
    ...
    unableToReadClipboard: 'Неуспешно четене от клипборда.',
    ...
    urlNotAllowed: 'Предоставеният URL адрес не е разрешен.',
  ...
  fields: {
    ...
    hidePassword: 'Скриване на парола',
    ...
    showPassword: 'Показване на парола',
  ...
  general: {
    ...
    delete: 'Изтрий',
    deleted: 'Изтрито',
    deletedAgo: 'Изтрито преди {{distance}}',
