...
export const bgTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    confirm: 'Потвърди',
    confirmCopy: 'Потвърдете копирането',
    ...
    copying: 'Копиране',
    copyWarning:
      'Предстои да копирате данни от {{from}} в {{to}}. Това ще презапише вече съществуващите данни в {{to}} и ще ви пренасочи да продължите редактирането в това локация. Сигурни ли сте, че искате да продължите?',
    create: 'Създай',
    created: 'Създаден',
