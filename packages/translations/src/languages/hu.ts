...
export const huTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    beginCreateFirstUser: 'Hozza létre első felhasználóját a kezdéshez.',
  ...
  branching: {
    andMoreChanges: 'további {{count}} változás',
    branch: 'Ág',
    branchClosed: 'Ez az ág le van zárva. Megmarad annak nyilvántartásaként, amit egyesített.',
    branchDescription: 'Ág leírása',
    branchedFrom: 'Leágazva innen',
    branches: 'Ágak',
    branchHistory: 'Ág előzményei',
    branchMerging: 'Egyesítés',
    branchName: 'Ág neve',
    branchSettings: 'Ág beállításai',
    cancelSchedule: 'Összefűzés visszavonása',
    changedDocuments: 'Módosított dokumentumok',
    changesTo: 'Változások: {{summary}}',
    closeBranchAfterMerge: 'Az ág lezárása az egyesítés után',
    closeBranchHelpOff:
      'Az ág nyitva marad, így tovább dolgozhat rajta, és később újra egyesítheti.',
    closeBranchHelpOn: 'Az ág csak olvashatóvá válik, és nem lehet újra egyesíteni.',
    confirmDiscardAll:
      'Az ágon lévő mind a {{count}} módosított dokumentum visszaáll a main állapotára. Ez nem vonható vissza.',
    confirmDiscardSelected:
      '{{count}} módosított dokumentum visszaáll a main állapotára. Ez nem vonható vissza.',
    createAndSwitch: 'Létrehozás és váltás',
    createNewBranch: 'Új ág létrehozása',
    currentChanges: 'Jelenlegi változások',
    defaultBranch: 'alapértelmezett',
    discardAll: 'Összes elvetése ({{count}})',
    discardChanges: 'Változások elvetése',
    discardedCount: '{{count}} változás elvetve.',
    discarding: 'Elvetés…',
    discardSelected: 'Kijelöltek elvetése ({{count}})',
    historyPageOf: '{{page}}. oldal / {{total}}',
    manage: 'Kezelés',
    manageBranches: 'Ágak kezelése…',
    merge: 'Egyesítés',
    mergeAllChanges: 'Az ág összes változása érvénybe lép.',
    mergeAllCount: 'Az ágon lévő mind a {{count}} módosított dokumentum érvénybe lép.',
    mergeBranchInto: '{{branch}} egyesítése a {{target}} ágba',
    mergeChanges: 'Változások egyesítése',
    mergeComplete: 'Egyesítés befejeződött',
    merged: 'Egyesített',
    mergedByCount: '{{count}} dokumentum – {{user}}',
    mergedCount: '{{count}} változás egyesítve.',
    mergedOfTotal: '{{current}} / {{total}} egyesítve',
    mergedOn: 'Egyesítve: {{date}}',
    mergeHistory: 'Egyesítési előzmények',
    mergeInterrupted: 'Az egyesítés megszakadt, és semmi nem lépett érvénybe. Próbálja újra.',
    mergeNow: 'Egyesítés most',
    mergeOnlySelected: 'Válassza ki, mely változások legyenek egyesítve',
    mergeScheduledFor: 'Egyesítés időzítve: {{date}}.',
    mergeSelectedOfTotal: '{{selected}} / {{total}} módosított dokumentum lép érvénybe.',
    mergeStarting: 'Egyesítés indítása…',
    merging: 'Egyesítés…',
    mergingProgress: 'Egyesítés: {{current}} / {{total}}',
    noChangesYet: 'Ezen az ágon még nincsenek változások.',
    operation_create: 'Létrehozva',
    operation_delete: 'Törölve',
    operation_update: 'Frissítve',
    reviewingChangedDocuments: 'Módosított dokumentumok áttekintése',
    scheduleAnotherMerge: 'Újabb egyesítés időzítése',
    scheduleCancelled: 'Időzített egyesítés visszavonva.',
    scheduleCount: '{{count}} időzítve',
    scheduledMerges: 'Időzített egyesítések',
    scheduledToMerge: 'Egyesítés időzítve',
    scheduledToMergeOn: 'Ez az ág {{date}} időpontban lesz egyesítve.',
    scheduleHasNothingLeft:
      'Nincs már mit alkalmazni — ezeket a változásokat elvetették, vagy már egyesítették.',
    scheduleMerge: 'Egyesítés időzítése',
    scheduleMergeHelp:
      'Az egyesítés a megadott időben fut le, és a jogosultságait akkor újra ellenőrizzük.',
    scheduleWillApplyAll: 'Mindent alkalmaz, ami várakozik ({{count}})',
    scheduleWillApplySelected: '{{count}} kijelölt változást alkalmaz',
    scheduling: 'Időzítés…',
    searchBranches: 'Ágak keresése',
    selectBranch: 'Ág kiválasztása',
    untouchedDocumentsNote:
      'Azok a Dokumentumok, amelyeken ezen az ágon nem történt módosítás, a main jelenlegi tartalmát mutatják, nem pedig az ág létrehozásának időpontjában készült pillanatképet.',
  },
  commandPalette: {
    actions: 'Műveletek',
  ...
  error: {
    ...
    fileFetchFailed: 'A fájl lekérése sikertelen.',
    ...
    noFileFoundInClipboard: 'Nem található fájl a vágólapon.',
    ...
    unableToReadClipboard: 'Nem sikerült olvasni a vágólapról.',
    ...
    urlNotAllowed: 'A megadott URL nem engedélyezett.',
  ...
  general: {
    ...
    delete: 'Törlés',
    deleted: 'Törölt',
    deletedAgo: 'Törölve: {{distance}} ezelőtt',
    ...
    updatedAgo: 'Frissítve {{distance}} ezelőtt',
    updatedAt: 'Frissítve:',
  ...
  upload: {
    ...
    fromURL: 'Fájl feltöltése URL-ről',
    height: 'Magasság',
