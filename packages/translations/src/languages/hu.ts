...
export const huTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    draftsHint: 'A legutóbbi piszkozataid itt jelennek meg',
    dropFiles: 'Ejtse ide a feltöltendő fájlokat',
    editDashboard: 'Műszerfal szerkesztése',
    editingDashboard: 'Szerkesztési irányítópult',
    gridView: 'Rácsnézet',
    listView: 'Listanézet',
    loadError:
      'Egyes dokumentumokat nem sikerült betölteni. Frissítsd az oldalt az újrapróbálkozáshoz.',
    noDrafts: 'Nincsenek újabb piszkozatok',
    noItems:
      'Nincsenek widgetek az irányítópulton. Hozzáadhatja őket a felső sávban található "Irányítópult" menüből.',
    noPinned: 'Nincsenek rögzített dokumentumok',
    noRecents: 'Nincsenek nemrég megtekintett dokumentumok',
    pinDocument: '{{title}} rögzítése',
    pinned: 'Rögzítettek',
    pinnedHint: 'A rögzített dokumentumok itt jelennek meg',
    recentDrafts: 'Legutóbbi piszkozatok',
    recentlyViewed: 'Nemrég megtekintett',
    recentsHint: 'A megtekintett dokumentumok itt jelennek meg',
    resetLayout: 'Alaphelyzet visszaállítása',
    saveError: 'Nem sikerült menteni a vezérlőpult beállítását. Próbáld újra.',
    searchWidgets: 'Keresés widgetek...',
    unpinDocument: '{{title}} rögzítésének feloldása',
    updatedBy: 'Frissítette',
    uploadDropzone: 'Feltöltési terület',
    uploadFiles: 'Fájlok feltöltése',
    uploadHint: 'Húzz ide fájlokat a számítógépedről, vagy kattints az alábbi gombra',
    viewMode: 'Dokumentumnézet',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Fejléc és vezérlők igazítása',
    all: 'Mind',
    ...
    editViewWidth: 'Szerkesztőnézet szélessége',
    editViewWidthFull: 'Teljes',
    email: 'E-mail',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Szövegméretek',
    typeSizeSmall: 'Jelenlegi',
