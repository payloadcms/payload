...
export const huTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    confirm: 'Megerősítés',
    confirmCopy: 'Megerősített másolat',
    ...
    copying: 'Másolás',
    copyWarning:
      'Ön arra készül, hogy adatokat másoljon a {{from}}-ról a {{to}}-ra. Ez felülírja a meglévő {{to}} adatokat, és átirányítja Önt, hogy folytassa ennek a helységnek a szerkesztését. Biztosan folytatni szeretné?',
    create: 'Létrehozás',
    created: 'Létrehozva',
