...
export const huTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Ez a művelet kizárja Önt ebből az előbeállításból.',
    attachmentContentInvalid: 'A melléklet tartalmának karakterláncnak vagy puffernek kell lennie',
    attachmentMissingContentAndPath: 'A mellékletből hiányzik mind a tartalom, mind az elérési út',
    attachmentMissingFilename: 'A mellékletből hiányzik a fájlnév',
    authenticationRequiredForExport:
      'Az exportálás létrehozásához felhasználói hitelesítés szükséges.',
    autosaving: 'Hiba történt a dokumentum automatikus mentése közben.',
    busboyMultipartError: 'Busboy hiba a többrészes kérés elemzésekor',
    collectionSlugRequired: 'A gyűjtemény azonosító kötelező',
    contentTypeExpectedJSON: 'A Content-Type értékének application/json-nak kell lennie',
    ...
    eitherCollectionOrGlobalRequired: 'A gyűjtemény vagy a globalSlug megadása kötelező.',
    emailOrPasswordIncorrect: 'A megadott e-mail-cím vagy jelszó helytelen.',
    expectedResponseFromUploadHandler: 'Válasz várt a feltöltéskezelőtől.',
    failedToFetchFromURL: 'Nem sikerült letölteni a fájlt a megadott URL-ről.',
    failedToResetLayout: 'A felület visszaállítása sikertelen.',
    failedToSaveLayout: 'Nem sikerült menteni az elrendezést.',
    fieldMustBeSpecified: 'a mező megadása kötelező',
    fieldsNotInitialized: 'A mezők nincsenek inicializálva.',
    filenameRequired: 'Fájlnév megadása kötelező.',
    ...
    invalidFileURL: 'Érvénytelen fájl URL',
    invalidJSON: 'Érvénytelen JSON',
    invalidJSONFormat: 'Érvénytelen JSON formátum',
    invalidRequestArgs: 'Érvénytelen argumentumok a kérésben: {{args}}',
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Kapcsoló mezők nem adhatók hozzá tömbökhoz, blokkokhoz vagy globálisokhoz.',
    ...
    missingIDOfVersionToRestore: 'Hiányzik a visszaállítandó verzió azonosítója.',
    missingRequiredData: 'Hiányoznak kötelező adatok.',
    noConnectionToDatabase:
      'A beginTransaction hívása megtörtént, miközben nincs kapcsolat az adatbázissal',
    noFileDataForImport: 'Nincs megadva fájladat az importáláshoz',
    noFilesUploaded: 'Nem került fájl feltöltésre.',
    noMatchedField: 'Nem található egyező mező a következőhöz: "{{label}}"',
    noPayloadProvided: 'Nem lett megadva hasznos adat',
    ...
    orderableJoinsMustTargetSingleCollection:
      'A rendezhető kapcsolóknak egyetlen gyűjteményt kell megcélozniuk',
    pastingFromURLNotEnabled:
      'Az URL-ről történő beillesztés nincs engedélyezve ehhez a gyűjteményhez.',
    ...
    redirectTargetNotAllowed: 'Az átirányítási cél nem engedélyezett.',
    relationshipFieldNotFound: 'A kapcsolat mező nem található',
    relationshipNotFound: 'A kapcsolat nem található',
    requestDataRequired: 'Kérési adatok megadása kötelező.',
    requestNotEligibleForFileUpload: 'A kérés nem jogosult fájlfeltöltésre',
    requestURLMissing: 'A kérés URL hiányzik.',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug: 'Váratlan collectionSlug tömb, a szülőt meg kell adni',
    ...
    uploadConfigHandlersMissing: 'Az uploadConfig.handlers nincs jelen a(z) {{collection}} számára',
    uploadthingUnknownError:
      'Hiba történt a fájl feltöltésekor az uploadthing segítségével: Ismeretlen hiba',
    ...
    userRequiredForImport: 'Felhasználó szükséges az importálási műveletekhez',
    validURLRequired: 'Érvényes URL karakterlánc megadása kötelező.',
    valueMustBeUnique: 'Az értéknek egyedinek kell lennie',
    vercelBlobUploadError: 'storage-vercel-blob kliens feltöltési útvonal hiba',
