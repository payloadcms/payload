...
export const etTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'E-post on edukalt kinnitatud. Suuname teid sisse logima...',
  ...
  branching: {
    andMoreChanges: 'veel {{count}} muudatust',
    branch: 'Haru',
    branchClosed: 'See haru on suletud. See säilitatakse kirjena selle kohta, mis ühendati.',
    branchDescription: 'Haru kirjeldus',
    branchedFrom: 'Hargnes harust',
    branches: 'Harud',
    branchHistory: 'Haru ajalugu',
    branchMerging: 'Ühendamine',
    branchName: 'Haru nimi',
    branchSettings: 'Haru seaded',
    cancelSchedule: 'Tühista liitmine',
    changedDocuments: 'Muudetud dokumendid',
    changesTo: 'Muudatused: {{summary}}',
    closeBranchAfterMerge: 'Sulge see haru pärast ühendamist',
    closeBranchHelpOff:
      'Haru jääb avatuks, nii et saate sellega edasi töötada ja hiljem uuesti ühendada.',
    closeBranchHelpOn: 'Haru muutub ainult loetavaks ja seda ei saa enam ühendada.',
    confirmDiscardAll:
      'Kõik {{count}} muudetud dokumenti selles harus taastatakse nende olekusse main. Seda ei saa tagasi võtta.',
    confirmDiscardSelected:
      '{{count}} muudetud dokumenti taastatakse nende olekusse main. Seda ei saa tagasi võtta.',
    createAndSwitch: 'Loo ja mine üle',
    createNewBranch: 'Loo uus haru',
    currentChanges: 'Praegused muudatused',
    defaultBranch: 'vaikimisi',
    discardAll: 'Loobu kõigist ({{count}})',
    discardChanges: 'Loobu muudatustest',
    discardedCount: 'Loobutud muudatusi: {{count}}.',
    discarding: 'Loobutakse…',
    discardSelected: 'Loobu valitutest ({{count}})',
    historyPageOf: 'Lehekülg {{page}} / {{total}}',
    manage: 'Halda',
    manageBranches: 'Halda harusid…',
    merge: 'Ühenda',
    mergeAllChanges: 'Rakendatakse kõik selle haru muudatused.',
    mergeAllCount: 'Rakendatakse kõik {{count}} muudetud dokumenti selles harus.',
    mergeBranchInto: 'Ühenda {{branch}} haruga {{target}}',
    mergeChanges: 'Ühenda muudatused',
    mergeComplete: 'Ühendamine lõpetatud',
    merged: 'Ühendatud',
    mergedByCount: '{{count}} dokumenti – {{user}}',
    mergedCount: 'Ühendatud muudatusi: {{count}}.',
    mergedOfTotal: 'Ühendatud {{current}} / {{total}}',
    mergedOn: 'Ühendatud {{date}}',
    mergeHistory: 'Ühendamiste ajalugu',
    mergeInterrupted: 'Ühendamine katkes ja midagi ei rakendatud. Proovige uuesti.',
    mergeNow: 'Ühenda kohe',
    mergeOnlySelected: 'Valige, millised muudatused ühendada',
    mergeScheduledFor: 'Ühendamine ajastatud: {{date}}.',
    mergeSelectedOfTotal: 'Rakendatakse {{selected}} / {{total}} muudetud dokumendist.',
    mergeStarting: 'Ühendamise alustamine…',
    merging: 'Ühendamine…',
    mergingProgress: 'Ühendamine {{current}} / {{total}}',
    noChangesYet: 'Sellel harul pole veel muudatusi.',
    operation_create: 'Loodud',
    operation_delete: 'Kustutatud',
    operation_update: 'Uuendatud',
    reviewingChangedDocuments: 'Muudetud dokumentide ülevaatamine',
    scheduleAnotherMerge: 'Ajasta veel üks ühendamine',
    scheduleCancelled: 'Ajastatud ühendamine tühistatud.',
    scheduleCount: '{{count}} ajastatud',
    scheduledMerges: 'Ajastatud ühendamised',
    scheduledToMerge: 'Ühendamine ajastatud',
    scheduledToMergeOn: 'See haru on ajastatud ühendamiseks {{date}}.',
    scheduleHasNothingLeft:
      'Rakendada pole enam midagi — need muudatused loobuti või on juba ühendatud.',
    scheduleMerge: 'Ajasta ühendamine',
    scheduleMergeHelp: 'Ühendamine toimub valitud ajal ja teie õigusi kontrollitakse siis uuesti.',
    scheduleWillApplyAll: 'Rakendab kõik ootel oleva ({{count}})',
    scheduleWillApplySelected: 'Rakendab {{count}} valitud muudatust',
    scheduling: 'Ajastamine…',
    searchBranches: 'Otsi harusid',
    selectBranch: 'Vali haru',
    untouchedDocumentsNote:
      'Dokumendid, mida te pole selles harus muutnud, kuvavad main-haru praegust sisu, mitte hetkeseisu sellest ajast, kui haru loodi.',
  },
  commandPalette: {
    actions: 'Tegevused',
    createNew: 'Loo uus',
  ...
  error: {
    ...
    fileFetchFailed: 'Failis ei õnnestunud tuua.',
    ...
    noFileFoundInClipboard: 'Lõikepuhvris ei leitud ühtegi faili.',
    ...
    unableToReadClipboard: 'Ei saa lugeda lõikelaualt.',
    ...
    urlNotAllowed: 'Antud URL ei ole lubatud.',
  ...
  general: {
    ...
    delete: 'Kustuta',
    deleted: 'Kustutatud',
    deletedAgo: 'Kustutatud {{distance}} tagasi',
  ...
  upload: {
    ...
    fromURL: 'Laadi fail üles URL-i kaudu',
    height: 'Kõrgus',
