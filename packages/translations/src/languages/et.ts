...
export const etTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection:
      'Üleslaetud faili ei olnud võimalik tüübi tuvastamiseks lugeda.',
    couldNotReadFileForValidation: 'Üleslaaditud faili ei õnnestunud valideerimiseks lugeda.',
    crop: 'Kärbi',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'Failitüüp {{mimeType}} (laiendist {{extension}}) ei ole lubatud.',
    focalPoint: 'Fookuspunkt',
    focalPointDescription: 'Lohista fookuspunkti otse eelvaatel või kohanda väärtusi allpool.',
    height: 'Kõrgus',
    invalidMimeType: 'Vigane MIME tüüp: {{mimeType}}.',
    invalidOrCorruptedPDF: 'Vigane või rikutud PDF-fail.',
    ...
    restrictedFileType:
      "Failitüüp '{{mimeType}}' ei ole lubatud failile {{fileName}}: tuvastatud piiratud failitüüp — selle kontrolli vahelejätmiseks seadke selle Collection jaoks 'allowRestrictedFileTypes' väärtuseks true.",
    ...
    svgHarmfulContent: 'SVG-fail sisaldab potentsiaalselt kahjulikku sisu.',
    width: 'Laius',
  },
  validation: {
