...
export const etTranslations: DefaultTranslationsObject = {
  ...
  version: {
    ...
    aboutToUnpublishIn: 'Te olete katki avaldamas seda dokumenti {{locale}}. Olete kindel?',
    ...
    revertUnsuccessful: 'Tühistamine ebaõnnestus. Varasemaid avaldatud versioone ei leitud.',
