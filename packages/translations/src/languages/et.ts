...
export const etTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'See tegevus lukustab teid sellest eelseadistusest välja.',
    attachmentContentInvalid: 'Manuse sisu peab olema string või puhver',
    attachmentMissingContentAndPath: 'Manusel puuduvad nii sisu kui tee',
    attachmentMissingFilename: 'Manusel puudub failinimi',
    authenticationRequiredForExport: 'Eksportide loomiseks on vajalik kasutaja autentimine.',
    autosaving: 'Dokumendi automaatsel salvestamisel tekkis probleem.',
    busboyMultipartError: 'Busboy viga mitmeosalise päringu parsimisel',
    collectionSlugRequired: 'Kogumi slug on nõutud',
    contentTypeExpectedJSON: 'Oodati Content-Type application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Peab olema edastatud kas kogum või globalSlug.',
    emailOrPasswordIncorrect: 'Sisestatud e-post või parool on vale.',
    expectedResponseFromUploadHandler: 'Oodati vastust üleslaadimise käitlejalt.',
    failedToFetchFromURL: 'Faili hankimine pakutud URL-ilt ebaõnnestus.',
    failedToResetLayout: 'Paigutuse lähtestamine ebaõnnestus.',
    failedToSaveLayout: 'Paigutuse salvestamine ebaõnnestus.',
    fieldMustBeSpecified: 'väli peab olema määratud',
    fieldsNotInitialized: 'Väljad ei ole initsialiseeritud.',
    filenameRequired: 'Failinimi on nõutud.',
    ...
    invalidFilename: 'Kehtetu failinimi',
    invalidFileType: 'Vale failitüüp',
    invalidFileTypeValue: 'Vale failitüüp: {{value}}',
    invalidFileURL: 'Kehtetu faili URL',
    invalidJSON: 'Kehtetu JSON',
    invalidJSONFormat: 'Kehtetu JSON vorming',
    invalidRequestArgs: 'Päringule edastati vigased argumendid: {{args}}',
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Liitumisväljasid ei saa lisada massiividesse, plokkidesse või üldistesse.',
    ...
    missingIDOfVersionToRestore: 'Puudub taastatava versiooni ID.',
    missingRequiredData: 'Puuduvad vajalikud andmed.',
    noConnectionToDatabase: 'beginTransaction kutsutud, kuid andmebaasiga puudub ühendus',
    noFileDataForImport: 'Importimiseks ei ole failandmeid esitatud',
    noFilesUploaded: 'Ühtegi faili ei laaditud üles.',
    noMatchedField: 'Välja "{{label}}" ei leitud',
    noPayloadProvided: 'Payload ei esitatud',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Järjestatavad liitumised peavad sihtima ühte kogumit',
    pastingFromURLNotEnabled: 'URL-ilt kleepimine pole selle kogumi jaoks lubatud.',
    previewing: 'Selle dokumendi eelvaatamisel tekkis probleem.',
    problemUploadingFile: 'Faili üleslaadimisel tekkis probleem.',
    redirectTargetNotAllowed: 'Ümbersuunamise sihtmärk pole lubatud.',
    relationshipFieldNotFound: 'Seose välja ei leitud',
    relationshipNotFound: 'Seost ei leitud',
    requestDataRequired: 'Päringu andmed on nõutud.',
    requestNotEligibleForFileUpload: 'Päring ei sobi faili üleslaadimiseks',
    requestURLMissing: 'Päringu URL puudub.',
    restoringTitle:
    ...
    tooManyRedirects: 'Liiga palju ümbersuunamisi.',
    ...
    unexpectedArrayCollectionSlug: 'Ootamatu collectionSlug massiiv, peab olema esitatud parent',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers puudub kogumi {{collection}} jaoks',
    uploadthingUnknownError: 'Viga faili üleslaadimisel uploadthing-iga: Tundmatu viga',
    urlNotAllowed: 'Esitatud URL pole lubatud.',
    ...
    userRequiredForImport: 'Kasutaja on importimistoimingute jaoks nõutud',
    validURLRequired: 'Nõutav on kehtiv URL string.',
    valueMustBeUnique: 'Väärtus peab olema unikaalne',
    vercelBlobUploadError: 'storage-vercel-blob kliendi üleslaadimise marsruudi viga',
