...
export const etTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    draftsHint: 'Sinu hiljutised mustandid ilmuvad siia',
    dropFiles: 'Üleslaadimiseks kukuta failid siia',
    editDashboard: 'Muuda armatuurlauda',
    editingDashboard: 'Redigeerimise armatuurlaud',
    gridView: 'Ruudustikuvaade',
    listView: 'Loendivaade',
    loadError: 'Mõnda dokumenti ei saanud laadida. Uuesti proovimiseks värskenda lehte.',
    noDrafts: 'Hiljutisi mustandeid pole',
    noItems:
      'Teie armatuurlauale pole vidinaid. Saate neid lisada ülemisel ribal asuvast "Armatuurlaua" menüüst.',
    noPinned: 'Kinnitatud dokumente pole',
    noRecents: 'Hiljuti vaadatud dokumente pole',
    pinDocument: 'Kinnita {{title}}',
    pinned: 'Kinnitatud',
    pinnedHint: 'Kinnitatud dokumendid ilmuvad siia',
    recentDrafts: 'Hiljutised mustandid',
    recentlyViewed: 'Hiljuti vaadatud',
    recentsHint: 'Vaadatud dokumendid ilmuvad siia',
    resetLayout: 'Lähtesta Paigutus',
    saveError: 'Töölaua eelistust ei saanud salvestada. Proovi uuesti.',
    searchWidgets: 'Otsi vidinaid...',
    unpinDocument: 'Vabasta {{title}}',
    updatedBy: 'Uuendaja',
    uploadDropzone: 'Üleslaadimisala',
    uploadFiles: 'Laadi failid üles',
    uploadHint: 'Lohista failid arvutist siia või klõpsa alloleval nupul',
    viewMode: 'Dokumendivaade',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Joonda päis ja juhtelemendid',
    all: 'Kõik',
    ...
    editViewWidth: 'Redigeerimisvaate laius',
    editViewWidthFull: 'Täislaius',
    email: 'E-post',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Teksti suurused',
    typeSizeSmall: 'Praegune',
