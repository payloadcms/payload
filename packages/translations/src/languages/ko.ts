...
export const koTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: '이 작업을 수행하면 이 프리셋에 액세스할 수 없게 됩니다.',
    attachmentContentInvalid: '첨부 파일 콘텐츠는 문자열 또는 버퍼여야 합니다',
    attachmentMissingContentAndPath: '첨부 파일에 콘텐츠와 경로가 모두 누락되었습니다',
    attachmentMissingFilename: '첨부 파일에 파일명이 누락되었습니다',
    authenticationRequiredForExport: '내보내기를 생성하려면 사용자 인증이 필요합니다.',
    autosaving: '이 문서를 자동 저장하는 중에 문제가 발생했습니다.',
    busboyMultipartError: 'Busboy가 multipart 요청을 분석하는 중 오류가 발생했습니다',
    collectionSlugRequired: 'Collection slug가 필요합니다',
    contentTypeExpectedJSON: 'Content-Type은 application/json이어야 합니다',
    ...
    eitherCollectionOrGlobalRequired: 'collection 또는 globalSlug를 전달해야 합니다.',
    emailOrPasswordIncorrect: '입력한 이메일 또는 비밀번호가 올바르지 않습니다.',
    expectedResponseFromUploadHandler: '업로드 핸들러로부터 응답이 예상됩니다.',
    failedToFetchFromURL: '제공된 URL에서 파일을 가져오는 데 실패했습니다.',
    failedToResetLayout: '레이아웃 리셋에 실패하였습니다.',
    failedToSaveLayout: '레이아웃 저장에 실패했습니다.',
    fieldMustBeSpecified: '필드를 지정해야 합니다',
    fieldsNotInitialized: '필드가 초기화되지 않았습니다.',
    filenameRequired: '파일 이름이 필요합니다.',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Join 필드는 배열, 블록 또는 전역에 추가할 수 없습니다.',
    ...
    missingIDOfVersionToRestore: '복원할 버전의 ID가 누락되었습니다.',
    missingRequiredData: '필수 데이터가 누락되었습니다.',
    noConnectionToDatabase:
      '데이터베이스에 연결되지 않은 상태에서 beginTransaction이 호출되었습니다',
    noFileDataForImport: '가져오기를 위한 파일 데이터가 제공되지 않았습니다',
    noFilesUploaded: '파일이 업로드되지 않았습니다.',
    noMatchedField: '"{{label}}"에 대한 일치하는 입력란이 없습니다.',
    noPayloadProvided: 'payload가 제공되지 않았습니다',
    ...
    orderableJoinsMustTargetSingleCollection:
      '정렬 가능한 join은 단일 collection을 대상으로 해야 합니다',
    pastingFromURLNotEnabled: '이 collection에서는 URL에서 붙여넣기가 활성화되지 않았습니다.',
    previewing: '이 문서를 미리보는 중에 문제가 발생했습니다.',
    problemUploadingFile: '파일 업로드 중에 문제가 발생했습니다.',
    redirectTargetNotAllowed: '리다이렉트 대상이 허용되지 않습니다.',
    relationshipFieldNotFound: '관계 필드를 찾을 수 없습니다',
    relationshipNotFound: '관계를 찾을 수 없습니다',
    requestDataRequired: '요청 데이터가 필요합니다.',
    requestNotEligibleForFileUpload: '요청이 파일 업로드 자격이 없습니다',
    requestURLMissing: '요청 URL이 누락되었습니다.',
    restoringTitle:
    ...
    tooManyRedirects: '리다이렉트가 너무 많습니다.',
    ...
    unexpectedArrayCollectionSlug: '예상치 못한 배열 collection slug',
    ...
    uploadConfigHandlersMissing: '업로드 구성 핸들러가 누락되었습니다',
    uploadthingUnknownError: 'Uploadthing 알 수 없는 오류',
    urlNotAllowed: 'URL이 허용되지 않습니다',
    ...
    userRequiredForImport: '가져오기를 위해 사용자가 필요합니다',
    validURLRequired: '유효한 URL이 필요합니다',
    valueMustBeUnique: '값은 고유해야 합니다.',
    vercelBlobUploadError: 'Vercel Blob 업로드 오류',
