...
export const koTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: '문서',
    draftsHint: '최근 초안이 여기에 표시됩니다',
    dropFiles: '업로드할 파일을 놓으세요',
    editDashboard: '대시보드 편집',
    editingDashboard: '대시보드 편집',
    gridView: '그리드 보기',
    listView: '목록 보기',
    loadError: '일부 문서를 불러오지 못했습니다. 새로고침하여 다시 시도해 주세요.',
    noDrafts: '최근 초안이 없습니다',
    noItems: '대시보드에 위젯이 없습니다. 상단 바에 위치한 "대시보드" 메뉴에서 추가할 수 있습니다.',
    noPinned: '고정된 문서가 없습니다',
    noRecents: '최근 본 문서가 없습니다',
    pinDocument: '{{title}} 고정',
    pinned: '고정됨',
    pinnedHint: '고정한 문서가 여기에 표시됩니다',
    recentDrafts: '최근 초안',
    recentlyViewed: '최근 본 문서',
    recentsHint: '열어 본 문서가 여기에 표시됩니다',
    resetLayout: '레이아웃 재설정',
    saveError: '대시보드 설정을 저장하지 못했습니다. 다시 시도해 주세요.',
    searchWidgets: '위젯 검색...',
    unpinDocument: '{{title}} 고정 해제',
    updatedBy: '수정한 사람',
    uploadDropzone: '업로드 영역',
    uploadFiles: '파일 업로드',
    uploadHint: '컴퓨터에서 파일을 끌어다 놓거나 아래 버튼을 클릭하세요',
    viewMode: '문서 보기',
  ...
  general: {
    ...
    addFilter: '필터 추가',
    adminTheme: '관리자 테마',
    alignHeaderAndControls: '헤더 및 컨트롤 정렬',
    all: '모두',
    ...
    editLabel: '{{label}} 수정',
    editViewWidth: '편집 화면 너비',
    editViewWidthFull: '전체 너비',
    email: '이메일',
    emailAddress: '이메일 주소',
    emptyTrash: '휴지통 비우기',
