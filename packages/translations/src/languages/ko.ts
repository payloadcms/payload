...
export const koTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: '이메일이 성공적으로 인증되었습니다. 로그인 페이지로 이동합니다...',
    ...
    notRedirected: '리디렉션되지 않았습니까? <0>여기에서 로그인하세요</0>',
    passed: '인증 통과',
  ...
  branching: {
    andMoreChanges: '그 외 변경 사항 {{count}}개',
    branch: '브랜치',
    branchClosed: '이 브랜치는 닫혔습니다. 병합한 내용의 기록으로 보관됩니다.',
    branchDescription: '브랜치 설명',
    branchedFrom: '분기 원본',
    branches: '브랜치',
    branchHistory: '브랜치 기록',
    branchMerging: '병합 중',
    branchName: '브랜치 이름',
    branchSettings: '브랜치 설정',
    cancelSchedule: '병합 취소',
    changedDocuments: '변경된 문서',
    changesTo: '{{summary}}의 변경 사항',
    closeBranchAfterMerge: '병합 후 이 브랜치 닫기',
    closeBranchHelpOff:
      '브랜치가 열린 상태로 유지되므로 계속 작업하고 나중에 다시 병합할 수 있습니다.',
    closeBranchHelpOn: '브랜치가 읽기 전용이 되며 다시 병합할 수 없습니다.',
    confirmDiscardAll:
      '이 브랜치에서 변경된 문서 {{count}}개가 모두 main의 상태로 되돌아갑니다. 이 작업은 취소할 수 없습니다.',
    confirmDiscardSelected:
      '변경된 문서 {{count}}개가 main의 상태로 되돌아갑니다. 이 작업은 취소할 수 없습니다.',
    createAndSwitch: '생성 후 전환',
    createNewBranch: '새 브랜치 생성',
    currentChanges: '현재 변경 사항',
    defaultBranch: '기본',
    discardAll: '모두 취소 ({{count}})',
    discardChanges: '변경 사항 취소',
    discardedCount: '변경 사항 {{count}}개를 취소했습니다.',
    discarding: '취소 중…',
    discardSelected: '선택 항목 취소 ({{count}})',
    historyPageOf: '{{total}}페이지 중 {{page}}페이지',
    manage: '관리',
    manageBranches: '브랜치 관리…',
    merge: '병합',
    mergeAllChanges: '이 브랜치의 모든 변경 사항이 적용됩니다.',
    mergeAllCount: '이 브랜치에서 변경된 문서 {{count}}개가 모두 적용됩니다.',
    mergeBranchInto: '{{branch}}을(를) {{target}}에 병합',
    mergeChanges: '변경 사항 병합',
    mergeComplete: '병합 완료',
    merged: '병합됨',
    mergedByCount: '문서 {{count}}개 – {{user}}',
    mergedCount: '변경 사항 {{count}}개를 병합했습니다.',
    mergedOfTotal: '{{total}}개 중 {{current}}개 병합',
    mergedOn: '{{date}}에 병합',
    mergeHistory: '병합 기록',
    mergeInterrupted: '병합이 중단되어 아무것도 적용되지 않았습니다. 다시 시도하세요.',
    mergeNow: '지금 병합',
    mergeOnlySelected: '병합할 변경 사항 선택',
    mergeScheduledFor: '{{date}}에 병합이 예약되었습니다.',
    mergeSelectedOfTotal: '변경된 문서 {{total}}개 중 {{selected}}개가 적용됩니다.',
    mergeStarting: '병합 시작 중…',
    merging: '병합 중…',
    mergingProgress: '{{total}}개 중 {{current}}개 병합 중',
    noChangesYet: '이 브랜치에는 아직 변경 사항이 없습니다.',
    operation_create: '생성됨',
    operation_delete: '삭제됨',
    operation_update: '업데이트됨',
    reviewingChangedDocuments: '변경된 문서 검토',
    scheduleAnotherMerge: '다른 병합 예약',
    scheduleCancelled: '예약된 병합을 취소했습니다.',
    scheduleCount: '{{count}}건 예약됨',
    scheduledMerges: '예약된 병합',
    scheduledToMerge: '병합 예약됨',
    scheduledToMergeOn: '이 브랜치는 {{date}}에 병합될 예정입니다.',
    scheduleHasNothingLeft:
      '적용할 것이 남아 있지 않습니다 — 이 변경 사항은 취소되었거나 이미 병합되었습니다.',
    scheduleMerge: '병합 예약',
    scheduleMergeHelp: '병합은 선택한 시각에 실행되며, 그때 권한을 다시 확인합니다.',
    scheduleWillApplyAll: '대기 중인 모든 항목을 적용합니다({{count}}건)',
    scheduleWillApplySelected: '선택한 변경 사항 {{count}}건을 적용합니다',
    scheduling: '예약 중…',
    searchBranches: '브랜치 검색',
    selectBranch: '브랜치 선택',
    untouchedDocumentsNote:
      '이 브랜치에서 변경하지 않은 문서는 브랜치가 생성된 시점의 스냅샷이 아니라 main의 현재 콘텐츠를 표시합니다.',
  },
  commandPalette: {
    actions: '작업',
    createNew: '새로 만들기',
  ...
  error: {
    ...
    fileFetchFailed: '파일을 가져오지 못했습니다.',
    ...
    noFileFoundInClipboard: '클립보드에서 파일을 찾을 수 없습니다.',
    ...
    unableToReadClipboard: '클립보드에서 읽을 수 없습니다.',
    ...
    urlNotAllowed: '제공된 URL은 허용되지 않습니다.',
