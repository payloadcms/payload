...
export const koTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    addFiles: '파일 추가',
    bulkUpload: '일괄 업로드',
    couldNotReadFileForTypeDetection: '유형 감지를 위해 업로드된 파일을 읽을 수 없습니다.',
    couldNotReadFileForValidation: '유효성 검사를 위해 업로드된 파일을 읽을 수 없습니다.',
    crop: '자르기',
    cropToolDescription:
    ...
    fileTypeNotAllowed:
      '파일 형식 {{mimeType}}(확장자 {{extension}}에서 가져옴)는 허용되지 않습니다.',
    focalPoint: '초점',
    focalPointDescription: '미리보기에서 초점을 직접 드래그하거나 아래의 값을 조정하세요.',
    height: '높이',
    invalidMimeType: '유효하지 않은 MIME 유형: {{mimeType}}.',
    invalidOrCorruptedPDF: '유효하지 않거나 손상된 PDF 파일입니다.',
    lessInfo: '정보 숨기기',
    moreInfo: '정보 더보기',
    noFile: '파일 없음',
    pasteURL: 'URL 붙여넣기',
    ...
    restrictedFileType:
      "파일 유형 '{{mimeType}}'은(는) {{fileName}}에 허용되지 않습니다: 제한된 파일 유형이 감지되었습니다 — 이 컬렉션에 대해 해당 확인을 건너뛰려면 'allowRestrictedFileTypes'를 true로 설정하십시오.",
    ...
    sizes: '크기',
    sizesFor: '{{label}} 크기',
    svgHarmfulContent: 'SVG 파일에 잠재적으로 유해한 내용이 포함되어 있습니다.',
    width: '너비',
  },
  validation: {
