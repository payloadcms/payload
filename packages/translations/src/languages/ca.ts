...
export const caTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: "Aquesta acció et bloquejarà l'accés a aquest preset.",
    attachmentContentInvalid: "El contingut de l'adjunt ha de ser una cadena de text o un buffer",
    attachmentMissingContentAndPath: "L'adjunt no té ni contingut ni ruta",
    attachmentMissingFilename: "L'adjunt no té nom d'arxiu",
    authenticationRequiredForExport:
      "L'autenticació d'usuari és necessària per crear exportacions.",
    autosaving: "Hi ha hagut un problema mentre s'estava desant automàticament aquest document.",
    busboyMultipartError: 'Error de Busboy en analitzar la sol·licitud multiparte',
    collectionSlugRequired: 'El slug de la col·lecció és obligatori',
    contentTypeExpectedJSON: "S'esperava que el Content-Type fos application/json",
    ...
    eitherCollectionOrGlobalRequired: "S'ha de proporcionar collection o globalSlug.",
    emailOrPasswordIncorrect:
      'El correu electrònic o la contrasenya proporcionats no són correctes.',
    expectedResponseFromUploadHandler: "S'esperava una resposta del gestor de pujada.",
    failedToFetchFromURL: "No s'ha pogut obtenir l'arxiu des de l'URL proporcionada.",
    failedToResetLayout: "No s'ha pogut restablir la disposició.",
    failedToSaveLayout: "No s'ha pogut guardar la disposició.",
    fieldMustBeSpecified: "s'ha d'especificar el camp",
    fieldsNotInitialized: 'Els camps no estan inicialitzats.',
    filenameRequired: "Es requereix un nom d'arxiu.",
    ...
    missingIDOfVersionToRestore: "Falta l'ID de la versió a restaurar.",
    missingRequiredData: 'Falten dades necessàries.',
    noConnectionToDatabase: 'beginTransaction cridat sense connexió a la base de dades',
    noFileDataForImport: "No s'han proporcionat dades d'arxiu per a la importació",
    noFilesUploaded: "No s'ha carregat cap arxiu.",
    noMatchedField: 'No s\'ha trobat cap camp coincident per a "{{label}}"',
    noPayloadProvided: "No s'ha proporcionat cap payload",
    ...
    orderableJoinsMustTargetSingleCollection:
      "Els joins ordenables han d'apuntar a una única col·lecció",
    pastingFromURLNotEnabled: "La pujada des d'URL no està habilitada per a aquesta col·lecció.",
    ...
    redirectTargetNotAllowed: 'La destinació de redirecció no està permesa.',
    relationshipFieldNotFound: "No s'ha trobat el camp de relació",
    relationshipNotFound: "No s'ha trobat la relació",
    requestDataRequired: 'Les dades de la sol·licitud són obligatòries.',
    requestNotEligibleForFileUpload: "La sol·licitud no és vàlida per a la pujada d'arxius",
    requestURLMissing: "Falta l'URL de la sol·licitud.",
    restoringTitle:
    ...
    tooManyRedirects: 'Massa redireccions.',
    ...
    unexpectedArrayCollectionSlug:
      "Array inesperat de collectionSlug, s'ha de proporcionar el parent",
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers no està present per a {{collection}}',
    uploadthingUnknownError: "Error en pujar l'arxiu amb uploadthing: Error desconegut",
    ...
    userRequiredForImport: "Es requereix un usuari per a les operacions d'importació",
    validURLRequired: "Es requereix una cadena d'URL vàlida.",
    valueMustBeUnique: 'El valor ha de ser únic.',
    vercelBlobUploadError: 'error de ruta de pujada del client storage-vercel-blob',
