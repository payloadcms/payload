...
export const caTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Documents',
    draftsHint: 'Els teus esborranys recents apareixeran aquí',
    dropFiles: 'Deixa anar els fitxers per carregar-los',
    editDashboard: 'Edita el Tauler',
    editingDashboard: 'Editant el Tauler',
    gridView: 'Vista de quadrícula',
    listView: 'Vista de llista',
    loadError: 'No s’han pogut carregar alguns documents. Actualitza per tornar-ho a provar.',
    noDrafts: 'No hi ha esborranys recents',
    noItems:
      'No hi ha cap widget al vostre tauler de control. Podeu afegir-los des del menú "Dashboard" situat a la barra superior.',
    noPinned: 'No hi ha documents fixats',
    noRecents: 'No hi ha documents vistos recentment',
    pinDocument: 'Fixa {{title}}',
    pinned: 'Fixats',
    pinnedHint: 'Els documents que fixis apareixeran aquí',
    recentDrafts: 'Esborranys recents',
    recentlyViewed: 'Vistos recentment',
    recentsHint: 'Els documents que vegis apareixeran aquí',
    resetLayout: 'Restableix la disposició',
    saveError: 'No s’ha pogut desar la preferència del tauler. Torna-ho a provar.',
    searchWidgets: 'Cerca de ginys...',
    unpinDocument: 'Desfixa {{title}}',
    updatedBy: 'Actualitzat per',
    uploadDropzone: 'Zona de càrrega',
    uploadFiles: 'Carrega fitxers',
    uploadHint: 'Arrossega fitxers des de l’ordinador o fes clic al botó de sota',
    viewMode: 'Vista de documents',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Alinea la capçalera i els controls',
    all: 'Tots',
    ...
    editViewWidth: 'Amplada de la vista d’edició',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Mides del text',
    typeSizeSmall: 'Actual',
