...
export const caTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: '{{count}} canvis més',
    branch: 'Branca',
    branchClosed: 'Aquesta branca està tancada. Es conserva com a registre del que ha fusionat.',
    branchDescription: 'Descripció de la branca',
    branchedFrom: 'Ramificada des de',
    branches: 'Branques',
    branchHistory: 'Historial de la branca',
    branchMerging: 'Fusionant',
    branchName: 'Nom de la branca',
    branchSettings: 'Configuració de la branca',
    cancelSchedule: 'Cancel·lar la fusió',
    changedDocuments: 'Documents modificats',
    changesTo: 'Canvis a {{summary}}',
    closeBranchAfterMerge: 'Tanca aquesta branca després de fusionar',
    closeBranchHelpOff:
      'La branca es manté oberta, així pots continuar treballant-hi i tornar a fusionar-la més tard.',
    closeBranchHelpOn: 'La branca passarà a ser només de lectura i no es podrà tornar a fusionar.',
    confirmDiscardAll:
      'Els {{count}} documents modificats d’aquesta branca es revertiran al seu estat a main. Això no es pot desfer.',
    confirmDiscardSelected:
      '{{count}} documents modificats es revertiran al seu estat a main. Això no es pot desfer.',
    createAndSwitch: 'Crea i canvia',
    createNewBranch: 'Crea una branca nova',
    currentChanges: 'Canvis actuals',
    defaultBranch: 'per defecte',
    discardAll: 'Descarta-ho tot ({{count}})',
    discardChanges: 'Descarta els canvis',
    discardedCount: '{{count}} canvis descartats.',
    discarding: 'S’està descartant…',
    discardSelected: 'Descarta la selecció ({{count}})',
    historyPageOf: 'Pàgina {{page}} de {{total}}',
    manage: 'Gestiona',
    manageBranches: 'Gestiona les branques…',
    merge: 'Fusiona',
    mergeAllChanges: 'S’aplicaran tots els canvis d’aquesta branca.',
    mergeAllCount: 'S’aplicaran els {{count}} documents modificats d’aquesta branca.',
    mergeBranchInto: 'Fusiona {{branch}} a {{target}}',
    mergeChanges: 'Fusiona els canvis',
    mergeComplete: 'Fusió completada',
    merged: 'Fusionada',
    mergedByCount: '{{count}} documents per {{user}}',
    mergedCount: '{{count}} canvis fusionats.',
    mergedOfTotal: '{{current}} de {{total}} fusionats',
    mergedOn: 'Fusionat el {{date}}',
    mergeHistory: 'Historial de fusions',
    mergeInterrupted: 'La fusió s’ha interromput i no s’ha aplicat res. Torna-ho a provar.',
    mergeNow: 'Fusiona ara',
    mergeOnlySelected: 'Tria quins canvis vols fusionar',
    mergeScheduledFor: 'Fusió programada per al {{date}}.',
    mergeSelectedOfTotal: 'S’aplicaran {{selected}} de {{total}} documents modificats.',
    mergeStarting: 'S’està iniciant la fusió…',
    merging: 'S’està fusionant…',
    mergingProgress: 'S’està fusionant {{current}} de {{total}}',
    noChangesYet: 'Encara no hi ha canvis en aquesta branca.',
    operation_create: 'Creat',
    operation_delete: 'Eliminat',
    operation_update: 'Actualitzat',
    reviewingChangedDocuments: 'Revisant els documents modificats',
    scheduleAnotherMerge: 'Programa una altra fusió',
    scheduleCancelled: 'Fusió programada cancel·lada.',
    scheduleCount: '{{count}} programades',
    scheduledMerges: 'Fusions programades',
    scheduledToMerge: 'Programada per fusionar',
    scheduledToMergeOn: 'Aquesta branca està programada per fusionar-se el {{date}}.',
    scheduleHasNothingLeft:
      'No queda res per aplicar: aquests canvis s’han descartat o ja s’han fusionat.',
    scheduleMerge: 'Programa la fusió',
    scheduleMergeHelp:
      'La fusió s’executa a l’hora que triïs, comprovant de nou els teus permisos en aquell moment.',
    scheduleWillApplyAll: 'Aplicarà tot el que està pendent ({{count}})',
    scheduleWillApplySelected: 'Aplicarà {{count}} canvi(s) seleccionat(s)',
    scheduling: 'S’està programant…',
    searchBranches: 'Cerca branques',
    selectBranch: 'Selecciona una branca',
    untouchedDocumentsNote:
      'Els documents que no heu modificat en aquesta branca mostren el contingut actual de main, no una captura de quan es va crear la branca.',
  },
  commandPalette: {
    actions: 'Accions',
    createNew: 'Crear nou',
  ...
  error: {
    ...
    fileFetchFailed: 'No s’ha pogut obtenir l’arxiu.',
    ...
    noFileFoundInClipboard: "No s'ha trobat cap fitxer al porta-retalls.",
    ...
    unableToReadClipboard: 'No es pot llegir des del porta-retalls.',
    ...
    urlNotAllowed: "L'URL proporcionada no està permesa.",
  ...
  general: {
    ...
    delete: 'Eliminar',
    deleted: 'Eliminat',
    deletedAgo: 'Suprimit fa {{distance}}',
