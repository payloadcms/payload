...
export const faTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    checkYourEmailForPasswordReset:
      'اگر این آدرس ایمیل با حسابی مرتبط باشد، دستورالعمل‌هایی برای بازنشانی گذرواژه خود به زودی دریافت خواهید کرد. لطفاً پوشه اسپم یا زباله‌ها را بررسی کنید اگر ایمیل را در صندوق ورودی خود نمی‌بینید.',
