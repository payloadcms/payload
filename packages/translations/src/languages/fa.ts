...
export const faTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'اسناد',
    draftsHint: 'پیش‌نویس‌های اخیر شما اینجا نمایش داده می‌شوند',
    dropFiles: 'فایل‌ها را برای بارگذاری رها کنید',
    editDashboard: 'ویرایش داشبورد',
    editingDashboard: 'داشبورد ویرایش',
    gridView: 'نمای شبکه‌ای',
    listView: 'نمای فهرست',
    loadError: 'برخی اسناد بارگیری نشدند. برای تلاش دوباره صفحه را تازه‌سازی کنید.',
    noDrafts: 'پیش‌نویس اخیری وجود ندارد',
    noItems:
      'در داشبورد شما هیچ ویجتی وجود ندارد. شما می توانید آنها را از منوی "داشبورد" که در نوار بالا قرار دارد اضافه کنید.',
    noPinned: 'سند سنجاق‌شده‌ای وجود ندارد',
    noRecents: 'سند اخیراً مشاهده‌شده‌ای وجود ندارد',
    pinDocument: 'سنجاق کردن {{title}}',
    pinned: 'سنجاق‌شده',
    pinnedHint: 'اسنادی که سنجاق می‌کنید اینجا نمایش داده می‌شوند',
    recentDrafts: 'پیش‌نویس‌های اخیر',
    recentlyViewed: 'اخیراً مشاهده‌شده',
    recentsHint: 'اسنادی که مشاهده می‌کنید اینجا نمایش داده می‌شوند',
    resetLayout: 'تنظیم مجدد طرح بندی',
    saveError: 'تنظیم داشبورد ذخیره نشد. دوباره تلاش کنید.',
    searchWidgets: 'جستجوی ابزارک‌ها...',
    unpinDocument: 'برداشتن سنجاق {{title}}',
    updatedBy: 'به‌روزرسانی توسط',
    uploadDropzone: 'ناحیه بارگذاری',
    uploadFiles: 'بارگذاری فایل‌ها',
    uploadHint: 'فایل‌ها را از رایانه بکشید و رها کنید یا روی دکمه زیر کلیک کنید',
    viewMode: 'نمای اسناد',
  ...
  general: {
    ...
    alignHeaderAndControls: 'تراز کردن سربرگ و کنترل‌ها',
    all: 'همه',
    ...
    editViewWidth: 'عرض نمای ویرایش',
    editViewWidthFull: 'کامل',
    email: 'ایمیل',
