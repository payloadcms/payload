...
export const faTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'کپی کردن',
    copyWarning:
      'شما در حال کپی کردن داده ها از {{از}} به {{به}} هستید. این کار هر داده موجود {{به}} را بازنویسی می کند و شما را به ادامه ویرایش این محل منتقل می کند. آیا مطمئن هستید که می خواهید ادامه دهید؟',
    create: 'ساختن',
    created: 'ساخته شده',
