...
export const faTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'ایمیل با موفقیت تأیید شد. در حال انتقال به صفحه ورود...',
  ...
  branching: {
    andMoreChanges: '{{count}} تغییر دیگر',
    branch: 'شاخه',
    branchClosed: 'این شاخه بسته شده است. به‌عنوان سابقه‌ای از آنچه ادغام شده نگه داشته می‌شود.',
    branchDescription: 'توضیح شاخه',
    branchedFrom: 'منشعب‌شده از',
    branches: 'شاخه‌ها',
    branchHistory: 'تاریخچه شاخه',
    branchMerging: 'در حال ادغام',
    branchName: 'نام شاخه',
    branchSettings: 'تنظیمات شاخه',
    cancelSchedule: 'لغو ادغام',
    changedDocuments: 'اسناد تغییریافته',
    changesTo: 'تغییرات در {{summary}}',
    closeBranchAfterMerge: 'بستن این شاخه پس از ادغام',
    closeBranchHelpOff:
      'شاخه باز می‌ماند، بنابراین می‌توانید کار روی آن را ادامه دهید و بعداً دوباره ادغام کنید.',
    closeBranchHelpOn: 'شاخه فقط‌خواندنی می‌شود و دیگر نمی‌توان آن را ادغام کرد.',
    confirmDiscardAll:
      'همه {{count}} سند تغییریافته در این شاخه به وضعیت خود در main بازگردانده می‌شوند. این کار قابل بازگشت نیست.',
    confirmDiscardSelected:
      '{{count}} سند تغییریافته به وضعیت خود در main بازگردانده می‌شوند. این کار قابل بازگشت نیست.',
    createAndSwitch: 'ایجاد و تغییر',
    createNewBranch: 'ایجاد شاخه جدید',
    currentChanges: 'تغییرات فعلی',
    defaultBranch: 'پیش‌فرض',
    discardAll: 'نادیده گرفتن همه ({{count}})',
    discardChanges: 'نادیده گرفتن تغییرات',
    discardedCount: '{{count}} تغییر نادیده گرفته شد.',
    discarding: 'در حال نادیده گرفتن…',
    discardSelected: 'نادیده گرفتن موارد انتخابی ({{count}})',
    historyPageOf: 'صفحه {{page}} از {{total}}',
    manage: 'مدیریت',
    manageBranches: 'مدیریت شاخه‌ها…',
    merge: 'ادغام',
    mergeAllChanges: 'همه تغییرات این شاخه اعمال می‌شود.',
    mergeAllCount: 'همه {{count}} سند تغییریافته در این شاخه اعمال می‌شود.',
    mergeBranchInto: 'ادغام {{branch}} در {{target}}',
    mergeChanges: 'ادغام تغییرات',
    mergeComplete: 'ادغام کامل شد',
    merged: 'ادغام‌شده',
    mergedByCount: '{{count}} سند توسط {{user}}',
    mergedCount: '{{count}} تغییر ادغام شد.',
    mergedOfTotal: '{{current}} از {{total}} ادغام شد',
    mergedOn: 'ادغام‌شده در {{date}}',
    mergeHistory: 'تاریخچه ادغام',
    mergeInterrupted: 'ادغام قطع شد و چیزی اعمال نشد. دوباره تلاش کنید.',
    mergeNow: 'ادغام همین حالا',
    mergeOnlySelected: 'انتخاب کنید کدام تغییرات ادغام شوند',
    mergeScheduledFor: 'ادغام برای {{date}} زمان‌بندی شد.',
    mergeSelectedOfTotal: '{{selected}} از {{total}} سند تغییریافته اعمال می‌شود.',
    mergeStarting: 'در حال شروع ادغام…',
    merging: 'در حال ادغام…',
    mergingProgress: 'در حال ادغام {{current}} از {{total}}',
    noChangesYet: 'هنوز تغییری در این شاخه وجود ندارد.',
    operation_create: 'ایجاد شد',
    operation_delete: 'حذف شد',
    operation_update: 'به‌روزرسانی شد',
    reviewingChangedDocuments: 'بررسی اسناد تغییریافته',
    scheduleAnotherMerge: 'زمان‌بندی ادغام دیگر',
    scheduleCancelled: 'ادغام زمان‌بندی‌شده لغو شد.',
    scheduleCount: '{{count}} زمان‌بندی‌شده',
    scheduledMerges: 'ادغام‌های زمان‌بندی‌شده',
    scheduledToMerge: 'ادغام زمان‌بندی‌شده',
    scheduledToMergeOn: 'این شاخه برای ادغام در {{date}} زمان‌بندی شده است.',
    scheduleHasNothingLeft:
      'چیزی برای اعمال نمانده — این تغییرات نادیده گرفته شده یا قبلاً ادغام شده‌اند.',
    scheduleMerge: 'زمان‌بندی ادغام',
    scheduleMergeHelp:
      'ادغام در زمانی که انتخاب می‌کنید اجرا می‌شود و دسترسی‌های شما در آن زمان دوباره بررسی می‌شود.',
    scheduleWillApplyAll: 'همه موارد در انتظار را اعمال می‌کند ({{count}})',
    scheduleWillApplySelected: '{{count}} تغییر انتخاب‌شده را اعمال می‌کند',
    scheduling: 'در حال زمان‌بندی…',
    searchBranches: 'جستجوی شاخه‌ها',
    selectBranch: 'انتخاب شاخه',
    untouchedDocumentsNote:
      'اسنادی که در این شاخه تغییر نداده‌اید، محتوای فعلی شاخه main را نمایش می‌دهند، نه یک تصویر لحظه‌ای از زمانی که شاخه ایجاد شده است.',
  },
  commandPalette: {
    actions: 'اقدامات',
  ...
  error: {
    ...
    fileFetchFailed: 'دریافت فایل با شکست مواجه شد.',
    ...
    noFileFoundInClipboard: 'هیچ فایلی در کلیپ‌بورد یافت نشد.',
    ...
    unableToReadClipboard: 'قادر به خواندن از کلیپ‌بورد نیستم.',
    ...
    urlNotAllowed: 'نشانی اینترنتی ارائه‌شده مجاز نیست.',
  ...
  general: {
    ...
    delete: 'حذف',
    deleted: 'حذف شد',
    deletedAgo: 'حذف شده در {{distance}} پیش',
    deletedAt: 'تاریخ حذف',
  ...
  upload: {
    ...
    fromURL: 'بارگذاری فایل از طریق نشانی اینترنتی',
    height: 'ارتفاع',
