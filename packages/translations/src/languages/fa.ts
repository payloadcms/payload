...
export const faTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'کپی کردن',
    copyWarning:
      'شما در حال کپی کردن داده ها از {{from}} به {{to}} هستید. این کار هر گونه داده موجود {{to}} را بازنویسی می کند و شما را به ادامه ویرایش این محل هدایت می کند. آیا مطمئن هستید که می خواهید ادامه دهید؟',
    create: 'ساختن',
    created: 'ساخته شده',
