...
export const faTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    noResultsFound:
      'معنی متن اصلی را در زمینه Payload رعایت کنید. در اینجا فهرستی از اصطلاحات متداول Payload که معانی خاصی دارند، آورده شده است:\n  - مجموعه: مجموعه گروهی از اسناد است که ساختار و هدف مشترکی را به اشتراک می گذارند. مجموعه ها برای سا',
    notFound: 'یافت نشد',
