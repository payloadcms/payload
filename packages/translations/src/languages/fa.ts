...
export const faTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'این عمل شما را از دسترسی به این پیش‌تنظیم قفل خواهد کرد.',
    attachmentContentInvalid: 'محتوای پیوست باید یک رشته متنی یا بافر باشد',
    attachmentMissingContentAndPath: 'پیوست فاقد محتوا و مسیر است',
    attachmentMissingFilename: 'نام فایل پیوست مشخص نشده است',
    authenticationRequiredForExport: 'برای ایجاد خروجی، احراز هویت کاربر الزامی است.',
    autosaving: 'هنگام ذخیره خودکار این صفحه، خطایی رخ داد.',
    busboyMultipartError: 'خطای Busboy در پردازش درخواست چندبخشی',
    collectionSlugRequired: 'شناسه مجموعه الزامی است',
    contentTypeExpectedJSON: 'Content-Type باید application/json باشد',
    ...
    eitherCollectionOrGlobalRequired: 'یکی از collection یا globalSlug باید ارسال شود.',
    emailOrPasswordIncorrect: 'ایمیل یا رمز عبور اشتباه است.',
    expectedResponseFromUploadHandler: 'پاسخی از هندلر آپلود انتظار می‌رفت.',
    failedToFetchFromURL: 'دریافت فایل از URL ارائه شده ناموفق بود.',
    failedToResetLayout: 'تنظیم مجدد طرح ناموفق بود.',
    failedToSaveLayout: 'تنظیمات ذخیره نشد.',
    fieldMustBeSpecified: 'فیلد باید مشخص شود',
    fieldsNotInitialized: 'فیلدها مقداردهی اولیه نشده‌اند.',
    filenameRequired: 'نام فایل الزامی است.',
    ...
    invalidFileURL: 'URL فایل نامعتبر است',
    invalidJSON: 'JSON نامعتبر است',
    invalidJSONFormat: 'فرمت JSON نامعتبر است',
    invalidRequestArgs: 'آرگومان‌های نامعتبری در درخواست ارسال شد: {{args}}',
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'فیلدهای Join نمی‌توانند به آرایه‌ها، بلاک‌ها یا سراسری‌ها اضافه شوند.',
    ...
    missingIDOfVersionToRestore: 'شناسه نسخه برای بازیابی مشخص نشده است.',
    missingRequiredData: 'اطلاعات مورد نیاز ارسال نشده است.',
    noConnectionToDatabase:
      'beginTransaction فراخوانی شد در حالی که اتصالی به پایگاه داده وجود ندارد',
    noFileDataForImport: 'اطلاعات فایلی برای ورود ارائه نشده است',
    noFilesUploaded: 'هیچ فایلی آپلود نشده است.',
    noMatchedField: 'فیلدی با عنوان "{{label}}" پیدا نشد.',
    noPayloadProvided: 'هیچ payload ارسال نشده است',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Join های قابل مرتب‌سازی باید به یک مجموعه واحد اشاره کنند',
    pastingFromURLNotEnabled: 'جای‌گذاری از URL برای این مجموعه فعال نیست.',
    previewing: 'هنگام نمایش پیش‌نمایش این فایل، خطایی رخ داد.',
    problemUploadingFile: 'هنگام آپلود فایل خطایی رخ داد.',
    redirectTargetNotAllowed: 'مقصد تغییرمسیر مجاز نیست.',
    relationshipFieldNotFound: 'فیلد ارتباطی یافت نشد',
    relationshipNotFound: 'ارتباط یافت نشد',
    requestDataRequired: 'اطلاعات درخواست الزامی است.',
    requestNotEligibleForFileUpload: 'درخواست واجد شرایط آپلود فایل نیست',
    requestURLMissing: 'URL درخواست مشخص نشده است.',
    restoringTitle:
    ...
    tooManyRedirects: 'تعداد تغییرمسیرها بیش از حد مجاز است.',
    ...
    unexpectedArrayCollectionSlug: 'آرایه غیرمنتظره از collectionSlug، والد باید ارائه شود',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers برای {{collection}} موجود نیست',
    uploadthingUnknownError: 'خطا در آپلود فایل با uploadthing: خطای ناشناخته',
    urlNotAllowed: 'URL ارائه شده مجاز نیست.',
    ...
    userRequiredForImport: 'کاربر برای عملیات ورود اطلاعات الزامی است',
    validURLRequired: 'یک رشته URL معتبر الزامی است.',
    valueMustBeUnique: 'این مقدار باید منحصر به فرد باشد.',
    vercelBlobUploadError: 'خطای مسیر آپلود کلاینت storage-vercel-blob',
