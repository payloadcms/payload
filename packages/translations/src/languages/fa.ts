...
export const faTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection:
      'امکان خواندن فایل بارگذاری شده جهت شناسایی نوع آن وجود ندارد.',
    couldNotReadFileForValidation: 'امکان خواندن فایل بارگذاری‌شده جهت اعتبارسنجی وجود ندارد.',
    crop: 'برش',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'نوع پرونده {{mimeType}} (بر اساس پسوند {{extension}}) مجاز نیست.',
    focalPoint: 'نقطه کانونی',
    focalPointDescription: 'نقطه کانونی را مستقیماً روی تصویر بکشید یا مقادیر زیر را تنظیم کنید.',
    height: 'ارتفاع',
    invalidMimeType: 'نوع MIME نامعتبر: {{mimeType}}.',
    invalidOrCorruptedPDF: 'فایل PDF نامعتبر یا خراب است.',
    ...
    restrictedFileType:
      "نوع پرونده '{{mimeType}}' برای {{fileName}} مجاز نیست: نوع پرونده محدود شناسایی شد — برای عبور از این بررسی در این Collection، گزینه 'allowRestrictedFileTypes' را روی true تنظیم کنید.",
    ...
    svgHarmfulContent: 'فایل SVG شامل محتوایی با پتانسیل آسیب‌رسان است.',
    width: 'عرض',
  },
  validation: {
