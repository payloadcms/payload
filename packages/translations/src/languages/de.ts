...
export const deTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Dokumente',
    draftsHint: 'Ihre neuesten Entwürfe erscheinen hier',
    dropFiles: 'Dateien zum Hochladen ablegen',
    editDashboard: 'Dashboard bearbeiten',
    editingDashboard: 'Dashboard bearbeiten',
    gridView: 'Rasteransicht',
    listView: 'Listenansicht',
    loadError: 'Einige Dokumente konnten nicht geladen werden. Bitte aktualisieren.',
    noDrafts: 'Keine aktuellen Entwürfe',
    noItems:
      'Auf deinem Dashboard befinden sich keine Widgets. Du kannst diese über das "Dashboard"-Menü in der oberen Leiste hinzufügen.',
    noPinned: 'Keine angehefteten Dokumente',
    noRecents: 'Keine zuletzt angesehenen Dokumente',
    pinDocument: '{{title}} anheften',
    pinned: 'Angeheftet',
    pinnedHint: 'Angeheftete Dokumente erscheinen hier',
    recentDrafts: 'Neueste Entwürfe',
    recentlyViewed: 'Zuletzt angesehen',
    recentsHint: 'Angesehene Dokumente erscheinen hier',
    resetLayout: 'Layout zurücksetzen',
    saveError: 'Die Dashboard-Einstellung konnte nicht gespeichert werden. Bitte erneut versuchen.',
    searchWidgets: 'Suche Widgets...',
    unpinDocument: '{{title}} lösen',
    updatedBy: 'Aktualisiert von',
    uploadDropzone: 'Upload-Bereich',
    uploadFiles: 'Dateien hochladen',
    uploadHint: 'Dateien vom Computer hierher ziehen oder auf die Schaltfläche unten klicken',
    viewMode: 'Dokumentansicht',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Kopfzeile und Steuerelemente ausrichten',
    all: 'Alle',
    ...
    editViewWidth: 'Breite der Bearbeitungsansicht',
    editViewWidthFull: 'Volle Breite',
    email: 'E-Mail',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Textgrößen',
    typeSizeSmall: 'Aktuell',
