...
export const deTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Kopieren',
    copyWarning:
      'Sie sind dabei, Daten von {{from}} nach {{to}} zu kopieren. Dies wird alle vorhandenen {{to}} Daten überschreiben und Sie zur weiteren Bearbeitung dieser Lokalisierung weiterleiten. Sind Sie sicher, dass Sie fortfahren möchten?',
    create: 'Erstellen',
    created: 'Erstellt',
