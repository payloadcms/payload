...
export const deTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: '{{count}} weitere Änderungen',
    branch: 'Branch',
    branchClosed:
      'Dieser Branch ist geschlossen. Er bleibt als Nachweis darüber erhalten, was zusammengeführt wurde.',
    branchDescription: 'Branch-Beschreibung',
    branchedFrom: 'Abgezweigt von',
    branches: 'Branches',
    branchHistory: 'Branch-Verlauf',
    branchMerging: 'Wird zusammengeführt',
    branchName: 'Branch-Name',
    branchSettings: 'Branch-Einstellungen',
    cancelSchedule: 'Zusammenführung abbrechen',
    changedDocuments: 'Geänderte Dokumente',
    changesTo: 'Änderungen an {{summary}}',
    closeBranchAfterMerge: 'Diesen Branch nach dem Zusammenführen schließen',
    closeBranchHelpOff:
      'Der Branch bleibt offen, sodass Sie weiter daran arbeiten und ihn später erneut zusammenführen können.',
    closeBranchHelpOn:
      'Der Branch wird schreibgeschützt und kann nicht erneut zusammengeführt werden.',
    confirmDiscardAll:
      'Alle {{count}} geänderten Dokumente in diesem Branch werden auf ihren Stand in main zurückgesetzt. Das kann nicht rückgängig gemacht werden.',
    confirmDiscardSelected:
      '{{count}} geänderte Dokumente werden auf ihren Stand in main zurückgesetzt. Das kann nicht rückgängig gemacht werden.',
    createAndSwitch: 'Erstellen und wechseln',
    createNewBranch: 'Neuen Branch erstellen',
    currentChanges: 'Aktuelle Änderungen',
    defaultBranch: 'Standard',
    discardAll: 'Alle verwerfen ({{count}})',
    discardChanges: 'Änderungen verwerfen',
    discardedCount: '{{count}} Änderungen verworfen.',
    discarding: 'Wird verworfen…',
    discardSelected: 'Auswahl verwerfen ({{count}})',
    historyPageOf: 'Seite {{page}} von {{total}}',
    manage: 'Verwalten',
    manageBranches: 'Branches verwalten…',
    merge: 'Zusammenführen',
    mergeAllChanges: 'Alle Änderungen in diesem Branch werden übernommen.',
    mergeAllCount: 'Alle {{count}} geänderten Dokumente in diesem Branch werden übernommen.',
    mergeBranchInto: '{{branch}} in {{target}} zusammenführen',
    mergeChanges: 'Änderungen zusammenführen',
    mergeComplete: 'Zusammenführung abgeschlossen',
    merged: 'Zusammengeführt',
    mergedByCount: '{{count}} Dokumente von {{user}}',
    mergedCount: '{{count}} Änderungen zusammengeführt.',
    mergedOfTotal: '{{current}} von {{total}} zusammengeführt',
    mergedOn: 'Zusammengeführt am {{date}}',
    mergeHistory: 'Zusammenführungsverlauf',
    mergeInterrupted:
      'Die Zusammenführung wurde unterbrochen und nichts wurde übernommen. Bitte erneut versuchen.',
    mergeNow: 'Jetzt zusammenführen',
    mergeOnlySelected: 'Auswählen, welche Änderungen zusammengeführt werden',
    mergeScheduledFor: 'Zusammenführung geplant für {{date}}.',
    mergeSelectedOfTotal: '{{selected}} von {{total}} geänderten Dokumenten werden übernommen.',
    mergeStarting: 'Zusammenführung wird gestartet…',
    merging: 'Wird zusammengeführt…',
    mergingProgress: '{{current}} von {{total}} wird zusammengeführt',
    noChangesYet: 'Noch keine Änderungen in diesem Branch.',
    operation_create: 'Erstellt',
    operation_delete: 'Gelöscht',
    operation_update: 'Aktualisiert',
    reviewingChangedDocuments: 'Geänderte Dokumente überprüfen',
    scheduleAnotherMerge: 'Weitere Zusammenführung planen',
    scheduleCancelled: 'Geplante Zusammenführung abgebrochen.',
    scheduleCount: '{{count}} geplant',
    scheduledMerges: 'Geplante Zusammenführungen',
    scheduledToMerge: 'Zusammenführung geplant',
    scheduledToMergeOn: 'Dieser Branch wird am {{date}} zusammengeführt.',
    scheduleHasNothingLeft:
      'Es ist nichts mehr anzuwenden – diese Änderungen wurden verworfen oder bereits zusammengeführt.',
    scheduleMerge: 'Zusammenführung planen',
    scheduleMergeHelp:
      'Die Zusammenführung läuft zur gewählten Zeit, wobei Ihre Berechtigungen dann erneut geprüft werden.',
    scheduleWillApplyAll: 'Wendet alles Ausstehende an ({{count}})',
    scheduleWillApplySelected: 'Wendet {{count}} ausgewählte Änderung(en) an',
    scheduling: 'Wird geplant…',
    searchBranches: 'Branches durchsuchen',
    selectBranch: 'Branch auswählen',
    untouchedDocumentsNote:
      'Dokumente, die Sie in diesem Branch nicht geändert haben, zeigen den aktuellen Inhalt von main und nicht einen Schnappschuss vom Zeitpunkt der Erstellung des Branches.',
  },
  commandPalette: {
    actions: 'Aktionen',
  ...
  error: {
    ...
    fileFetchFailed: 'Datei konnte nicht abgerufen werden.',
    ...
    noFileFoundInClipboard: 'Keine Datei in der Zwischenablage gefunden.',
    ...
    unableToReadClipboard: 'Kann nicht aus der Zwischenablage lesen.',
    ...
    urlNotAllowed: 'Die angegebene URL ist nicht zulässig.',
