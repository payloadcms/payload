...
export const deTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Diese Aktion wird dich von diesem Preset aussperren.',
    attachmentContentInvalid: 'Anhanginhalt muss ein String oder Buffer sein',
    attachmentMissingContentAndPath: 'Dem Anhang fehlen sowohl Inhalt als auch Pfad',
    attachmentMissingFilename: 'Dem Anhang fehlt der Dateiname',
    authenticationRequiredForExport:
      'Benutzerauthentifizierung ist erforderlich, um Exporte zu erstellen.',
    autosaving: 'Es gab ein Problem bei der automatischen Speicherung für dieses Dokument',
    busboyMultipartError: 'Busboy-Fehler beim Parsen der Multipart-Anfrage',
    collectionSlugRequired: 'Collection-Slug ist erforderlich',
    contentTypeExpectedJSON: 'Content-Type sollte application/json sein',
    ...
    eitherCollectionOrGlobalRequired: 'Collection oder globalSlug muss angegeben werden.',
    emailOrPasswordIncorrect: 'Die E-Mail-Adresse oder das Passwort sind nicht korrekt.',
    expectedResponseFromUploadHandler: 'Antwort vom Upload-Handler erwartet.',
    failedToFetchFromURL: 'Datei konnte nicht von der angegebenen URL abgerufen werden.',
    failedToResetLayout: 'Layout konnte nicht zurückgesetzt werden.',
    failedToSaveLayout: 'Layout konnte nicht gespeichert werden.',
    fieldMustBeSpecified: 'Feld muss angegeben werden',
    fieldsNotInitialized: 'Felder sind nicht initialisiert.',
    ...
    invalidFileURL: 'Ungültige Datei-URL',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Join-Felder können nicht zu Arrays, Blöcken oder Globals hinzugefügt werden.',
    ...
    missingIDOfVersionToRestore: 'ID der wiederherzustellenden Version fehlt.',
    missingRequiredData: 'Erforderliche Daten fehlen.',
    noConnectionToDatabase:
      'beginTransaction aufgerufen, ohne dass eine Datenbankverbindung besteht',
    noFileDataForImport: 'Keine Dateidaten für Import bereitgestellt',
    noFilesUploaded: 'Es wurden keine Dateien hochgeladen.',
    noMatchedField: 'Kein übereinstimmendes Feld für "{{label}}" gefunden',
    noPayloadProvided: 'Keine Payload bereitgestellt',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Sortierbare Joins müssen auf eine einzelne Collection abzielen',
    pastingFromURLNotEnabled: 'Das Einfügen von URL ist für diese Collection nicht aktiviert.',
    ...
    redirectTargetNotAllowed: 'Umleitungsziel nicht erlaubt.',
    relationshipFieldNotFound: 'Beziehungsfeld nicht gefunden',
    relationshipNotFound: 'Beziehung nicht gefunden',
    requestDataRequired: 'Anfragedaten erforderlich.',
    requestNotEligibleForFileUpload: 'Die Anfrage ist nicht für Datei-Upload geeignet',
    requestURLMissing: 'Anfrage-URL fehlt.',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug:
      'Unerwartetes Array von collectionSlug, parent muss angegeben werden',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers ist nicht vorhanden für {{collection}}',
    uploadthingUnknownError: 'Fehler beim Hochladen der Datei mit uploadthing: Unbekannter Fehler',
    urlNotAllowed: 'Die angegebene URL ist nicht erlaubt.',
    ...
    userRequiredForImport: 'Benutzer ist für Import-Operationen erforderlich',
    validURLRequired: 'Eine gültige URL ist erforderlich.',
    valueMustBeUnique: 'Wert muss eindeutig sein',
    vercelBlobUploadError: 'Fehler bei storage-vercel-blob Client-Upload-Route',
