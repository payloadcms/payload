...
export const ukTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Ця дія заблокує вам доступ до цього пресету.',
    attachmentContentInvalid: 'Вміст вкладення має бути рядком або буфером',
    attachmentMissingContentAndPath: 'У вкладення відсутні як вміст, так і шлях',
    attachmentMissingFilename: "У вкладення відсутнє ім'я файлу",
    authenticationRequiredForExport: 'Для створення експорту потрібна автентифікація користувача.',
    autosaving: 'Виникла проблема під час автозбереження цього документа.',
    busboyMultipartError: 'Помилка аналізу multipart запиту Busboy',
    collectionSlugRequired: 'Потрібен slug колекції',
    contentTypeExpectedJSON: 'Очікується Content-Type application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Потрібно передати collection або globalSlug.',
    emailOrPasswordIncorrect: 'Вказана адреса електронної пошти або пароль є невірними',
    expectedResponseFromUploadHandler: 'Очікується відповідь від обробника завантаження.',
    failedToFetchFromURL: 'Не вдалося завантажити файл з наданої URL-адреси.',
    failedToResetLayout: 'Не вдалося скинути макет.',
    failedToSaveLayout: 'Не вдалося зберегти макет.',
    fieldMustBeSpecified: 'поле має бути вказано',
    fieldsNotInitialized: 'Поля не ініціалізовано.',
    filenameRequired: "Ім'я файлу обов'язкове.",
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Поля join не дозволені в масивах, блоках або глобалах.',
    ...
    missingIDOfVersionToRestore: 'Відсутній ID версії для відновлення.',
    missingRequiredData: "Відсутні обов'язкові дані.",
    noConnectionToDatabase: 'beginTransaction викликано без підключення до бази даних',
    noFileDataForImport: 'Не надано дані файлу для імпорту',
    noFilesUploaded: 'Жодного файлу не було завантажено.',
    noMatchedField: 'Не знайдено відповідного поля для "{{label}}"',
    noPayloadProvided: 'Payload не надано',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Сортувальні join повинні бути спрямовані на одну колекцію',
    pastingFromURLNotEnabled: 'Вставка з URL не увімкнена для цієї колекції.',
    ...
    redirectTargetNotAllowed: 'Ціль переспрямування не дозволена.',
    relationshipFieldNotFound: 'Поле відношення не знайдено',
    relationshipNotFound: 'Відношення не знайдено',
    requestDataRequired: 'Потрібні дані запиту.',
    requestNotEligibleForFileUpload: 'Запит не придатний для завантаження файлу',
    requestURLMissing: 'URL-адреса запиту відсутня.',
    restoringTitle:
    ...
    tooManyRedirects: 'Забагато переспрямувань.',
    ...
    unexpectedArrayCollectionSlug: 'Неочікуваний slug колекції масиву',
    ...
    uploadConfigHandlersMissing: 'Відсутні обробники конфігурації завантаження',
    uploadthingUnknownError: 'Невідома помилка Uploadthing',
    urlNotAllowed: 'URL не дозволена',
    ...
    userRequiredForImport: 'Для імпорту потрібен користувач',
    validURLRequired: 'Потрібна дійсна URL-адреса',
    valueMustBeUnique: 'Значення має бути унікальним',
    vercelBlobUploadError: 'Помилка завантаження Vercel Blob',
