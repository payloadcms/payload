...
export const ukTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Копіювання',
    copyWarning:
      'Ви збираєтеся скопіювати дані з {{from}} до {{to}}. Це перезапише будь-які існуючі дані {{to}} і перенаправить вас для продовження редагування цієї локалі. Ви впевнені, що хочете продовжити?',
    create: 'Створити',
    created: 'Створено',
