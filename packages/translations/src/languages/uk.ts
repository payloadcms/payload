  ...
  translations: {
    authentication: {
      ...
      checkYourEmailForPasswordReset:
        'Перевірте вашу пошту на наявність посилання, що дозволить вам безпечно скинути пароль',
      ...
      newAccountCreated:
        'Новий обліковий запис було створено, щоб отримати доступ до <a href="{{serverURL}}">{{serverURL}}</a>, будь ласка, натисніть на наступне посилання, або вставте його в адресний рядок браузера, щоб підтвердити вашу пошту: <a href="{{verificationURL}}">{{verificationURL}}</a><br> Після підтвердження вашої електронно пошти, ви зможете увійти в систему.',
    ...
    general: {
      ...
      cancel: 'Скасувати',
      changesNotSaved:
        'Ваши зміни не були збережені. Якщо ви вийдете зараз, то втратите свої зміни.',
      close: 'Закрити',
      collapse: 'Згорнути',
    ...
    validation: {
      ...
      longerThanMin:
        'Це значення має бути довшим, ніж мінімальна кількість символів {{minLength}}.',
      ...
      shorterThanMax: 'Це значення має бути коротшим, ніж максимальна кількість символів {{maxLength}}.',
