...
export const ukTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Копіювання',
    copyWarning:
      'Ви збираєтесь скопіювати дані з {{from}} до {{to}}. Це перезапише будь-які існуючі дані {{to}} і перенаправить вас продовжити редагування цієї локалізації. Ви впевнені, що хочете продовжити?',
    create: 'Створити',
    created: 'Створено',
