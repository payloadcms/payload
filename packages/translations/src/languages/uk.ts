...
export const ukTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    apiKey: 'API ключ',
    apiKeyGeneratedOnSave: 'API-ключ генерується під час збереження.',
    apiKeyIsHidden:
      'Цей API ключ зберігається у вигляді одностороннього хешу та не може бути показаний повторно. Згенеруйте новий ключ, якщо у вас його більше немає.',
    ...
    copyAPIKeyNow: 'Скопіюйте цей API-ключ зараз. Він більше не буде показаний.',
