...
export const ukTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'Не вдалося прочитати завантажений файл для визначення типу.',
    couldNotReadFileForValidation: 'Не вдалося прочитати завантажений файл для перевірки.',
    crop: 'Обрізати',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'Тип файлу {{mimeType}} (з розширенням {{extension}}) не дозволений.',
    ...
    height: 'Висота',
    invalidMimeType: 'Недійсний тип MIME: {{mimeType}}.',
    invalidOrCorruptedPDF: 'Недійсний або пошкоджений файл PDF.',
    ...
    restrictedFileType:
      "Тип файлу '{{mimeType}}' не дозволений для {{fileName}}: виявлено обмежений тип файлу — встановіть 'allowRestrictedFileTypes' у значення true, щоб пропустити цю перевірку для цієї Collection.",
    ...
    svgHarmfulContent: 'Файл SVG містить потенційно шкідливий вміст.',
    width: 'Ширина',
  },
  validation: {
