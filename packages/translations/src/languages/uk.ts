...
export const ukTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Документи',
    draftsHint: 'Ваші нещодавні чернетки з’являться тут',
    dropFiles: 'Перетягніть сюди файли для завантаження',
    editDashboard: 'Редагувати макет',
    editingDashboard: 'Редагування макету',
    gridView: 'Сітка',
    listView: 'Список',
    loadError: 'Не вдалося завантажити деякі документи. Оновіть сторінку.',
    noDrafts: 'Немає нещодавніх чернеток',
    noItems:
      'На вашій панелі немає віджетів. Ви можете додати їх з меню "Головна", розташованого в верхній панелі.',
    noPinned: 'Немає закріплених документів',
    noRecents: 'Немає нещодавно переглянутих документів',
    pinDocument: 'Закріпити {{title}}',
    pinned: 'Закріплені',
    pinnedHint: 'Закріплені документи з’являться тут',
    recentDrafts: 'Нещодавні чернетки',
    recentlyViewed: 'Нещодавно переглянуті',
    recentsHint: 'Переглянуті документи з’являться тут',
    resetLayout: 'Скинути макет',
    saveError: 'Не вдалося зберегти налаштування панелі. Спробуйте ще раз.',
    searchWidgets: 'Пошук віджетів...',
    unpinDocument: 'Відкріпити {{title}}',
    updatedBy: 'Оновив',
    uploadDropzone: 'Область завантаження',
    uploadFiles: 'Завантажити файли',
    uploadHint: 'Перетягніть файли з комп’ютера або натисніть кнопку нижче',
    viewMode: 'Вигляд документів',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Вирівняти заголовок і елементи керування',
    all: 'Все',
    ...
    editViewWidth: 'Ширина подання редагування',
    editViewWidthFull: 'Повна',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Розміри тексту',
    typeSizeSmall: 'Поточний',
