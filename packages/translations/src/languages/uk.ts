...
export const ukTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    checkYourEmailForPasswordReset:
      'Якщо ця електронна адреса пов’язана з обліковим записом, ви незабаром отримаєте інструкції для скидання пароля. Будь ласка, перевірте папку зі спамом або небажаною поштою, якщо ви не бачите електронного листа у своїй вхідній скриньці.',
