...
export const ukTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'Електронну пошту успішно підтверджено. Перенаправлення до входу...',
  ...
  branching: {
    andMoreChanges: 'ще {{count}} змін',
    branch: 'Гілка',
    branchClosed: 'Ця гілка закрита. Вона зберігається як запис того, що було обʼєднано.',
    branchDescription: 'Опис гілки',
    branchedFrom: 'Відгалужено від',
    branches: 'Гілки',
    branchHistory: 'Історія гілки',
    branchMerging: 'Обʼєднання',
    branchName: 'Назва гілки',
    branchSettings: 'Налаштування гілки',
    cancelSchedule: 'Скасувати злиття',
    changedDocuments: 'Змінені документи',
    changesTo: 'Зміни: {{summary}}',
    closeBranchAfterMerge: 'Закрити цю гілку після обʼєднання',
    closeBranchHelpOff:
      'Гілка залишиться відкритою, тож ви зможете продовжити роботу й обʼєднати її знову пізніше.',
    closeBranchHelpOn:
      'Гілка стане доступною лише для читання, і обʼєднати її знову буде неможливо.',
    confirmDiscardAll:
      'Усі {{count}} змінених документів у цій гілці повернуться до стану в main. Цю дію не можна скасувати.',
    confirmDiscardSelected:
      '{{count}} змінених документів повернуться до стану в main. Цю дію не можна скасувати.',
    createAndSwitch: 'Створити й перейти',
    createNewBranch: 'Створити нову гілку',
    currentChanges: 'Поточні зміни',
    defaultBranch: 'за замовчуванням',
    discardAll: 'Скасувати всі ({{count}})',
    discardChanges: 'Скасувати зміни',
    discardedCount: 'Скасовано змін: {{count}}.',
    discarding: 'Скасування…',
    discardSelected: 'Скасувати вибрані ({{count}})',
    historyPageOf: 'Сторінка {{page}} з {{total}}',
    manage: 'Керувати',
    manageBranches: 'Керування гілками…',
    merge: 'Обʼєднати',
    mergeAllChanges: 'Буде застосовано всі зміни цієї гілки.',
    mergeAllCount: 'Буде застосовано всі {{count}} змінених документів цієї гілки.',
    mergeBranchInto: 'Обʼєднати {{branch}} у {{target}}',
    mergeChanges: 'Обʼєднати зміни',
    mergeComplete: 'Обʼєднання завершено',
    merged: 'Обʼєднана',
    mergedByCount: '{{count}} документів, {{user}}',
    mergedCount: 'Обʼєднано змін: {{count}}.',
    mergedOfTotal: 'Обʼєднано {{current}} з {{total}}',
    mergedOn: 'Обʼєднано {{date}}',
    mergeHistory: 'Історія обʼєднань',
    mergeInterrupted: 'Обʼєднання було перервано, і нічого не застосовано. Спробуйте ще раз.',
    mergeNow: 'Обʼєднати зараз',
    mergeOnlySelected: 'Виберіть, які зміни обʼєднати',
    mergeScheduledFor: 'Обʼєднання заплановано на {{date}}.',
    mergeSelectedOfTotal: 'Буде застосовано {{selected}} з {{total}} змінених документів.',
    mergeStarting: 'Початок обʼєднання…',
    merging: 'Обʼєднання…',
    mergingProgress: 'Обʼєднання {{current}} з {{total}}',
    noChangesYet: 'У цій гілці ще немає змін.',
    operation_create: 'Створено',
    operation_delete: 'Видалено',
    operation_update: 'Оновлено',
    reviewingChangedDocuments: 'Перегляд змінених документів',
    scheduleAnotherMerge: 'Запланувати ще обʼєднання',
    scheduleCancelled: 'Заплановане обʼєднання скасовано.',
    scheduleCount: 'Заплановано: {{count}}',
    scheduledMerges: 'Заплановані обʼєднання',
    scheduledToMerge: 'Обʼєднання заплановано',
    scheduledToMergeOn: 'Цю гілку заплановано обʼєднати {{date}}.',
    scheduleHasNothingLeft: 'Застосовувати нічого — ці зміни скасовано або вже обʼєднано.',
    scheduleMerge: 'Запланувати обʼєднання',
    scheduleMergeHelp: 'Обʼєднання виконається у вибраний час, і ваші права буде перевірено знову.',
    scheduleWillApplyAll: 'Застосує все, що очікує ({{count}})',
    scheduleWillApplySelected: 'Застосує вибраних змін: {{count}}',
    scheduling: 'Планування…',
    searchBranches: 'Пошук гілок',
    selectBranch: 'Вибрати гілку',
    untouchedDocumentsNote:
      'Документи, які ви не змінювали у цій гілці, відображають поточний вміст main, а не знімок стану на момент створення цієї гілки.',
  },
  commandPalette: {
    actions: 'Дії',
  ...
  error: {
    ...
    fileFetchFailed: 'Не вдалося отримати файл.',
    ...
    noFileFoundInClipboard: 'Файл у буфері обміну не знайдено.',
    ...
    unableToReadClipboard: 'Неможливо зчитати з буфера обміну.',
    ...
    urlNotAllowed: 'Надане посилання не дозволено.',
  ...
  general: {
    ...
    delete: 'Видалити',
    deleted: 'Видалено',
    deletedAgo: 'Видалено {{distance}} тому',
    ...
    editColumns: 'Редагувати стовпці',
  ...
  upload: {
    ...
    fromURL: 'Завантажити файл з URL-адреси',
    height: 'Висота',
