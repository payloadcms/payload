...
export const esTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    draftsHint: 'Tus borradores recientes aparecerán aquí',
    dropFiles: 'Suelta archivos para cargarlos',
    editDashboard: 'Editar el Panel de Control',
    editingDashboard: 'Editando el Tablero',
    gridView: 'Vista de cuadrícula',
    listView: 'Vista de lista',
    loadError: 'No se pudieron cargar algunos documentos. Actualiza para volver a intentarlo.',
    noDrafts: 'No hay borradores recientes',
    noItems:
      'No hay widgets en su tablero. Puede agregarlos desde el menú "Tablero" ubicado en la barra superior.',
    noPinned: 'No hay documentos fijados',
    noRecents: 'No hay documentos vistos recientemente',
    pinDocument: 'Fijar {{title}}',
    pinned: 'Fijados',
    pinnedHint: 'Los documentos que fijes aparecerán aquí',
    recentDrafts: 'Borradores recientes',
    recentlyViewed: 'Vistos recientemente',
    recentsHint: 'Los documentos que veas aparecerán aquí',
    resetLayout: 'Restablecer Diseño',
    saveError: 'No se pudo guardar la preferencia del panel. Inténtalo de nuevo.',
    searchWidgets: 'Buscar widgets...',
    unpinDocument: 'Desfijar {{title}}',
    updatedBy: 'Actualizado por',
    uploadDropzone: 'Zona de carga',
    uploadFiles: 'Cargar archivos',
    uploadHint: 'Arrastra archivos desde tu equipo o haz clic en el botón de abajo',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Alinear el encabezado y los controles',
    all: 'Todo',
    ...
    editViewWidth: 'Ancho de la vista de edición',
    editViewWidthFull: 'Completo',
