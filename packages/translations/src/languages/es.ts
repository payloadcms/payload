...
export const esTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    localesNotSaved_one: 'No se pudo guardar la siguiente idioma:',
    localesNotSaved_other: 'No se pudieron guardar las siguientes idiomas:',
  ...
  general: {
    ...
    errors: 'Errores',
    export: 'Exportación',
    fallbackToDefaultLocale: 'Volver a la idioma configurada por defecto',
    false: 'Falso',
    filter: 'Filtro',
    filters: 'Filtros',
  ...
  localization: {
    cannotCopySameLocale: 'No se puede copiar a la misma idioma',
    copyFrom: 'Copiar de',
    copyFromTo: 'Copiando de {{from}} a {{to}}',
    copyTo: 'Copia a',
    copyToLocale: 'Copiar a idioma',
    localeToPublish: 'Idioma para publicar',
    selectLocaleToCopy: 'Seleccione la idioma para copiar',
  },
  operators: {
    contains: 'contiene',
    equals: 'igual',
  ...
  version: {
    ...
    publish: 'Publicar',
    publishAllLocales: 'Publicar todas las idiomas',
