...
export const esTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Esta acción te bloqueará el acceso a este preajuste.',
    attachmentContentInvalid: 'El contenido del adjunto debe ser una cadena o un búfer',
    attachmentMissingContentAndPath: 'El adjunto carece de contenido y ruta',
    attachmentMissingFilename: 'Falta el nombre de archivo del adjunto',
    authenticationRequiredForExport:
      'Se requiere autenticación de usuario para crear exportaciones.',
    autosaving: 'Hubo un problema al guardar automáticamente este documento.',
    busboyMultipartError: 'Error de Busboy al analizar la solicitud multipart',
    collectionSlugRequired: 'Se requiere el slug de colección',
    contentTypeExpectedJSON: 'Se esperaba que Content-Type fuera application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Se debe proporcionar collection o globalSlug.',
    emailOrPasswordIncorrect: 'El correo o la contraseña son incorrectos.',
    expectedResponseFromUploadHandler: 'Se esperaba respuesta del controlador de carga.',
    failedToFetchFromURL: 'No se pudo obtener el archivo de la URL proporcionada.',
    failedToResetLayout: 'Error al restablecer la disposición.',
    failedToSaveLayout: 'Error al guardar la disposición.',
    fieldMustBeSpecified: 'El campo debe ser especificado',
    fieldsNotInitialized: 'Los campos no están inicializados.',
    filenameRequired: 'Se requiere un nombre de archivo.',
    ...
    invalidFileURL: 'URL de archivo inválida',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Los campos de unión no se pueden agregar a arrays, bloques o globales.',
    ...
    missingIDOfVersionToRestore: 'Falta el ID de la versión a restaurar.',
    missingRequiredData: 'Falta información obligatoria.',
    noConnectionToDatabase: 'beginTransaction llamado sin conexión a la base de datos',
    noFileDataForImport: 'No se proporcionaron datos de archivo para la importación',
    noFilesUploaded: 'No se subieron archivos.',
    noMatchedField: 'No se encontró un campo para "{{label}}"',
    noPayloadProvided: 'No se proporcionó carga útil',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Las uniones ordenables deben apuntar a una sola colección',
    pastingFromURLNotEnabled: 'Pegar desde URL no está habilitado para esta colección.',
    ...
    redirectTargetNotAllowed: 'Destino de redirección no permitido.',
    relationshipFieldNotFound: 'Campo de relación no encontrado',
    relationshipNotFound: 'Relación no encontrada',
    requestDataRequired: 'Se requieren datos de solicitud.',
    requestNotEligibleForFileUpload: 'La solicitud no es elegible para carga de archivos',
    requestURLMissing: 'Falta la URL de solicitud.',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug:
      'Array inesperado de collectionSlug, se debe proporcionar parent',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers no está presente para {{collection}}',
    uploadthingUnknownError: 'Error al cargar archivo con uploadthing: Error desconocido',
    ...
    userRequiredForImport: 'Se requiere usuario para operaciones de importación',
    validURLRequired: 'Se requiere una URL válida.',
    valueMustBeUnique: 'El valor debe ser único',
    vercelBlobUploadError: 'Error en la ruta de carga del cliente storage-vercel-blob',
