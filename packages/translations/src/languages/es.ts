...
export const esTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: '{{count}} cambios más',
    branch: 'Rama',
    branchClosed: 'Esta rama está cerrada. Se conserva como registro de lo que fusionó.',
    branchDescription: 'Descripción de la rama',
    branchedFrom: 'Ramificada desde',
    branches: 'Ramas',
    branchHistory: 'Historial de la rama',
    branchMerging: 'Fusionando',
    branchName: 'Nombre de la rama',
    branchSettings: 'Ajustes de la rama',
    cancelSchedule: 'Cancelar la fusión',
    changedDocuments: 'Documentos modificados',
    changesTo: 'Cambios en {{summary}}',
    closeBranchAfterMerge: 'Cerrar esta rama después de fusionar',
    closeBranchHelpOff:
      'La rama permanece abierta, así que puedes seguir trabajando en ella y fusionarla de nuevo más tarde.',
    closeBranchHelpOn: 'La rama pasará a ser de solo lectura y no podrá fusionarse de nuevo.',
    confirmDiscardAll:
      'Los {{count}} documentos modificados de esta rama volverán a su estado en main. Esto no se puede deshacer.',
    confirmDiscardSelected:
      '{{count}} documentos modificados volverán a su estado en main. Esto no se puede deshacer.',
    createAndSwitch: 'Crear y cambiar',
    createNewBranch: 'Crear nueva rama',
    currentChanges: 'Cambios actuales',
    defaultBranch: 'predeterminada',
    discardAll: 'Descartar todo ({{count}})',
    discardChanges: 'Descartar cambios',
    discardedCount: '{{count}} cambios descartados.',
    discarding: 'Descartando…',
    discardSelected: 'Descartar seleccionados ({{count}})',
    historyPageOf: 'Página {{page}} de {{total}}',
    manage: 'Gestionar',
    manageBranches: 'Gestionar ramas…',
    merge: 'Fusionar',
    mergeAllChanges: 'Se aplicarán todos los cambios de esta rama.',
    mergeAllCount: 'Se aplicarán los {{count}} documentos modificados de esta rama.',
    mergeBranchInto: 'Fusionar {{branch}} en {{target}}',
    mergeChanges: 'Fusionar cambios',
    mergeComplete: 'Fusión completada',
    merged: 'Fusionada',
    mergedByCount: '{{count}} documentos por {{user}}',
    mergedCount: '{{count}} cambios fusionados.',
    mergedOfTotal: '{{current}} de {{total}} fusionados',
    mergedOn: 'Fusionado el {{date}}',
    mergeHistory: 'Historial de fusiones',
    mergeInterrupted: 'La fusión se interrumpió y no se aplicó nada. Inténtalo de nuevo.',
    mergeNow: 'Fusionar ahora',
    mergeOnlySelected: 'Elige qué cambios fusionar',
    mergeScheduledFor: 'Fusión programada para {{date}}.',
    mergeSelectedOfTotal: 'Se aplicarán {{selected}} de {{total}} documentos modificados.',
    mergeStarting: 'Iniciando la fusión…',
    merging: 'Fusionando…',
    mergingProgress: 'Fusionando {{current}} de {{total}}',
    noChangesYet: 'Aún no hay cambios en esta rama.',
    operation_create: 'Creado',
    operation_delete: 'Eliminado',
    operation_update: 'Actualizado',
    reviewingChangedDocuments: 'Revisando documentos modificados',
    scheduleAnotherMerge: 'Programar otra fusión',
    scheduleCancelled: 'Fusión programada cancelada.',
    scheduleCount: '{{count}} programadas',
    scheduledMerges: 'Fusiones programadas',
    scheduledToMerge: 'Programada para fusionar',
    scheduledToMergeOn: 'Esta rama está programada para fusionarse el {{date}}.',
    scheduleHasNothingLeft:
      'No queda nada por aplicar: estos cambios se descartaron o ya se fusionaron.',
    scheduleMerge: 'Programar fusión',
    scheduleMergeHelp:
      'La fusión se ejecuta a la hora que elijas, comprobando de nuevo tus permisos en ese momento.',
    scheduleWillApplyAll: 'Aplicará todo lo pendiente ({{count}})',
    scheduleWillApplySelected: 'Aplicará {{count}} cambio(s) seleccionado(s)',
    scheduling: 'Programando…',
    searchBranches: 'Buscar ramas',
    selectBranch: 'Seleccionar rama',
    untouchedDocumentsNote:
      'Los documentos que no ha modificado en esta rama muestran el contenido actual de main, no una instantánea del momento en que se creó la rama.',
  },
  commandPalette: {
    actions: 'Acciones',
  ...
  general: {
    ...
    delete: 'Eliminar',
    deleted: 'Eliminado',
    deletedAgo: 'Eliminado hace {{distance}}',
  ...
  upload: {
    ...
    fromURL: 'Subir archivo desde URL',
    height: 'Alto',
    lessInfo: 'Menos info',
