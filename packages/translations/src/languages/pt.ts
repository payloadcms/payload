...
export const ptTranslations: DefaultTranslationsObject = {
  ...
  version: {
    ...
    aboutToUnpublishIn:
      'Você está prestes a retirar a publicação deste documento em {{locale}}. Tem certeza?',
    ...
    revertUnsuccessful: 'Reversão sem sucesso. Nenhuma versão publicada anteriormente encontrada.',
