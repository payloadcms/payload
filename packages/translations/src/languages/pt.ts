...
export const ptTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    draftsHint: 'Os seus rascunhos recentes aparecerão aqui',
    dropFiles: 'Largue os ficheiros para carregar',
    editDashboard: 'Editar Painel',
    editingDashboard: 'Edição do Painel',
    gridView: 'Visualização em grelha',
    listView: 'Visualização em lista',
    loadError: 'Não foi possível carregar alguns documentos. Atualize para tentar novamente.',
    noDrafts: 'Nenhum rascunho recente',
    noItems:
      'Não existem widgets no seu painel. Você pode adicioná-los a partir do menu "Painel", localizado na barra superior.',
    noPinned: 'Nenhum documento fixado',
    noRecents: 'Nenhum documento visto recentemente',
    pinDocument: 'Fixar {{title}}',
    pinned: 'Fixados',
    pinnedHint: 'Os documentos que fixar aparecerão aqui',
    recentDrafts: 'Rascunhos recentes',
    recentlyViewed: 'Vistos recentemente',
    recentsHint: 'Os documentos que visualizar aparecerão aqui',
    resetLayout: 'Redefinir Layout',
    saveError: 'Não foi possível guardar a preferência do painel. Tente novamente.',
    searchWidgets: 'Pesquisar widgets...',
    unpinDocument: 'Desafixar {{title}}',
    updatedBy: 'Atualizado por',
    uploadDropzone: 'Área de carregamento',
    uploadFiles: 'Carregar ficheiros',
    uploadHint: 'Arraste ficheiros do computador ou clique no botão abaixo',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Alinhar cabeçalho e controles',
    all: 'Todos',
    ...
    editViewWidth: 'Largura da visualização de edição',
    editViewWidthFull: 'Completa',
    email: 'Email',
