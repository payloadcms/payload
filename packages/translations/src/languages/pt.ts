...
export const ptTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'E-mail verificado com sucesso. Redirecionando você para o login...',
    ...
    verificationFailedRequestNew:
      'Não foi possível verificar sua conta. Solicite um novo e-mail de verificação e tente novamente.',
    verified: 'Verificado',
  ...
  branching: {
    andMoreChanges: 'mais {{count}} alterações',
    branch: 'Ramificação',
    branchClosed: 'Esta ramificação está fechada. É mantida como registro do que foi mesclado.',
    branchDescription: 'Descrição da ramificação',
    branchedFrom: 'Ramificado de',
    branches: 'Ramificações',
    branchHistory: 'Histórico da ramificação',
    branchMerging: 'Mesclando',
    branchName: 'Nome da ramificação',
    branchSettings: 'Configurações da ramificação',
    cancelSchedule: 'Cancelar a mesclagem',
    changedDocuments: 'Documentos alterados',
    changesTo: 'Alterações em {{summary}}',
    closeBranchAfterMerge: 'Fechar esta ramificação após mesclar',
    closeBranchHelpOff:
      'A ramificação continua aberta, então você pode seguir trabalhando nela e mesclar novamente mais tarde.',
    closeBranchHelpOn:
      'A ramificação passará a ser somente leitura e não poderá ser mesclada novamente.',
    confirmDiscardAll:
      'Todos os {{count}} documentos alterados nesta ramificação voltarão ao estado em main. Isso não pode ser desfeito.',
    confirmDiscardSelected:
      '{{count}} documentos alterados voltarão ao estado em main. Isso não pode ser desfeito.',
    createAndSwitch: 'Criar e alternar',
    createNewBranch: 'Criar nova ramificação',
    currentChanges: 'Alterações atuais',
    defaultBranch: 'padrão',
    discardAll: 'Descartar tudo ({{count}})',
    discardChanges: 'Descartar alterações',
    discardedCount: '{{count}} alterações descartadas.',
    discarding: 'Descartando…',
    discardSelected: 'Descartar selecionados ({{count}})',
    historyPageOf: 'Página {{page}} de {{total}}',
    manage: 'Gerenciar',
    manageBranches: 'Gerenciar ramificações…',
    merge: 'Mesclar',
    mergeAllChanges: 'Todas as alterações desta ramificação serão aplicadas.',
    mergeAllCount: 'Todos os {{count}} documentos alterados desta ramificação serão aplicados.',
    mergeBranchInto: 'Mesclar {{branch}} em {{target}}',
    mergeChanges: 'Mesclar alterações',
    mergeComplete: 'Mesclagem concluída',
    merged: 'Mesclada',
    mergedByCount: '{{count}} documentos por {{user}}',
    mergedCount: '{{count}} alterações mescladas.',
    mergedOfTotal: '{{current}} de {{total}} mesclados',
    mergedOn: 'Mesclado em {{date}}',
    mergeHistory: 'Histórico de mesclagens',
    mergeInterrupted: 'A mesclagem foi interrompida e nada foi aplicado. Tente novamente.',
    mergeNow: 'Mesclar agora',
    mergeOnlySelected: 'Escolha quais alterações mesclar',
    mergeScheduledFor: 'Mesclagem agendada para {{date}}.',
    mergeSelectedOfTotal: '{{selected}} de {{total}} documentos alterados serão aplicados.',
    mergeStarting: 'Iniciando a mesclagem…',
    merging: 'Mesclando…',
    mergingProgress: 'Mesclando {{current}} de {{total}}',
    noChangesYet: 'Ainda não há alterações nesta ramificação.',
    operation_create: 'Criado',
    operation_delete: 'Excluído',
    operation_update: 'Atualizado',
    reviewingChangedDocuments: 'Revisando documentos alterados',
    scheduleAnotherMerge: 'Agendar outra mesclagem',
    scheduleCancelled: 'Mesclagem agendada cancelada.',
    scheduleCount: '{{count}} agendadas',
    scheduledMerges: 'Mesclagens agendadas',
    scheduledToMerge: 'Mesclagem agendada',
    scheduledToMergeOn: 'Esta ramificação está agendada para mesclar em {{date}}.',
    scheduleHasNothingLeft:
      'Não resta nada a aplicar — estas alterações foram descartadas ou já mescladas.',
    scheduleMerge: 'Agendar mesclagem',
    scheduleMergeHelp:
      'A mesclagem é executada no horário escolhido, com suas permissões verificadas novamente nesse momento.',
    scheduleWillApplyAll: 'Aplicará tudo o que está pendente ({{count}})',
    scheduleWillApplySelected: 'Aplicará {{count}} alteração(ões) selecionada(s)',
    scheduling: 'Agendando…',
    searchBranches: 'Pesquisar ramificações',
    selectBranch: 'Selecionar ramificação',
    untouchedDocumentsNote:
      'Os documentos que você não alterou neste branch exibem o conteúdo atual do main, e não um instantâneo do momento em que o branch foi criado.',
  },
  commandPalette: {
    actions: 'Ações',
  ...
  error: {
    ...
    fileFetchFailed: 'Falha ao obter o arquivo.',
    ...
    noFileFoundInClipboard: 'Nenhum arquivo encontrado na área de transferência.',
    ...
    unableToReadClipboard: 'Não foi possível ler da área de transferência.',
    ...
    urlNotAllowed: 'A URL fornecida não é permitida.',
  ...
  general: {
    ...
    delete: 'Excluir',
    deleted: 'Excluído',
    deletedAgo: 'Excluído há {{distance}}',
  ...
  upload: {
    ...
    fromURL: 'Carregar arquivo a partir de URL',
    height: 'Altura',
    lessInfo: 'Ver menos',
  ...
  version: {
    ...
    lastSavedAgo: 'Gravado há {{distance}}',
