...
export const ptTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Esta ação irá bloquear seu acesso a este predefinido.',
    attachmentContentInvalid: 'O conteúdo do anexo deve ser uma string ou buffer',
    attachmentMissingContentAndPath: 'O anexo está faltando conteúdo e caminho',
    attachmentMissingFilename: 'O nome do arquivo do anexo está faltando',
    authenticationRequiredForExport: 'Autenticação do usuário é necessária para criar exportações.',
    autosaving: 'Ocorreu um problema ao salvar automaticamente esse documento.',
    busboyMultipartError: 'Erro do Busboy ao analisar solicitação multipart',
    collectionSlugRequired: 'O slug da coleção é obrigatório',
    contentTypeExpectedJSON: 'Content-Type deveria ser application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Collection ou globalSlug deve ser fornecido.',
    emailOrPasswordIncorrect: 'O email ou senha fornecido está incorreto.',
    expectedResponseFromUploadHandler: 'Resposta esperada do manipulador de upload.',
    failedToFetchFromURL: 'Falha ao buscar o arquivo da URL fornecida.',
    failedToResetLayout: 'Falha ao redefinir layout.',
    failedToSaveLayout: 'Falha ao salvar o layout.',
    fieldMustBeSpecified: 'O campo deve ser especificado',
    fieldsNotInitialized: 'Os campos não estão inicializados.',
    filenameRequired: 'Um nome de arquivo é obrigatório.',
    ...
    invalidFileURL: 'URL de arquivo inválido',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Campos de junção não podem ser adicionados a arrays, blocos ou globais.',
    ...
    missingIDOfVersionToRestore: 'ID da versão para restaurar ausente.',
    missingRequiredData: 'Dados requeridos ausentes.',
    noConnectionToDatabase: 'beginTransaction chamado sem conexão com o banco de dados',
    noFileDataForImport: 'Nenhum dado de arquivo fornecido para importação',
    noFilesUploaded: 'Nenhum arquivo foi carregado.',
    noMatchedField: 'Não foi encontrado nenhum campo correspondente a "{{label}}"',
    noPayloadProvided: 'Nenhum payload fornecido',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Junções ordenáveis devem ter como alvo uma única coleção',
    pastingFromURLNotEnabled: 'Colar de URL não está habilitado para esta coleção.',
    ...
    redirectTargetNotAllowed: 'Destino de redirecionamento não permitido.',
    relationshipFieldNotFound: 'Campo de relacionamento não encontrado',
    relationshipNotFound: 'Relacionamento não encontrado',
    requestDataRequired: 'Dados da solicitação obrigatórios.',
    requestNotEligibleForFileUpload: 'A solicitação não é elegível para upload de arquivo',
    requestURLMissing: 'URL da solicitação ausente.',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug: 'Array inesperado de collectionSlug, parent deve ser fornecido',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers não está presente para {{collection}}',
    uploadthingUnknownError: 'Erro ao carregar arquivo com uploadthing: Erro desconhecido',
    ...
    userRequiredForImport: 'É necessário usuário para operações de importação',
    validURLRequired: 'Uma URL válida é necessária.',
    valueMustBeUnique: 'Valor deve ser único',
    vercelBlobUploadError: 'Erro na rota de upload do cliente storage-vercel-blob',
