...
export const ptTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Copiando',
    copyWarning:
      'Você está prestes a copiar dados de {{from}} para {{to}}. Isso substituirá quaisquer dados existentes em {{to}} e redirecionará você para continuar a editar este local. Tem certeza de que deseja continuar?',
    create: 'Criar',
    created: 'Criado',
    createdAt: 'Criado Em',
