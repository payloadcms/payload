...
export const itTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: "Questa azione ti bloccherà l'accesso a questo preset.",
    attachmentContentInvalid: "Il contenuto dell'allegato deve essere una stringa o un buffer",
    attachmentMissingContentAndPath: "L'allegato manca sia di contenuto che di percorso",
    attachmentMissingFilename: "Il nome file dell'allegato manca",
    authenticationRequiredForExport: "L'autenticazione utente è richiesta per creare esportazioni.",
    autosaving:
      'Si è verificato un problema durante il salvataggio automatico di questo documento.',
    busboyMultipartError: "Errore Busboy durante l'analisi della richiesta multipart",
    collectionSlugRequired: 'Lo slug della collezione è richiesto',
    contentTypeExpectedJSON: 'Content-Type dovrebbe essere application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Deve essere fornito collection o globalSlug.',
    emailOrPasswordIncorrect: "L'email o la password fornita non è corretta.",
    expectedResponseFromUploadHandler: 'Risposta attesa dal gestore di caricamento.',
    failedToFetchFromURL: "Impossibile recuperare il file dall'URL fornito.",
    failedToResetLayout: 'Impossibile reimpostare il layout.',
    failedToSaveLayout: 'Impossibile salvare il layout.',
    fieldMustBeSpecified: 'Il campo deve essere specificato',
    fieldsNotInitialized: 'I campi non sono inizializzati.',
    filenameRequired: 'È richiesto un nome file.',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'I campi join non possono essere aggiunti a array, blocchi o globali.',
    loadingDocument:
    ...
    missingIDOfVersionToRestore: 'ID della versione da ripristinare mancante.',
    missingRequiredData: 'Data mancante.',
    noConnectionToDatabase: 'beginTransaction chiamato senza connessione al database',
    noFileDataForImport: "Nessun dato file fornito per l'importazione",
    noFilesUploaded: 'Nessun file è stato caricato.',
    noMatchedField: 'Nessun campo corrispondente trovato per "{{label}}"',
    noPayloadProvided: 'Nessun payload fornito',
    ...
    orderableJoinsMustTargetSingleCollection:
      'I join ordinabili devono mirare a una singola collezione',
    pastingFromURLNotEnabled: 'Incollare da URL non è abilitato per questa collezione.',
    ...
    redirectTargetNotAllowed: 'Destinazione di reindirizzamento non consentita.',
    relationshipFieldNotFound: 'Campo relazione non trovato',
    relationshipNotFound: 'Relazione non trovata',
    requestDataRequired: 'Dati della richiesta richiesti.',
    requestNotEligibleForFileUpload: 'La richiesta non è idonea per il caricamento di file',
    requestURLMissing: 'URL della richiesta mancante.',
    restoringTitle:
    ...
    somethingWentWrong: 'È andato qualcosa storto.',
    ...
    unexpectedArrayCollectionSlug:
      'Array inaspettato di collectionSlug, parent deve essere fornito',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers non è presente per {{collection}}',
    uploadthingUnknownError:
      'Errore durante il caricamento del file con uploadthing: Errore sconosciuto',
    ...
    userRequiredForImport: "È richiesto l'utente per le operazioni di importazione",
    validURLRequired: 'È richiesto un URL valido.',
    valueMustBeUnique: 'Il valore deve essere univoco',
    vercelBlobUploadError: 'Errore della route di caricamento client storage-vercel-blob',
