...
export const itTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Documenti',
    draftsHint: 'Le tue bozze recenti appariranno qui',
    dropFiles: 'Rilascia i file da caricare',
    editDashboard: 'Modifica Dashboard',
    editingDashboard: 'Modifica la Dashboard',
    gridView: 'Vista griglia',
    listView: 'Vista elenco',
    loadError: 'Impossibile caricare alcuni documenti. Aggiorna per riprovare.',
    noDrafts: 'Nessuna bozza recente',
    noItems:
      'Non ci sono widget sulla tua dashboard. Puoi aggiungerli dal menu "Dashboard" situato nella barra superiore.',
    noPinned: 'Nessun documento fissato',
    noRecents: 'Nessun documento visualizzato di recente',
    pinDocument: 'Fissa {{title}}',
    pinned: 'Fissati',
    pinnedHint: 'I documenti fissati appariranno qui',
    recentDrafts: 'Bozze recenti',
    recentlyViewed: 'Visualizzati di recente',
    recentsHint: 'I documenti visualizzati appariranno qui',
    resetLayout: 'Ripristina Layout',
    saveError: 'Impossibile salvare la preferenza della dashboard. Riprova.',
    searchWidgets: 'Cerca widget...',
    unpinDocument: 'Rimuovi {{title}} dai fissati',
    updatedBy: 'Aggiornato da',
    uploadDropzone: 'Area di caricamento',
    uploadFiles: 'Carica file',
    uploadHint: 'Trascina i file dal computer o fai clic sul pulsante qui sotto',
    viewMode: 'Vista documenti',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Allinea intestazione e controlli',
    all: 'Tutto',
    ...
    editViewWidth: 'Larghezza della vista di modifica',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Dimensioni del testo',
    typeSizeSmall: 'Attuale',
