...
export const itTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    beginCreateFirstUser: 'Crea il tuo primo utente per iniziare.',
  ...
  branching: {
    andMoreChanges: 'altre {{count}} modifiche',
    branch: 'Ramo',
    branchClosed: 'Questo ramo è chiuso. Viene conservato come registro di ciò che ha unito.',
    branchDescription: 'Descrizione del ramo',
    branchedFrom: 'Diramato da',
    branches: 'Rami',
    branchHistory: 'Cronologia del ramo',
    branchMerging: 'In unione',
    branchName: 'Nome del ramo',
    branchSettings: 'Impostazioni del ramo',
    cancelSchedule: "Annulla l'unione",
    changedDocuments: 'Documenti modificati',
    changesTo: 'Modifiche a {{summary}}',
    closeBranchAfterMerge: 'Chiudi questo ramo dopo l’unione',
    closeBranchHelpOff:
      'Il ramo resta aperto, così puoi continuare a lavorarci e unirlo di nuovo più tardi.',
    closeBranchHelpOn: 'Il ramo diventerà di sola lettura e non potrà essere unito di nuovo.',
    confirmDiscardAll:
      'Tutti i {{count}} documenti modificati su questo ramo torneranno al loro stato su main. L’operazione non può essere annullata.',
    confirmDiscardSelected:
      '{{count}} documenti modificati torneranno al loro stato su main. L’operazione non può essere annullata.',
    createAndSwitch: 'Crea e passa',
    createNewBranch: 'Crea nuovo ramo',
    currentChanges: 'Modifiche correnti',
    defaultBranch: 'predefinito',
    discardAll: 'Scarta tutto ({{count}})',
    discardChanges: 'Scarta le modifiche',
    discardedCount: '{{count}} modifiche scartate.',
    discarding: 'Scarto in corso…',
    discardSelected: 'Scarta selezionati ({{count}})',
    historyPageOf: 'Pagina {{page}} di {{total}}',
    manage: 'Gestisci',
    manageBranches: 'Gestisci rami…',
    merge: 'Unisci',
    mergeAllChanges: 'Verranno applicate tutte le modifiche di questo ramo.',
    mergeAllCount: 'Verranno applicati tutti i {{count}} documenti modificati di questo ramo.',
    mergeBranchInto: 'Unisci {{branch}} in {{target}}',
    mergeChanges: 'Unisci le modifiche',
    mergeComplete: 'Unione completata',
    merged: 'Unito',
    mergedByCount: '{{count}} documenti da {{user}}',
    mergedCount: '{{count}} modifiche unite.',
    mergedOfTotal: '{{current}} di {{total}} uniti',
    mergedOn: 'Unito il {{date}}',
    mergeHistory: 'Cronologia delle unioni',
    mergeInterrupted: 'L’unione è stata interrotta e non è stato applicato nulla. Riprova.',
    mergeNow: 'Unisci ora',
    mergeOnlySelected: 'Scegli quali modifiche unire',
    mergeScheduledFor: 'Unione pianificata per {{date}}.',
    mergeSelectedOfTotal: 'Verranno applicati {{selected}} di {{total}} documenti modificati.',
    mergeStarting: 'Avvio dell’unione…',
    merging: 'Unione in corso…',
    mergingProgress: 'Unione di {{current}} di {{total}}',
    noChangesYet: 'Nessuna modifica su questo ramo per ora.',
    operation_create: 'Creato',
    operation_delete: 'Eliminato',
    operation_update: 'Aggiornato',
    reviewingChangedDocuments: 'Revisione dei documenti modificati',
    scheduleAnotherMerge: 'Pianifica un’altra unione',
    scheduleCancelled: 'Unione pianificata annullata.',
    scheduleCount: '{{count}} pianificate',
    scheduledMerges: 'Unioni pianificate',
    scheduledToMerge: 'Unione pianificata',
    scheduledToMergeOn: 'Questo ramo verrà unito il {{date}}.',
    scheduleHasNothingLeft:
      'Non resta nulla da applicare: queste modifiche sono state scartate o già unite.',
    scheduleMerge: 'Pianifica l’unione',
    scheduleMergeHelp:
      'L’unione viene eseguita all’ora scelta, con i tuoi permessi verificati di nuovo in quel momento.',
    scheduleWillApplyAll: 'Applicherà tutto ciò che è in attesa ({{count}})',
    scheduleWillApplySelected: 'Applicherà {{count}} modifica/modifiche selezionate',
    scheduling: 'Pianificazione…',
    searchBranches: 'Cerca rami',
    selectBranch: 'Seleziona ramo',
    untouchedDocumentsNote:
      'I documenti che non hai modificato in questo branch mostrano il contenuto attuale di main, non uno snapshot del momento in cui il branch è stato creato.',
  },
  commandPalette: {
    actions: 'Azioni',
  ...
  error: {
    ...
    fileFetchFailed: 'Impossibile recuperare il file.',
    ...
    noFileFoundInClipboard: 'Nessun file trovato negli appunti.',
    ...
    unableToReadClipboard: 'Impossibile leggere dagli appunti.',
    ...
    urlNotAllowed: "L'URL fornito non è consentito.",
  ...
  general: {
    ...
    delete: 'Elimina',
    deleted: 'Cancellato',
    deletedAgo: 'Eliminato {{distance}} fa',
