...
export const arTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'نسخ',
    copyWarning:
      'أنت على وشك نسخ البيانات من {{from}} إلى {{to}}. سيتم هذا الإجراء الكتابة فوق أي بيانات موجودة في {{to}} وتوجيهك لمتابعة تعديل هذا اللغة. هل أنت متأكد من أنك تريد المتابعة؟',
    create: 'إنشاء',
    created: 'تمّ الإنشاء',
