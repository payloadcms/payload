...
export const arTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'تعذّر قراءة الملف المرفوع لاكتشاف نوعه.',
    couldNotReadFileForValidation: 'تعذر قراءة الملف المرفوع للتحقق.',
    crop: 'محصول',
    ...
    fileTypeNotAllowed: 'نوع الملف {{mimeType}} (من الامتداد {{extension}}) غير مسموح به.',
    focalPoint: 'نقطة التركيز',
    focalPointDescription: 'اسحب النقطة المركزية مباشرة على المعاينة أو قم بضبط القيم أدناه.',
    height: 'الطّول',
    invalidMimeType: 'نوع MIME غير صالح: {{mimeType}}.',
    invalidOrCorruptedPDF: 'ملف PDF غير صالح أو تالف.',
    ...
    restrictedFileType:
      "نوع الملف '{{mimeType}}' غير مسموح به للملف {{fileName}}: تم الكشف عن نوع ملف مقيد — يمكنك تعيين 'allowRestrictedFileTypes' إلى true لتجاوز هذا الفحص لهذه الـ Collection.",
    ...
    svgHarmfulContent: 'ملف SVG يحتوي على محتوى قد يكون ضارًا.',
    width: 'العرض',
  },
  validation: {
