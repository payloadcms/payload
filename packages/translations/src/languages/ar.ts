...
export const arTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'سيؤدي هذا الإجراء إلى منعك من الوصول إلى هذا الإعداد المسبق.',
    attachmentContentInvalid: 'يجب أن يكون محتوى المرفق سلسلة نصية أو مخزن مؤقت للبيانات',
    attachmentMissingContentAndPath: 'المرفق يفتقر إلى كل من المحتوى والمسار',
    attachmentMissingFilename: 'المرفق يفتقد اسم الملف',
    authenticationRequiredForExport: 'يتطلب إنشاء عمليات التصدير مصادقة المستخدم.',
    autosaving: 'حدثت مشكلة أثناء حفظ هذا المستند تلقائيًا.',
    busboyMultipartError: 'خطأ Busboy في تحليل طلب multipart',
    collectionSlugRequired: 'حقل الاسم المستعار للمجموعة مطلوب',
    contentTypeExpectedJSON: 'من المتوقع أن يكون نوع المحتوى application/json',
    ...
    eitherCollectionOrGlobalRequired: 'يجب تمرير إما collection أو globalSlug.',
    emailOrPasswordIncorrect: 'البريد الإلكتروني أو كلمة المرور المقدمة غير صحيحة.',
    expectedResponseFromUploadHandler: 'الاستجابة المتوقعة من معالج التحميل.',
    failedToFetchFromURL: 'فشل في جلب الملف من عنوان الإنترنت المقدم.',
    failedToResetLayout: 'فشل في إعادة تعيين التخطيط.',
    failedToSaveLayout: 'فشل في حفظ التخطيط.',
    fieldMustBeSpecified: 'يجب تحديد الحقل',
    fieldsNotInitialized: 'لم يتم تهيئة الحقول.',
    ...
    invalidFileURL: 'عنوان URL للملف غير صالح',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'حقول الانضمام غير مسموح بها في المصفوفات أو الكتل أو العناصر العامة.',
    ...
    missingIDOfVersionToRestore: 'معرّف النسخة المراد استعادتها مفقود.',
    missingRequiredData: 'توجد بيانات مطلوبة مفقودة.',
    noConnectionToDatabase: 'تم استدعاء beginTransaction بدون اتصال بقاعدة البيانات',
    noFileDataForImport: 'لم يتم توفير بيانات ملف للاستيراد',
    noFilesUploaded: 'لم يتمّ رفع أيّة ملفّات.',
    noMatchedField: 'لم يتمّ العثور على حقل مطابق لـ "{{label}}"',
    noPayloadProvided: 'لم يتم توفير Payload',
    ...
    orderableJoinsMustTargetSingleCollection:
      'يجب أن تستهدف الانضمامات القابلة للترتيب مجموعة واحدة',
    pastingFromURLNotEnabled: 'اللصق من عنوان URL غير ممكّن لهذه المجموعة.',
    previewing: 'حدث خطأ في اثناء معاينة هذا المستند.',
    problemUploadingFile: 'حدث خطأ اثناء رفع الملفّ.',
    redirectTargetNotAllowed: 'هدف إعادة التوجيه غير مسموح به.',
    relationshipFieldNotFound: 'حقل العلاقة غير موجود',
    relationshipNotFound: 'العلاقة غير موجودة',
    requestDataRequired: 'بيانات الطلب مطلوبة.',
    requestNotEligibleForFileUpload: 'الطلب غير مؤهل لتحميل الملف',
    requestURLMissing: 'عنوان URL للطلب مفقود.',
    ...
    tooManyRedirects: 'عدد كبير جدًا من عمليات إعادة التوجيه.',
    ...
    unexpectedArrayCollectionSlug: 'slug مجموعة مصفوفة غير متوقع',
    ...
    uploadConfigHandlersMissing: 'معالجات تكوين التحميل مفقودة',
    uploadthingUnknownError: 'خطأ غير معروف في Uploadthing',
    urlNotAllowed: 'عنوان URL غير مسموح به',
    ...
    userRequiredForImport: 'المستخدم مطلوب للاستيراد',
    validURLRequired: 'عنوان URL صالح مطلوب',
    valueMustBeUnique: 'على القيمة أن تكون فريدة',
    vercelBlobUploadError: 'خطأ في تحميل Vercel Blob',
