...
export const arTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: 'و{{count}} تغييرات أخرى',
    branch: 'فرع',
    branchClosed: 'هذا الفرع مغلق. يُحتفظ به كسجل لما تم دمجه.',
    branchDescription: 'وصف الفرع',
    branchedFrom: 'مُتفرّع من',
    branches: 'الفروع',
    branchHistory: 'سجل الفرع',
    branchMerging: 'جارٍ الدمج',
    branchName: 'اسم الفرع',
    branchSettings: 'إعدادات الفرع',
    cancelSchedule: 'إلغاء الدمج',
    changedDocuments: 'المستندات المتغيّرة',
    changesTo: 'تغييرات على {{summary}}',
    closeBranchAfterMerge: 'إغلاق هذا الفرع بعد الدمج',
    closeBranchHelpOff: 'يبقى الفرع مفتوحًا، فيمكنك متابعة العمل عليه ودمجه مرة أخرى لاحقًا.',
    closeBranchHelpOn: 'سيصبح الفرع للقراءة فقط ولا يمكن دمجه مرة أخرى.',
    confirmDiscardAll:
      'ستُعاد جميع المستندات المتغيّرة في هذا الفرع، وعددها {{count}}، إلى حالتها في main. لا يمكن التراجع عن ذلك.',
    confirmDiscardSelected:
      'ستُعاد {{count}} من المستندات المتغيّرة إلى حالتها في main. لا يمكن التراجع عن ذلك.',
    createAndSwitch: 'إنشاء والتبديل',
    createNewBranch: 'إنشاء فرع جديد',
    currentChanges: 'التغييرات الحالية',
    defaultBranch: 'افتراضي',
    discardAll: 'تجاهل الكل ({{count}})',
    discardChanges: 'تجاهل التغييرات',
    discardedCount: 'تم تجاهل {{count}} من التغييرات.',
    discarding: 'جارٍ التجاهل…',
    discardSelected: 'تجاهل المحدد ({{count}})',
    historyPageOf: 'صفحة {{page}} من {{total}}',
    manage: 'إدارة',
    manageBranches: 'إدارة الفروع…',
    merge: 'دمج',
    mergeAllChanges: 'سيتم تطبيق جميع التغييرات في هذا الفرع.',
    mergeAllCount: 'سيتم تطبيق جميع المستندات المتغيّرة في هذا الفرع، وعددها {{count}}.',
    mergeBranchInto: 'دمج {{branch}} في {{target}}',
    mergeChanges: 'دمج التغييرات',
    mergeComplete: 'تم الدمج',
    merged: 'مدموج',
    mergedByCount: '{{count}} من المستندات بواسطة {{user}}',
    mergedCount: 'تم دمج {{count}} من التغييرات.',
    mergedOfTotal: 'تم دمج {{current}} من {{total}}',
    mergedOn: 'تم الدمج في {{date}}',
    mergeHistory: 'سجل الدمج',
    mergeInterrupted: 'تمت مقاطعة الدمج ولم يُطبَّق أي شيء. حاول مرة أخرى.',
    mergeNow: 'دمج الآن',
    mergeOnlySelected: 'اختر التغييرات التي تريد دمجها',
    mergeScheduledFor: 'تم جدولة الدمج في {{date}}.',
    mergeSelectedOfTotal: 'سيتم تطبيق {{selected}} من {{total}} من المستندات المتغيّرة.',
    mergeStarting: 'جارٍ بدء الدمج…',
    merging: 'جارٍ الدمج…',
    mergingProgress: 'جارٍ دمج {{current}} من {{total}}',
    noChangesYet: 'لا توجد تغييرات في هذا الفرع بعد.',
    operation_create: 'أُنشئ',
    operation_delete: 'حُذف',
    operation_update: 'حُدّث',
    reviewingChangedDocuments: 'مراجعة المستندات المتغيرة',
    scheduleAnotherMerge: 'جدولة دمج آخر',
    scheduleCancelled: 'تم إلغاء الدمج المُجدول.',
    scheduleCount: '{{count}} مُجدولة',
    scheduledMerges: 'عمليات الدمج المُجدولة',
    scheduledToMerge: 'مُجدول للدمج',
    scheduledToMergeOn: 'هذا الفرع مُجدول للدمج في {{date}}.',
    scheduleHasNothingLeft: 'لم يبقَ شيء لتطبيقه — تم تجاهل هذه التغييرات أو دمجها بالفعل.',
    scheduleMerge: 'جدولة الدمج',
    scheduleMergeHelp: 'يُنفَّذ الدمج في الوقت الذي تختاره، وتُفحَص صلاحياتك مرة أخرى عندئذٍ.',
    scheduleWillApplyAll: 'سيطبّق كل ما هو معلّق ({{count}})',
    scheduleWillApplySelected: 'سيطبّق {{count}} من التغييرات المحددة',
    scheduling: 'جارٍ الجدولة…',
    searchBranches: 'البحث في الفروع',
    selectBranch: 'اختر الفرع',
    untouchedDocumentsNote:
      'المستندات التي لم تُجرِ عليها تغييرات في هذا الفرع تعرض المحتوى الحالي للفرع الرئيسي (main)، وليس لقطة من الوقت الذي تم فيه إنشاء الفرع.',
  },
  commandPalette: {
    actions: 'الإجراءات',
  ...
  error: {
    ...
    fileFetchFailed: 'فشل في جلب الملف.',
    ...
    noFileFoundInClipboard: 'لم يتم العثور على ملف في الحافظة.',
    ...
    unableToReadClipboard: 'تعذّر القراءة من الحافظة.',
    ...
    urlNotAllowed: 'عنوان URL المقدم غير مسموح به.',
  ...
  general: {
    ...
    delete: 'حذف',
    deleted: 'تم الحذف',
    deletedAgo: 'تم الحذف منذ {{distance}}',
  ...
  version: {
    ...
    lastSavedAgo: 'تم الحفظ قبل {{distance}}',
