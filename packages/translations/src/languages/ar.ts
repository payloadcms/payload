...
export const arTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'المستندات',
    draftsHint: 'ستظهر هنا مسوداتك الحديثة',
    dropFiles: 'أفلت الملفات لرفعها',
    editDashboard: 'تعديل لوحة التحكم',
    editingDashboard: 'لوحة تحرير',
    gridView: 'عرض شبكي',
    listView: 'عرض قائمة',
    loadError: 'تعذر تحميل بعض المستندات. حدّث الصفحة للمحاولة مرة أخرى.',
    noDrafts: 'لا توجد مسودات حديثة',
    noItems:
      'لا توجد أدوات على لوحة التحكم الخاصة بك. يمكنك إضافتها من القائمة "لوحة التحكم" الموجودة في الشريط العلوي.',
    noPinned: 'لا توجد مستندات مثبتة',
    noRecents: 'لا توجد مستندات معروضة مؤخرًا',
    pinDocument: 'تثبيت {{title}}',
    pinned: 'المثبتة',
    pinnedHint: 'ستظهر هنا المستندات التي تثبتها',
    recentDrafts: 'المسودات الحديثة',
    recentlyViewed: 'المعروضة مؤخرًا',
    recentsHint: 'ستظهر هنا المستندات التي تعرضها',
    resetLayout: 'إعادة تعيين التخطيط',
    saveError: 'تعذر حفظ تفضيل لوحة التحكم. حاول مرة أخرى.',
    searchWidgets: 'ابحث عن الأدوات...',
    unpinDocument: 'إلغاء تثبيت {{title}}',
    updatedBy: 'تم التحديث بواسطة',
    uploadDropzone: 'منطقة رفع الملفات',
    uploadFiles: 'رفع الملفات',
    uploadHint: 'اسحب الملفات من جهازك وأفلتها هنا أو انقر على الزر أدناه',
    viewMode: 'عرض المستندات',
  ...
  general: {
    ...
    alignHeaderAndControls: 'محاذاة الترويسة وعناصر التحكم',
    all: 'الكل',
    ...
    editViewWidth: 'عرض صفحة التحرير',
    editViewWidthFull: 'كامل',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'أحجام النص',
    typeSizeSmall: 'الحالي',
