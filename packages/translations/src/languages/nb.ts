...
export const nbTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: '{{count}} endringer til',
    branch: 'Gren',
    branchClosed: 'Denne grenen er lukket. Den beholdes som en oversikt over hva den slo sammen.',
    branchDescription: 'Beskrivelse av gren',
    branchedFrom: 'Forgrenet fra',
    branches: 'Grener',
    branchHistory: 'Grenhistorikk',
    branchMerging: 'Slår sammen',
    branchName: 'Navn på gren',
    branchSettings: 'Greninnstillinger',
    cancelSchedule: 'Avbryt fletting',
    changedDocuments: 'Endrede dokumenter',
    changesTo: 'Endringer i {{summary}}',
    closeBranchAfterMerge: 'Lukk denne grenen etter sammenslåing',
    closeBranchHelpOff:
      'Grenen forblir åpen, så du kan fortsette å jobbe med den og slå sammen igjen senere.',
    closeBranchHelpOn: 'Grenen blir skrivebeskyttet og kan ikke slås sammen igjen.',
    confirmDiscardAll:
      'Alle {{count}} endrede dokumenter i denne grenen settes tilbake til tilstanden på main. Dette kan ikke angres.',
    confirmDiscardSelected:
      '{{count}} endrede dokumenter settes tilbake til tilstanden på main. Dette kan ikke angres.',
    createAndSwitch: 'Opprett og bytt',
    createNewBranch: 'Opprett ny gren',
    currentChanges: 'Gjeldende endringer',
    defaultBranch: 'standard',
    discardAll: 'Forkast alle ({{count}})',
    discardChanges: 'Forkast endringer',
    discardedCount: '{{count}} endringer forkastet.',
    discarding: 'Forkaster…',
    discardSelected: 'Forkast valgte ({{count}})',
    historyPageOf: 'Side {{page}} av {{total}}',
    manage: 'Administrer',
    manageBranches: 'Administrer grener…',
    merge: 'Slå sammen',
    mergeAllChanges: 'Alle endringer i denne grenen blir tatt i bruk.',
    mergeAllCount: 'Alle {{count}} endrede dokumenter i denne grenen blir tatt i bruk.',
    mergeBranchInto: 'Slå sammen {{branch}} inn i {{target}}',
    mergeChanges: 'Slå sammen endringer',
    mergeComplete: 'Sammenslåing fullført',
    merged: 'Slått sammen',
    mergedByCount: '{{count}} dokumenter av {{user}}',
    mergedCount: '{{count}} endringer slått sammen.',
    mergedOfTotal: '{{current}} av {{total}} slått sammen',
    mergedOn: 'Slått sammen {{date}}',
    mergeHistory: 'Sammenslåingshistorikk',
    mergeInterrupted: 'Sammenslåingen ble avbrutt, og ingenting ble tatt i bruk. Prøv igjen.',
    mergeNow: 'Slå sammen nå',
    mergeOnlySelected: 'Velg hvilke endringer som skal slås sammen',
    mergeScheduledFor: 'Sammenslåing planlagt til {{date}}.',
    mergeSelectedOfTotal: '{{selected}} av {{total}} endrede dokumenter blir tatt i bruk.',
    mergeStarting: 'Starter sammenslåing…',
    merging: 'Slår sammen…',
    mergingProgress: 'Slår sammen {{current}} av {{total}}',
    noChangesYet: 'Ingen endringer i denne grenen ennå.',
    operation_create: 'Opprettet',
    operation_delete: 'Slettet',
    operation_update: 'Oppdatert',
    reviewingChangedDocuments: 'Gjennomgang av endrede dokumenter',
    scheduleAnotherMerge: 'Planlegg en ny sammenslåing',
    scheduleCancelled: 'Planlagt sammenslåing avbrutt.',
    scheduleCount: '{{count}} planlagt',
    scheduledMerges: 'Planlagte sammenslåinger',
    scheduledToMerge: 'Sammenslåing planlagt',
    scheduledToMergeOn: 'Denne grenen er planlagt slått sammen {{date}}.',
    scheduleHasNothingLeft:
      'Det er ingenting igjen å ta i bruk — disse endringene ble forkastet eller er allerede slått sammen.',
    scheduleMerge: 'Planlegg sammenslåing',
    scheduleMergeHelp:
      'Sammenslåingen kjører på tidspunktet du velger, og rettighetene dine sjekkes på nytt da.',
    scheduleWillApplyAll: 'Tar i bruk alt som venter ({{count}})',
    scheduleWillApplySelected: 'Tar i bruk {{count}} valgte endringer',
    scheduling: 'Planlegger…',
    searchBranches: 'Søk i grener',
    selectBranch: 'Velg gren',
    untouchedDocumentsNote:
      'Dokumenter du ikke har endret på denne grenen viser innholdet fra main slik det er nå, ikke et øyeblikksbilde fra da grenen ble opprettet.',
  },
  commandPalette: {
    actions: 'Handlinger',
  ...
  error: {
    ...
    fileFetchFailed: 'Kunne ikke hente filen.',
    ...
    noFileFoundInClipboard: 'Ingen fil funnet i utklippstavlen.',
    ...
    unableToReadClipboard: 'Kan ikke lese fra utklippstavlen.',
    ...
    urlNotAllowed: 'Den oppgitte URL-en er ikke tillatt.',
