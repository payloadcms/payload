...
export const nbTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    draftsHint: 'Dine nylige utkast vises her',
    dropFiles: 'Slipp filer for å laste opp',
    editDashboard: 'Rediger Dashboard',
    editingDashboard: 'Redigeringsdashbord',
    gridView: 'Rutenettvisning',
    listView: 'Listevisning',
    loadError: 'Noen dokumenter kunne ikke lastes inn. Oppdater for å prøve igjen.',
    noDrafts: 'Ingen nylige utkast',
    noItems:
      'Det er ingen widgets på dashbordet ditt. Du kan legge dem til fra "Dashboard" -menyen som ligger i toppfeltet.',
    noPinned: 'Ingen festede dokumenter',
    noRecents: 'Ingen nylig viste dokumenter',
    pinDocument: 'Fest {{title}}',
    pinned: 'Festede',
    pinnedHint: 'Dokumenter du fester, vises her',
    recentDrafts: 'Nylige utkast',
    recentlyViewed: 'Nylig viste',
    recentsHint: 'Dokumenter du viser, vises her',
    resetLayout: 'Tilbakestill layout',
    saveError: 'Kunne ikke lagre innstillingen for kontrollpanelet. Prøv igjen.',
    searchWidgets: 'Søk widgets...',
    unpinDocument: 'Løsne {{title}}',
    updatedBy: 'Oppdatert av',
    uploadDropzone: 'Opplastingsområde',
    uploadFiles: 'Last opp filer',
    uploadHint: 'Dra filer fra datamaskinen eller klikk på knappen nedenfor',
    viewMode: 'Dokumentvisning',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Juster topptekst og kontroller',
    all: 'Alle',
    ...
    editViewWidth: 'Redigeringsvisningens bredde',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Tekststørrelser',
    typeSizeSmall: 'Nåværende',
