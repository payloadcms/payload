...
export const nbTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Denne handlingen vil låse deg ute fra denne forhåndsinnstillingen.',
    attachmentContentInvalid: 'Vedleggsinnhold må være en streng eller buffer',
    attachmentMissingContentAndPath: 'Vedlegg mangler både innhold og sti',
    attachmentMissingFilename: 'Vedlegg mangler filnavn',
    authenticationRequiredForExport: 'Brukerautentisering er nødvendig for å opprette eksporter.',
    autosaving: 'Det oppstod et problem under automatisk lagring av dokumentet.',
    busboyMultipartError: 'Busboy multipart-forespørsel parsing-feil',
    collectionSlugRequired: 'Samlings-slug er påkrevd',
    contentTypeExpectedJSON: 'Content-Type forventes å være application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Enten collection eller globalSlug må sendes.',
    emailOrPasswordIncorrect: 'E-postadressen eller passordet er feil.',
    expectedResponseFromUploadHandler: 'Forventet respons fra opplastingshåndterer.',
    failedToFetchFromURL: 'Kunne ikke hente filen fra den angitte URL-en.',
    failedToResetLayout: 'Klarte ikke å tilbakestille layout.',
    failedToSaveLayout: 'Kunne ikke lagre layout.',
    fieldMustBeSpecified: 'felt må spesifiseres',
    fieldsNotInitialized: 'Feltene er ikke initialisert.',
    ...
    missingIDOfVersionToRestore: 'Mangler versjons-ID å gjenopprette.',
    missingRequiredData: 'Mangler påkrevd data.',
    noConnectionToDatabase: 'beginTransaction ble kalt uten databaseforbindelse',
    noFileDataForImport: 'Ingen fildata ble gitt for import',
    noFilesUploaded: 'Ingen filer ble lastet opp.',
    noMatchedField: 'Ingen matchende felt funnet for "{{label}}"',
    noPayloadProvided: 'Ingen Payload ble gitt',
    ...
    noUser: 'Ingen bruker',
    orderableJoinsMustTargetSingleCollection: 'Sorterbare joins må målrette en enkelt samling',
    pastingFromURLNotEnabled: 'Liming fra URL er ikke aktivert for denne samlingen.',
    ...
    redirectTargetNotAllowed: 'Omdirigeringsmål er ikke tillatt.',
    relationshipFieldNotFound: 'Relasjonsfelt ble ikke funnet',
    relationshipNotFound: 'Relasjon ble ikke funnet',
    requestDataRequired: 'Forespørselsdata er påkrevd.',
    requestNotEligibleForFileUpload: 'Forespørsel er ikke kvalifisert for filopplasting',
    requestURLMissing: 'Forespørselens URL mangler.',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug: 'Uventet array-samlings-slug',
    ...
    uploadConfigHandlersMissing: 'Opplastingskonfigurasjonshåndterere mangler',
    uploadthingUnknownError: 'Uploadthing ukjent feil',
    urlNotAllowed: 'URL er ikke tillatt',
    ...
    userRequiredForImport: 'Bruker er påkrevd for import',
    validURLRequired: 'Gyldig URL er påkrevd',
    valueMustBeUnique: 'Verdien må være unik',
    vercelBlobUploadError: 'Vercel Blob-opplastingsfeil',
