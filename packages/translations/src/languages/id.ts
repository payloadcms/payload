...
export const idTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Tindakan ini akan mengunci Anda dari preset ini.',
    attachmentContentInvalid: 'Konten lampiran harus berupa string atau buffer',
    attachmentMissingContentAndPath: 'Lampiran tidak memiliki konten dan path',
    attachmentMissingFilename: 'Lampiran tidak memiliki nama file',
    authenticationRequiredForExport: 'Autentikasi pengguna diperlukan untuk membuat ekspor.',
    autosaving: 'Terjadi masalah saat menyimpan otomatis dokumen ini.',
    busboyMultipartError: 'Kesalahan Busboy saat mengurai permintaan multipart',
    collectionSlugRequired: 'Slug koleksi diperlukan',
    contentTypeExpectedJSON: 'Content-Type diharapkan application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Koleksi atau globalSlug harus diberikan.',
    emailOrPasswordIncorrect: 'Email atau kata sandi yang diberikan salah.',
    expectedResponseFromUploadHandler: 'Respons diharapkan dari penangan unggahan.',
    failedToFetchFromURL: 'Gagal mengambil file dari URL yang diberikan.',
    failedToResetLayout: 'Gagal mereset tata letak.',
    failedToSaveLayout: 'Gagal menyimpan tata letak.',
    fieldMustBeSpecified: 'field harus ditentukan',
    fieldsNotInitialized: 'Field tidak diinisialisasi.',
    filenameRequired: 'Nama file diperlukan.',
    ...
    invalidFileURL: 'URL file tidak valid',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Field join tidak dapat ditambahkan ke array, blok, atau global.',
    ...
    missingIDOfVersionToRestore: 'ID versi yang akan dipulihkan tidak ada.',
    missingRequiredData: 'Data yang diperlukan tidak ada.',
    noConnectionToDatabase: 'beginTransaction dipanggil saat tidak ada koneksi ke database',
    noFileDataForImport: 'Tidak ada data file yang diberikan untuk impor',
    noFilesUploaded: 'Tidak ada file yang diunggah.',
    noMatchedField: 'Tidak ada isian yang cocok ditemukan untuk "{{label}}"',
    noPayloadProvided: 'Tidak ada payload yang diberikan',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Join yang dapat diurutkan harus menargetkan satu koleksi',
    pastingFromURLNotEnabled: 'Menempel dari URL tidak diaktifkan untuk koleksi ini.',
    previewing: 'Terjadi masalah saat mempratinjau dokumen ini.',
    problemUploadingFile: 'Terjadi masalah saat mengunggah file.',
    redirectTargetNotAllowed: 'Target pengalihan tidak diizinkan.',
    relationshipFieldNotFound: 'Field relasi tidak ditemukan',
    relationshipNotFound: 'Relasi tidak ditemukan',
    requestDataRequired: 'Data permintaan diperlukan.',
    requestNotEligibleForFileUpload: 'Permintaan tidak memenuhi syarat untuk unggah file',
    requestURLMissing: 'URL permintaan tidak ada.',
    restoringTitle:
    ...
    tooManyRedirects: 'Terlalu banyak pengalihan.',
    ...
    unexpectedArrayCollectionSlug: 'Array collectionSlug tidak terduga, parent harus diberikan',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers tidak ada untuk {{collection}}',
    uploadthingUnknownError:
      'Kesalahan mengunggah file dengan uploadthing: Kesalahan tidak diketahui',
    ...
    userRequiredForImport: 'Pengguna diperlukan untuk operasi impor',
    validURLRequired: 'String URL yang valid diperlukan.',
    valueMustBeUnique: 'Nilai harus unik',
    vercelBlobUploadError: 'Kesalahan rute unggah klien storage-vercel-blob',
