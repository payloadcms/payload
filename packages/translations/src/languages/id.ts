...
export const idTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'Email berhasil diverifikasi. Mengarahkan Anda ke halaman masuk...',
  ...
  branching: {
    andMoreChanges: '{{count}} perubahan lainnya',
    branch: 'Cabang',
    branchClosed:
      'Cabang ini ditutup. Cabang ini disimpan sebagai catatan atas apa yang digabungkan.',
    branchDescription: 'Deskripsi cabang',
    branchedFrom: 'Dicabangkan dari',
    branches: 'Cabang',
    branchHistory: 'Riwayat cabang',
    ...
    closeBranchAfterMerge: 'Tutup cabang ini setelah digabungkan',
    closeBranchHelpOff:
      'Cabang tetap terbuka, jadi Anda bisa terus mengerjakannya dan menggabungkannya lagi nanti.',
    closeBranchHelpOn: 'Cabang akan menjadi hanya-baca dan tidak dapat digabungkan lagi.',
    confirmDiscardAll:
      'Seluruh {{count}} dokumen yang diubah di cabang ini akan dikembalikan ke keadaannya di main. Tindakan ini tidak dapat dibatalkan.',
    confirmDiscardSelected:
      '{{count}} dokumen yang diubah akan dikembalikan ke keadaannya di main. Tindakan ini tidak dapat dibatalkan.',
    createAndSwitch: 'Buat dan alihkan',
    createNewBranch: 'Buat cabang baru',
    currentChanges: 'Perubahan saat ini',
    defaultBranch: 'bawaan',
    ...
    historyPageOf: 'Halaman {{page}} dari {{total}}',
    manage: 'Kelola',
    manageBranches: 'Kelola cabang…',
    merge: 'Gabungkan',
    mergeAllChanges: 'Semua perubahan di cabang ini akan diterapkan.',
    mergeAllCount: 'Seluruh {{count}} dokumen yang diubah di cabang ini akan diterapkan.',
    mergeBranchInto: 'Gabungkan {{branch}} ke {{target}}',
    mergeChanges: 'Gabungkan perubahan',
    mergeComplete: 'Penggabungan selesai',
    merged: 'Digabungkan',
    mergedByCount: '{{count}} dokumen oleh {{user}}',
    mergedCount: '{{count}} perubahan digabungkan.',
    mergedOfTotal: '{{current}} dari {{total}} digabungkan',
    mergedOn: 'Digabungkan pada {{date}}',
    mergeHistory: 'Riwayat penggabungan',
    mergeInterrupted: 'Penggabungan terhenti dan tidak ada yang diterapkan. Coba lagi.',
    mergeNow: 'Gabungkan sekarang',
    mergeOnlySelected: 'Pilih perubahan mana yang akan digabungkan',
    mergeScheduledFor: 'Penggabungan dijadwalkan pada {{date}}.',
    mergeSelectedOfTotal: '{{selected}} dari {{total}} dokumen yang diubah akan diterapkan.',
    mergeStarting: 'Memulai penggabungan…',
    merging: 'Menggabungkan…',
    mergingProgress: 'Menggabungkan {{current}} dari {{total}}',
    noChangesYet: 'Belum ada perubahan di cabang ini.',
    operation_create: 'Dibuat',
    operation_delete: 'Dihapus',
    operation_update: 'Diperbarui',
    reviewingChangedDocuments: 'Meninjau dokumen yang diubah',
    scheduleAnotherMerge: 'Jadwalkan penggabungan lain',
    scheduleCancelled: 'Penggabungan terjadwal dibatalkan.',
    scheduleCount: '{{count}} terjadwal',
    scheduledMerges: 'Penggabungan terjadwal',
    scheduledToMerge: 'Penggabungan dijadwalkan',
    scheduledToMergeOn: 'Cabang ini dijadwalkan untuk digabungkan pada {{date}}.',
    scheduleHasNothingLeft:
      'Tidak ada lagi yang perlu diterapkan — perubahan ini dibuang atau sudah digabungkan.',
    scheduleMerge: 'Jadwalkan penggabungan',
    scheduleMergeHelp:
      'Penggabungan berjalan pada waktu yang Anda pilih, dan izin Anda diperiksa kembali saat itu.',
    scheduleWillApplyAll: 'Akan menerapkan semua yang tertunda ({{count}})',
    scheduleWillApplySelected: 'Akan menerapkan {{count}} perubahan terpilih',
    scheduling: 'Menjadwalkan…',
    searchBranches: 'Cari cabang',
    selectBranch: 'Pilih cabang',
    untouchedDocumentsNote:
      'Dokumen yang belum Anda ubah pada cabang ini akan menampilkan konten terkini dari main, bukan cuplikan dari saat cabang tersebut dibuat.',
  },
  commandPalette: {
    actions: 'Tindakan',
    createNew: 'Buat Baru',
  ...
  error: {
    ...
    fileFetchFailed: 'Gagal mengambil file.',
    ...
    noFileFoundInClipboard: 'Tidak ada berkas yang ditemukan di papan klip.',
    ...
    unableToReadClipboard: 'Tidak dapat membaca dari clipboard.',
    ...
    urlNotAllowed: 'URL yang diberikan tidak diizinkan.',
  ...
  upload: {
    ...
    fromURL: 'Unggah berkas dari URL',
    height: 'Tinggi',
