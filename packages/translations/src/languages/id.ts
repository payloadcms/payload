...
export const idTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Dokumen',
    draftsHint: 'Draf terbaru Anda akan muncul di sini',
    dropFiles: 'Lepaskan file untuk mengunggah',
    editDashboard: 'Sunting Dasbor',
    editingDashboard: 'Mengedit Dashboard',
    gridView: 'Tampilan kisi',
    listView: 'Tampilan daftar',
    loadError: 'Beberapa dokumen tidak dapat dimuat. Muat ulang untuk mencoba lagi.',
    noDrafts: 'Tidak ada draf terbaru',
    noItems:
      'Tidak ada widget di dasbor Anda. Anda dapat menambahkannya dari menu "Dashboard" yang terletak di bar atas.',
    noPinned: 'Tidak ada dokumen yang disematkan',
    noRecents: 'Tidak ada dokumen yang baru dilihat',
    pinDocument: 'Sematkan {{title}}',
    pinned: 'Disematkan',
    pinnedHint: 'Dokumen yang Anda sematkan akan muncul di sini',
    recentDrafts: 'Draf terbaru',
    recentlyViewed: 'Baru dilihat',
    recentsHint: 'Dokumen yang Anda lihat akan muncul di sini',
    resetLayout: 'Atur Ulang Tata Letak',
    saveError: 'Preferensi dasbor tidak dapat disimpan. Silakan coba lagi.',
    searchWidgets: 'Cari widget...',
    unpinDocument: 'Lepas sematan {{title}}',
    updatedBy: 'Diperbarui oleh',
    uploadDropzone: 'Area unggah',
    uploadFiles: 'Unggah file',
    uploadHint: 'Seret file dari komputer atau klik tombol di bawah',
    viewMode: 'Tampilan dokumen',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Sejajarkan header dan kontrol',
    all: 'Semua',
    ...
    editViewWidth: 'Lebar tampilan edit',
    editViewWidthFull: 'Penuh',
    email: 'Email',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Ukuran teks',
    typeSizeSmall: 'Saat ini',
