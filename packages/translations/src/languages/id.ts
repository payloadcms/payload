...
export const idTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'Tidak dapat membaca file yang diunggah untuk deteksi tipe.',
    couldNotReadFileForValidation: 'Tidak dapat membaca file yang diunggah untuk validasi.',
    crop: 'Pangkas',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'Tipe file {{mimeType}} (dari ekstensi {{extension}}) tidak diizinkan.',
    focalPoint: 'Titik Fokus',
    focalPointDescription:
      'Seret titik fokus langsung pada pratinjau atau sesuaikan nilai di bawah ini.',
    height: 'Tinggi',
    invalidMimeType: 'Jenis MIME tidak valid: {{mimeType}}.',
    invalidOrCorruptedPDF: 'Berkas PDF tidak valid atau rusak.',
    ...
    restrictedFileType:
      "Tipe berkas '{{mimeType}}' tidak diizinkan untuk {{fileName}}: tipe berkas terbatas terdeteksi — atur 'allowRestrictedFileTypes' ke true untuk melewati pemeriksaan ini pada Collection ini.",
    ...
    svgHarmfulContent: 'File SVG mengandung konten yang berpotensi membahayakan.',
    width: 'Lebar',
  },
  validation: {
