...
export const zhTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    addFiles: '添加文件',
    bulkUpload: '批量上传',
    couldNotReadFileForTypeDetection: '无法读取上传的文件以进行类型检测。',
    couldNotReadFileForValidation: '无法读取上传的文件进行验证。',
    crop: '裁剪',
    ...
    fileToUpload: '要上传的文件',
    fileTypeNotAllowed: '文件类型 {{mimeType}}（来自扩展名 {{extension}}）不被允许。',
    focalPoint: '焦点',
    focalPointDescription: '直接在预览中拖动焦点或调整下面的值。',
    height: '高度',
    invalidMimeType: '无效的 MIME 类型：{{mimeType}}。',
    invalidOrCorruptedPDF: '无效或损坏的 PDF 文件。',
    lessInfo: '更少信息',
    moreInfo: '更多信息',
    noFile: '没有文件',
    pasteURL: '粘贴网址',
    previewSizes: '预览尺寸',
    restrictedFileType:
      '文件类型“{{mimeType}}”不允许用于 {{fileName}}：检测到受限文件类型 —— 如需跳过此集合的检查，请将“allowRestrictedFileTypes”设置为 true。',
    ...
    sizes: '尺寸',
    sizesFor: '{{label}} 的尺寸',
    svgHarmfulContent: 'SVG 文件包含潜在有害内容。',
    width: '宽度',
  },
  validation: {
