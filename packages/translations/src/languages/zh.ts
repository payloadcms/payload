...
export const zhTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    discardTitle: '放弃更改？',
    documents: '文档',
    draftsHint: '最近的草稿将显示在这里',
    dropFiles: '将文件拖放到此处上传',
    editDashboard: '编辑仪表板',
    editingDashboard: '编辑仪表板',
    gridView: '网格视图',
    listView: '列表视图',
    loadError: '部分文档无法加载。请刷新页面后重试。',
    noDrafts: '没有最近的草稿',
    noItems: '您的仪表板上没有小部件。您可以从位于顶部栏的“仪表板”菜单中添加它们。',
    noPinned: '没有固定的文档',
    noRecents: '没有最近浏览的文档',
    pinDocument: '固定 {{title}}',
    pinned: '已固定',
    pinnedHint: '固定的文档将显示在这里',
    recentDrafts: '最近草稿',
    recentlyViewed: '最近浏览',
    recentsHint: '浏览过的文档将显示在这里',
    resetLayout: '重置布局',
    saveError: '无法保存仪表板偏好设置。请重试。',
    searchWidgets: '搜索小工具...',
    unpinDocument: '取消固定 {{title}}',
    updatedBy: '更新者',
    uploadDropzone: '上传区域',
    uploadFiles: '上传文件',
    uploadHint: '从电脑拖放文件，或点击下方按钮',
    viewMode: '文档视图',
  ...
  general: {
    ...
    addFilter: '添加过滤条件',
    adminTheme: '管理页面主题',
    alignHeaderAndControls: '对齐标题和控件',
    all: '所有',
    allCollections: '所有集合',
    allLocales: '所有语言环境',
    and: '和',
    ...
    editLabel: '编辑 {{label}}',
    editViewWidth: '编辑视图宽度',
    editViewWidthFull: '全宽',
    email: '电子邮件',
    emailAddress: '电子邮件地址',
    emptyTrash: '清空垃圾箱',
