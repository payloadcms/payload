...
export const zhTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    checkYourEmailForPasswordReset:
      '如果此电子邮件地址已关联到一个账号，你将会很快收到重置密码的说明。如果你在收件箱中看不到此电子邮件，请检查你的垃圾邮件或垃圾邮件夹。',
  ...
  error: {
    ...
    localesNotSaved_one: '无法保存以下语言设置：',
    localesNotSaved_other: '无法保存以下语言设置：',
    logoutFailed: '登出失败。',
    missingEmail: '缺少电子邮件。',
  ...
  general: {
    ...
    errors: '错误',
    export: '导出',
    fallbackToDefaultLocale: '回退到默认语言',
    false: '假',
    filter: '过滤器',
    filters: '过滤器',
  ...
  localization: {
    cannotCopySameLocale: '无法复制到相同的语言',
    copyFrom: '复制自',
    copyFromTo: '从{{from}}复制到{{to}}',
    copyTo: '复制到',
    copyToLocale: '复制到指定语言',
    localeToPublish: '发布的语言',
    selectLocaleToCopy: '选择要复制的语言',
  },
  operators: {
    contains: '包含',
    equals: '等于',
