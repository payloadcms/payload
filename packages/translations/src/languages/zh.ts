...
export const zhTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: '此操作将锁定你对此预设的访问。',
    attachmentContentInvalid: '附件内容必须是字符串或缓冲区',
    attachmentMissingContentAndPath: '附件缺少内容和路径',
    attachmentMissingFilename: '附件缺少文件名',
    authenticationRequiredForExport: '创建导出需要用户认证。',
    autosaving: '自动保存该文档时出现了问题。',
    busboyMultipartError: '解析multipart请求时出现Busboy错误',
    collectionSlugRequired: '需要集合slug',
    contentTypeExpectedJSON: 'Content-Type应该是application/json',
    ...
    eitherCollectionOrGlobalRequired: '必须提供collection或globalSlug。',
    emailOrPasswordIncorrect: '提供的电子邮件或密码不正确。',
    expectedResponseFromUploadHandler: '期望从上传处理程序得到响应。',
    failedToFetchFromURL: '无法从提供的URL获取文件。',
    failedToResetLayout: '未能重置布局。',
    failedToSaveLayout: '未能保存布局。',
    fieldMustBeSpecified: '必须指定字段',
    fieldsNotInitialized: '字段未初始化。',
    filenameRequired: '需要文件名。',
    ...
    invalidFileURL: '无效的文件URL',
    invalidJSON: '无效的JSON',
    invalidJSONFormat: '无效的JSON格式',
    invalidRequestArgs: '请求中传递了无效的参数：{{args}}',
    joinFieldsNotAllowedInArraysBlocksOrGlobals: '联接字段不能添加到数组、块或全局字段。',
    ...
    missingIDOfVersionToRestore: '缺少要恢复的版本ID。',
    missingRequiredData: '缺少必要的数据。',
    noConnectionToDatabase: '在没有数据库连接的情况下调用了beginTransaction',
    noFileDataForImport: '未提供用于导入的文件数据',
    noFilesUploaded: '没有上传文件。',
    noMatchedField: '找不到与「{{label}}」匹配的字段',
    noPayloadProvided: '未提供payload',
    notAllowedToAccessPage: '您无权访问此页面。',
    notAllowedToPerformAction: '您无权执行此操作。',
    notFound: '没有找到请求的资源。',
    notSupported: '不支持',
    noUser: '没有用户',
    orderableJoinsMustTargetSingleCollection: '可排序联接必须针对单个集合',
    pastingFromURLNotEnabled: '该集合未启用从 URL 粘贴。',
    previewing: '预览该文档时出现了问题。',
    problemUploadingFile: '上传文件时出现了问题。',
    redirectTargetNotAllowed: '不允许重定向目标。',
    relationshipFieldNotFound: '未找到关系字段',
    relationshipNotFound: '未找到关系',
    requestDataRequired: '需要请求数据。',
    requestNotEligibleForFileUpload: '请求不符合文件上传条件',
    requestURLMissing: '缺少请求URL。',
    ...
    unexpectedArrayCollectionSlug: 'collectionSlug的意外数组，必须提供parent',
    unknown: '发生了一个未知的错误。',
    unPublishingDocument: '取消发布此文档时出现了问题。',
    unreachable: '不可达',
    unspecific: '发生了一个错误。',
    unverifiedEmail: '请在登录前验证您的电子邮件。',
    uploadConfigHandlersMissing: 'uploadConfig.handlers不存在于{{collection}}',
    uploadthingUnknownError: '使用uploadthing上传文件时出错：未知错误',
    urlNotAllowed: '提供的URL不被允许。',
    ...
    userRequiredForImport: '导入操作需要用户',
    validURLRequired: '需要有效的URL。',
    valueMustBeUnique: '值必须是唯一的',
    vercelBlobUploadError: 'storage-vercel-blob客户端上传路由错误',
