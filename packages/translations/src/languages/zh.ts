...
export const zhTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: '邮箱验证成功。正在为您跳转至登录页面……',
  ...
  branching: {
    andMoreChanges: '另有 {{count}} 项更改',
    branch: '分支',
    branchClosed: '此分支已关闭。它将作为已合并内容的记录保留。',
    ...
    branchSettings: '分支设置',
    cancelSchedule: '取消合并',
    changedDocuments: '已更改的文档',
    changesTo: '{{summary}} 的更改',
    closeBranchAfterMerge: '合并后关闭此分支',
    closeBranchHelpOff: '分支保持开启，你可以继续在其中工作，稍后再次合并。',
    closeBranchHelpOn: '分支将变为只读，且无法再次合并。',
    confirmDiscardAll:
      '此分支上全部 {{count}} 个已更改的文档都将还原为 main 上的状态。此操作无法撤销。',
    confirmDiscardSelected: '{{count}} 个已更改的文档将还原为 main 上的状态。此操作无法撤销。',
    createAndSwitch: '创建并切换',
    createNewBranch: '创建新分支',
    currentChanges: '当前更改',
    defaultBranch: '默认',
    discardAll: '全部放弃（{{count}}）',
    discardChanges: '放弃更改',
    discardedCount: '已放弃 {{count}} 项更改。',
    discarding: '正在放弃…',
    discardSelected: '放弃所选（{{count}}）',
    historyPageOf: '第 {{page}} 页，共 {{total}} 页',
    manage: '管理',
    manageBranches: '管理分支…',
    merge: '合并',
    mergeAllChanges: '将应用此分支上的所有更改。',
    mergeAllCount: '将应用此分支上全部 {{count}} 个已更改的文档。',
    mergeBranchInto: '将 {{branch}} 合并到 {{target}}',
    mergeChanges: '合并更改',
    mergeComplete: '合并完成',
    merged: '已合并',
    mergedByCount: '{{count}} 个文档，由 {{user}}',
    mergedCount: '已合并 {{count}} 项更改。',
    mergedOfTotal: '已合并 {{current}}/{{total}}',
    mergedOn: '于 {{date}} 合并',
    mergeHistory: '合并历史',
    mergeInterrupted: '合并被中断，未应用任何内容。请重试。',
    mergeNow: '立即合并',
    mergeOnlySelected: '选择要合并的更改',
    mergeScheduledFor: '已计划在 {{date}} 合并。',
    mergeSelectedOfTotal: '将应用 {{total}} 个已更改文档中的 {{selected}} 个。',
    mergeStarting: '正在开始合并…',
    merging: '正在合并…',
    mergingProgress: '正在合并 {{current}}/{{total}}',
    noChangesYet: '此分支尚无更改。',
    operation_create: '已创建',
    operation_delete: '已删除',
    operation_update: '已更新',
    reviewingChangedDocuments: '查看已更改的文档',
    scheduleAnotherMerge: '计划另一次合并',
    scheduleCancelled: '已取消计划的合并。',
    scheduleCount: '已计划 {{count}} 次',
    scheduledMerges: '计划的合并',
    scheduledToMerge: '已计划合并',
    scheduledToMergeOn: '此分支计划于 {{date}} 合并。',
    scheduleHasNothingLeft: '没有可应用的内容了——这些更改已放弃或已合并。',
    scheduleMerge: '计划合并',
    scheduleMergeHelp: '合并将在你选择的时间执行，并在那时重新检查你的权限。',
    scheduleWillApplyAll: '将应用所有待处理内容（{{count}}）',
    scheduleWillApplySelected: '将应用 {{count}} 项所选更改',
    scheduling: '正在计划…',
    searchBranches: '搜索分支',
    selectBranch: '选择分支',
    untouchedDocumentsNote:
      '在此分支上未被更改的文档显示的是 main 当前的内容，而不是分支创建时的快照。',
  },
  commandPalette: {
    actions: '操作',
    createNew: '新建',
    ...
    hintSelect: '打开',
    noResults: '未找到结果',
    pinToFavorites: '固定到收藏夹',
    placeholder: '请输入命令或搜索…',
  ...
  error: {
    ...
    noFileFoundInClipboard: '剪贴板中未找到文件。',
    ...
    unableToReadClipboard: '无法从剪贴板读取。',
