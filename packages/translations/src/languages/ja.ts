...
export const jaTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'メールの認証に成功しました。ログイン画面へリダイレクトしています…',
  ...
  commandPalette: {
    ...
    placeholder: 'コマンドを入力するか、検索してください…',
    recentlyVisited: '最近閲覧した',
  ...
  error: {
    ...
    actionWillLockoutPreset: 'このアクションはこのプリセットへのアクセスをロックします。',
    attachmentContentInvalid: '添付ファイルの内容は文字列またはバッファでなければなりません',
    attachmentMissingContentAndPath: '添付ファイルに内容とパスの両方がありません',
    attachmentMissingFilename: '添付ファイル名がありません',
    authenticationRequiredForExport: 'エクスポートを作成するにはユーザー認証が必要です。',
    autosaving: 'このデータを自動保存する際に問題が発生しました。',
    busboyMultipartError: 'multipartリクエストの解析中にBusboyエラーが発生しました',
    collectionSlugRequired: 'コレクションスラッグが必要です',
    contentTypeExpectedJSON: 'Content-Typeはapplication/jsonである必要があります',
    ...
    eitherCollectionOrGlobalRequired: 'collectionまたはglobalSlugを指定する必要があります。',
    emailOrPasswordIncorrect: 'メールアドレス、または、パスワードが正しくありません。',
    expectedResponseFromUploadHandler: 'アップロードハンドラーからの応答が必要です。',
    failedToFetchFromURL: '指定されたURLからファイルを取得できませんでした。',
    failedToResetLayout: 'レイアウトのリセットに失敗しました。',
    failedToSaveLayout: 'レイアウトの保存に失敗しました。',
    fieldMustBeSpecified: 'フィールドを指定する必要があります',
    fieldsNotInitialized: 'フィールドが初期化されていません。',
    ...
    missingIDOfVersionToRestore: '復元するバージョンのIDが不足しています。',
    missingRequiredData: '必須データが不足しています。',
    noConnectionToDatabase: 'データベース接続が存在しない状態でbeginTransactionが呼び出されました',
    noFileDataForImport: 'インポート用のファイルデータが提供されていません',
    noFilesUploaded: 'ファイルがアップロードされていません。',
    noMatchedField: '"{{label}}" に該当するフィールドがありません。',
    noPayloadProvided: 'ペイロードが提供されていません',
    ...
    orderableJoinsMustTargetSingleCollection:
      '並べ替え可能な結合は単一のコレクションを対象とする必要があります',
    pastingFromURLNotEnabled: 'このコレクションではURLからの貼り付けが有効になっていません。',
    previewing: 'このデータをプレビューする際に問題が発生しました。',
    problemUploadingFile: 'ファイルのアップロード中に問題が発生しました。',
    redirectTargetNotAllowed: 'リダイレクト先が許可されていません。',
    relationshipFieldNotFound: 'リレーションフィールドが見つかりません',
    relationshipNotFound: 'リレーションが見つかりません',
    requestDataRequired: 'リクエストデータが必要です。',
    requestNotEligibleForFileUpload: 'このリクエストはファイルアップロードの対象ではありません',
    requestURLMissing: 'リクエストURLがありません。',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug: 'collectionSlugの予期しない配列、parentを指定する必要があります',
    unknown: '不明なエラーが発生しました。',
    unPublishingDocument: 'このデータを非公開にする際に問題が発生しました。',
    unreachable: '到達不可能',
    unspecific: 'エラーが発生しました。',
    unverifiedEmail: 'ログインする前にメールを確認してください。',
    uploadConfigHandlersMissing: 'uploadConfig.handlersが{{collection}}に存在しません',
    uploadthingUnknownError: 'uploadthingでのファイルアップロードエラー: 不明なエラー',
    urlNotAllowed: '指定されたURLは許可されていません。',
    ...
    userRequiredForImport: 'インポート操作にはユーザーが必要です',
    validURLRequired: '有効なURLが必要です。',
    valueMustBeUnique: 'ユニークな値である必要があります。',
    vercelBlobUploadError: 'storage-vercel-blobクライアントアップロードルートエラー',
