...
export const jaTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: '他 {{count}} 件の変更',
    branch: 'ブランチ',
    branchClosed: 'このブランチはクローズされています。マージした内容の記録として残されます。',
    branchDescription: 'ブランチの説明',
    branchedFrom: '分岐元',
    branches: 'ブランチ',
    ...
    cancelSchedule: 'マージをキャンセル',
    changedDocuments: '変更されたドキュメント',
    changesTo: '{{summary}} への変更',
    closeBranchAfterMerge: 'マージ後にこのブランチをクローズする',
    closeBranchHelpOff: 'ブランチは開いたままなので、作業を続けて後で再度マージできます。',
    closeBranchHelpOn: 'ブランチは読み取り専用になり、再度マージすることはできません。',
    confirmDiscardAll:
      'このブランチの変更されたドキュメント {{count}} 件すべてが main の状態に戻されます。この操作は取り消せません。',
    confirmDiscardSelected:
      '変更されたドキュメント {{count}} 件が main の状態に戻されます。この操作は取り消せません。',
    createAndSwitch: '作成して切り替え',
    createNewBranch: '新しいブランチを作成',
    currentChanges: '現在の変更',
    defaultBranch: 'デフォルト',
    discardAll: 'すべて破棄 ({{count}})',
    discardChanges: '変更を破棄',
    discardedCount: '{{count}} 件の変更を破棄しました。',
    discarding: '破棄中…',
    discardSelected: '選択項目を破棄 ({{count}})',
    historyPageOf: '{{total}} ページ中 {{page}} ページ',
    manage: '管理',
    manageBranches: 'ブランチを管理…',
    merge: 'マージ',
    ...
    mergeComplete: 'マージ完了',
    merged: 'マージ済み',
    mergedByCount: '{{count}} 件のドキュメント（{{user}}）',
    mergedCount: '{{count}} 件の変更をマージしました。',
    mergedOfTotal: '{{total}} 件中 {{current}} 件をマージ',
    mergedOn: '{{date}} にマージ',
    mergeHistory: 'マージ履歴',
    ...
    mergeStarting: 'マージを開始中…',
    merging: 'マージ中…',
    mergingProgress: '{{total}} 件中 {{current}} 件をマージ中',
    noChangesYet: 'このブランチにはまだ変更がありません。',
    operation_create: '作成',
    operation_delete: '削除',
    operation_update: '更新',
    reviewingChangedDocuments: '変更されたドキュメントの確認',
    scheduleAnotherMerge: '別のマージを予約',
    scheduleCancelled: '予約マージをキャンセルしました。',
    scheduleCount: '{{count}} 件予約済み',
    scheduledMerges: '予約されたマージ',
    scheduledToMerge: 'マージ予約済み',
    scheduledToMergeOn: 'このブランチは {{date}} にマージされる予定です。',
    scheduleHasNothingLeft:
      '適用するものが残っていません。これらの変更は破棄済みか、すでにマージされています。',
    scheduleMerge: 'マージを予約',
    scheduleMergeHelp: 'マージは指定した時刻に実行され、その時点で権限が再確認されます。',
    scheduleWillApplyAll: '保留中のすべてを適用します（{{count}} 件）',
    scheduleWillApplySelected: '選択した {{count}} 件の変更を適用します',
    scheduling: '予約中…',
    searchBranches: 'ブランチを検索',
    selectBranch: 'ブランチを選択',
    untouchedDocumentsNote:
      'このブランチで変更していないDocumentは、ブランチ作成時点のスナップショットではなく、mainの最新の内容が表示されます。',
  },
  commandPalette: {
    actions: 'アクション',
    createNew: '新規作成',
  ...
  error: {
    ...
    fileFetchFailed: 'ファイルの取得に失敗しました。',
    ...
    noFileFoundInClipboard: 'クリップボードにファイルが見つかりません。',
    ...
    unableToReadClipboard: 'クリップボードから読み取ることができません。',
  ...
  general: {
    ...
    document: 'ドキュメント',
    documentIsTrashed: 'この{{label}}はゴミ箱に移動されており、読み取り専用です。',
  ...
  localization: {
    ...
    selectLocaleToDuplicate: '複製するロケールを選択してください',
  },
  operators: {
    contains: '含む',
    equals: '完全一致',
