...
export const jaTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'ドキュメント',
    draftsHint: '最近の下書きがここに表示されます',
    dropFiles: 'ファイルをドロップしてアップロード',
    editDashboard: 'ダッシュボードを編集する',
    editingDashboard: 'ダッシュボードの編集',
    gridView: 'グリッド表示',
    listView: 'リスト表示',
    loadError: '一部のドキュメントを読み込めませんでした。ページを再読み込みしてください。',
    noDrafts: '最近の下書きはありません',
    noItems:
      'あなたのダッシュボードにはウィジェットがありません。 上部バーにある「ダッシュボード」メニューからそれらを追加することができます。',
    noPinned: 'ピン留めしたドキュメントはありません',
    noRecents: '最近閲覧したドキュメントはありません',
    pinDocument: '{{title}}をピン留め',
    pinned: 'ピン留め',
    pinnedHint: 'ピン留めしたドキュメントがここに表示されます',
    recentDrafts: '最近の下書き',
    recentlyViewed: '最近閲覧した項目',
    recentsHint: '閲覧したドキュメントがここに表示されます',
    resetLayout: 'レイアウトをリセット',
    saveError: 'ダッシュボードの設定を保存できませんでした。もう一度お試しください。',
    searchWidgets: 'ウィジェットを検索...',
    unpinDocument: '{{title}}のピン留めを解除',
    updatedBy: '更新者',
    uploadDropzone: 'アップロードエリア',
    uploadFiles: 'ファイルをアップロード',
    uploadHint: 'パソコンからファイルをドラッグ＆ドロップするか、下のボタンをクリックしてください',
    viewMode: 'ドキュメント表示',
  ...
  general: {
    ...
    addFilter: '絞り込みを追加',
    adminTheme: '管理画面のテーマ',
    alignHeaderAndControls: 'ヘッダーとコントロールを揃える',
    all: 'すべて',
    ...
    editLabel: '{{label}} を編集',
    editViewWidth: '編集画面の幅',
    editViewWidthFull: '全幅',
    email: 'メールアドレス',
