...
export const ltTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'El. paštas sėkmingai patvirtintas. Nukreipiame jus prisijungti...',
  ...
  branching: {
    andMoreChanges: 'dar {{count}} pakeitimai',
    branch: 'Šaka',
    branchClosed: 'Ši šaka uždaryta. Ji paliekama kaip įrašas apie tai, kas buvo sujungta.',
    branchDescription: 'Šakos aprašymas',
    branchedFrom: 'Atskirta nuo',
    branches: 'Šakos',
    branchHistory: 'Šakos istorija',
    branchMerging: 'Sujungiama',
    branchName: 'Šakos pavadinimas',
    branchSettings: 'Šakos nustatymai',
    cancelSchedule: 'Atšaukti sujungimą',
    changedDocuments: 'Pakeisti dokumentai',
    changesTo: 'Pakeitimai: {{summary}}',
    closeBranchAfterMerge: 'Uždaryti šią šaką po sujungimo',
    closeBranchHelpOff:
      'Šaka lieka atvira, todėl galėsite toliau su ja dirbti ir vėliau sujungti dar kartą.',
    closeBranchHelpOn: 'Šaka taps tik skaitoma ir jos nebebus galima sujungti.',
    confirmDiscardAll:
      'Visi {{count}} pakeisti dokumentai šioje šakoje bus grąžinti į jų būseną main. Šio veiksmo negalima atšaukti.',
    confirmDiscardSelected:
      '{{count}} pakeisti dokumentai bus grąžinti į jų būseną main. Šio veiksmo negalima atšaukti.',
    createAndSwitch: 'Sukurti ir perjungti',
    createNewBranch: 'Sukurti naują šaką',
    currentChanges: 'Dabartiniai pakeitimai',
    defaultBranch: 'numatytoji',
    discardAll: 'Atmesti visus ({{count}})',
    discardChanges: 'Atmesti pakeitimus',
    discardedCount: 'Atmesta pakeitimų: {{count}}.',
    discarding: 'Atmetama…',
    discardSelected: 'Atmesti pasirinktus ({{count}})',
    historyPageOf: '{{page}} psl. iš {{total}}',
    manage: 'Tvarkyti',
    manageBranches: 'Tvarkyti šakas…',
    merge: 'Sujungti',
    mergeAllChanges: 'Bus pritaikyti visi šios šakos pakeitimai.',
    mergeAllCount: 'Bus pritaikyti visi {{count}} pakeisti šios šakos dokumentai.',
    mergeBranchInto: 'Sujungti {{branch}} į {{target}}',
    mergeChanges: 'Sujungti pakeitimus',
    mergeComplete: 'Sujungimas baigtas',
    merged: 'Sujungta',
    mergedByCount: '{{count}} dokumentų – {{user}}',
    mergedCount: 'Sujungta pakeitimų: {{count}}.',
    mergedOfTotal: 'Sujungta {{current}} iš {{total}}',
    mergedOn: 'Sujungta {{date}}',
    mergeHistory: 'Sujungimų istorija',
    mergeInterrupted: 'Sujungimas buvo nutrauktas ir nieko nepritaikyta. Bandykite dar kartą.',
    mergeNow: 'Sujungti dabar',
    mergeOnlySelected: 'Pasirinkite, kuriuos pakeitimus sujungti',
    mergeScheduledFor: 'Sujungimas suplanuotas {{date}}.',
    mergeSelectedOfTotal: 'Bus pritaikyta {{selected}} iš {{total}} pakeistų dokumentų.',
    mergeStarting: 'Pradedamas sujungimas…',
    merging: 'Sujungiama…',
    mergingProgress: 'Sujungiama {{current}} iš {{total}}',
    noChangesYet: 'Šioje šakoje kol kas nėra pakeitimų.',
    operation_create: 'Sukurta',
    operation_delete: 'Ištrinta',
    operation_update: 'Atnaujinta',
    reviewingChangedDocuments: 'Peržiūrimi pakeisti dokumentai',
    scheduleAnotherMerge: 'Suplanuoti dar vieną sujungimą',
    scheduleCancelled: 'Suplanuotas sujungimas atšauktas.',
    scheduleCount: 'Suplanuota: {{count}}',
    scheduledMerges: 'Suplanuoti sujungimai',
    scheduledToMerge: 'Sujungimas suplanuotas',
    scheduledToMergeOn: 'Ši šaka suplanuota sujungti {{date}}.',
    scheduleHasNothingLeft:
      'Nebeliko ko pritaikyti — šie pakeitimai buvo atmesti arba jau sujungti.',
    scheduleMerge: 'Suplanuoti sujungimą',
    scheduleMergeHelp:
      'Sujungimas bus atliktas pasirinktu laiku, o jūsų leidimai tada bus patikrinti dar kartą.',
    scheduleWillApplyAll: 'Pritaikys viską, kas laukia ({{count}})',
    scheduleWillApplySelected: 'Pritaikys {{count}} pasirinktų pakeitimų',
    scheduling: 'Planuojama…',
    searchBranches: 'Ieškoti šakų',
    selectBranch: 'Pasirinkti šaką',
    untouchedDocumentsNote:
      'Tie dokumentai, kurių šiame šakoje nepakeitėte, rodo dabartinį pagrindinės šakos turinį, o ne momentinę kopiją nuo šakos sukūrimo momento.',
  },
  commandPalette: {
    actions: 'Veiksmai',
  ...
  error: {
    ...
    fileFetchFailed: 'Nepavyko gauti failo.',
    ...
    noFileFoundInClipboard: 'Nerastas joks failas iškarpinėje.',
    ...
    unableToReadClipboard: 'Nepavyko nuskaityti iš iškarpinės.',
    ...
    urlNotAllowed: 'Pateiktas URL nėra leidžiamas.',
  ...
  general: {
    ...
    delete: 'Ištrinti',
    deleted: 'Ištrinta',
    deletedAgo: 'Ištrinta prieš {{distance}}',
    deletedAt: 'Ištrinta',
    ...
    editColumns: 'Redaguoti stulpelius',
