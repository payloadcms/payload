...
export const ltTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Šis veiksmas užrakina jus iš šio išankstinio nustatymo.',
    attachmentContentInvalid: 'Priedo turinys turi būti eilutė arba buferis',
    attachmentMissingContentAndPath: 'Priede trūksta ir turinio, ir kelio',
    attachmentMissingFilename: 'Priede trūksta failo pavadinimo',
    authenticationRequiredForExport:
      'Norint kurti eksportus, reikalingas vartotojo autentifikavimas.',
    autosaving: 'Šio dokumento automatinio išsaugojimo metu kilo problema.',
    busboyMultipartError: 'Busboy klaida analizuojant multipart užklausą',
    collectionSlugRequired: 'Reikalingas kolekcijos identifikatorius',
    contentTypeExpectedJSON: 'Tikimasi, kad Content-Type bus application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Turi būti perduota arba kolekcija, arba globalSlug.',
    emailOrPasswordIncorrect: 'Pateiktas el. pašto adresas arba slaptažodis yra neteisingi.',
    expectedResponseFromUploadHandler: 'Tikėtasi atsakymo iš įkėlimo tvarkyklės.',
    failedToFetchFromURL: 'Nepavyko gauti failo iš pateikto URL.',
    failedToResetLayout: 'Nepavyko atstatyti išdėstymo.',
    failedToSaveLayout: 'Nepavyko išsaugoti išdėstymo.',
    fieldMustBeSpecified: 'laukas turi būti nurodytas',
    fieldsNotInitialized: 'Laukai nėra inicializuoti.',
    filenameRequired: 'Reikalingas failo pavadinimas.',
    ...
    missingIDOfVersionToRestore: 'Trūksta atkuriamos versijos ID.',
    missingRequiredData: 'Trūksta reikalingų duomenų.',
    noConnectionToDatabase: 'beginTransaction iškviestas, kai nėra ryšio su duomenų baze',
    noFileDataForImport: 'Nepateikta failo duomenų importui',
    noFilesUploaded: 'Neįkelta jokių failų.',
    noMatchedField: 'Nerasta atitinkamo lauko „{{label}}“',
    noPayloadProvided: 'Nepateikta jokių duomenų',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Rūšiuojami sujungimai turi būti nukreipti į vieną kolekciją',
    pastingFromURLNotEnabled: 'Įklijavimas iš URL nėra įjungtas šiai kolekcijai.',
    previewing: 'Šiam dokumentui peržiūrėti kilo problema.',
    problemUploadingFile: 'Failo įkelti nepavyko dėl problemos.',
    redirectTargetNotAllowed: 'Peradresavimo tikslas nėra leidžiamas.',
    relationshipFieldNotFound: 'Santykio laukas nerastas',
    relationshipNotFound: 'Santykis nerastas',
    requestDataRequired: 'Reikalingi užklausos duomenys.',
    requestNotEligibleForFileUpload: 'Užklausa netinkama failo įkėlimui',
    requestURLMissing: 'Trūksta užklausos URL.',
    restoringTitle:
    ...
    tooManyRedirects: 'Per daug peradresavimų.',
    ...
    unexpectedArrayCollectionSlug:
      'Netikėtas collectionSlug masyvas, turi būti nurodytas tėvinis elementas',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers nėra {{collection}}',
    uploadthingUnknownError: 'Klaida įkeliant failą su uploadthing: nežinoma klaida',
    ...
    userRequiredForImport: 'Importo operacijoms reikalingas vartotojas',
    validURLRequired: 'Reikalinga galiojanti URL eilutė.',
    valueMustBeUnique: 'Vertė turi būti unikalu.',
    vercelBlobUploadError: 'storage-vercel-blob kliento įkėlimo maršruto klaida',
