...
export const ltTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    draftsHint: 'Jūsų naujausi juodraščiai bus rodomi čia',
    dropFiles: 'Numeskite failus, kad įkeltumėte',
    ...
    loadError: 'Nepavyko įkelti kai kurių dokumentų. Atnaujinkite puslapį.',
    noDrafts: 'Nėra naujausių juodraščių',
    noItems:
      'Jūsų prietaisų skydelyje nėra valdiklių. Juos galite pridėti iš „Skydelio“ meniu, esančio viršutinėje juostoje.',
    noPinned: 'Nėra prisegtų dokumentų',
    noRecents: 'Nėra neseniai peržiūrėtų dokumentų',
    pinDocument: 'Prisegti {{title}}',
    pinned: 'Prisegti',
    pinnedHint: 'Prisegti dokumentai bus rodomi čia',
    recentDrafts: 'Naujausi juodraščiai',
    recentlyViewed: 'Neseniai peržiūrėti',
    recentsHint: 'Peržiūrėti dokumentai bus rodomi čia',
    resetLayout: 'Atstatyti išdėstymą',
    saveError: 'Nepavyko išsaugoti skydelio nuostatos. Bandykite dar kartą.',
    searchWidgets: 'Ieškokite valdiklių...',
    unpinDocument: 'Atsegti {{title}}',
    updatedBy: 'Atnaujino',
    uploadDropzone: 'Įkėlimo sritis',
    uploadFiles: 'Įkelti failus',
    uploadHint: 'Vilkite failus iš kompiuterio arba spustelėkite toliau esantį mygtuką',
    viewMode: 'Dokumentų rodinys',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Lygiuoti antraštę ir valdiklius',
    all: 'Visi',
    ...
    editViewWidth: 'Redagavimo rodinio plotis',
    editViewWidthFull: 'Visas plotis',
    email: 'El. paštas',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Teksto dydžiai',
    typeSizeSmall: 'Dabartinis',
