...
export const roTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Copiere',
    copyWarning:
      'Sunteți pe punctul de a copia date din {{from}} în {{to}}. Acest lucru va suprascrie orice date existente în {{to}} și vă va redirecționa pentru a continua editarea acestei locații. Sunteți sigur că doriți să continuați?',
    create: 'Creează',
    created: 'Creat',
    createdAt: 'Creat la',
