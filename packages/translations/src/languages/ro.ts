...
export const roTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: 'încă {{count}} modificări',
    branch: 'Ramură',
    branchClosed: 'Această ramură este închisă. Este păstrată ca evidență a ceea ce a îmbinat.',
    branchDescription: 'Descrierea ramurii',
    branchedFrom: 'Ramificat din',
    branches: 'Ramuri',
    branchHistory: 'Istoricul ramurii',
    branchMerging: 'În îmbinare',
    branchName: 'Numele ramurii',
    branchSettings: 'Setările ramurii',
    cancelSchedule: 'Anulează fuzionarea',
    changedDocuments: 'Documente modificate',
    changesTo: 'Modificări la {{summary}}',
    closeBranchAfterMerge: 'Închide această ramură după îmbinare',
    closeBranchHelpOff:
      'Ramura rămâne deschisă, așa că poți continua să lucrezi la ea și să o îmbini din nou mai târziu.',
    closeBranchHelpOn: 'Ramura va deveni doar pentru citire și nu va mai putea fi îmbinată.',
    confirmDiscardAll:
      'Toate cele {{count}} documente modificate din această ramură vor reveni la starea lor din main. Această acțiune nu poate fi anulată.',
    confirmDiscardSelected:
      '{{count}} documente modificate vor reveni la starea lor din main. Această acțiune nu poate fi anulată.',
    createAndSwitch: 'Creează și comută',
    createNewBranch: 'Creează o ramură nouă',
    currentChanges: 'Modificări curente',
    defaultBranch: 'implicită',
    discardAll: 'Renunță la tot ({{count}})',
    discardChanges: 'Renunță la modificări',
    discardedCount: '{{count}} modificări eliminate.',
    discarding: 'Se renunță…',
    discardSelected: 'Renunță la cele selectate ({{count}})',
    historyPageOf: 'Pagina {{page}} din {{total}}',
    manage: 'Gestionează',
    manageBranches: 'Gestionează ramurile…',
    merge: 'Îmbină',
    mergeAllChanges: 'Toate modificările din această ramură vor fi aplicate.',
    mergeAllCount: 'Toate cele {{count}} documente modificate din această ramură vor fi aplicate.',
    mergeBranchInto: 'Îmbină {{branch}} în {{target}}',
    mergeChanges: 'Îmbină modificările',
    mergeComplete: 'Îmbinare finalizată',
    merged: 'Îmbinată',
    mergedByCount: '{{count}} documente de {{user}}',
    mergedCount: '{{count}} modificări îmbinate.',
    mergedOfTotal: '{{current}} din {{total}} îmbinate',
    mergedOn: 'Îmbinat la {{date}}',
    mergeHistory: 'Istoricul îmbinărilor',
    mergeInterrupted: 'Îmbinarea a fost întreruptă și nu s-a aplicat nimic. Încearcă din nou.',
    mergeNow: 'Îmbină acum',
    mergeOnlySelected: 'Alege ce modificări să fie îmbinate',
    mergeScheduledFor: 'Îmbinare programată pentru {{date}}.',
    mergeSelectedOfTotal: '{{selected}} din {{total}} documente modificate vor fi aplicate.',
    mergeStarting: 'Se începe îmbinarea…',
    merging: 'Se îmbină…',
    mergingProgress: 'Se îmbină {{current}} din {{total}}',
    noChangesYet: 'Încă nu există modificări pe această ramură.',
    operation_create: 'Creat',
    operation_delete: 'Șters',
    operation_update: 'Actualizat',
    reviewingChangedDocuments: 'Revizuirea documentelor modificate',
    scheduleAnotherMerge: 'Programează altă îmbinare',
    scheduleCancelled: 'Îmbinarea programată a fost anulată.',
    scheduleCount: '{{count}} programate',
    scheduledMerges: 'Îmbinări programate',
    scheduledToMerge: 'Îmbinare programată',
    scheduledToMergeOn: 'Această ramură este programată să fie îmbinată la {{date}}.',
    scheduleHasNothingLeft:
      'Nu mai este nimic de aplicat — aceste modificări au fost eliminate sau deja îmbinate.',
    scheduleMerge: 'Programează îmbinarea',
    scheduleMergeHelp:
      'Îmbinarea rulează la ora aleasă, iar permisiunile tale sunt verificate din nou atunci.',
    scheduleWillApplyAll: 'Va aplica tot ce este în așteptare ({{count}})',
    scheduleWillApplySelected: 'Va aplica {{count}} modificare(modificări) selectate',
    scheduling: 'Se programează…',
    searchBranches: 'Caută ramuri',
    selectBranch: 'Selectează ramura',
    untouchedDocumentsNote:
      'Documentele pe care nu le-ați modificat pe această ramură afișează conținutul actual al ramurii main, nu un instantaneu din momentul în care a fost creată ramura.',
  },
  commandPalette: {
    actions: 'Acțiuni',
  ...
  error: {
    ...
    fileFetchFailed: 'Nu s-a putut prelua fișierul.',
    ...
    noFileFoundInClipboard: 'Nu a fost găsit niciun fișier în clipboard.',
    ...
    unableToReadClipboard: 'Imposibil de citit din clipboard.',
    ...
    urlNotAllowed: 'URL-ul furnizat nu este permis.',
  ...
  general: {
    ...
    delete: 'Șterge',
    deleted: 'Șters',
    deletedAgo: 'Șters acum {{distance}}',
    deletedAt: 'Șters la',
  ...
  upload: {
    ...
    fromURL: 'Încarcă fișier din URL',
    height: 'Înălțime',
    ...
    replaceFile: 'Înlocuiți fișierul',
