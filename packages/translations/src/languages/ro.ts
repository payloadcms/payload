...
export const roTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Documente',
    draftsHint: 'Ciornele tale recente vor apărea aici',
    dropFiles: 'Plasează fișierele pentru încărcare',
    ...
    loadError:
      'Unele documente nu au putut fi încărcate. Reîmprospătează pentru a încerca din nou.',
    noDrafts: 'Nicio ciornă recentă',
    noItems:
      'Nu există widget-uri pe tabloul dvs. de bord. Le puteți adăuga din meniul "Tablou de bord" situat în bara superioară.',
    noPinned: 'Niciun document fixat',
    noRecents: 'Niciun document vizualizat recent',
    pinDocument: 'Fixează {{title}}',
    pinned: 'Fixate',
    pinnedHint: 'Documentele fixate vor apărea aici',
    recentDrafts: 'Ciorne recente',
    recentlyViewed: 'Vizualizate recent',
    recentsHint: 'Documentele vizualizate vor apărea aici',
    resetLayout: 'Resetează Aspectul',
    saveError: 'Preferința panoului nu a putut fi salvată. Încearcă din nou.',
    searchWidgets: 'Caută widgeturi...',
    unpinDocument: 'Anulează fixarea {{title}}',
    updatedBy: 'Actualizat de',
    uploadDropzone: 'Zonă de încărcare',
    uploadFiles: 'Încarcă fișiere',
    uploadHint: 'Trage fișiere de pe computer sau apasă butonul de mai jos',
    viewMode: 'Vizualizare documente',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Aliniază antetul și comenzile',
    all: 'Toate',
    ...
    editViewWidth: 'Lățimea vizualizării de editare',
    editViewWidthFull: 'Completă',
    email: 'Email',
