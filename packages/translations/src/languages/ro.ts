...
export const roTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Această acțiune vă va bloca această presetare.',
    attachmentContentInvalid: 'Conținutul atașamentului trebuie să fie un string sau un buffer',
    attachmentMissingContentAndPath: 'Atașamentului îi lipsesc atât conținutul cât și calea',
    attachmentMissingFilename: 'Atașamentului îi lipsește numele fișierului',
    authenticationRequiredForExport:
      'Autentificarea utilizatorului este necesară pentru a crea export-uri.',
    autosaving: 'A existat o problemă în timpul salvării automate a acestui document.',
    busboyMultipartError: 'Eroare Busboy la parsarea cererii multipart',
    collectionSlugRequired: 'Slug-ul colecției este necesar',
    contentTypeExpectedJSON: 'Content-Type ar trebui să fie application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Trebuie furnizată colecția sau globalSlug.',
    emailOrPasswordIncorrect: 'Adresa de e-mail sau parola este incorectă.',
    expectedResponseFromUploadHandler: 'Răspuns așteptat de la handler-ul de upload.',
    failedToFetchFromURL: 'Eșuare la preluarea fișierului de la URL-ul furnizat.',
    failedToResetLayout: 'Resetarea aspectului a eșuat.',
    failedToSaveLayout: 'Salvarea aspectului a eșuat.',
    fieldMustBeSpecified: 'câmpul trebuie să fie specificat',
    fieldsNotInitialized: 'Câmpurile nu sunt inițializate.',
    filenameRequired: 'Este necesar un nume de fișier.',
    ...
    invalidFileURL: 'URL-ul fișierului este invalid',
    invalidJSON: 'JSON invalid',
    invalidJSONFormat: 'Format JSON invalid',
    invalidRequestArgs: 'Argumente invalide transmise în cerere: {{args}}',
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Câmpurile de tip join nu pot fi adăugate în array-uri, blocuri sau globale.',
    ...
    missingIDOfVersionToRestore: 'Lipsește ID-ul versiunii de restaurat.',
    missingRequiredData: 'Lipsesc datele necesare.',
    noConnectionToDatabase:
      'beginTransaction a fost apelat în timp ce nu există conexiune la baza de date',
    noFileDataForImport: 'Nu au fost furnizate date de fișier pentru import',
    noFilesUploaded: 'Nu a fost încărcat niciun fișier.',
    noMatchedField: 'Nu s-a găsit niciun câmp corespunzător pentru "{{label}}"',
    noPayloadProvided: 'Nu a fost furnizat payload',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Join-urile ordonabile trebuie să vizeze o singură colecție',
    pastingFromURLNotEnabled: 'Lipirea din URL nu este activată pentru această colecție.',
    ...
    redirectTargetNotAllowed: 'Ținta redirecționării nu este permisă.',
    relationshipFieldNotFound: 'Câmpul de relație nu a fost găsit',
    relationshipNotFound: 'Relația nu a fost găsită',
    requestDataRequired: 'Datele cererii sunt necesare.',
    requestNotEligibleForFileUpload: 'Cererea nu este eligibilă pentru încărcarea fișierului',
    requestURLMissing: 'Lipsește URL-ul cererii.',
    restoringTitle:
    ...
    tooManyRedirects: 'Prea multe redirecționări.',
    ...
    unexpectedArrayCollectionSlug:
      'Array neașteptat de collectionSlug, părintele trebuie să fie furnizat',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers nu este prezent pentru {{collection}}',
    uploadthingUnknownError: 'Eroare la încărcarea fișierului cu uploadthing: Eroare necunoscută',
    ...
    userRequiredForImport: 'Utilizatorul este necesar pentru operațiunile de import',
    validURLRequired: 'Este necesar un șir URL valid.',
    valueMustBeUnique: 'Valoarea trebuie să fie unică',
    vercelBlobUploadError: 'Eroare la ruta de încărcare client storage-vercel-blob',
