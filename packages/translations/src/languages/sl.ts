...
export const slTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Dokumenti',
    draftsHint: 'Vaši nedavni osnutki bodo prikazani tukaj',
    dropFiles: 'Spustite datoteke za nalaganje',
    ...
    loadError: 'Nekaterih dokumentov ni bilo mogoče naložiti. Osvežite in poskusite znova.',
    noDrafts: 'Ni nedavnih osnutkov',
    noItems:
      'Na vaši nadzorni plošči ni pripomočkov. Dodate jih lahko iz menija "Nadzorna plošča", ki se nahaja v zgornji vrstici.',
    noPinned: 'Ni pripetih dokumentov',
    noRecents: 'Ni nedavno ogledanih dokumentov',
    pinDocument: 'Pripni {{title}}',
    pinned: 'Pripeti',
    pinnedHint: 'Pripeti dokumenti bodo prikazani tukaj',
    recentDrafts: 'Nedavni osnutki',
    recentlyViewed: 'Nedavno ogledani',
    recentsHint: 'Ogledani dokumenti bodo prikazani tukaj',
    resetLayout: 'Ponastavi postavitev',
    saveError: 'Nastavitve nadzorne plošče ni bilo mogoče shraniti. Poskusite znova.',
    searchWidgets: 'Išči gradnike...',
    unpinDocument: 'Odpni {{title}}',
    updatedBy: 'Posodobil',
    uploadDropzone: 'Območje nalaganja',
    uploadFiles: 'Naloži datoteke',
    uploadHint: 'Povlecite datoteke iz računalnika ali kliknite spodnji gumb',
    viewMode: 'Prikaz dokumentov',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Poravnaj glavo in kontrolnike',
    all: 'Vse',
    ...
    editViewWidth: 'Širina pogleda za urejanje',
    editViewWidthFull: 'Polna širina',
    email: 'E-pošta',
