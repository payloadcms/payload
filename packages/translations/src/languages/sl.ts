...
export const slTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'E-pošta je bila uspešno preverjena. Preusmerjamo vas na prijavo...',
  ...
  branching: {
    andMoreChanges: 'še {{count}} sprememb',
    branch: 'Veja',
    branchClosed: 'Ta veja je zaprta. Ohrani se kot zapis o tem, kaj je združila.',
    branchDescription: 'Opis veje',
    branchedFrom: 'Odcepljeno od',
    branches: 'Veje',
    branchHistory: 'Zgodovina veje',
    branchMerging: 'Združevanje',
    branchName: 'Ime veje',
    branchSettings: 'Nastavitve veje',
    cancelSchedule: 'Prekliči združitev',
    changedDocuments: 'Spremenjeni dokumenti',
    changesTo: 'Spremembe v {{summary}}',
    closeBranchAfterMerge: 'Po združitvi zapri to vejo',
    closeBranchHelpOff:
      'Veja ostane odprta, tako da lahko na njej še naprej delate in jo pozneje znova združite.',
    closeBranchHelpOn: 'Veja bo samo za branje in je ne bo mogoče znova združiti.',
    confirmDiscardAll:
      'Vseh {{count}} spremenjenih dokumentov v tej veji bo povrnjenih v stanje na main. Tega ni mogoče razveljaviti.',
    confirmDiscardSelected:
      '{{count}} spremenjenih dokumentov bo povrnjenih v stanje na main. Tega ni mogoče razveljaviti.',
    createAndSwitch: 'Ustvari in preklopi',
    createNewBranch: 'Ustvari novo vejo',
    currentChanges: 'Trenutne spremembe',
    defaultBranch: 'privzeta',
    discardAll: 'Zavrzi vse ({{count}})',
    discardChanges: 'Zavrzi spremembe',
    discardedCount: 'Zavrženih {{count}} sprememb.',
    discarding: 'Zavračanje…',
    discardSelected: 'Zavrzi izbrano ({{count}})',
    historyPageOf: 'Stran {{page}} od {{total}}',
    manage: 'Upravljanje',
    manageBranches: 'Upravljanje vej…',
    merge: 'Združi',
    mergeAllChanges: 'Uporabljene bodo vse spremembe v tej veji.',
    mergeAllCount: 'Uporabljenih bo vseh {{count}} spremenjenih dokumentov v tej veji.',
    mergeBranchInto: 'Združi {{branch}} v {{target}}',
    mergeChanges: 'Združi spremembe',
    mergeComplete: 'Združevanje končano',
    merged: 'Združena',
    mergedByCount: '{{count}} dokumentov – {{user}}',
    mergedCount: 'Združenih {{count}} sprememb.',
    mergedOfTotal: 'Združenih {{current}} od {{total}}',
    mergedOn: 'Združeno {{date}}',
    mergeHistory: 'Zgodovina združevanj',
    mergeInterrupted: 'Združevanje je bilo prekinjeno in nič ni bilo uporabljeno. Poskusite znova.',
    mergeNow: 'Združi zdaj',
    mergeOnlySelected: 'Izberite, katere spremembe naj se združijo',
    mergeScheduledFor: 'Združevanje načrtovano za {{date}}.',
    mergeSelectedOfTotal: 'Uporabljenih bo {{selected}} od {{total}} spremenjenih dokumentov.',
    mergeStarting: 'Začenjanje združevanja…',
    merging: 'Združevanje…',
    mergingProgress: 'Združevanje {{current}} od {{total}}',
    noChangesYet: 'V tej veji še ni sprememb.',
    operation_create: 'Ustvarjeno',
    operation_delete: 'Izbrisano',
    operation_update: 'Posodobljeno',
    reviewingChangedDocuments: 'Pregled spremenjenih dokumentov',
    scheduleAnotherMerge: 'Načrtuj še eno združevanje',
    scheduleCancelled: 'Načrtovano združevanje preklicano.',
    scheduleCount: '{{count}} načrtovanih',
    scheduledMerges: 'Načrtovana združevanja',
    scheduledToMerge: 'Združevanje načrtovano',
    scheduledToMergeOn: 'Ta veja je načrtovana za združitev {{date}}.',
    scheduleHasNothingLeft:
      'Ni več ničesar za uporabo — te spremembe so bile zavržene ali že združene.',
    scheduleMerge: 'Načrtuj združevanje',
    scheduleMergeHelp:
      'Združevanje se izvede v izbranem času, vaša dovoljenja pa se takrat znova preverijo.',
    scheduleWillApplyAll: 'Uporabil bo vse, kar čaka ({{count}})',
    scheduleWillApplySelected: 'Uporabil bo {{count}} izbranih sprememb',
    scheduling: 'Načrtovanje…',
    searchBranches: 'Iskanje vej',
    selectBranch: 'Izberi vejo',
    untouchedDocumentsNote:
      'Dokumenti, ki jih na tej veji niste spremenili, prikazujejo trenutno vsebino glavne veje in ne posnetka iz časa, ko je bila veja ustvarjena.',
  },
  commandPalette: {
    actions: 'Dejanja',
  ...
  error: {
    ...
    fileFetchFailed: 'Datoteke ni bilo mogoče pridobiti.',
    ...
    noFileFoundInClipboard: 'V odložišču ni najdene nobene datoteke.',
    ...
    unableToReadClipboard: 'Ni mogoče brati iz odložišča.',
    ...
    urlNotAllowed: 'Navedeni URL ni dovoljen.',
  ...
  general: {
    ...
    delete: 'Izbriši',
    deleted: 'Izbrisano',
    deletedAgo: 'Izbrisano pred {{distance}}',
  ...
  upload: {
    ...
    fromURL: 'Naloži datoteko iz URL-ja',
    height: 'Višina',
  ...
  version: {
    ...
    lastSavedAgo: 'Shranjeno pred {{distance}}',
