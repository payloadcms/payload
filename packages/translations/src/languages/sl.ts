...
export const slTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'To dejanje vas bo zaklenilo iz te prednastavitve.',
    attachmentContentInvalid: 'Vsebina priloge mora biti niz ali medpomnilnik',
    attachmentMissingContentAndPath: 'Prilogi manjkata vsebina in pot',
    attachmentMissingFilename: 'Prilogi manjka ime datoteke',
    authenticationRequiredForExport: 'Za ustvarjanje izvozov je potrebna avtentikacija uporabnika.',
    autosaving: 'Pri samodejnem shranjevanju tega dokumenta je prišlo do težave.',
    busboyMultipartError: 'Napaka Busboy pri razčlenjevanju večdelne zahteve',
    collectionSlugRequired: 'Oznaka zbirke je obvezna',
    contentTypeExpectedJSON: 'Pričakovan Content-Type je application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Posredovati je treba zbirko ali globalSlug.',
    emailOrPasswordIncorrect: 'Vnesena e-pošta ali geslo je napačno.',
    expectedResponseFromUploadHandler: 'Pričakovan odgovor od upravitelja nalaganja.',
    failedToFetchFromURL: 'Pridobitev datoteke iz podanega URL-ja ni uspela.',
    failedToResetLayout: 'Ni uspelo ponastaviti razporeda.',
    failedToSaveLayout: 'Shranjevanje postavitve ni uspelo.',
    fieldMustBeSpecified: 'polje mora biti določeno',
    fieldsNotInitialized: 'Polja niso inicializirana.',
    filenameRequired: 'Ime datoteke je obvezno.',
    ...
    missingIDOfVersionToRestore: 'Manjka ID različice za obnovitev.',
    missingRequiredData: 'Manjkajo zahtevani podatki.',
    noConnectionToDatabase: 'beginTransaction klican, medtem ko ni povezave z bazo podatkov',
    noFileDataForImport: 'Za uvoz niso bili posredovani podatki o datoteki',
    noFilesUploaded: 'Nobena datoteka ni bila naložena.',
    noMatchedField: 'Za "{{label}}" ni bilo najdeno ujemajoče se polje',
    noPayloadProvided: 'Payload ni bil posredovan',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Razvrščljive povezave morajo biti usmerjene v eno zbirko',
    pastingFromURLNotEnabled: 'Lepljenje iz URL-ja ni omogočeno za to zbirko.',
    ...
    redirectTargetNotAllowed: 'Cilj preusmeritve ni dovoljen.',
    relationshipFieldNotFound: 'Polje za povezavo ni bilo najdeno',
    relationshipNotFound: 'Povezava ni bila najdena',
    requestDataRequired: 'Podatki zahteve so obvezni.',
    requestNotEligibleForFileUpload: 'Zahteva ni primerna za nalaganje datotek',
    requestURLMissing: 'URL zahteve manjka.',
    restoringTitle:
    ...
    tooManyRedirects: 'Preveč preusmeritev.',
    ...
    unexpectedArrayCollectionSlug:
      'Nepričakovano polje collectionSlug, posredovati je treba parent',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers manjka za {{collection}}',
    uploadthingUnknownError: 'Napaka pri nalaganju datoteke z uploadthing: Neznana napaka',
    urlNotAllowed: 'Podani URL ni dovoljen.',
    ...
    userRequiredForImport: 'Uporabnik je obvezen za operacije uvoza',
    validURLRequired: 'Veljaven niz URL je obvezen.',
    valueMustBeUnique: 'Vrednost mora biti unikatna',
    vercelBlobUploadError: 'Napaka poti nalaganja odjemalca storage-vercel-blob',
