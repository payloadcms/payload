...
export const heTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'העתקה',
    copyWarning:
      'אתה עומד להעתיק נתונים מ-{{from}} אל {{to}}. פעולה זו תמחק את כל הנתונים הקיימים של {{to}} ותכווננך להמשיך לערוך את האזור הזה. האם אתה בטוח שאתה רוצה להמשיך?',
    create: 'יצירה',
    created: 'נוצר',
