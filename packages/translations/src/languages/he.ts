...
export const heTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'מסמכים',
    draftsHint: 'הטיוטות האחרונות שלכם יופיעו כאן',
    dropFiles: 'שחררו קבצים להעלאה',
    editDashboard: 'ערוך את לוח המחוונים',
    editingDashboard: 'עריכת לוח בקרה',
    gridView: 'תצוגת רשת',
    listView: 'תצוגת רשימה',
    loadError: 'לא ניתן לטעון חלק מהמסמכים. רעננו כדי לנסות שוב.',
    noDrafts: 'אין טיוטות אחרונות',
    noItems:
      'אין יישומונים בלוח הבקרה שלך. אתה יכול להוסיף אותם מתפריט "לוח הבקרה" שממוקם בבר העליון.',
    noPinned: 'אין מסמכים נעוצים',
    noRecents: 'אין מסמכים שנצפו לאחרונה',
    pinDocument: 'נעיצת {{title}}',
    pinned: 'נעוצים',
    pinnedHint: 'מסמכים שתנעצו יופיעו כאן',
    recentDrafts: 'טיוטות אחרונות',
    recentlyViewed: 'נצפו לאחרונה',
    recentsHint: 'מסמכים שתצפו בהם יופיעו כאן',
    resetLayout: 'איפוס תצוגה',
    saveError: 'לא ניתן לשמור את העדפת לוח הבקרה. נסו שוב.',
    searchWidgets: "חפש ווידג'טים...",
    unpinDocument: 'ביטול נעיצת {{title}}',
    updatedBy: 'עודכן על ידי',
    uploadDropzone: 'אזור העלאת קבצים',
    uploadFiles: 'העלאת קבצים',
    uploadHint: 'גררו קבצים מהמחשב או לחצו על הכפתור למטה',
    viewMode: 'תצוגת מסמכים',
  ...
  general: {
    ...
    alignHeaderAndControls: 'יישור הכותרת והפקדים',
    all: 'כל',
    ...
    editViewWidth: 'רוחב תצוגת העריכה',
    editViewWidthFull: 'מלא',
    email: 'דוא"ל',
