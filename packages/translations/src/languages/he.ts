...
export const heTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'לא ניתן היה לקרוא את הקובץ שהועלה לצורך זיהוי סוג.',
    couldNotReadFileForValidation: 'לא ניתן לקרוא את הקובץ שהועלה לצורך אימות.',
    crop: 'חתוך',
    ...
    fileTypeNotAllowed: 'סוג הקובץ {{mimeType}} (מתוך הסיומת {{extension}}) אינו מותר.',
    focalPoint: 'נקודת מיקוד',
    focalPointDescription: 'גרור את נקודת המיקוד ישירות על התצוגה המקדימה או התאם את הערכים למטה.',
    height: 'גובה',
    invalidMimeType: 'סוג MIME לא חוקי: {{mimeType}}.',
    invalidOrCorruptedPDF: 'קובץ PDF לא תקין או פגום.',
    lessInfo: 'פחות מידע',
    moreInfo: 'מידע נוסף',
    noFile: 'אין קובץ',
    ...
    restrictedFileType:
      "סוג הקובץ '{{mimeType}}' אינו מותר עבור {{fileName}}: זוהה סוג קובץ מוגבל — יש להגדיר 'allowRestrictedFileTypes' לערך true כדי לדלג על בדיקה זו עבור ה-Collection הזה.",
    ...
    svgHarmfulContent: 'קובץ SVG מכיל תוכן שעלול להיות מזיק.',
    width: 'רוחב',
  },
  validation: {
