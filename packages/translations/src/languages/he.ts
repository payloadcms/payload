...
export const heTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    failedToUnlock: 'נכשל בפתיחה',
    forceUnlock: 'פתיחה כפויה',
    ...
    successfullyUnlocked: 'נעול בהצלחה',
  ...
  general: {
    ...
    addBelow: 'הוסף מתחת',
    addFilter: 'הוסף מסנן',
    adminTheme: 'ערכת נושא מנהל',
    and: 'וגם',
    applyChanges: 'החל שינויים',
    ascending: 'בסדר עולה',
    automatic: 'אוטומטי',
    backToDashboard: 'חזור ללוח המחוונים',
    cancel: 'ביטול',
    changesNotSaved: 'השינויים שלך לא נשמרו. אם תעזוב כעת, תאבד את השינויים שלך.',
    close: 'סגור',
    collapse: 'כווץ',
    collections: 'אוספים',
    ...
    creating: 'יוצר',
    creatingNewLabel: 'יוצר {{label}} חדש',
    custom: 'מותאם אישית',
    dark: 'כהה',
    ...
    editing: 'עורך',
    editingLabel_many: 'עורך {{count}} {{label}}',
    editingLabel_one: 'עורך {{label}} אחד',
    editingLabel_other: 'עורך {{count}} {{label}}',
    email: 'דוא"ל',
    ...
    noResults: 'לא נמצאו {{label}}. או שאין {{label}} קיימים עדיין או שאף אחד מהם אינו תואם את המסננים שציינת למעלה.',
    noValue: 'אין ערך',
    none: 'ללא',
    notFound: 'לא נמצא',
    ...
    save: 'שמור',
    saving: 'שומר...',
    searchBy: 'חפש לפי {{label}}',
    selectAll: 'בחר את כל {{count}} {{label}}',
    selectAllRows: 'בחר את כל השורות',
    selectValue: 'בחר ערך',
    selectedCount: '{{count}} {{label}} נבחרו',
    showAllLabel: 'הצג את כל {{label}}',
    sorryNotFound: 'מצטערים - אין תוצאות התואמות לשאלתך.',
    sort: 'מיין',
    sortByLabelDirection: 'מיין לפי {{label}} {{direction}}',
    stayOnThisPage: 'הישאר בדף זה',
    submissionSuccessful: 'הגשה הצליחה.',
    submit: 'שלח',
    success: 'הצלחה',
  ...
  validation: {
    ...
    shorterThanMax: 'ערך זה חייב להיות קצר מאורך המרבי של {{maxLength}} תווים.',
    trueOrFalse: 'שדה זה יכול להיות רק true או false.',
    validUploadID: 'שדה זה אינו מזהה העלאה תקני.',
  },
  version: {
    type: 'סוג',
    aboutToPublishSelection: 'אתה עומד לפרסם את כל {{label}} שנבחרו. האם אתה בטוח?',
    ...
    aboutToRevertToPublished: 'אתה עומד להחזיר את השינויים במסמך הזה למצב הפורסם שלו. האם אתה בטוח?',
    aboutToUnpublish: 'אתה עומד לבטל את הפרסום של מסמך זה. האם אתה בטוח?',
    aboutToUnpublishSelection: 'אתה עומד לבטל את הפרסום של כל {{label}} שנבחרו. האם אתה בטוח?',
    ...
    versionCount_one: 'גרסה נמצאה אחת',
