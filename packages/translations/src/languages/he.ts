...
export const heTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'האימייל אומת בהצלחה. כעת תועבר למסך הכניסה...',
  ...
  branching: {
    andMoreChanges: 'עוד {{count}} שינויים',
    branch: 'ענף',
    branchClosed: 'הענף הזה סגור. הוא נשמר כתיעוד של מה שמוזג.',
    branchDescription: 'תיאור הענף',
    branchedFrom: 'הסתעף מ־',
    branches: 'ענפים',
    branchHistory: 'היסטוריית הענף',
    branchMerging: 'ממזג',
    branchName: 'שם הענף',
    branchSettings: 'הגדרות הענף',
    cancelSchedule: 'בטל מיזוג',
    changedDocuments: 'מסמכים שהשתנו',
    changesTo: 'שינויים ב{{summary}}',
    closeBranchAfterMerge: 'סגור את הענף הזה לאחר המיזוג',
    closeBranchHelpOff: 'הענף נשאר פתוח, כך שתוכל להמשיך לעבוד בו ולמזג אותו שוב מאוחר יותר.',
    closeBranchHelpOn: 'הענף יהיה לקריאה בלבד ולא יהיה אפשר למזג אותו שוב.',
    confirmDiscardAll:
      'כל {{count}} המסמכים שהשתנו בענף הזה יוחזרו למצבם ב-main. לא ניתן לבטל את הפעולה.',
    confirmDiscardSelected: '{{count}} מסמכים שהשתנו יוחזרו למצבם ב-main. לא ניתן לבטל את הפעולה.',
    createAndSwitch: 'צור והחלף',
    createNewBranch: 'צור ענף חדש',
    currentChanges: 'שינויים נוכחיים',
    defaultBranch: 'ברירת מחדל',
    discardAll: 'בטל הכל ({{count}})',
    discardChanges: 'בטל שינויים',
    discardedCount: '{{count}} שינויים בוטלו.',
    discarding: 'מבטל…',
    discardSelected: 'בטל את הנבחרים ({{count}})',
    historyPageOf: 'עמוד {{page}} מתוך {{total}}',
    manage: 'ניהול',
    manageBranches: 'ניהול ענפים…',
    merge: 'מיזוג',
    mergeAllChanges: 'כל השינויים בענף הזה יוחלו.',
    mergeAllCount: 'כל {{count}} המסמכים שהשתנו בענף הזה יוחלו.',
    mergeBranchInto: 'מיזוג {{branch}} אל {{target}}',
    mergeChanges: 'מיזוג שינויים',
    mergeComplete: 'המיזוג הושלם',
    merged: 'מוזג',
    mergedByCount: '{{count}} מסמכים מאת {{user}}',
    mergedCount: '{{count}} שינויים מוזגו.',
    mergedOfTotal: '{{current}} מתוך {{total}} מוזגו',
    mergedOn: 'מוזג ב-{{date}}',
    mergeHistory: 'היסטוריית מיזוגים',
    mergeInterrupted: 'המיזוג הופסק ודבר לא הוחל. נסה שוב.',
    mergeNow: 'מזג עכשיו',
    mergeOnlySelected: 'בחר אילו שינויים למזג',
    mergeScheduledFor: 'המיזוג תוזמן ל-{{date}}.',
    mergeSelectedOfTotal: '{{selected}} מתוך {{total}} מסמכים שהשתנו יוחלו.',
    mergeStarting: 'מתחיל מיזוג…',
    merging: 'ממזג…',
    mergingProgress: 'ממזג {{current}} מתוך {{total}}',
    noChangesYet: 'אין עדיין שינויים בענף הזה.',
    operation_create: 'נוצר',
    operation_delete: 'נמחק',
    operation_update: 'עודכן',
    reviewingChangedDocuments: 'סקירת מסמכים שהשתנו',
    scheduleAnotherMerge: 'תזמן מיזוג נוסף',
    scheduleCancelled: 'המיזוג המתוזמן בוטל.',
    scheduleCount: '{{count}} מתוזמנים',
    scheduledMerges: 'מיזוגים מתוזמנים',
    scheduledToMerge: 'מיזוג מתוזמן',
    scheduledToMergeOn: 'הענף הזה מתוזמן להתמזג ב-{{date}}.',
    scheduleHasNothingLeft: 'לא נשאר מה להחיל — השינויים האלה בוטלו או שכבר מוזגו.',
    scheduleMerge: 'תזמן מיזוג',
    scheduleMergeHelp: 'המיזוג יתבצע במועד שתבחר, וההרשאות שלך ייבדקו שוב אז.',
    scheduleWillApplyAll: 'יחיל את כל מה שממתין ({{count}})',
    scheduleWillApplySelected: 'יחיל {{count}} שינויים נבחרים',
    scheduling: 'מתזמן…',
    searchBranches: 'חיפוש ענפים',
    selectBranch: 'בחר ענף',
    untouchedDocumentsNote:
      'מסמכים שלא שיניתם בענף זה מציגים את התוכן הנוכחי של main, ולא תמונת מצב מהרגע שבו נוצר הענף.',
  },
  commandPalette: {
    actions: 'פעולות',
    createNew: 'צור חדש',
  ...
  error: {
    ...
    fileFetchFailed: 'נכשל באחזור הקובץ.',
    ...
    noFileFoundInClipboard: 'לא נמצא קובץ בלוח הגזירים.',
    ...
    unableToReadClipboard: 'לא ניתן לקרוא מהלוח.',
    ...
    urlNotAllowed: 'ה-URL שסופק אינו מורשה.',
