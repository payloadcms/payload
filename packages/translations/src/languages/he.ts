...
export const heTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'פעולה זו תנעל אותך ממערך זה.',
    attachmentContentInvalid: 'תוכן הקובץ המצורף חייב להיות מחרוזת או buffer',
    attachmentMissingContentAndPath: 'בקובץ המצורף חסרים גם תוכן וגם נתיב',
    attachmentMissingFilename: 'בקובץ המצורף חסר שם קובץ',
    authenticationRequiredForExport: 'אימות משתמש נדרש לצורך יצירת יצואים.',
    autosaving: 'אירעה בעיה בזמן שמירה אוטומטית של מסמך זה.',
    busboyMultipartError: 'שגיאת Busboy בפענוח בקשת multipart',
    collectionSlugRequired: 'slug של האוסף נדרש',
    contentTypeExpectedJSON: 'Content-Type צפוי להיות application/json',
    ...
    eitherCollectionOrGlobalRequired: 'יש להעביר אוסף או globalSlug.',
    emailOrPasswordIncorrect: 'כתובת הדוא"ל או הסיסמה שסופקו אינם נכונים.',
    expectedResponseFromUploadHandler: 'צפויה תגובה מהטיפול בהעלאה.',
    failedToFetchFromURL: 'נכשל באחזור הקובץ מה-URL שסופק.',
    failedToResetLayout: 'נכשל באיפוס הפריסה.',
    failedToSaveLayout: 'נכשל בשמירת הפריסה.',
    fieldMustBeSpecified: 'יש לציין שדה',
    fieldsNotInitialized: 'השדות לא אותחלו.',
    filenameRequired: 'שם קובץ נדרש.',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'לא ניתן להוסיף שדות חיבור למערכים, בלוקים או גלובלים.',
    ...
    missingIDOfVersionToRestore: 'חסר מזהה הגרסה לשחזור.',
    missingRequiredData: 'חסרים נתונים חובה.',
    noConnectionToDatabase: 'beginTransaction נקרא כאשר אין חיבור למאגר הנתונים',
    noFileDataForImport: 'לא סופקו נתוני קובץ לייבוא',
    noFilesUploaded: 'לא הועלו קבצים.',
    noMatchedField: 'לא נמצא שדה מתאים עבור "{{label}}"',
    noPayloadProvided: 'לא סופק payload',
    ...
    noUser: 'אין משתמש',
    orderableJoinsMustTargetSingleCollection: 'חיבורים הניתנים למיון חייבים להתמקד לאוסף אחד',
    pastingFromURLNotEnabled: 'הדבקה מ-URL אינה מופעלת עבור אוסף זה.',
    previewing: 'אירעה בעיה בתצוגה מקדימה של מסמך זה.',
    problemUploadingFile: 'אירעה בעיה בזמן העלאת הקובץ.',
    redirectTargetNotAllowed: 'יעד ההפנייה אינו מותר',
    relationshipFieldNotFound: 'שדה הקשר לא נמצא',
    relationshipNotFound: 'הקשר לא נמצא',
    requestDataRequired: 'נדרשים נתוני בקשה',
    requestNotEligibleForFileUpload: 'הבקשה אינה מתאימה להעלאת קובץ',
    requestURLMissing: 'חסר URL הבקשה',
    ...
    tooManyRedirects: 'יותר מדי הפניות',
    ...
    unexpectedArrayCollectionSlug: 'slug אוסף לא צפוי במערך',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers חסר עבור {{collection}}',
    uploadthingUnknownError: 'שגיאה בהעלאת קובץ עם uploadthing: שגיאה לא ידועה',
    urlNotAllowed: 'URL שסופק איננו מותר.',
    ...
    userRequiredForImport: 'נדרש משתמש לפעולות ייבוא',
    validURLRequired: 'נדרש מחרוזת URL תקינה.',
    valueMustBeUnique: 'הערך חייב להיות ייחודי',
    vercelBlobUploadError: 'שגיאה במסלול העלאה של storage-vercel-blob client',
