...
export const csTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Kopírování',
    copyWarning:
      'Chystáte se kopírovat data z {{from}} do {{to}}. Toto přepíše jakákoli existující data {{to}} a přesměruje vás na pokračování v úpravách tohoto národního prostředí. Jste si jistý, že chcete pokračovat?',
    create: 'Vytvořit',
    created: 'Vytvořeno',
