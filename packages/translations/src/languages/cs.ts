...
export const csTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'E-mail byl úspěšně ověřen. Přesměrovávám vás na přihlášení...',
  ...
  branching: {
    andMoreChanges: 'a další {{count}} změny',
    branch: 'Větev',
    branchClosed: 'Tato větev je uzavřená. Zůstává zachována jako záznam o tom, co sloučila.',
    branchDescription: 'Popis větve',
    branchedFrom: 'Odvětveno z',
    branches: 'Větve',
    branchHistory: 'Historie větve',
    branchMerging: 'Slučuje se',
    branchName: 'Název větve',
    branchSettings: 'Nastavení větve',
    cancelSchedule: 'Zrušit sloučení',
    changedDocuments: 'Změněné dokumenty',
    changesTo: 'Změny v {{summary}}',
    closeBranchAfterMerge: 'Po sloučení tuto větev uzavřít',
    closeBranchHelpOff:
      'Větev zůstane otevřená, takže na ní můžete dál pracovat a později ji sloučit znovu.',
    closeBranchHelpOn: 'Větev bude jen ke čtení a už ji nebude možné sloučit.',
    confirmDiscardAll:
      'Všech {{count}} změněných dokumentů v této větvi se vrátí do stavu na main. Tuto akci nelze vzít zpět.',
    confirmDiscardSelected:
      '{{count}} změněných dokumentů se vrátí do stavu na main. Tuto akci nelze vzít zpět.',
    createAndSwitch: 'Vytvořit a přepnout',
    createNewBranch: 'Vytvořit novou větev',
    currentChanges: 'Aktuální změny',
    defaultBranch: 'výchozí',
    discardAll: 'Zahodit vše ({{count}})',
    discardChanges: 'Zahodit změny',
    discardedCount: 'Zahozeno {{count}} změn.',
    discarding: 'Zahazuje se…',
    discardSelected: 'Zahodit vybrané ({{count}})',
    historyPageOf: 'Stránka {{page}} z {{total}}',
    manage: 'Spravovat',
    manageBranches: 'Správa větví…',
    merge: 'Sloučit',
    mergeAllChanges: 'Použijí se všechny změny v této větvi.',
    mergeAllCount: 'Použije se všech {{count}} změněných dokumentů v této větvi.',
    mergeBranchInto: 'Sloučit {{branch}} do {{target}}',
    mergeChanges: 'Sloučit změny',
    mergeComplete: 'Sloučení dokončeno',
    merged: 'Sloučená',
    mergedByCount: '{{count}} dokumentů od {{user}}',
    mergedCount: 'Sloučeno {{count}} změn.',
    mergedOfTotal: 'Sloučeno {{current}} z {{total}}',
    mergedOn: 'Sloučeno {{date}}',
    mergeHistory: 'Historie sloučení',
    mergeInterrupted: 'Sloučení bylo přerušeno a nic se nepoužilo. Zkuste to znovu.',
    mergeNow: 'Sloučit nyní',
    mergeOnlySelected: 'Vyberte, které změny sloučit',
    mergeScheduledFor: 'Sloučení naplánováno na {{date}}.',
    mergeSelectedOfTotal: 'Použije se {{selected}} z {{total}} změněných dokumentů.',
    mergeStarting: 'Sloučení se spouští…',
    merging: 'Slučuje se…',
    mergingProgress: 'Slučuje se {{current}} z {{total}}',
    noChangesYet: 'V této větvi zatím nejsou žádné změny.',
    operation_create: 'Vytvořeno',
    operation_delete: 'Smazáno',
    operation_update: 'Aktualizováno',
    reviewingChangedDocuments: 'Kontrola změněných dokumentů',
    scheduleAnotherMerge: 'Naplánovat další sloučení',
    scheduleCancelled: 'Naplánované sloučení zrušeno.',
    scheduleCount: '{{count}} naplánováno',
    scheduledMerges: 'Naplánovaná sloučení',
    scheduledToMerge: 'Sloučení naplánováno',
    scheduledToMergeOn: 'Tato větev má být sloučena {{date}}.',
    scheduleHasNothingLeft:
      'Nezbývá nic k použití — tyto změny byly zahozeny nebo už jsou sloučené.',
    scheduleMerge: 'Naplánovat sloučení',
    scheduleMergeHelp:
      'Sloučení proběhne ve zvolený čas a vaše oprávnění se tehdy zkontrolují znovu.',
    scheduleWillApplyAll: 'Použije vše čekající ({{count}})',
    scheduleWillApplySelected: 'Použije {{count}} vybraných změn',
    scheduling: 'Plánuje se…',
    searchBranches: 'Hledat větve',
    selectBranch: 'Vybrat větev',
    untouchedDocumentsNote:
      'Dokumenty, které jste na této větvi nezměnili, zobrazují aktuální obsah větve main, nikoliv snímek z doby, kdy byla větev vytvořena.',
  },
  commandPalette: {
    actions: 'Akce',
    ...
    hintActions: 'Akce',
    hintClose: 'Zavřít',
    hintCreate: 'Vytvořit nový',
    hintNavigate: 'Navigovat',
    hintSelect: 'Otevřít',
    noResults: 'Nebyly nalezeny žádné výsledky',
    pinToFavorites: 'Připnout k oblíbeným',
    placeholder: 'Zadejte příkaz nebo vyhledávání…',
    recentlyVisited: 'Naposledy navštíveno',
  ...
  error: {
    ...
    fileFetchFailed: 'Soubor se nepodařilo načíst.',
    ...
    noFileFoundInClipboard: 'Žádný soubor nebyl nalezen ve schránce.',
    ...
    unableToReadClipboard: 'Nelze číst ze schránky.',
    ...
    urlNotAllowed: 'Poskytnutá adresa URL není povolena.',
  ...
  general: {
    ...
    delete: 'Odstranit',
    deleted: 'Smazáno',
    deletedAgo: 'Smazáno před {{distance}}',
