...
export const csTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'Nebylo možné načíst nahraný soubor pro detekci typu.',
    couldNotReadFileForValidation: 'Nepodařilo se načíst nahraný soubor pro ověření.',
    crop: 'Ořez',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'Typ souboru {{mimeType}} (podle přípony {{extension}}) není povolen.',
    ...
    invalidOrCorruptedPDF: 'Neplatný nebo poškozený PDF soubor.',
    ...
    restrictedFileType:
      "Typ souboru '{{mimeType}}' není povolen pro {{fileName}}: detekován omezený typ souboru — nastavte 'allowRestrictedFileTypes' na hodnotu true, chcete-li tuto kontrolu pro tuto Collection přeskočit.",
    ...
    svgHarmfulContent: 'Soubor SVG obsahuje potenciálně nebezpečný obsah.',
    width: 'Šířka',
  },
  validation: {
