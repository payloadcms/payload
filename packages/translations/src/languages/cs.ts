...
export const csTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Dokumenty',
    draftsHint: 'Zde se zobrazí vaše nedávné koncepty',
    dropFiles: 'Pusťte soubory pro nahrání',
    editDashboard: 'Upravit řídicí panel',
    editingDashboard: 'Úprava řídícího panelu',
    gridView: 'Mřížka',
    listView: 'Seznam',
    loadError: 'Některé dokumenty se nepodařilo načíst. Obnovte stránku a zkuste to znovu.',
    noDrafts: 'Žádné nedávné koncepty',
    noItems:
      'Na vaší nástěnce nejsou žádné widgety. Můžete je přidat z menu „Nástěnka“, které se nachází v horní liště.',
    noPinned: 'Žádné připnuté dokumenty',
    noRecents: 'Žádné nedávno zobrazené dokumenty',
    pinDocument: 'Připnout {{title}}',
    pinned: 'Připnuté',
    pinnedHint: 'Zde se zobrazí připnuté dokumenty',
    recentDrafts: 'Nedávné koncepty',
    recentlyViewed: 'Nedávno zobrazené',
    recentsHint: 'Zde se zobrazí prohlížené dokumenty',
    resetLayout: 'Obnovit rozložení',
    saveError: 'Nastavení přehledu se nepodařilo uložit. Zkuste to znovu.',
    searchWidgets: 'Hledat widgety...',
    unpinDocument: 'Odepnout {{title}}',
    updatedBy: 'Aktualizoval',
    uploadDropzone: 'Oblast nahrávání',
    uploadFiles: 'Nahrát soubory',
    uploadHint: 'Přetáhněte soubory z počítače nebo klikněte na tlačítko níže',
    viewMode: 'Zobrazení dokumentů',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Zarovnat záhlaví a ovládací prvky',
    all: 'Všechny',
    ...
    editViewWidth: 'Šířka zobrazení úprav',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Velikosti textu',
    typeSizeSmall: 'Aktuální',
