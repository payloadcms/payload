...
export const csTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Tato akce vás zablokuje z tohoto přednastavení.',
    attachmentContentInvalid: 'Obsah přílohy musí být řetězec nebo buffer',
    attachmentMissingContentAndPath: 'Příloze chybí obsah i cesta',
    attachmentMissingFilename: 'Příloze chybí název souboru',
    authenticationRequiredForExport: 'K vytvoření exportů je vyžadováno ověření uživatele.',
    autosaving: 'Při automatickém ukládání tohoto dokumentu došlo k chybě.',
    busboyMultipartError: 'Chyba zpracování Busboy multipart požadavku',
    collectionSlugRequired: 'Je vyžadován slug kolekce',
    contentTypeExpectedJSON: 'Content-Type se očekává být application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Musí být předán buď collection nebo globalSlug.',
    emailOrPasswordIncorrect: 'Zadaný email nebo heslo není správné.',
    expectedResponseFromUploadHandler: 'Očekávaná odpověď od správce nahrávání.',
    failedToFetchFromURL: 'Nepodařilo se načíst soubor z poskytnuté URL.',
    failedToResetLayout: 'Nepodařilo se obnovit rozložení.',
    failedToSaveLayout: 'Nepodařilo se uložit rozložení.',
    fieldMustBeSpecified: 'pole musí být specifikováno',
    fieldsNotInitialized: 'Pole nejsou inicializována.',
    filenameRequired: 'Název souboru je vyžadován.',
    ...
    invalidFileURL: 'Neplatná URL souboru',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Join pole nejsou povolena v polích, blocích nebo globálech.',
    ...
    missingIDOfVersionToRestore: 'Chybí ID verze k obnovení.',
    missingRequiredData: 'Chybějící povinná data.',
    noConnectionToDatabase: 'beginTransaction bylo voláno bez připojení k databázi',
    noFileDataForImport: 'Pro import nebyla poskytnuta žádná data souboru',
    noFilesUploaded: 'Nebyly nahrány žádné soubory.',
    noMatchedField: 'Pro "{{label}}" nebylo nalezeno žádné odpovídající pole',
    noPayloadProvided: 'Nebyl poskytnut Payload',
    ...
    orderableJoinsMustTargetSingleCollection: 'Řaditelné joiny musí cílit na jednu kolekci',
    pastingFromURLNotEnabled: 'Vkládání z URL není pro tuto kolekci povoleno.',
    previewing: 'Při náhledu tohoto dokumentu došlo k chybě.',
    problemUploadingFile: 'Při nahrávání souboru došlo k chybě.',
    redirectTargetNotAllowed: 'Cíl přesměrování není povolen.',
    relationshipFieldNotFound: 'Pole vztahu nebylo nalezeno',
    relationshipNotFound: 'Vztah nebyl nalezen',
    requestDataRequired: 'Data požadavku jsou vyžadována.',
    requestNotEligibleForFileUpload: 'Požadavek není způsobilý pro nahrání souboru',
    requestURLMissing: 'URL požadavku chybí.',
    restoringTitle:
    ...
    tooManyRedirects: 'Příliš mnoho přesměrování.',
    ...
    unexpectedArrayCollectionSlug: 'Neočekávaný slug pole kolekce',
    ...
    uploadConfigHandlersMissing: 'Správci konfigurace nahrávání chybí',
    uploadthingUnknownError: 'Uploadthing neznámá chyba',
    urlNotAllowed: 'URL není povolena',
    ...
    userRequiredForImport: 'Uživatel je vyžadován pro import',
    validURLRequired: 'Vyžaduje se platná URL',
    valueMustBeUnique: 'Hodnota musí být jedinečná',
    vercelBlobUploadError: 'Chyba nahrávání Vercel Blob',
