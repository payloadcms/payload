...
export const plTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Ta akcja spowoduje, że stracisz dostęp do tego ustawienia wstępnego.',
    attachmentContentInvalid: 'Treść załącznika musi być ciągiem znaków lub buforem',
    attachmentMissingContentAndPath: 'Załącznik nie ma ani treści, ani ścieżki',
    attachmentMissingFilename: 'Załącznik nie ma nazwy pliku',
    authenticationRequiredForExport:
      'Do tworzenia eksportów wymagane jest uwierzytelnienie użytkownika.',
    autosaving: 'Wystąpił problem podczas automatycznego zapisywania tego dokumentu.',
    busboyMultipartError: 'Błąd Busboy podczas parsowania żądania multipart',
    collectionSlugRequired: 'Wymagany jest slug kolekcji',
    contentTypeExpectedJSON: 'Oczekiwany Content-Type to application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Musi zostać przekazana kolekcja lub globalSlug.',
    emailOrPasswordIncorrect: 'Podany adres e-mail lub hasło jest nieprawidłowe.',
    expectedResponseFromUploadHandler: 'Oczekiwana odpowiedź od obsługi przesyłania.',
    failedToFetchFromURL: 'Nie udało się pobrać pliku z podanego adresu URL.',
    failedToResetLayout: 'Nie udało się zresetować układu.',
    failedToSaveLayout: 'Nie udało się zapisać układu.',
    fieldMustBeSpecified: 'pole musi być określone',
    fieldsNotInitialized: 'Pola nie zostały zainicjalizowane.',
    filenameRequired: 'Wymagana jest nazwa pliku.',
    ...
    invalidFileURL: 'Nieprawidłowy adres URL pliku',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Pola Join nie mogą być dodawane do tablic, bloków lub globów.',
    ...
    missingIDOfVersionToRestore: 'Brak ID wersji do przywrócenia.',
    missingRequiredData: 'Brak wymaganych danych.',
    noConnectionToDatabase: 'beginTransaction wywołany, gdy nie ma połączenia z bazą danych',
    noFileDataForImport: 'Brak danych pliku dla importu',
    noFilesUploaded: 'Nie przesłano żadnych plików.',
    noMatchedField: 'Nie znaleziono pasującego pola dla "{{label}}"',
    noPayloadProvided: 'Nie dostarczono payload',
    ...
    orderableJoinsMustTargetSingleCollection: 'Sortowalny join musi dotyczyć pojedynczej kolekcji',
    pastingFromURLNotEnabled: 'Wklejanie z adresu URL nie jest włączone dla tej kolekcji.',
    ...
    redirectTargetNotAllowed: 'Cel przekierowania nie jest dozwolony.',
    relationshipFieldNotFound: 'Nie znaleziono pola relacji',
    relationshipNotFound: 'Nie znaleziono relacji',
    requestDataRequired: 'Wymagane są dane żądania.',
    requestNotEligibleForFileUpload: 'Żądanie nie kwalifikuje się do przesyłania plików',
    requestURLMissing: 'Brak adresu URL żądania.',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug: 'Nieoczekiwany slug kolekcji tablicowej',
    ...
    uploadConfigHandlersMissing: 'Brak obsługi konfiguracji przesyłania',
    uploadthingUnknownError: 'Nieznany błąd Uploadthing',
    urlNotAllowed: 'Adres URL jest niedozwolony',
    ...
    userRequiredForImport: 'Użytkownik jest wymagany do importu',
    validURLRequired: 'Wymagany jest prawidłowy adres URL',
    valueMustBeUnique: 'Wartość musi być unikalna',
    vercelBlobUploadError: 'Błąd przesyłania Vercel Blob',
