...
export const plTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Dokumenty',
    draftsHint: 'Twoje najnowsze wersje robocze pojawią się tutaj',
    dropFiles: 'Upuść pliki, aby je przesłać',
    editDashboard: 'Edytuj Pulpit',
    editingDashboard: 'Edycja Panelu sterowania',
    gridView: 'Widok siatki',
    listView: 'Widok listy',
    loadError: 'Nie udało się wczytać niektórych dokumentów. Odśwież, aby spróbować ponownie.',
    noDrafts: 'Brak najnowszych wersji roboczych',
    noItems:
      'Na Twoim pulpicie nie ma żadnych widgetów. Możesz je dodać z menu "Pulpit", które znajduje się na górnej belce.',
    noPinned: 'Brak przypiętych dokumentów',
    noRecents: 'Brak ostatnio oglądanych dokumentów',
    pinDocument: 'Przypnij {{title}}',
    pinned: 'Przypięte',
    pinnedHint: 'Przypięte dokumenty pojawią się tutaj',
    recentDrafts: 'Najnowsze wersje robocze',
    recentlyViewed: 'Ostatnio oglądane',
    recentsHint: 'Oglądane dokumenty pojawią się tutaj',
    resetLayout: 'Zresetuj Układ',
    saveError: 'Nie udało się zapisać ustawienia panelu. Spróbuj ponownie.',
    searchWidgets: 'Szukaj widgetów...',
    unpinDocument: 'Odepnij {{title}}',
    updatedBy: 'Zaktualizowane przez',
    uploadDropzone: 'Obszar przesyłania',
    uploadFiles: 'Prześlij pliki',
    uploadHint: 'Przeciągnij pliki z komputera lub kliknij przycisk poniżej',
    viewMode: 'Widok dokumentów',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Wyrównaj nagłówek i elementy sterujące',
    all: 'Wszystko',
    ...
    editViewWidth: 'Szerokość widoku edycji',
    editViewWidthFull: 'Pełna',
    email: 'Email',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Rozmiary tekstu',
    typeSizeSmall: 'Obecny',
