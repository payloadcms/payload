...
export const plTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: 'jeszcze {{count}} zmian',
    branch: 'Gałąź',
    branchClosed: 'Ta gałąź jest zamknięta. Zachowujemy ją jako zapis tego, co scaliła.',
    branchDescription: 'Opis gałęzi',
    branchedFrom: 'Odgałęziono od',
    branches: 'Gałęzie',
    branchHistory: 'Historia gałęzi',
    branchMerging: 'Scalanie',
    branchName: 'Nazwa gałęzi',
    branchSettings: 'Ustawienia gałęzi',
    cancelSchedule: 'Anuluj scalanie',
    changedDocuments: 'Zmienione dokumenty',
    changesTo: 'Zmiany w {{summary}}',
    closeBranchAfterMerge: 'Zamknij tę gałąź po scaleniu',
    closeBranchHelpOff:
      'Gałąź pozostaje otwarta, więc możesz dalej nad nią pracować i scalić ją ponownie później.',
    closeBranchHelpOn: 'Gałąź stanie się tylko do odczytu i nie będzie można jej ponownie scalić.',
    confirmDiscardAll:
      'Wszystkie {{count}} zmienione dokumenty w tej gałęzi wrócą do stanu z main. Tego nie można cofnąć.',
    confirmDiscardSelected:
      '{{count}} zmienionych dokumentów wróci do stanu z main. Tego nie można cofnąć.',
    createAndSwitch: 'Utwórz i przełącz',
    createNewBranch: 'Utwórz nową gałąź',
    currentChanges: 'Bieżące zmiany',
    defaultBranch: 'domyślna',
    discardAll: 'Odrzuć wszystkie ({{count}})',
    discardChanges: 'Odrzuć zmiany',
    discardedCount: 'Odrzucono {{count}} zmian.',
    discarding: 'Odrzucanie…',
    discardSelected: 'Odrzuć wybrane ({{count}})',
    historyPageOf: 'Strona {{page}} z {{total}}',
    manage: 'Zarządzaj',
    manageBranches: 'Zarządzaj gałęziami…',
    merge: 'Scal',
    mergeAllChanges: 'Wszystkie zmiany w tej gałęzi zostaną zastosowane.',
    mergeAllCount: 'Wszystkie {{count}} zmienione dokumenty w tej gałęzi zostaną zastosowane.',
    mergeBranchInto: 'Scal {{branch}} do {{target}}',
    mergeChanges: 'Scal zmiany',
    mergeComplete: 'Scalanie zakończone',
    merged: 'Scalona',
    mergedByCount: '{{count}} dokumentów, {{user}}',
    mergedCount: 'Scalono {{count}} zmian.',
    mergedOfTotal: 'Scalono {{current}} z {{total}}',
    mergedOn: 'Scalono {{date}}',
    mergeHistory: 'Historia scaleń',
    mergeInterrupted: 'Scalanie zostało przerwane i nic nie zostało zastosowane. Spróbuj ponownie.',
    mergeNow: 'Scal teraz',
    mergeOnlySelected: 'Wybierz, które zmiany scalić',
    mergeScheduledFor: 'Scalanie zaplanowane na {{date}}.',
    mergeSelectedOfTotal: 'Zostanie zastosowanych {{selected}} z {{total}} zmienionych dokumentów.',
    mergeStarting: 'Rozpoczynanie scalania…',
    merging: 'Scalanie…',
    mergingProgress: 'Scalanie {{current}} z {{total}}',
    noChangesYet: 'Brak zmian w tej gałęzi.',
    operation_create: 'Utworzono',
    operation_delete: 'Usunięto',
    operation_update: 'Zaktualizowano',
    reviewingChangedDocuments: 'Przegląd zmienionych dokumentów',
    scheduleAnotherMerge: 'Zaplanuj kolejne scalanie',
    scheduleCancelled: 'Zaplanowane scalanie anulowano.',
    scheduleCount: '{{count}} zaplanowane',
    scheduledMerges: 'Zaplanowane scalania',
    scheduledToMerge: 'Scalanie zaplanowane',
    scheduledToMergeOn: 'Ta gałąź ma zostać scalona {{date}}.',
    scheduleHasNothingLeft: 'Nie ma już nic do zastosowania — te zmiany odrzucono lub już scalono.',
    scheduleMerge: 'Zaplanuj scalanie',
    scheduleMergeHelp:
      'Scalanie wykona się w wybranym czasie, a Twoje uprawnienia zostaną wtedy sprawdzone ponownie.',
    scheduleWillApplyAll: 'Zastosuje wszystko oczekujące ({{count}})',
    scheduleWillApplySelected: 'Zastosuje {{count}} wybranych zmian',
    scheduling: 'Planowanie…',
    searchBranches: 'Szukaj gałęzi',
    selectBranch: 'Wybierz gałąź',
    untouchedDocumentsNote:
      'Dokumenty, których nie zmieniłeś na tej gałęzi, wyświetlają aktualną zawartość głównej gałęzi, a nie migawkę z momentu utworzenia gałęzi.',
  },
  commandPalette: {
    actions: 'Działania',
  ...
  error: {
    ...
    fileFetchFailed: 'Nie udało się pobrać pliku.',
    ...
    noFileFoundInClipboard: 'Nie znaleziono pliku w schowku.',
    ...
    unableToReadClipboard: 'Nie można odczytać z schowka.',
    ...
    urlNotAllowed: 'Podany adres URL nie jest dozwolony.',
  ...
  general: {
    ...
    delete: 'Usuń',
    deleted: 'Usunięte',
    deletedAgo: 'Usunięto {{distance}} temu',
  ...
  upload: {
    ...
    fromURL: 'Prześlij plik z adresu URL',
    height: 'Wysokość',
