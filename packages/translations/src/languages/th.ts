...
export const thTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'การคัดลอก',
    copyWarning:
      'คุณกำลังจะคัดลอกข้อมูลจาก {{from}} ไปยัง {{to}} นี่จะทำการเขียนทับข้อมูล {{to}} ที่มีอยู่แล้วและเปลี่ยนทางคุณไปสู่การแก้ไขภาษานี้ต่อ คุณแน่ใจหรือว่าต้องการดำเนินการต่อ?',
    create: 'สร้าง',
