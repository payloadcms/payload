...
export const thTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'การคัดลอก',
    copyWarning:
      'คุณกำลังจะคัดลอกข้อมูลจาก {{from}} ไปยัง {{to}} การดำเนินการนี้จะทำให้ข้อมูล {{to}} ที่มีอยู่เดิมถูกเขียนทับและนำคุณไปยังการแก้ไขที่คุณต้องการในภาษานั้น คุณแน่ใจว่าต้องการทำต่อไปใช่ไหม?',
    create: 'สร้าง',
