...
export const thTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'ไม่สามารถอ่านไฟล์ที่อัปโหลดเพื่อระบุประเภทได้',
    couldNotReadFileForValidation: 'ไม่สามารถอ่านไฟล์ที่อัปโหลดเพื่อการตรวจสอบได้',
    crop: 'พืชผล',
    ...
    fileTypeNotAllowed: 'ประเภทไฟล์ {{mimeType}} (จากนามสกุลไฟล์ {{extension}}) ไม่ได้รับอนุญาต',
    focalPoint: 'จุดสนใจ',
    focalPointDescription: 'ลากจุดโฟกัสตรงบนภาพตัวอย่างหรือปรับค่าที่อยู่ด้านล่าง',
    height: 'ความสูง',
    invalidMimeType: 'ประเภท MIME ไม่ถูกต้อง: {{mimeType}}.',
    invalidOrCorruptedPDF: 'ไฟล์ PDF ไม่ถูกต้องหรือเสียหาย',
    lessInfo: 'ซ่อนข้อมูล',
    moreInfo: 'แสดงข้อมูล',
    noFile: 'ไม่มีไฟล์',
    pasteURL: 'วาง URL',
    ...
    restrictedFileType:
      "ประเภทไฟล์ '{{mimeType}}' ไม่ได้รับอนุญาตสำหรับ {{fileName}}: ตรวจพบประเภทไฟล์ที่ถูกจำกัด — โปรดตั้งค่า 'allowRestrictedFileTypes' เป็น true เพื่อข้ามการตรวจสอบนี้สำหรับ Collection นี้",
    ...
    svgHarmfulContent: 'ไฟล์ SVG มีเนื้อหาที่อาจเป็นอันตราย',
    width: 'ความกว้าง',
  },
  validation: {
