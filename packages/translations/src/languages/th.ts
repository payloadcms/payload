...
export const thTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'ยืนยันอีเมลสำเร็จแล้ว กำลังเปลี่ยนเส้นทางไปยังหน้าลงชื่อเข้าใช้...',
  ...
  branching: {
    andMoreChanges: 'การเปลี่ยนแปลงอีก {{count}} รายการ',
    branch: 'สาขา',
    branchClosed: 'สาขานี้ถูกปิดแล้ว โดยเก็บไว้เป็นบันทึกของสิ่งที่ผสานไป',
    branchDescription: 'คำอธิบายสาขา',
    branchedFrom: 'แยกสาขาจาก',
    branches: 'สาขา',
    branchHistory: 'ประวัติสาขา',
    branchMerging: 'กำลังผสาน',
    branchName: 'ชื่อสาขา',
    branchSettings: 'ตั้งค่าสาขา',
    cancelSchedule: 'ยกเลิกการผสาน',
    changedDocuments: 'เอกสารที่เปลี่ยนแปลง',
    changesTo: 'การเปลี่ยนแปลงใน {{summary}}',
    closeBranchAfterMerge: 'ปิดสาขานี้หลังผสาน',
    closeBranchHelpOff: 'สาขาจะยังเปิดอยู่ คุณจึงทำงานต่อและผสานอีกครั้งในภายหลังได้',
    closeBranchHelpOn: 'สาขาจะกลายเป็นอ่านได้เท่านั้นและจะผสานอีกไม่ได้',
    confirmDiscardAll:
      'เอกสารที่เปลี่ยนแปลงทั้ง {{count}} รายการในสาขานี้จะถูกย้อนกลับไปเป็นสถานะบน main การกระทำนี้ย้อนกลับไม่ได้',
    confirmDiscardSelected:
      'เอกสารที่เปลี่ยนแปลง {{count}} รายการจะถูกย้อนกลับไปเป็นสถานะบน main การกระทำนี้ย้อนกลับไม่ได้',
    createAndSwitch: 'สร้างและสลับไป',
    createNewBranch: 'สร้างสาขาใหม่',
    currentChanges: 'การเปลี่ยนแปลงปัจจุบัน',
    defaultBranch: 'ค่าเริ่มต้น',
    discardAll: 'ละทิ้งทั้งหมด ({{count}})',
    discardChanges: 'ละทิ้งการเปลี่ยนแปลง',
    discardedCount: 'ละทิ้งการเปลี่ยนแปลง {{count}} รายการแล้ว',
    discarding: 'กำลังละทิ้ง…',
    discardSelected: 'ละทิ้งที่เลือก ({{count}})',
    historyPageOf: 'หน้า {{page}} จาก {{total}}',
    manage: 'จัดการ',
    manageBranches: 'จัดการสาขา…',
    merge: 'ผสาน',
    mergeAllChanges: 'การเปลี่ยนแปลงทั้งหมดในสาขานี้จะถูกนำไปใช้',
    mergeAllCount: 'เอกสารที่เปลี่ยนแปลงทั้ง {{count}} รายการในสาขานี้จะถูกนำไปใช้',
    mergeBranchInto: 'ผสาน {{branch}} เข้ากับ {{target}}',
    mergeChanges: 'ผสานการเปลี่ยนแปลง',
    mergeComplete: 'ผสานเสร็จสิ้น',
    merged: 'ผสานแล้ว',
    mergedByCount: '{{count}} เอกสาร โดย {{user}}',
    mergedCount: 'ผสานการเปลี่ยนแปลง {{count}} รายการแล้ว',
    mergedOfTotal: 'ผสานแล้ว {{current}} จาก {{total}}',
    mergedOn: 'ผสานเมื่อ {{date}}',
    mergeHistory: 'ประวัติการผสาน',
    mergeInterrupted: 'การผสานถูกขัดจังหวะและไม่มีการนำไปใช้ ลองอีกครั้ง',
    mergeNow: 'ผสานทันที',
    mergeOnlySelected: 'เลือกการเปลี่ยนแปลงที่จะผสาน',
    mergeScheduledFor: 'ตั้งเวลาผสานไว้ที่ {{date}}',
    mergeSelectedOfTotal: 'เอกสารที่เปลี่ยนแปลง {{selected}} จาก {{total}} รายการจะถูกนำไปใช้',
    mergeStarting: 'กำลังเริ่มผสาน…',
    merging: 'กำลังผสาน…',
    mergingProgress: 'กำลังผสาน {{current}} จาก {{total}}',
    noChangesYet: 'ยังไม่มีการเปลี่ยนแปลงในสาขานี้',
    operation_create: 'สร้างแล้ว',
    operation_delete: 'ลบแล้ว',
    operation_update: 'อัปเดตแล้ว',
    reviewingChangedDocuments: 'กำลังตรวจสอบเอกสารที่เปลี่ยนแปลง',
    scheduleAnotherMerge: 'ตั้งเวลาผสานอีกครั้ง',
    scheduleCancelled: 'ยกเลิกการผสานตามกำหนดเวลาแล้ว',
    scheduleCount: 'ตั้งเวลาไว้ {{count}} รายการ',
    scheduledMerges: 'การผสานตามกำหนดเวลา',
    scheduledToMerge: 'ตั้งเวลาผสานไว้',
    scheduledToMergeOn: 'สาขานี้ถูกตั้งเวลาให้ผสานในวันที่ {{date}}',
    scheduleHasNothingLeft:
      'ไม่มีอะไรเหลือให้นำไปใช้ — การเปลี่ยนแปลงเหล่านี้ถูกละทิ้งหรือผสานแล้ว',
    scheduleMerge: 'ตั้งเวลาผสาน',
    scheduleMergeHelp: 'การผสานจะทำงานตามเวลาที่คุณเลือก และจะตรวจสอบสิทธิ์ของคุณอีกครั้งในตอนนั้น',
    scheduleWillApplyAll: 'จะนำทุกอย่างที่รออยู่ไปใช้ ({{count}})',
    scheduleWillApplySelected: 'จะนำการเปลี่ยนแปลงที่เลือก {{count}} รายการไปใช้',
    scheduling: 'กำลังตั้งเวลา…',
    searchBranches: 'ค้นหาสาขา',
    selectBranch: 'เลือกสาขา',
    untouchedDocumentsNote:
      'เอกสารที่คุณไม่ได้แก้ไขในสาขานี้จะแสดงเนื้อหาปัจจุบันของ main ไม่ใช่ภาพรวมจากตอนที่สร้างสาขานี้',
  },
  commandPalette: {
  ...
  error: {
    ...
    fileFetchFailed: 'ไม่สามารถดึงไฟล์มาได้',
    ...
    noFileFoundInClipboard: 'ไม่พบไฟล์ในคลิปบอร์ด',
    ...
    unableToReadClipboard: 'ไม่สามารถอ่านข้อมูลจากคลิปบอร์ดได้',
    ...
    urlNotAllowed: 'URL ที่ให้มาไม่ได้รับอนุญาต',
  ...
  general: {
    ...
    delete: 'ลบ',
    deleted: 'ถูกลบ',
    deletedAgo: 'ถูกลบเมื่อ {{distance}} ที่ผ่านมา',
    deletedAt: 'ถูกลบที่',
    ...
    updatedAgo: 'อัปเดตเมื่อ {{distance}} ที่ผ่านมา',
