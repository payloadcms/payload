...
export const thTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'เอกสาร',
    draftsHint: 'ฉบับร่างล่าสุดของคุณจะแสดงที่นี่',
    dropFiles: 'วางไฟล์เพื่ออัปโหลด',
    editDashboard: 'แก้ไขแดชบอร์ด',
    editingDashboard: 'แก้ไขแดชบอร์ด',
    gridView: 'มุมมองตาราง',
    listView: 'มุมมองรายการ',
    loadError: 'ไม่สามารถโหลดเอกสารบางรายการได้ โปรดรีเฟรชเพื่อลองอีกครั้ง',
    noDrafts: 'ไม่มีฉบับร่างล่าสุด',
    noItems: 'ไม่มีวิดเจ็ตในแดชบอร์ดของคุณ คุณสามารถเพิ่มได้จากเมนู "แดชบอร์ด" ที่ตั้งอยู่บนแถบบน',
    noPinned: 'ไม่มีเอกสารที่ปักหมุด',
    noRecents: 'ไม่มีเอกสารที่ดูล่าสุด',
    pinDocument: 'ปักหมุด {{title}}',
    pinned: 'ปักหมุดแล้ว',
    pinnedHint: 'เอกสารที่คุณปักหมุดจะแสดงที่นี่',
    recentDrafts: 'ฉบับร่างล่าสุด',
    recentlyViewed: 'ดูล่าสุด',
    recentsHint: 'เอกสารที่คุณดูจะแสดงที่นี่',
    resetLayout: 'รีเซ็ตเลย์เอาท์',
    saveError: 'ไม่สามารถบันทึกการตั้งค่าแดชบอร์ดได้ โปรดลองอีกครั้ง',
    searchWidgets: 'ค้นหาวิดเจ็ต...',
    unpinDocument: 'เลิกปักหมุด {{title}}',
    updatedBy: 'อัปเดตโดย',
    uploadDropzone: 'พื้นที่อัปโหลด',
    uploadFiles: 'อัปโหลดไฟล์',
    uploadHint: 'ลากและวางไฟล์จากคอมพิวเตอร์ หรือคลิกปุ่มด้านล่าง',
    viewMode: 'มุมมองเอกสาร',
  ...
  general: {
    ...
    alignHeaderAndControls: 'จัดแนวส่วนหัวและส่วนควบคุม',
    all: 'ทั้งหมด',
    ...
    editViewWidth: 'ความกว้างของมุมมองแก้ไข',
    editViewWidthFull: 'เต็มความกว้าง',
    email: 'อีเมล',
    emailAddress: 'อีเมล',
    emptyTrash: 'ลบถังขยะ',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'ขนาดข้อความ',
    typeSizeSmall: 'ปัจจุบัน',
