...
export const thTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'การกระทำนี้จะล็อกคุณออกจากการตั้งค่าล่วงหน้านี้',
    attachmentContentInvalid: 'เนื้อหาไฟล์แนบต้องเป็น string หรือ buffer',
    attachmentMissingContentAndPath: 'ไฟล์แนบขาดทั้งเนื้อหาและเส้นทาง',
    attachmentMissingFilename: 'ไฟล์แนบขาดชื่อไฟล์',
    authenticationRequiredForExport: 'ต้องมีการยืนยันตัวตนผู้ใช้เพื่อสร้างการส่งออก',
    autosaving: 'เกิดปัญหาระหว่างการบันทึกเอกสารอัตโนมัติ',
    busboyMultipartError: 'ข้อผิดพลาด Busboy ในการวิเคราะห์คำขอ multipart',
    collectionSlugRequired: 'คอลเลกชัน slug จำเป็น',
    contentTypeExpectedJSON: 'Content-Type คาดว่าควรเป็น application/json',
    ...
    eitherCollectionOrGlobalRequired: 'ต้องระบุ collection หรือ globalSlug',
    emailOrPasswordIncorrect: 'อีเมลหรือรหัสผ่านไม่ถูกต้อง',
    expectedResponseFromUploadHandler: 'คาดว่าจะมีการตอบกลับจากตัวจัดการอัปโหลด',
    failedToFetchFromURL: 'ไม่สามารถดึงไฟล์จาก URL ที่ระบุ',
    failedToResetLayout: 'ไม่สามารถรีเซ็ตเค้าโครงได้',
    failedToSaveLayout: 'ไม่สามารถบันทึกเค้าโครงได้',
    fieldMustBeSpecified: 'ต้องระบุ field',
    fieldsNotInitialized: 'ช่องยังไม่ได้เริ่มต้น',
    filenameRequired: 'ต้องมีชื่อไฟล์',
    ...
    invalidFileURL: 'URL ไฟล์ไม่ถูกต้อง',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'ไม่สามารถเพิ่มช่อง join ใน array, block หรือ global ได้',
    ...
    missingIDOfVersionToRestore: 'ไม่พบ ID ของเวอร์ชันที่จะคืนค่า',
    missingRequiredData: 'ไม่พบข้อมูลที่จำเป็น',
    noConnectionToDatabase: 'เรียก beginTransaction ขณะที่ไม่มีการเชื่อมต่อกับฐานข้อมูล',
    noFileDataForImport: 'ไม่มีข้อมูลไฟล์สำหรับการนำเข้า',
    noFilesUploaded: 'ไม่มีไฟล์ถูกอัปโหลด',
    noMatchedField: 'ไม่พบช่อง "{{label}}"',
    noPayloadProvided: 'ไม่มีการส่ง payload',
    ...
    orderableJoinsMustTargetSingleCollection:
      'join ที่สามารถจัดเรียงได้ต้องชี้ไปที่ collection เดียว',
    pastingFromURLNotEnabled: 'ไม่ได้เปิดการวางจาก URL สำหรับ collection นี้',
    previewing: 'เกิดปัญหาระหว่างการแสดงตัวอย่างเอกสาร',
    problemUploadingFile: 'เกิดปัญหาระหว่างการอัปโหลดไฟล์',
    redirectTargetNotAllowed: 'ไม่อนุญาตเป้าหมายการเปลี่ยนทาง',
    relationshipFieldNotFound: 'ไม่พบช่องความสัมพันธ์',
    relationshipNotFound: 'ไม่พบความสัมพันธ์',
    requestDataRequired: 'ต้องมีข้อมูลคำขอ',
    requestNotEligibleForFileUpload: 'คำขอไม่มีคุณสมบัติสำหรับการอัปโหลดไฟล์',
    requestURLMissing: 'ขาด URL คำขอ',
    restoringTitle:
    ...
    somethingWentWrong: 'เกิดปัญหาบางอย่าง',
    tokenInvalidOrExpired: 'Token ไม่ถูกต้องหรือหมดอายุ',
    tokenNotProvided: 'ไม่ได้รับโทเค็น',
    tooManyRedirects: 'มีการเปลี่ยนเส้นทางมากเกินไป',
    ...
    unexpectedArrayCollectionSlug: 'ได้รับ array ของ collectionSlug ที่ไม่คาดคิด ต้องระบุ parent',
    ...
    uploadConfigHandlersMissing: 'ไม่มี uploadConfig.handlers สำหรับ {{collection}}',
    uploadthingUnknownError:
      'ข้อผิดพลาดในการอัปโหลดไฟล์ด้วย uploadthing: ข้อผิดพลาดที่ไม่ทราบสาเหตุ',
    urlNotAllowed: 'URL ที่ระบุไม่ได้รับอนุญาต',
    ...
    userRequiredForImport: 'ต้องมีผู้ใช้สำหรับการดำเนินการนำเข้า',
    validURLRequired: 'ต้องมี URL ที่ถูกต้อง',
    valueMustBeUnique: 'ค่าต้องไม่ซ้ำกับเอกสารอื่น',
    vercelBlobUploadError: 'ข้อผิดพลาด route อัปโหลด storage-vercel-blob client',
