...
export const hrTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'E-pošta je uspješno potvrđena. Preusmjeravamo vas na prijavu...',
    ...
    notRedirected: 'Niste preusmjereni? <0>Prijavite se ovdje</0>',
  ...
  branching: {
    andMoreChanges: 'još {{count}} promjena',
    branch: 'Grana',
    branchClosed: 'Ova grana je zatvorena. Zadržana je kao zapis o tome što je spojila.',
    branchDescription: 'Opis grane',
    branchedFrom: 'Odvojeno od',
    branches: 'Grane',
    branchHistory: 'Povijest grane',
    branchMerging: 'Spajanje',
    branchName: 'Naziv grane',
    branchSettings: 'Postavke grane',
    cancelSchedule: 'Otkaži spajanje',
    changedDocuments: 'Promijenjeni dokumenti',
    changesTo: 'Promjene na {{summary}}',
    closeBranchAfterMerge: 'Zatvori ovu granu nakon spajanja',
    closeBranchHelpOff:
      'Grana ostaje otvorena, pa možete nastaviti raditi na njoj i kasnije je ponovno spojiti.',
    closeBranchHelpOn: 'Grana će postati samo za čitanje i više se neće moći spojiti.',
    confirmDiscardAll:
      'Svih {{count}} promijenjenih dokumenata u ovoj grani vratit će se u stanje na main. To se ne može poništiti.',
    confirmDiscardSelected:
      '{{count}} promijenjenih dokumenata vratit će se u stanje na main. To se ne može poništiti.',
    createAndSwitch: 'Kreiraj i prebaci',
    createNewBranch: 'Kreiraj novu granu',
    currentChanges: 'Trenutne promjene',
    defaultBranch: 'zadano',
    discardAll: 'Odbaci sve ({{count}})',
    discardChanges: 'Odbaci promjene',
    discardedCount: 'Odbačeno {{count}} promjena.',
    discarding: 'Odbacivanje…',
    discardSelected: 'Odbaci odabrano ({{count}})',
    historyPageOf: 'Stranica {{page}} od {{total}}',
    manage: 'Upravljaj',
    manageBranches: 'Upravljanje granama…',
    merge: 'Spoji',
    mergeAllChanges: 'Primijenit će se sve promjene u ovoj grani.',
    mergeAllCount: 'Primijenit će se svih {{count}} promijenjenih dokumenata u ovoj grani.',
    mergeBranchInto: 'Spoji {{branch}} u {{target}}',
    mergeChanges: 'Spoji promjene',
    mergeComplete: 'Spajanje završeno',
    merged: 'Spojena',
    mergedByCount: '{{count}} dokumenata – {{user}}',
    mergedCount: 'Spojeno {{count}} promjena.',
    mergedOfTotal: 'Spojeno {{current}} od {{total}}',
    mergedOn: 'Spojeno {{date}}',
    mergeHistory: 'Povijest spajanja',
    mergeInterrupted: 'Spajanje je prekinuto i ništa nije primijenjeno. Pokušajte ponovno.',
    mergeNow: 'Spoji sada',
    mergeOnlySelected: 'Odaberite koje promjene spojiti',
    mergeScheduledFor: 'Spajanje zakazano za {{date}}.',
    mergeSelectedOfTotal: 'Primijenit će se {{selected}} od {{total}} promijenjenih dokumenata.',
    mergeStarting: 'Pokretanje spajanja…',
    merging: 'Spajanje…',
    mergingProgress: 'Spajanje {{current}} od {{total}}',
    noChangesYet: 'Još nema promjena u ovoj grani.',
    operation_create: 'Stvoreno',
    operation_delete: 'Izbrisano',
    operation_update: 'Ažurirano',
    reviewingChangedDocuments: 'Pregled promijenjenih dokumenata',
    scheduleAnotherMerge: 'Zakaži još jedno spajanje',
    scheduleCancelled: 'Zakazano spajanje otkazano.',
    scheduleCount: '{{count}} zakazano',
    scheduledMerges: 'Zakazana spajanja',
    scheduledToMerge: 'Spajanje zakazano',
    scheduledToMergeOn: 'Ova grana zakazana je za spajanje {{date}}.',
    scheduleHasNothingLeft:
      'Nije ostalo ništa za primjenu — te su promjene odbačene ili već spojene.',
    scheduleMerge: 'Zakaži spajanje',
    scheduleMergeHelp:
      'Spajanje se izvodi u odabrano vrijeme, a vaše se dopuštenja tada ponovno provjeravaju.',
    scheduleWillApplyAll: 'Primijenit će sve što je na čekanju ({{count}})',
    scheduleWillApplySelected: 'Primijenit će {{count}} odabranih promjena',
    scheduling: 'Zakazivanje…',
    searchBranches: 'Pretraži grane',
    selectBranch: 'Odaberi granu',
    untouchedDocumentsNote:
      'Dokumenti koje niste mijenjali na ovoj grani prikazuju trenutačni sadržaj glavne grane, a ne snimku iz trenutka kada je grana stvorena.',
  },
  commandPalette: {
    actions: 'Radnje',
  ...
  error: {
    ...
    fileFetchFailed: 'Neuspješno preuzimanje datoteke.',
    ...
    noFileFoundInClipboard: 'Nije pronađena datoteka u međuspremniku.',
    ...
    unableToReadClipboard: 'Nije moguće čitati iz međuspremnika.',
    ...
    urlNotAllowed: 'Navedeni URL nije dopušten.',
  ...
  general: {
    ...
    delete: 'Izbriši',
    deleted: 'Izbrisano',
    deletedAgo: 'Izbrisano prije {{distance}}',
  ...
  upload: {
    ...
    fromURL: 'Prenesite datoteku s URL-a',
    height: 'Visina',
    ...
    replaceFile: 'Zamijenite datoteku',
