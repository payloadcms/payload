...
export const hrTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset:
      'Ova radnja će vas zaključati iz ove unaprijed postavljene konfiguracije.',
    attachmentContentInvalid: 'Sadržaj privitka mora biti tekst ili međuspremnik',
    attachmentMissingContentAndPath: 'Privitak nema ni sadržaj ni putanju',
    attachmentMissingFilename: 'Privitak nema naziv datoteke',
    authenticationRequiredForExport: 'Autentifikacija korisnika je potrebna za stvaranje izvoza.',
    autosaving: 'Nastao je problem pri automatskom spremanju ovog dokumenta.',
    busboyMultipartError: 'Busboy greška pri parsiranju multipart zahtjeva',
    collectionSlugRequired: 'Slug kolekcije je obavezan',
    contentTypeExpectedJSON: 'Content-Type mora biti application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Mora biti proslijeđena kolekcija ili globalSlug.',
    emailOrPasswordIncorrect: 'E-mail adresa ili lozinka netočni.',
    expectedResponseFromUploadHandler: 'Očekivan je odgovor od rukovatelja prijenosom.',
    failedToFetchFromURL: 'Preuzimanje datoteke s navedenog URL-a nije uspjelo.',
    failedToResetLayout: 'Ponovno postavljanje rasporeda nije uspjelo.',
    failedToSaveLayout: 'Spremanje rasporeda nije uspjelo.',
    fieldMustBeSpecified: 'polje mora biti specificirano',
    fieldsNotInitialized: 'Polja nisu inicijalizirana.',
    filenameRequired: 'Naziv datoteke je obavezan.',
    ...
    missingIDOfVersionToRestore: 'Nedostaje ID verzije za vraćanje.',
    missingRequiredData: 'Nedostaju obvezni podaci.',
    noConnectionToDatabase: 'beginTransaction pozvan dok ne postoji veza s bazom podataka',
    noFileDataForImport: 'Nisu dostavljeni podaci datoteke za uvoz',
    noFilesUploaded: 'Nijedna datoteka nije učitana.',
    noMatchedField: 'Nema podudarajućih polja za "{{label}}"',
    noPayloadProvided: 'Payload nije proslijeđen',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Join polja koja se mogu poredati moraju ciljati jednu kolekciju',
    pastingFromURLNotEnabled: 'Lijepljenje s URL-a nije omogućeno za ovu kolekciju.',
    ...
    redirectTargetNotAllowed: 'Cilj preusmjeravanja nije dopušten.',
    relationshipFieldNotFound: 'Polje odnosa nije pronađeno',
    relationshipNotFound: 'Odnos nije pronađen',
    requestDataRequired: 'Podaci zahtjeva su obavezni.',
    requestNotEligibleForFileUpload: 'Zahtjev nije prihvatljiv za prijenos datoteke',
    requestURLMissing: 'URL zahtjeva nedostaje.',
    restoringTitle:
    ...
    tooManyRedirects: 'Previše preusmjeravanja.',
    ...
    unexpectedArrayCollectionSlug:
      'Neočekivani niz collectionSlug-a, roditelj mora biti proslijeđen',
    unknown: 'Došlo je do nepoznate pogreške.',
    unPublishingDocument: 'Došlo je do problema pri poništavanju objave ovog dokumenta.',
    unreachable: 'Nedostižno',
    unspecific: 'Došlo je do pogreške.',
    unverifiedEmail: 'Molimo potvrdite svoju e-mail adresu prije prijave.',
    uploadConfigHandlersMissing: 'uploadConfig.handlers nije prisutan za {{collection}}',
    uploadthingUnknownError: 'Greška pri prijenosu datoteke s uploadthing: Nepoznata greška',
    ...
    userRequiredForImport: 'Korisnik je obavezan za operacije uvoza',
    validURLRequired: 'Neophodan je važeći URL.',
    valueMustBeUnique: 'Vrijednost mora biti jedinstvena.',
    vercelBlobUploadError: 'storage-vercel-blob greška pri ruti prijenosa klijenta',
