...
export const hrTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Dokumenti',
    draftsHint: 'Vaši nedavni nacrti pojavit će se ovdje',
    dropFiles: 'Ispustite datoteke za prijenos',
    ...
    loadError: 'Neke dokumente nije moguće učitati. Osvježite i pokušajte ponovno.',
    noDrafts: 'Nema nedavnih nacrta',
    noItems:
      'Na vašoj nadzornoj ploči nema widgeta. Možete ih dodati iz izbornika "Nadzorna ploča" smještenog na vrhu.',
    noPinned: 'Nema prikvačenih dokumenata',
    noRecents: 'Nema nedavno pregledanih dokumenata',
    pinDocument: 'Prikvači {{title}}',
    pinned: 'Prikvačeni',
    pinnedHint: 'Prikvačeni dokumenti pojavit će se ovdje',
    recentDrafts: 'Nedavni nacrti',
    recentlyViewed: 'Nedavno pregledani',
    recentsHint: 'Pregledani dokumenti pojavit će se ovdje',
    resetLayout: 'Resetiraj raspored',
    saveError: 'Nije moguće spremiti postavku nadzorne ploče. Pokušajte ponovno.',
    searchWidgets: 'Pretraži widgete...',
    unpinDocument: 'Otkvači {{title}}',
    updatedBy: 'Ažurirao',
    uploadDropzone: 'Područje za prijenos',
    uploadFiles: 'Prenesi datoteke',
    uploadHint: 'Povucite datoteke s računala ili kliknite gumb u nastavku',
    viewMode: 'Prikaz dokumenata',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Poravnaj zaglavlje i kontrole',
    all: 'Svi',
    ...
    editViewWidth: 'Širina prikaza uređivanja',
    editViewWidthFull: 'Puna širina',
    email: 'Email',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Veličine teksta',
    typeSizeSmall: 'Trenutno',
