...
export const hrTranslations: DefaultTranslationsObject = {
  ...
  version: {
    ...
    aboutToUnpublishIn:
      'Uskoro ćete povući objavljivanje ovog dokumenta na {{locale}}. Jeste li sigurni?',
    ...
    revertUnsuccessful: 'Vraćanje neuspješno. Nije pronađena prethodno objavljena verzija.',
