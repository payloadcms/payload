...
export const ruTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: 'ещё {{count}} изменений',
    branch: 'Ветка',
    branchClosed: 'Эта ветка закрыта. Она сохраняется как запись о том, что было объединено.',
    branchDescription: 'Описание ветки',
    branchedFrom: 'Ответвлено от',
    branches: 'Ветки',
    branchHistory: 'История ветки',
    branchMerging: 'Объединение',
    branchName: 'Название ветки',
    branchSettings: 'Настройки ветки',
    cancelSchedule: 'Отменить слияние',
    changedDocuments: 'Изменённые документы',
    changesTo: 'Изменения: {{summary}}',
    closeBranchAfterMerge: 'Закрыть эту ветку после объединения',
    closeBranchHelpOff:
      'Ветка останется открытой, поэтому вы сможете продолжить работу и объединить её снова позже.',
    closeBranchHelpOn:
      'Ветка станет доступной только для чтения, и объединить её снова будет нельзя.',
    confirmDiscardAll:
      'Все {{count}} изменённых документов в этой ветке вернутся к состоянию в main. Это действие нельзя отменить.',
    confirmDiscardSelected:
      '{{count}} изменённых документов вернутся к состоянию в main. Это действие нельзя отменить.',
    createAndSwitch: 'Создать и переключиться',
    createNewBranch: 'Создать новую ветку',
    currentChanges: 'Текущие изменения',
    defaultBranch: 'по умолчанию',
    discardAll: 'Отменить все ({{count}})',
    discardChanges: 'Отменить изменения',
    discardedCount: 'Отменено изменений: {{count}}.',
    discarding: 'Отмена…',
    discardSelected: 'Отменить выбранные ({{count}})',
    historyPageOf: 'Страница {{page}} из {{total}}',
    manage: 'Управление',
    manageBranches: 'Управление ветками…',
    merge: 'Объединить',
    mergeAllChanges: 'Будут применены все изменения этой ветки.',
    mergeAllCount: 'Будут применены все {{count}} изменённых документов этой ветки.',
    mergeBranchInto: 'Объединить {{branch}} в {{target}}',
    mergeChanges: 'Объединить изменения',
    mergeComplete: 'Объединение завершено',
    merged: 'Объединена',
    mergedByCount: '{{count}} документов, {{user}}',
    mergedCount: 'Объединено изменений: {{count}}.',
    mergedOfTotal: 'Объединено {{current}} из {{total}}',
    mergedOn: 'Объединено {{date}}',
    mergeHistory: 'История объединений',
    mergeInterrupted: 'Объединение было прервано, и ничего не применено. Попробуйте снова.',
    mergeNow: 'Объединить сейчас',
    mergeOnlySelected: 'Выберите, какие изменения объединить',
    mergeScheduledFor: 'Объединение запланировано на {{date}}.',
    mergeSelectedOfTotal: 'Будет применено {{selected}} из {{total}} изменённых документов.',
    mergeStarting: 'Начало объединения…',
    merging: 'Объединение…',
    mergingProgress: 'Объединение {{current}} из {{total}}',
    noChangesYet: 'В этой ветке пока нет изменений.',
    operation_create: 'Создан',
    operation_delete: 'Удалён',
    operation_update: 'Обновлён',
    reviewingChangedDocuments: 'Просмотр изменённых документов',
    scheduleAnotherMerge: 'Запланировать ещё объединение',
    scheduleCancelled: 'Запланированное объединение отменено.',
    scheduleCount: 'Запланировано: {{count}}',
    scheduledMerges: 'Запланированные объединения',
    scheduledToMerge: 'Объединение запланировано',
    scheduledToMergeOn: 'Эта ветка запланирована к объединению {{date}}.',
    scheduleHasNothingLeft: 'Применять нечего — эти изменения отменены или уже объединены.',
    scheduleMerge: 'Запланировать объединение',
    scheduleMergeHelp:
      'Объединение выполнится в выбранное время, и ваши права будут проверены заново.',
    scheduleWillApplyAll: 'Применит всё ожидающее ({{count}})',
    scheduleWillApplySelected: 'Применит выбранных изменений: {{count}}',
    scheduling: 'Планирование…',
    searchBranches: 'Поиск веток',
    selectBranch: 'Выбрать ветку',
    untouchedDocumentsNote:
      'Документы, которые вы не изменяли в этой ветке, показывают текущее содержимое основной ветки, а не снимок на момент создания этой ветки.',
  },
  commandPalette: {
    actions: 'Действия',
  ...
  error: {
    ...
    fileFetchFailed: 'Не удалось получить файл.',
    ...
    noFileFoundInClipboard: 'Файл не найден в буфере обмена.',
    ...
    unableToReadClipboard: 'Не удалось прочитать данные из буфера обмена.',
    ...
    urlNotAllowed: 'Предоставленный URL не разрешён.',
