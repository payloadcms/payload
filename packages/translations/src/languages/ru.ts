...
export const ruTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Документы',
    draftsHint: 'Ваши недавние черновики появятся здесь',
    dropFiles: 'Перетащите сюда файлы для загрузки',
    editDashboard: 'Редактировать панель управления',
    editingDashboard: 'Панель редактирования',
    gridView: 'Сетка',
    listView: 'Список',
    loadError: 'Не удалось загрузить некоторые документы. Обновите страницу.',
    noDrafts: 'Нет недавних черновиков',
    noItems:
      'На вашей панели нет виджетов. Вы можете добавить их из меню "Панель управления", расположенного в верхней панели.',
    noPinned: 'Нет закреплённых документов',
    noRecents: 'Нет недавно просмотренных документов',
    pinDocument: 'Закрепить {{title}}',
    pinned: 'Закреплённые',
    pinnedHint: 'Закреплённые документы появятся здесь',
    recentDrafts: 'Недавние черновики',
    recentlyViewed: 'Недавно просмотренные',
    recentsHint: 'Просмотренные документы появятся здесь',
    resetLayout: 'Сбросить Макет',
    saveError: 'Не удалось сохранить настройку панели. Повторите попытку.',
    searchWidgets: 'Поиск виджетов...',
    unpinDocument: 'Открепить {{title}}',
    updatedBy: 'Обновил',
    uploadDropzone: 'Область загрузки',
    uploadFiles: 'Загрузить файлы',
    uploadHint: 'Перетащите файлы с компьютера или нажмите кнопку ниже',
    viewMode: 'Вид документов',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Выровнять заголовок и элементы управления',
    all: 'Все',
    ...
    editViewWidth: 'Ширина окна редактирования',
    editViewWidthFull: 'Полная',
    email: 'Email',
    emailAddress: 'Email',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Размеры текста',
    typeSizeSmall: 'Текущий',
