...
export const ruTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    previewing: 'При просмотре этого документа возникла проблема.',
    ...
    valueMustBeUnique: 'Это поле должно быть уникальным',
  ...
  general: {
    ...
    resetPreferencesDescription: 'Это сбросит все ваши настройки до состояния по умолчанию.',
  ...
  upload: {
    ...
    crop: 'Kадрировать',
    cropToolDescription:
      'Перетащите углы кадра, нарисуйте новый кадр или отрегулируйте числа ниже.',
    ...
    focalPoint: 'Фокусная точка',
    focalPointDescription:
      'Перетащите точку фокуса прямо на просмотр или отрегулируйте числа ниже.',
    height: 'Высота',
    lessInfo: 'Меньше информации',
    moreInfo: 'Больше информации',
    noFile: 'Нет файла',
    pasteURL: 'Вставить URL',
    previewSizes: 'Просмотр размеров',
    selectCollectionToBrowse: 'Выберите Коллекцию для просмотра',
    selectFile: 'Выберите файл',
    setCropArea: 'Установите кадр',
    setFocalPoint: 'Установить фокусную точку',
    sizes: 'Размеры',
  ...
  validation: {
    ...
    greaterThanMax: '{{value}} больше максимально допустимого числа {{label}} {{max}}.',
    invalidInput: 'Это поле заполнено неправильно.',
    ...
    lessThanMin: '{{value}} меньше минимально допустимого числа {{label}} {{min}}.',
    limitReached: 'Достигнут лимит, можно добавить только {{max}} элементов.',
    longerThanMin: 'Это поле требует как минимум {{minLength}} символов.',
    ...
    shorterThanMax: 'Текст должен быть короче максимальной длины символов: {{maxLength}}.',
