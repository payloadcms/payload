...
export const ruTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    noResultsFound:
      'Уважайте значение оригинального текста в контексте Payload. Вот список общих терминов Payload, которые имеют очень конкретные значения:\n    - Коллекция: Коллекция - это группа документов, которые имеют общую структуру и цель. Коллекции используются для организации и управления контентом в Payload.\n    - Поле: Поле - это конкретный элемент данных в документе коллекции. Поля определяют структуру и тип',
    notFound: 'Не найдено',
