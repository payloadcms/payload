...
export const ruTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    crop: 'Обрезать',
    cropToolDescription:
      'Перетащите углы выбранной области, нарисуйте новую область или отрегулируйте числа ниже.',
    ...
    focalPointDescription:
      'Перетащите фокусное расстояние прямо на предварительный просмотр или отрегулируйте числа ниже.',
    height: 'Высота',
