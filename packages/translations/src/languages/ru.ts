...
export const ruTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'Не удалось прочитать загруженный файл для определения типа.',
    couldNotReadFileForValidation: 'Не удалось прочитать загруженный файл для проверки.',
    crop: 'Обрезать',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'Тип файла {{mimeType}} (с расширением {{extension}}) не разрешён.',
    ...
    height: 'Высота',
    invalidMimeType: 'Недопустимый MIME-тип: {{mimeType}}.',
    invalidOrCorruptedPDF: 'Недействительный или повреждённый файл PDF.',
    ...
    restrictedFileType:
      'Тип файла «{{mimeType}}» не разрешён для {{fileName}}: обнаружен ограниченный тип файла — установите «allowRestrictedFileTypes» в значение true, чтобы пропустить эту проверку для данной Collection.',
    ...
    svgHarmfulContent: 'Файл SVG содержит потенциально вредоносный контент.',
    width: 'Ширина',
  },
  validation: {
