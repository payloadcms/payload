...
export const ruTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Копирование',
    copyWarning:
      'Вы собираетесь скопировать данные из {{from}} в {{to}}. Это перезапишет все существующие данные {{to}} и перенаправит вас на продолжение редактирования этой локали. Вы уверены, что хотите продолжить?',
    create: 'Создать',
    created: 'Создано',
