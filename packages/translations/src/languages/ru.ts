...
export const ruTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    checkYourEmailForPasswordReset:
      'Если этот адрес электронной почты связан с учетной записью, вы скоро получите инструкции по сбросу пароля. Пожалуйста, проверьте папку «Спам» или «Мусор», если вы не видите электронное письмо в своей входящей почте.',
