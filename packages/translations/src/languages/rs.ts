...
export const rsTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Kopiranje',
    copyWarning:
      'Uskoro ćete kopirati podatke iz {{from}} u {{to}}. Ovo će prepisati sve postojeće {{to}} podatke i preusmeriti vas da nastavite uređivanje ovog lokaliteta. Da li ste sigurni da želite nastaviti?',
    create: 'Креирај',
    created: 'Креирано',
