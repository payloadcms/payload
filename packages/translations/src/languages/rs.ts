...
export const rsTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'Email je uspešno verifikovan. Preusmeravamo vas na prijavu...',
  ...
  branching: {
    andMoreChanges: 'још {{count}} промена',
    branch: 'Гранка',
    branchClosed: 'Ова гранка је затворена. Чува се као запис о томе шта је спојила.',
    branchDescription: 'Опис гранке',
    branchedFrom: 'Одвојено од',
    branches: 'Гранке',
    branchHistory: 'Историја гранке',
    branchMerging: 'Спајање',
    branchName: 'Назив гранке',
    branchSettings: 'Подешавања гранке',
    cancelSchedule: 'Откажи спајање',
    changedDocuments: 'Промењени документи',
    changesTo: 'Промене на {{summary}}',
    closeBranchAfterMerge: 'Затвори ову гранку након спајања',
    closeBranchHelpOff:
      'Гранка остаје отворена, па можете наставити да радите на њој и касније је поново спојити.',
    closeBranchHelpOn: 'Гранка ће постати само за читање и више неће моћи да се споји.',
    confirmDiscardAll:
      'Свих {{count}} промењених докумената у овој гранки вратиће се у стање на main. Ово се не може опозвати.',
    confirmDiscardSelected:
      '{{count}} промењених докумената вратиће се у стање на main. Ово се не може опозвати.',
    createAndSwitch: 'Направи и пређи',
    createNewBranch: 'Направи нову гранку',
    currentChanges: 'Тренутне промене',
    defaultBranch: 'подразумевано',
    discardAll: 'Одбаци све ({{count}})',
    discardChanges: 'Одбаци промене',
    discardedCount: 'Одбачено промена: {{count}}.',
    discarding: 'Одбацивање…',
    discardSelected: 'Одбаци изабрано ({{count}})',
    historyPageOf: 'Страница {{page}} од {{total}}',
    manage: 'Управљај',
    manageBranches: 'Управљање гранкама…',
    merge: 'Споји',
    mergeAllChanges: 'Примениће се све промене у овој гранки.',
    mergeAllCount: 'Примениће се свих {{count}} промењених докумената у овој гранки.',
    mergeBranchInto: 'Споји {{branch}} у {{target}}',
    mergeChanges: 'Споји измене',
    mergeComplete: 'Спајање завршено',
    merged: 'Спојена',
    mergedByCount: '{{count}} докумената – {{user}}',
    mergedCount: 'Спојено промена: {{count}}.',
    mergedOfTotal: 'Спојено {{current}} од {{total}}',
    mergedOn: 'Спојено {{date}}',
    mergeHistory: 'Историја спајања',
    mergeInterrupted: 'Спајање је прекинуто и ништа није примењено. Пробајте поново.',
    mergeNow: 'Споји сада',
    mergeOnlySelected: 'Изаберите које промене да се споје',
    mergeScheduledFor: 'Спајање заказано за {{date}}.',
    mergeSelectedOfTotal: 'Примениће се {{selected}} од {{total}} промењених докумената.',
    mergeStarting: 'Покретање спајања…',
    merging: 'Спајање…',
    mergingProgress: 'Спајање {{current}} од {{total}}',
    noChangesYet: 'Још нема промена у овој гранки.',
    operation_create: 'Креирано',
    operation_delete: 'Обрисано',
    operation_update: 'Ажурирано',
    reviewingChangedDocuments: 'Преглед измењених докумената',
    scheduleAnotherMerge: 'Закажи још једно спајање',
    scheduleCancelled: 'Заказано спајање је отказано.',
    scheduleCount: '{{count}} заказано',
    scheduledMerges: 'Заказана спајања',
    scheduledToMerge: 'Спајање заказано',
    scheduledToMergeOn: 'Ова гранка је заказана за спајање {{date}}.',
    scheduleHasNothingLeft:
      'Није остало ништа за примену — те промене су одбачене или већ спојене.',
    scheduleMerge: 'Закажи спајање',
    scheduleMergeHelp:
      'Спајање се изводи у изабрано време, а ваша дозволе се тада поново проверавају.',
    scheduleWillApplyAll: 'Примениће све што чека ({{count}})',
    scheduleWillApplySelected: 'Примениће {{count}} изабраних промена',
    scheduling: 'Заказивање…',
    searchBranches: 'Претражи гранке',
    selectBranch: 'Изабери гранку',
    untouchedDocumentsNote:
      'Dokumenti koje niste izmenili na ovoj grani prikazuju trenutni sadržaj glavne grane, a ne snimak iz trenutka kada je grana kreirana.',
  },
  commandPalette: {
    actions: 'Akcije',
    ...
    hintNavigate: 'Navigacija',
    hintSelect: 'Otvori',
    noResults: 'Nema pronađenih rezultata',
    pinToFavorites: 'Zakačite za omiljene',
  ...
  error: {
    ...
    fileFetchFailed: 'Nije uspelo preuzimanje datoteke.',
    ...
    noFileFoundInClipboard: 'Nije pronađena nijedna datoteka u međumemoriji.',
    ...
    unableToReadClipboard: 'Nije moguće učitati sa međumemorije.',
    ...
    urlNotAllowed: 'Dati URL nije dozvoljen.',
  ...
  general: {
    ...
    delete: 'Обриши',
    deleted: 'Obrisano',
    deletedAgo: 'Obrisano pre {{distance}}',
  ...
  upload: {
    ...
    fromURL: 'Отпремите датотеку са URL-а',
    height: 'Висина',
