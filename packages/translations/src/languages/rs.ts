...
export const rsTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Ова акција ће вас закључати из овог подешавања.',
    attachmentContentInvalid: 'Садржај прилога мора бити стринг или бафер',
    attachmentMissingContentAndPath: 'Прилогу недостаје и садржај и путања',
    attachmentMissingFilename: 'Прилогу недостаје име датотеке',
    authenticationRequiredForExport: 'Аутентификација корисника је потребна за креирање извоза.',
    autosaving: 'Настао је проблем при аутоматском чувању овог документа.',
    busboyMultipartError: 'Busboy грешка при парсирању multipart захтева',
    collectionSlugRequired: 'Назив колекције је обавезан',
    contentTypeExpectedJSON: 'Content-Type се очекује да буде application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Мора бити прослеђена или колекција или globalSlug.',
    emailOrPasswordIncorrect: 'Емаил или лозинка су неисправни.',
    expectedResponseFromUploadHandler: 'Очекиван одговор од руковаоца отпремањем.',
    failedToFetchFromURL: 'Неуспело преузимање датотеке са наведеног URL-а.',
    failedToResetLayout: 'Неуспело ресетовање распореда.',
    failedToSaveLayout: 'Неуспешно сачуван распоред.',
    fieldMustBeSpecified: 'поље мора бити наведено',
    fieldsNotInitialized: 'Поља нису иницијализована.',
    filenameRequired: 'Име датотеке је обавезно.',
    ...
    invalidFileURL: 'Неважећи URL датотеке',
    invalidJSON: 'Неважећи JSON',
    invalidJSONFormat: 'Неважећи JSON формат',
    invalidRequestArgs: 'Неважећи аргументи прослеђени у захтеву: {{args}}',
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Поља за спајање не могу бити додата у низове, блокове или глобална подешавања.',
    ...
    missingIDOfVersionToRestore: 'Недостаје ИД верзије за враћање.',
    missingRequiredData: 'Недостају обавезни подаци.',
    noConnectionToDatabase: 'beginTransaction позван док нема конекције са базом података',
    noFileDataForImport: 'Нема података датотеке за увоз',
    noFilesUploaded: 'Ниједна датотека није учитана.',
    noMatchedField: 'Нема подударајућих поља за "{{label}}"',
    noPayloadProvided: 'Payload није прослеђен',
    ...
    notSupported: 'Није подржано',
    noUser: 'Нема корисника',
    orderableJoinsMustTargetSingleCollection: 'Сортирајућа спајања морају циљати једну колекцију',
    pastingFromURLNotEnabled: 'Налепљивање са URL-а није омогућено за ову колекцију.',
    previewing: 'Постоји проблем при прегледу овог документа.',
    problemUploadingFile: 'Постоји проблем при учитавању датотеке.',
    redirectTargetNotAllowed: 'Циљ преусмеравања није дозвољен.',
    relationshipFieldNotFound: 'Поље везе није пронађено',
    relationshipNotFound: 'Веза није пронађена',
    requestDataRequired: 'Подаци захтева су обавезни.',
    requestNotEligibleForFileUpload: 'Захтев није квалификован за отпремање датотеке',
    requestURLMissing: 'URL захтева недостаје.',
    restoringTitle:
    ...
    tooManyRedirects: 'Превише преусмеравања.',
    ...
    unexpectedArrayCollectionSlug: 'Неочекиван низ collectionSlug, родитељ мора бити прослеђен',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers није присутан за {{collection}}',
    uploadthingUnknownError: 'Грешка при отпремању датотеке са uploadthing: Непозната грешка',
    urlNotAllowed: 'Наведени URL није дозвољен.',
    ...
    userRequiredForImport: 'Корисник је обавезан за операције увоза',
    validURLRequired: 'Важећи URL стринг је обавезан.',
    valueMustBeUnique: 'Вредност мора бити јединствена.',
    vercelBlobUploadError: 'storage-vercel-blob грешка у клијентској рути за отпремање',
