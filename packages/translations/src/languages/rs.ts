...
export const rsTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Документи',
    draftsHint: 'Ваши недавни нацрти ће се појавити овде',
    dropFiles: 'Отпустите датотеке за отпремање',
    editDashboard: 'Izmeni kontrolnu tablu',
    editingDashboard: 'Uređivanje kontrolne table',
    gridView: 'Мрежни приказ',
    listView: 'Приказ листе',
    loadError: 'Неки документи нису могли бити учитани. Освежите страницу.',
    noDrafts: 'Нема недавних нацрта',
    noItems:
      'Na vašoj kontrolnoj tabli nema vidžeta. Možete ih dodati iz menija "Kontrolna tabla" koji se nalazi na vrhu.',
    noPinned: 'Нема закачених докумената',
    noRecents: 'Нема недавно прегледаних докумената',
    pinDocument: 'Закачи {{title}}',
    pinned: 'Закачени',
    pinnedHint: 'Закачени документи ће се појавити овде',
    recentDrafts: 'Недавни нацрти',
    recentlyViewed: 'Недавно прегледани',
    recentsHint: 'Прегледани документи ће се појавити овде',
    resetLayout: 'Ресетуј распоред',
    saveError: 'Није могуће сачувати подешавање контролне табле. Покушајте поново.',
    searchWidgets: 'Pretraži widgete...',
    unpinDocument: 'Откачи {{title}}',
    updatedBy: 'Ажурирао',
    uploadDropzone: 'Област за отпремање',
    uploadFiles: 'Отпреми датотеке',
    uploadHint: 'Превуците датотеке са рачунара или кликните на дугме испод',
    viewMode: 'Приказ докумената',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Поравнај заглавље и контроле',
    all: 'Svi',
    ...
    editViewWidth: 'Ширина приказа уређивања',
    editViewWidthFull: 'Пуна ширина',
    email: 'Е-пошта',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Величине текста',
    typeSizeSmall: 'Тренутно',
