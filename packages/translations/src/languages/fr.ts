...
export const frTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Documents',
    draftsHint: 'Vos brouillons récents apparaîtront ici',
    ...
    loadError: 'Certains documents n’ont pas pu être chargés. Actualisez pour réessayer.',
    noDrafts: 'Aucun brouillon récent',
    noItems:
    ...
    noPinned: 'Aucun document épinglé',
    noRecents: 'Aucun document consulté récemment',
    pinDocument: 'Épingler {{title}}',
    pinned: 'Épinglés',
    pinnedHint: 'Les documents épinglés apparaîtront ici',
    recentDrafts: 'Brouillons récents',
    recentlyViewed: 'Consultés récemment',
    recentsHint: 'Les documents consultés apparaîtront ici',
    resetLayout: 'Réinitialiser la mise en page',
    saveError: 'Impossible d’enregistrer la préférence du tableau de bord. Réessayez.',
    searchWidgets: 'Rechercher des widgets...',
    unpinDocument: 'Désépingler {{title}}',
    updatedBy: 'Mis à jour par',
    uploadDropzone: 'Zone de téléversement',
    uploadFiles: 'Téléverser des fichiers',
    uploadHint: 'Glissez des fichiers depuis votre ordinateur ou cliquez sur le bouton ci-dessous',
    viewMode: 'Affichage des documents',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Aligner l’en-tête et les commandes',
    all: 'Tout',
    ...
    editViewWidth: 'Largeur de la vue d’édition',
    editViewWidthFull: 'Toute la largeur',
    email: 'E-mail',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Tailles du texte',
    typeSizeSmall: 'Actuel',
