...
export const frTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'E-mail vérifié avec succès. Redirection vers la connexion...',
    ...
    verificationFailedRequestNew:
      'Nous n’avons pas pu vérifier votre compte. Demandez un nouvel e-mail de vérification et réessayez.',
    verified: 'Vérifié',
  ...
  branching: {
    andMoreChanges: '{{count}} modifications de plus',
    branch: 'Branche',
    branchClosed:
      'Cette branche est fermée. Elle est conservée comme trace de ce qu’elle a fusionné.',
    branchDescription: 'Description de la branche',
    branchedFrom: 'Dérivée de',
    branches: 'Branches',
    branchHistory: 'Historique de la branche',
    branchMerging: 'Fusion en cours',
    branchName: 'Nom de la branche',
    branchSettings: 'Paramètres de la branche',
    cancelSchedule: 'Annuler la fusion',
    changedDocuments: 'Documents modifiés',
    changesTo: 'Modifications sur {{summary}}',
    closeBranchAfterMerge: 'Fermer cette branche après la fusion',
    closeBranchHelpOff:
      'La branche reste ouverte : vous pouvez continuer à y travailler et la fusionner à nouveau plus tard.',
    closeBranchHelpOn: 'La branche passera en lecture seule et ne pourra plus être fusionnée.',
    confirmDiscardAll:
      'Les {{count}} documents modifiés de cette branche seront rétablis dans leur état sur main. Cette action est irréversible.',
    confirmDiscardSelected:
      '{{count}} documents modifiés seront rétablis dans leur état sur main. Cette action est irréversible.',
    createAndSwitch: 'Créer et basculer',
    createNewBranch: 'Créer une nouvelle branche',
    currentChanges: 'Modifications en cours',
    defaultBranch: 'par défaut',
    discardAll: 'Tout abandonner ({{count}})',
    discardChanges: 'Abandonner les modifications',
    discardedCount: '{{count}} modifications abandonnées.',
    discarding: 'Abandon en cours…',
    discardSelected: 'Abandonner la sélection ({{count}})',
    historyPageOf: 'Page {{page}} sur {{total}}',
    manage: 'Gérer',
    manageBranches: 'Gérer les branches…',
    merge: 'Fusionner',
    mergeAllChanges: 'Toutes les modifications de cette branche seront appliquées.',
    mergeAllCount: 'Les {{count}} documents modifiés de cette branche seront appliqués.',
    mergeBranchInto: 'Fusionner {{branch}} dans {{target}}',
    mergeChanges: 'Fusionner les modifications',
    mergeComplete: 'Fusion terminée',
    merged: 'Fusionnée',
    mergedByCount: '{{count}} documents par {{user}}',
    mergedCount: '{{count}} modifications fusionnées.',
    mergedOfTotal: '{{current}} sur {{total}} fusionnés',
    mergedOn: 'Fusionné le {{date}}',
    mergeHistory: 'Historique des fusions',
    mergeInterrupted: 'La fusion a été interrompue et rien n’a été appliqué. Réessayez.',
    mergeNow: 'Fusionner maintenant',
    mergeOnlySelected: 'Choisir les modifications à fusionner',
    mergeScheduledFor: 'Fusion planifiée pour le {{date}}.',
    mergeSelectedOfTotal: '{{selected}} des {{total}} documents modifiés seront appliqués.',
    mergeStarting: 'Démarrage de la fusion…',
    merging: 'Fusion en cours…',
    mergingProgress: 'Fusion de {{current}} sur {{total}}',
    noChangesYet: 'Aucune modification sur cette branche pour le moment.',
    operation_create: 'Créé',
    operation_delete: 'Supprimé',
    operation_update: 'Mis à jour',
    reviewingChangedDocuments: 'Révision des documents modifiés',
    scheduleAnotherMerge: 'Planifier une autre fusion',
    scheduleCancelled: 'Fusion planifiée annulée.',
    scheduleCount: '{{count}} planifiées',
    scheduledMerges: 'Fusions planifiées',
    scheduledToMerge: 'Fusion planifiée',
    scheduledToMergeOn: 'Cette branche doit être fusionnée le {{date}}.',
    scheduleHasNothingLeft:
      'Il ne reste rien à appliquer : ces modifications ont été abandonnées ou déjà fusionnées.',
    scheduleMerge: 'Planifier la fusion',
    scheduleMergeHelp:
      'La fusion s’exécute à l’heure choisie, vos permissions étant vérifiées à nouveau à ce moment-là.',
    scheduleWillApplyAll: 'Appliquera tout ce qui est en attente ({{count}})',
    scheduleWillApplySelected: 'Appliquera {{count}} modification(s) sélectionnée(s)',
    scheduling: 'Planification…',
    searchBranches: 'Rechercher des branches',
    selectBranch: 'Sélectionner une branche',
    untouchedDocumentsNote:
      "Les documents que vous n'avez pas modifiés sur cette branche affichent le contenu actuel de main, et non une capture d'écran du moment où la branche a été créée.",
  },
  commandPalette: {
    actions: 'Actions',
  ...
  upload: {
    ...
    fromURL: 'Téléverser un fichier à partir d’une URL',
    height: 'Hauteur',
