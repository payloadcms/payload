...
export const frTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: "Cette action vous empêchera d'accéder à ce préréglage.",
    attachmentContentInvalid: 'Le contenu de la pièce jointe doit être une chaîne ou un tampon',
    attachmentMissingContentAndPath: 'La pièce jointe manque à la fois de contenu et de chemin',
    attachmentMissingFilename: 'Le nom de fichier de la pièce jointe est manquant',
    authenticationRequiredForExport:
      "L'authentification de l'utilisateur est requise pour créer des exports.",
    autosaving: "Un problème est survenu lors de l'enregistrement automatique de ce document.",
    busboyMultipartError: "Erreur Busboy lors de l'analyse de la requête multipart",
    collectionSlugRequired: 'Le slug de collection est requis',
    contentTypeExpectedJSON: 'Content-Type devrait être application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Collection ou globalSlug doivent être fournis.',
    emailOrPasswordIncorrect: "L'adresse e-mail ou le mot de passe fourni est incorrect.",
    expectedResponseFromUploadHandler: 'Réponse attendue du gestionnaire de téléversement.',
    failedToFetchFromURL: "Échec de la récupération du fichier depuis l'URL fournie.",
    ...
    fieldMustBeSpecified: 'Le champ doit être spécifié',
    fieldsNotInitialized: 'Les champs ne sont pas initialisés.',
    filenameRequired: 'Un nom de fichier est requis.',
    ...
    invalidFileURL: 'URL de fichier invalide',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Les champs de jointure ne peuvent pas être ajoutés aux tableaux, blocs ou globaux.',
    loadingDocument:
    ...
    missingIDOfVersionToRestore: 'ID de version à restaurer manquant.',
    missingRequiredData: 'Données requises manquantes.',
    noConnectionToDatabase:
      "beginTransaction appelé alors qu'aucune connexion à la base de données n'existe",
    noFileDataForImport: "Aucune donnée de fichier fournie pour l'importation",
    noFilesUploaded: 'Aucun fichier n’a été téléversé.',
    noMatchedField: 'Aucun champ correspondant n’a été trouvé pour "{{label}}"',
    noPayloadProvided: 'Aucune charge utile fournie',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Les jointures ordonnables doivent cibler une seule collection',
    pastingFromURLNotEnabled: "Le collage depuis une URL n'est pas activé pour cette collection.",
    ...
    redirectTargetNotAllowed: 'Cible de redirection non autorisée.',
    relationshipFieldNotFound: 'Champ de relation non trouvé',
    relationshipNotFound: 'Relation non trouvée',
    requestDataRequired: 'Données de requête requises.',
    requestNotEligibleForFileUpload:
      "La requête n'est pas éligible pour le téléversement de fichier",
    requestURLMissing: 'URL de requête manquante.',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug: 'Tableau inattendu de collectionSlug, parent doit être fourni',
    ...
    uploadConfigHandlersMissing: "uploadConfig.handlers n'est pas présent pour {{collection}}",
    uploadthingUnknownError:
      'Erreur lors du téléversement du fichier avec uploadthing : Erreur inconnue',
    ...
    userRequiredForImport: "L'utilisateur est requis pour les opérations d'importation",
    validURLRequired: 'Une URL valide est requise.',
    valueMustBeUnique: 'La valeur doit être unique',
    vercelBlobUploadError: 'Erreur de route de téléversement client storage-vercel-blob',
