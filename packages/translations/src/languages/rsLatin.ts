...
export const rsLatinTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Ova radnja će vas zaključati iz ovog podešavanja.',
    attachmentContentInvalid: 'Sadržaj priloga mora biti string ili buffer',
    attachmentMissingContentAndPath: 'Prilog nema ni sadržaj ni putanju',
    attachmentMissingFilename: 'Prilog nema ime datoteke',
    authenticationRequiredForExport: 'Autentifikacija korisnika je neophodna za kreiranje izvoza.',
    autosaving: 'Nastao je problem pri automatskom čuvanju ovog dokumenta.',
    busboyMultipartError: 'Busboy greška pri parsiranju multipart zahteva',
    collectionSlugRequired: 'Slug kolekcije je obavezan',
    contentTypeExpectedJSON: 'Content-Type se očekuje da bude application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Mora biti prosleđena ili kolekcija ili globalSlug.',
    emailOrPasswordIncorrect: 'Adresa e-pošte ili lozinka su neispravni.',
    expectedResponseFromUploadHandler: 'Očekivan odgovor od upload handler-a.',
    failedToFetchFromURL: 'Nije uspelo preuzimanje datoteke sa date URL adrese.',
    failedToResetLayout: 'Nije uspelo resetovanje rasporeda.',
    failedToSaveLayout: 'Pogreška pri čuvanju rasporeda.',
    fieldMustBeSpecified: 'polje mora biti navedeno',
    fieldsNotInitialized: 'Polja nisu inicijalizovana.',
    filenameRequired: 'Ime datoteke je obavezno.',
    ...
    invalidFilename: 'Neispravno ime datoteke',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Join polja ne mogu biti dodata u nizove, blokove ili globalne elemente.',
    ...
    noConnectionToDatabase: 'beginTransaction pozvan dok ne postoji veza sa bazom podataka',
    noFileDataForImport: 'Nisu obezbeđeni podaci datoteke za uvoz',
    noFilesUploaded: 'Nijedna datoteka nije učitana.',
    noMatchedField: 'Nema podudarajućih polja za "{{label}}"',
    noPayloadProvided: 'Payload nije obezbeđen',
    ...
    orderableJoinsMustTargetSingleCollection: 'Porediva join polja moraju ciljati jednu kolekciju',
    pastingFromURLNotEnabled: 'Nalepljivanje sa URL adrese nije omogućeno za ovu kolekciju.',
    previewing: 'Postoji problem pri pregledu ovog dokumenta.',
    problemUploadingFile: 'Postoji problem pri učitavanju datoteke.',
    redirectTargetNotAllowed: 'Cilj preusmeravanja nije dozvoljen.',
    relationshipFieldNotFound: 'Polje relacije nije pronađeno',
    relationshipNotFound: 'Relacija nije pronađena',
    requestDataRequired: 'Podaci zahteva su obavezni.',
    requestNotEligibleForFileUpload: 'Zahtev nije podoban za upload datoteke',
    requestURLMissing: 'URL zahteva nedostaje.',
    restoringTitle:
    ...
    tooManyRedirects: 'Previše preusmeravanja.',
    ...
    unexpectedArrayCollectionSlug: 'Neočekivan niz collectionSlug-a, parent mora biti obezbeđen',
    ...
    uploadthingUnknownError: 'Greška pri upload-u datoteke sa uploadthing: Nepoznata greška',
    urlNotAllowed: 'Obezbeđena URL adresa nije dozvoljena.',
    ...
    validURLRequired: 'Validan URL string je obavezan.',
    valueMustBeUnique: 'Vrednost mora biti jedinstvena.',
    vercelBlobUploadError: 'storage-vercel-blob greška klijentske upload rute',
