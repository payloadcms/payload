...
export const rsLatinTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'E-pošta je uspešno verifikovana. Preusmeravamo vas na prijavu...',
  ...
  branching: {
    andMoreChanges: 'još {{count}} promena',
    branch: 'Granka',
    branchClosed: 'Ova granka je zatvorena. Čuva se kao zapis o tome šta je spojila.',
    branchDescription: 'Opis granke',
    branchedFrom: 'Odvojeno od',
    branches: 'Granke',
    branchHistory: 'Istorija granke',
    branchMerging: 'Spajanje',
    branchName: 'Naziv granke',
    branchSettings: 'Podešavanja granke',
    cancelSchedule: 'Otkaži spajanje',
    changedDocuments: 'Promenjeni dokumenti',
    changesTo: 'Promene na {{summary}}',
    closeBranchAfterMerge: 'Zatvori ovu granku nakon spajanja',
    closeBranchHelpOff:
      'Granka ostaje otvorena, pa možete nastaviti da radite na njoj i kasnije je ponovo spojiti.',
    closeBranchHelpOn: 'Granka će postati samo za čitanje i više neće moći da se spoji.',
    confirmDiscardAll:
      'Svih {{count}} promenjenih dokumenata u ovoj granki vratiće se u stanje na main. Ovo se ne može opozvati.',
    confirmDiscardSelected:
      '{{count}} promenjenih dokumenata vratiće se u stanje na main. Ovo se ne može opozvati.',
    createAndSwitch: 'Napravi i pređi',
    createNewBranch: 'Napravi novu granku',
    currentChanges: 'Trenutne promene',
    defaultBranch: 'podrazumevano',
    discardAll: 'Odbaci sve ({{count}})',
    discardChanges: 'Odbaci promene',
    discardedCount: 'Odbačeno promena: {{count}}.',
    discarding: 'Odbacivanje…',
    discardSelected: 'Odbaci izabrano ({{count}})',
    historyPageOf: 'Stranica {{page}} od {{total}}',
    manage: 'Upravljaj',
    manageBranches: 'Upravljanje grankama…',
    merge: 'Spoji',
    mergeAllChanges: 'Primeniće se sve promene u ovoj granki.',
    mergeAllCount: 'Primeniće se svih {{count}} promenjenih dokumenata u ovoj granki.',
    mergeBranchInto: 'Spoji {{branch}} u {{target}}',
    mergeChanges: 'Spoji izmene',
    mergeComplete: 'Spajanje završeno',
    merged: 'Spojena',
    mergedByCount: '{{count}} dokumenata – {{user}}',
    mergedCount: 'Spojeno promena: {{count}}.',
    mergedOfTotal: 'Spojeno {{current}} od {{total}}',
    mergedOn: 'Spojeno {{date}}',
    mergeHistory: 'Istorija spajanja',
    mergeInterrupted: 'Spajanje je prekinuto i ništa nije primenjeno. Probajte ponovo.',
    mergeNow: 'Spoji sada',
    mergeOnlySelected: 'Izaberite koje promene da se spoje',
    mergeScheduledFor: 'Spajanje zakazano za {{date}}.',
    mergeSelectedOfTotal: 'Primeniće se {{selected}} od {{total}} promenjenih dokumenata.',
    mergeStarting: 'Pokretanje spajanja…',
    merging: 'Spajanje…',
    mergingProgress: 'Spajanje {{current}} od {{total}}',
    noChangesYet: 'Još nema promena u ovoj granki.',
    operation_create: 'Kreirano',
    operation_delete: 'Obrisano',
    operation_update: 'Ažurirano',
    reviewingChangedDocuments: 'Pregled izmenjenih dokumenata',
    scheduleAnotherMerge: 'Zakaži još jedno spajanje',
    scheduleCancelled: 'Zakazano spajanje je otkazano.',
    scheduleCount: '{{count}} zakazano',
    scheduledMerges: 'Zakazana spajanja',
    scheduledToMerge: 'Spajanje zakazano',
    scheduledToMergeOn: 'Ova granka je zakazana za spajanje {{date}}.',
    scheduleHasNothingLeft:
      'Nije ostalo ništa za primenu — te promene su odbačene ili već spojene.',
    scheduleMerge: 'Zakaži spajanje',
    scheduleMergeHelp:
      'Spajanje se izvodi u izabrano vreme, a vaše dozvole se tada ponovo proveravaju.',
    scheduleWillApplyAll: 'Primeniće sve što čeka ({{count}})',
    scheduleWillApplySelected: 'Primeniće {{count}} izabranih promena',
  ...
  error: {
    ...
    fileFetchFailed: 'Nije uspelo preuzimanje fajla.',
    ...
    noFileFoundInClipboard: 'Nijedan fajl nije pronađen u ostavi.',
    ...
    unableToReadClipboard: 'Nije moguće čitati iz ostave.',
    ...
    urlNotAllowed: 'Pruženi URL nije dozvoljen.',
  ...
  upload: {
    ...
    fromURL: 'Otpremite fajl sa URL adrese',
    height: 'Visina',
  ...
  version: {
    ...
    lastSavedAgo: 'Sačuvano pre {{distance}}',
