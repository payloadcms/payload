...
export const rsLatinTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Dokumenti',
    draftsHint: 'Vaši nedavni nacrti će se pojaviti ovde',
    dropFiles: 'Otpustite datoteke za otpremanje',
    editDashboard: 'Izmeni kontrolnu tablu',
    editingDashboard: 'Izmena kontrolne table',
    gridView: 'Mrežni prikaz',
    listView: 'Prikaz liste',
    loadError: 'Neki dokumenti nisu mogli biti učitani. Osvežite stranicu.',
    ...
    noPinned: 'Nema zakačenih dokumenata',
    noRecents: 'Nema nedavno pregledanih dokumenata',
    pinDocument: 'Zakači {{title}}',
    pinned: 'Zakačeni',
    pinnedHint: 'Zakačeni dokumenti će se pojaviti ovde',
    recentDrafts: 'Nedavni nacrti',
    recentlyViewed: 'Nedavno pregledani',
    recentsHint: 'Pregledani dokumenti će se pojaviti ovde',
    resetLayout: 'Resetuj raspored',
    saveError: 'Nije moguće sačuvati podešavanje kontrolne table. Pokušajte ponovo.',
    searchWidgets: 'Pretraži dodatke...',
    unpinDocument: 'Otkači {{title}}',
    updatedBy: 'Ažurirao',
    uploadDropzone: 'Oblast za otpremanje',
    uploadFiles: 'Otpremi datoteke',
    uploadHint: 'Prevucite datoteke sa računara ili kliknite na dugme ispod',
