...
export const nlTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    draftsHint: 'Je recente concepten verschijnen hier',
    dropFiles: 'Zet bestanden neer om te uploaden',
    editDashboard: 'Dashboard bewerken',
    editingDashboard: 'Dashboard bewerken',
    gridView: 'Rasterweergave',
    listView: 'Lijstweergave',
    loadError: 'Sommige documenten konden niet worden geladen. Vernieuw om opnieuw te proberen.',
    noDrafts: 'Geen recente concepten',
    noItems:
      'Er zijn geen widgets op uw dashboard. U kunt ze toevoegen vanuit het menu "Dashboard" dat zich in de bovenste balk bevindt.',
    noPinned: 'Geen vastgezette documenten',
    noRecents: 'Geen onlangs bekeken documenten',
    pinDocument: '{{title}} vastzetten',
    pinned: 'Vastgezet',
    pinnedHint: 'Vastgezette documenten verschijnen hier',
    recentDrafts: 'Recente concepten',
    recentlyViewed: 'Onlangs bekeken',
    recentsHint: 'Bekeken documenten verschijnen hier',
    resetLayout: 'Herstel Lay-out',
    saveError: 'De dashboardvoorkeur kon niet worden opgeslagen. Probeer het opnieuw.',
    searchWidgets: 'Zoek widgets...',
    unpinDocument: '{{title}} losmaken',
    updatedBy: 'Bijgewerkt door',
    uploadDropzone: 'Uploadgebied',
    uploadFiles: 'Bestanden uploaden',
    uploadHint: 'Sleep bestanden vanaf je computer of klik op de knop hieronder',
    viewMode: 'Documentweergave',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Koptekst en bedieningselementen uitlijnen',
    all: 'Alle',
    ...
    editViewWidth: 'Breedte van de bewerkingsweergave',
    editViewWidthFull: 'Volledig',
    email: 'E-mail',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Tekstgroottes',
    typeSizeSmall: 'Huidig',
