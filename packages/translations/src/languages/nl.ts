...
export const nlTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Kopiëren',
    copyWarning:
      'U staat op het punt om gegevens te kopiëren van {{from}} naar {{to}}. Dit zal alle bestaande {{to}} gegevens overschrijven en u doorsturen om de bewerking van deze locatie voort te zetten. Weet u zeker dat u wilt doorgaan?',
    create: 'Aanmaken',
    created: 'Aangemaakt',
