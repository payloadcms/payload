...
export const nlTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Deze actie zal je de toegang tot deze voorinstelling blokkeren.',
    attachmentContentInvalid: 'Bijlage inhoud moet een string of buffer zijn',
    attachmentMissingContentAndPath: 'Bijlage mist zowel inhoud als pad',
    attachmentMissingFilename: 'Bestandsnaam van bijlage ontbreekt',
    authenticationRequiredForExport: 'Gebruikersauthenticatie is vereist om exports te maken.',
    autosaving: 'Er is een probleem opgetreden bij het automatisch bewaren van dit document.',
    busboyMultipartError: 'Busboy-fout bij het verwerken van multipart-verzoek',
    collectionSlugRequired: 'Collectie slug is vereist',
    contentTypeExpectedJSON: 'Content-Type zou application/json moeten zijn',
    ...
    eitherCollectionOrGlobalRequired: 'Collection of globalSlug moet worden opgegeven.',
    emailOrPasswordIncorrect: 'Het opgegeven e-mailadres of wachtwoord is onjuist.',
    expectedResponseFromUploadHandler: 'Reactie verwacht van upload-handler.',
    failedToFetchFromURL: 'Ophalen van bestand van opgegeven URL is mislukt.',
    failedToResetLayout: 'Het opnieuw instellen van de lay-out is mislukt.',
    failedToSaveLayout: 'Opslaan lay-out mislukt.',
    fieldMustBeSpecified: 'Veld moet worden opgegeven',
    fieldsNotInitialized: 'Velden zijn niet geïnitialiseerd.',
    filenameRequired: 'Een bestandsnaam is vereist.',
    ...
    invalidFileURL: 'Ongeldige bestands-URL',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Samenvoegvelden kunnen niet worden toegevoegd aan arrays, blokken of globals.',
    ...
    missingIDOfVersionToRestore: 'ID van te herstellen versie ontbreekt.',
    missingRequiredData: 'Ontbrekende vereiste gegevens.',
    noConnectionToDatabase: 'beginTransaction aangeroepen zonder databaseverbinding',
    noFileDataForImport: 'Geen bestandsgegevens opgegeven voor import',
    noFilesUploaded: 'Er zijn geen bestanden geüpload.',
    noMatchedField: 'Geen overeenkomend veld gevonden voor "{{label}}"',
    noPayloadProvided: 'Geen payload opgegeven',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Sorteerbare samenvoegingen moeten op een enkele collectie gericht zijn',
    pastingFromURLNotEnabled: 'Plakken van URL is niet ingeschakeld voor deze collectie.',
    ...
    redirectTargetNotAllowed: 'Omleidingsdoel niet toegestaan.',
    relationshipFieldNotFound: 'Relatieveld niet gevonden',
    relationshipNotFound: 'Relatie niet gevonden',
    requestDataRequired: 'Verzoekgegevens vereist.',
    requestNotEligibleForFileUpload: 'Verzoek komt niet in aanmerking voor bestandsupload',
    requestURLMissing: 'Verzoek-URL ontbreekt.',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug:
      'Onverwacht array van collectionSlug, parent moet worden opgegeven',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers is niet aanwezig voor {{collection}}',
    uploadthingUnknownError: 'Fout bij uploaden van bestand met uploadthing: Onbekende fout',
    ...
    userRequiredForImport: 'Gebruiker is vereist voor importbewerkingen',
    validURLRequired: 'Een geldige URL is vereist.',
    valueMustBeUnique: 'De waarde moet uniek zijn',
    vercelBlobUploadError: 'Fout in storage-vercel-blob client upload route',
