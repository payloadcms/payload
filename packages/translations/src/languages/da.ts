...
export const daTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Denne handling vil låse dig ude fra denne forudindstilling.',
    attachmentContentInvalid: 'Vedhæftningsindhold skal være en streng eller buffer',
    attachmentMissingContentAndPath: 'Vedhæftning mangler både indhold og sti',
    attachmentMissingFilename: 'Vedhæftning mangler filnavn',
    authenticationRequiredForExport: 'Bruger-godkendelse er påkrævet for at oprette eksporter.',
    autosaving: 'Der opstod et problem under autosaving af dette dokument.',
    busboyMultipartError: 'Busboy multipart-anmodning parsing-fejl',
    collectionSlugRequired: 'Samlings-slug er påkrævet',
    contentTypeExpectedJSON: 'Content-Type forventes at være application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Enten collection eller globalSlug skal sendes.',
    emailOrPasswordIncorrect: 'Email eller adgangskode er forkert.',
    expectedResponseFromUploadHandler: 'Forventet svar fra upload-håndterer.',
    failedToFetchFromURL: 'Kunne ikke hente filen fra den angivne URL.',
    failedToResetLayout: 'Kunne ikke nulstille layout.',
    failedToSaveLayout: 'Kunne ikke gemme layoutet.',
    fieldMustBeSpecified: 'felt skal angives',
    fieldsNotInitialized: 'Felterne er ikke initialiseret.',
    filenameRequired: 'Filnavn er påkrævet.',
    ...
    missingIDOfVersionToRestore: 'ID for version der skal gendannes mangler.',
    missingRequiredData: 'Mangler påkrævet data.',
    noConnectionToDatabase: 'beginTransaction blev kaldt uden databaseforbindelse',
    noFileDataForImport: 'Ingen fildata blev givet til import',
    noFilesUploaded: 'Ingen filer blev uploadet.',
    noMatchedField: 'Ingen matchende felt fundet for "{{label}}"',
    noPayloadProvided: 'Ingen Payload blev givet',
    ...
    notSupported: 'Understøttes ikke',
    noUser: 'Ingen bruger',
    orderableJoinsMustTargetSingleCollection: 'Sorterbare joins skal målrette en enkelt samling',
    pastingFromURLNotEnabled: 'Indsætning fra URL er ikke aktiveret for denne samling.',
    ...
    redirectTargetNotAllowed: 'Omdirigeringsmål er ikke tilladt.',
    relationshipFieldNotFound: 'Relationsfelt blev ikke fundet',
    relationshipNotFound: 'Relation blev ikke fundet',
    requestDataRequired: 'Anmodningsdata er påkrævet.',
    requestNotEligibleForFileUpload: 'Anmodning er ikke kvalificeret til fil-upload',
    requestURLMissing: 'Anmodningens URL mangler.',
    restoringTitle:
    ...
    uploadConfigHandlersMissing: 'Upload-konfigurationshåndterere mangler',
    uploadthingUnknownError: 'Uploadthing ukendt fejl',
    urlNotAllowed: 'URL er ikke tilladt',
    ...
    userRequiredForImport: 'Bruger er påkrævet for import',
    validURLRequired: 'Gyldig URL er påkrævet',
    valueMustBeUnique: 'Værdien skal være unik',
    vercelBlobUploadError: 'Vercel Blob-upload-fejl',
