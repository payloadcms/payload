...
export const daTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    draftsHint: 'Dine seneste kladder vises her',
    dropFiles: 'Slip filer for at uploade',
    editDashboard: 'Rediger Dashboard',
    editingDashboard: 'Redigeringsdashboard',
    gridView: 'Gittervisning',
    listView: 'Listevisning',
    loadError: 'Nogle dokumenter kunne ikke indlæses. Opdater for at prøve igen.',
    noDrafts: 'Ingen seneste kladder',
    noItems:
      'Der er ingen widgets på dit kontrolpanel. Du kan tilføje dem fra "Kontrolpanel" menuen placeret i toppen.',
    noPinned: 'Ingen fastgjorte dokumenter',
    noRecents: 'Ingen senest sete dokumenter',
    pinDocument: 'Fastgør {{title}}',
    pinned: 'Fastgjorte',
    pinnedHint: 'Fastgjorte dokumenter vises her',
    recentDrafts: 'Seneste kladder',
    recentlyViewed: 'Senest sete',
    recentsHint: 'Dokumenter, du ser, vises her',
    resetLayout: 'Nulstil Layout',
    saveError: 'Dashboardindstillingen kunne ikke gemmes. Prøv igen.',
    searchWidgets: 'Søg widgets...',
    unpinDocument: 'Frigør {{title}}',
    updatedBy: 'Opdateret af',
    uploadDropzone: 'Uploadområde',
    uploadFiles: 'Upload filer',
    uploadHint: 'Træk filer fra din computer, eller klik på knappen nedenfor',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Juster sidehoved og kontrolelementer',
    all: 'Alle',
