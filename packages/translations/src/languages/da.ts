...
export const daTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'Kunne ikke læse den uploadede fil til typegenkendelse.',
    couldNotReadFileForValidation: 'Kunne ikke læse den uploadede fil til validering.',
    crop: 'Beskær',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'Filtype {{mimeType}} (fra filtypenavn {{extension}}) er ikke tilladt.',
    ...
    invalidOrCorruptedPDF: 'Ugyldig eller beskadiget PDF-fil.',
    ...
    restrictedFileType:
      "Filtypen '{{mimeType}}' er ikke tilladt for {{fileName}}: begrænset filtype registreret — indstil 'allowRestrictedFileTypes' til sand for at springe denne kontrol over for denne Collection.",
    ...
    svgHarmfulContent: 'SVG-fil indeholder potentielt skadeligt indhold.',
    width: 'Bredde',
  },
  validation: {
