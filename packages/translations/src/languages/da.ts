...
export const daTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'E-mail blev bekræftet succesfuldt. Du omdirigeres til login...',
  ...
  branching: {
    andMoreChanges: '{{count}} ændringer mere',
    branch: 'Gren',
    branchClosed: 'Denne gren er lukket. Den bevares som dokumentation for, hvad den flettede.',
    branchDescription: 'Beskrivelse af gren',
    branchedFrom: 'Forgrenet fra',
    branches: 'Grene',
    branchHistory: 'Grenhistorik',
    branchMerging: 'Fletter',
    branchName: 'Navn på gren',
    branchSettings: 'Gren-indstillinger',
    cancelSchedule: 'Annuller fletning',
    changedDocuments: 'Ændrede dokumenter',
    changesTo: 'Ændringer i {{summary}}',
    closeBranchAfterMerge: 'Luk denne gren efter fletning',
    closeBranchHelpOff:
      'Grenen forbliver åben, så du kan arbejde videre på den og flette igen senere.',
    closeBranchHelpOn: 'Grenen bliver skrivebeskyttet og kan ikke flettes igen.',
    confirmDiscardAll:
      'Alle {{count}} ændrede dokumenter i denne gren føres tilbage til deres tilstand på main. Det kan ikke fortrydes.',
    confirmDiscardSelected:
      '{{count}} ændrede dokumenter føres tilbage til deres tilstand på main. Det kan ikke fortrydes.',
    createAndSwitch: 'Opret og skift',
    createNewBranch: 'Opret ny gren',
    currentChanges: 'Aktuelle ændringer',
    defaultBranch: 'standard',
    discardAll: 'Kassér alle ({{count}})',
    discardChanges: 'Kassér ændringer',
    discardedCount: '{{count}} ændringer kasseret.',
    discarding: 'Kasserer…',
    discardSelected: 'Kassér valgte ({{count}})',
    historyPageOf: 'Side {{page}} af {{total}}',
    manage: 'Administrer',
    manageBranches: 'Administrer grene…',
    merge: 'Flet',
    mergeAllChanges: 'Alle ændringer i denne gren bliver anvendt.',
    mergeAllCount: 'Alle {{count}} ændrede dokumenter i denne gren bliver anvendt.',
    mergeBranchInto: 'Flet {{branch}} ind i {{target}}',
    mergeChanges: 'Flet ændringer',
    mergeComplete: 'Fletning gennemført',
    merged: 'Flettet',
    mergedByCount: '{{count}} dokumenter af {{user}}',
    mergedCount: '{{count}} ændringer flettet.',
    mergedOfTotal: '{{current}} af {{total}} flettet',
    mergedOn: 'Flettet den {{date}}',
    mergeHistory: 'Fletningshistorik',
    mergeInterrupted: 'Fletningen blev afbrudt, og intet blev anvendt. Prøv igen.',
    mergeNow: 'Flet nu',
    mergeOnlySelected: 'Vælg hvilke ændringer der skal flettes',
    mergeScheduledFor: 'Fletning planlagt til {{date}}.',
    mergeSelectedOfTotal: '{{selected}} af {{total}} ændrede dokumenter bliver anvendt.',
    mergeStarting: 'Starter fletning…',
    merging: 'Fletter…',
    mergingProgress: 'Fletter {{current}} af {{total}}',
    noChangesYet: 'Ingen ændringer i denne gren endnu.',
    operation_create: 'Oprettet',
    operation_delete: 'Slettet',
    operation_update: 'Opdateret',
    reviewingChangedDocuments: 'Gennemgang af ændrede dokumenter',
    scheduleAnotherMerge: 'Planlæg endnu en fletning',
    scheduleCancelled: 'Planlagt fletning annulleret.',
    scheduleCount: '{{count}} planlagt',
    scheduledMerges: 'Planlagte fletninger',
    scheduledToMerge: 'Fletning planlagt',
    scheduledToMergeOn: 'Denne gren er planlagt til at flette den {{date}}.',
    scheduleHasNothingLeft:
      'Der er intet tilbage at anvende — disse ændringer blev kasseret eller er allerede flettet.',
    scheduleMerge: 'Planlæg fletning',
    scheduleMergeHelp:
      'Fletningen kører på det valgte tidspunkt, hvor dine tilladelser tjekkes igen.',
    scheduleWillApplyAll: 'Anvender alt afventende ({{count}})',
    scheduleWillApplySelected: 'Anvender {{count}} valgte ændringer',
    scheduling: 'Planlægger…',
    searchBranches: 'Søg i grene',
    selectBranch: 'Vælg gren',
    untouchedDocumentsNote:
      'Dokumenter, som du ikke har ændret på denne gren, viser det nuværende indhold fra main og ikke et øjebliksbillede fra det tidspunkt, hvor grenen blev oprettet.',
  },
  commandPalette: {
    actions: 'Handlinger',
    createNew: 'Opret ny',
  ...
  error: {
    ...
    noFileFoundInClipboard: 'Ingen fil fundet i udklipsholderen.',
    ...
    unableToReadClipboard: 'Kan ikke læse fra udklipsholder.',
    ...
    urlNotAllowed: 'Den angivne URL er ikke tilladt.',
