...
export const myTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'ဤလုပ်ဆောင်ချက်သည် ဤကြိုတင်သတ်မှတ်ချက်မှ သင့်အား ပိတ်ဆို့ပစ်လိမ့်မည်။',
    attachmentContentInvalid: 'ပူးတွဲပါ အကြောင်းအရာသည် စာကြောင်း သို့မဟုတ် buffer ဖြစ်ရပါမည်။',
    attachmentMissingContentAndPath:
      'ပူးတွဲပါတွင် အကြောင်းအရာနှင့် လမ်းကြောင်း နှစ်ခုလုံး ပျောက်ဆုံးနေပါသည်။',
    attachmentMissingFilename: 'ပူးတွဲပါတွင် ဖိုင်အမည် ပျောက်ဆုံးနေပါသည်။',
    authenticationRequiredForExport:
      'ပို့ကုန်များ ဖန်တီးရန်အတွက် အသုံးပြုသူ အထောက်အထားပြခြင်း လိုအပ်ပါသည်။',
    autosaving: 'ဖိုင်ကို အလိုအလျောက်သိမ်းဆည်းရာတွင် ပြဿနာတစ်ခုရှိနေသည်။',
    busboyMultipartError:
      'Busboy မှ multipart တောင်းဆိုချက်ကို ခွဲခြမ်းစိတ်ဖြာရာတွင် အမှားရှိနေသည်။',
    collectionSlugRequired: 'စုစည်းမှု slug လိုအပ်ပါသည်။',
    contentTypeExpectedJSON: 'Content-Type သည် application/json ဖြစ်ရန် မျှော်လင့်ထားပါသည်။',
    ...
    eitherCollectionOrGlobalRequired: 'စုစည်းမှု သို့မဟုတ် globalSlug တစ်ခုကို ထည့်သွင်းရပါမည်။',
    expectedResponseFromUploadHandler: 'အပ်လုဒ် handler မှ တုံ့ပြန်ချက် မျှော်လင့်ထားပါသည်။',
    failedToFetchFromURL: 'ပေးထားသော URL မှ ဖိုင်ကို ရယူ၍မရပါ။',
    fieldMustBeSpecified: 'အကွက်ကို သတ်မှတ်ရပါမည်။',
    fieldsNotInitialized: 'အကွက်များကို အစပြု၍မရသေးပါ။',
    filenameRequired: 'ဖိုင်အမည် လိုအပ်ပါသည်။',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Join အကွက်များကို arrays၊ blocks သို့မဟုတ် globals များတွင် ထည့်၍မရပါ။',
    ...
    missingIDOfVersionToRestore: 'ပြန်လည်ထည့်သွင်းရန် ဗားရှင်း ID ပျောက်ဆုံးနေပါသည်။',
    missingRequiredData: 'လိုအပ်သောဒေတာ ပျောက်ဆုံးနေပါသည်။',
    noConnectionToDatabase:
      'ဒေတာဘေ့စ်သို့ ချိတ်ဆက်မှု မရှိသည့်အခါ beginTransaction ကို ခေါ်ယူခဲ့သည်။',
    noFileDataForImport: 'သွင်းကုန်အတွက် ဖိုင်ဒေတာ မပေးထားပါ။',
    noFilesUploaded: 'ဖိုင်များကို အပ်လုဒ်လုပ်ထားခြင်းမရှိပါ။',
    noMatchedField: '"{{label}}" အတွက် ကိုက်ညီသောအပိုင်းကို ရှာမတွေ့ပါ။',
    noPayloadProvided: 'Payload မပေးထားပါ။',
    ...
    notSupported: 'ပံ့ပိုးမထားပါ။',
    noUser: 'အသုံးပြုသူ မရှိပါ။',
    orderableJoinsMustTargetSingleCollection:
      'စီစဉ်နိုင်သော joins များသည် စုစည်းမှုတစ်ခုတည်းကို ပစ်မှတ်ထားရပါမည်။',
    pastingFromURLNotEnabled: 'URL မှ ကူးထည့်ခြင်းကို ဤစုစည်းမှုအတွက် ဖွင့်မထားပါ။',
    previewing: 'ဖိုင်ကို အစမ်းကြည့်ရန် ပြဿနာရှိနေသည်။',
    problemUploadingFile: 'ဖိုင်ကို အပ်လုဒ်တင်ရာတွင် ပြဿနာရှိနေသည်။',
    redirectTargetNotAllowed: 'လမ်းကြောင်းပြောင်းဦးတည်ရာကို ခွင့်မပြုပါ။',
    relationshipFieldNotFound: 'ဆက်နွယ်မှု အကွက်ကို ရှာမတွေ့ပါ။',
    relationshipNotFound: 'ဆက်နွယ်မှုကို ရှာမတွေ့ပါ။',
    requestDataRequired: 'တောင်းဆိုချက် ဒေတာ လိုအပ်ပါသည်။',
    requestNotEligibleForFileUpload: 'တောင်းဆိုချက်သည် ဖိုင်အပ်လုဒ်အတွက် အရည်အချင်းမပြည့်မီပါ။',
    requestURLMissing: 'တောင်းဆိုချက် URL ပျောက်ဆုံးနေပါသည်။',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug: 'မမျှော်လင့်ထားသော collectionSlug array၊ parent ကို ပေးရပါမည်။',
    unknown: 'ဘာမှန်းမသိသော error တက်သွားပါသည်။',
    unPublishingDocument: 'ဖိုင်ကို ပြန်လည့် သိမ်းဆည်းခြင်းမှာ ပြဿနာရှိနေသည်။',
    unreachable: 'ရောက်ရှိ၍မရပါ။',
    unspecific: 'Error တက်နေပါသည်။',
    unverifiedEmail: 'ထည့်သွင်းမည်မဆိုမီ သင့်အီးမေးလ်ကို အတည်ပြုပါ။',
    uploadConfigHandlersMissing: '{{collection}} အတွက် uploadConfig.handlers မရှိပါ။',
    uploadthingUnknownError: 'uploadthing ဖြင့် ဖိုင်အပ်လုဒ်လုပ်ရာတွင် အမှား- အကြောင်းရင်းမသိ',
    urlNotAllowed: 'ပေးထားသော URL ကို ခွင့်မပြုပါ။',
    ...
    userRequiredForImport: 'သွင်းကုန်လုပ်ဆောင်ချက်များအတွက် အသုံးပြုသူ လိုအပ်ပါသည်။',
    validURLRequired: 'တရားဝင် URL စာကြောင်း လိုအပ်ပါသည်။',
    valueMustBeUnique: 'value သည် အဓိပ္ပာယ်ရှိရပါမည်။',
    vercelBlobUploadError: 'storage-vercel-blob client အပ်လုဒ် လမ်းကြောင်း အမှား',
