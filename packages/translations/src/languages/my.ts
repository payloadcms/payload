...
export const myTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    draftsHint: 'သင်၏ မကြာသေးမီက မူကြမ်းများကို ဤနေရာတွင် ပြပါမည်',
    dropFiles: 'ဖိုင်တင်ရန် ဤနေရာတွင် လွှတ်ချပါ',
    ...
    loadError: 'စာရွက်စာတမ်းအချို့ကို မတင်နိုင်ပါ။ ထပ်ကြိုးစားရန် စာမျက်နှာကို ပြန်ဖွင့်ပါ။',
    noDrafts: 'မကြာသေးမီက မူကြမ်း မရှိပါ',
    noItems:
      'သင့်ဒက်ရှ်ဘုတ်တွင် ဝစ်ဂျက်များ မရှိပါ။ အပေါ်ဘားရှိ "Dashboard" မီနူးမှ ထည့်သွင်းနိုင်ပါသည်။',
    noPinned: 'ပင်ထိုးထားသော စာရွက်စာတမ်း မရှိပါ',
    noRecents: 'မကြာသေးမီက ကြည့်ရှုထားသော စာရွက်စာတမ်း မရှိပါ',
    pinDocument: '{{title}} ကို ပင်ထိုးရန်',
    pinned: 'ပင်ထိုးထားသည်',
    pinnedHint: 'သင်ပင်ထိုးထားသော စာရွက်စာတမ်းများကို ဤနေရာတွင် ပြပါမည်',
    recentDrafts: 'မကြာသေးမီက မူကြမ်းများ',
    recentlyViewed: 'မကြာသေးမီက ကြည့်ရှုထားသည်',
    recentsHint: 'သင်ကြည့်ရှုသော စာရွက်စာတမ်းများကို ဤနေရာတွင် ပြပါမည်',
    resetLayout: 'စီစဉ်မှုကို ပြန်လည်သတ်မှတ်ပါ',
    saveError: 'ဒက်ရှ်ဘုတ် ဆက်တင်ကို မသိမ်းဆည်းနိုင်ပါ။ ထပ်ကြိုးစားပါ။',
    searchWidgets: 'ဝစ်ဂျက်များ ရှာဖွေပါ...',
    unpinDocument: '{{title}} ကို ပင်ဖြုတ်ရန်',
    updatedBy: 'နောက်ဆုံးပြင်ဆင်သူ',
    uploadDropzone: 'ဖိုင်တင်ရန် နေရာ',
    uploadFiles: 'ဖိုင်များ တင်ရန်',
    uploadHint: 'ကွန်ပျူတာမှ ဖိုင်များကို ဆွဲချပါ သို့မဟုတ် အောက်ပါခလုတ်ကို နှိပ်ပါ',
    viewMode: 'စာရွက်စာတမ်းမြင်ကွင်း',
  ...
  general: {
    ...
    alignHeaderAndControls: 'ခေါင်းစီးနှင့် ထိန်းချုပ်မှုများကို ညှိပါ',
    all: 'အားလုံး',
    ...
    editViewWidth: 'တည်းဖြတ်မြင်ကွင်း အကျယ်',
    editViewWidthFull: 'အပြည့်',
    email: 'အီးမေးလ်',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'စာသားအရွယ်အစားများ',
    typeSizeSmall: 'လက်ရှိ',
