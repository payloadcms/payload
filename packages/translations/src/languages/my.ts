...
export const myTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    confirm: 'သေချာပါပြီ။',
    confirmCopy: 'အကောင့်အားအတည်ပြုပါ',
    ...
    copying: 'ကူးယူခြင်း',
    copyWarning:
      'Anda akan menyalin data dari {{from}} ke {{to}}. Ini akan menimpa data {{to}} yang ada dan mengarahkan Anda untuk melanjutkan penyuntingan pada lokasi ini. Apakah Anda yakin ingin melanjutkan?',
    create: 'ဖန်တီးမည်။',
