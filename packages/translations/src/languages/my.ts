...
export const myTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: '{{count}} perubahan lain',
    branch: 'Cawangan',
    branchClosed:
      'Cawangan ini telah ditutup. Ia disimpan sebagai rekod tentang apa yang telah digabungkan.',
    branchDescription: 'Penerangan cawangan',
    branchedFrom: 'Dicabang daripada',
    branches: 'Cawangan',
    branchHistory: 'Sejarah cawangan',
    branchMerging: 'Menggabungkan',
    branchName: 'Nama cawangan',
    branchSettings: 'Tetapan cawangan',
    cancelSchedule: 'Batalkan penggabungan',
    changedDocuments: 'Dokumen yang diubah',
    changesTo: 'Perubahan pada {{summary}}',
    closeBranchAfterMerge: 'Tutup cawangan ini selepas penggabungan',
    closeBranchHelpOff:
      'Cawangan kekal terbuka, jadi anda boleh terus bekerja padanya dan menggabungkannya semula kemudian.',
    closeBranchHelpOn: 'Cawangan akan menjadi baca sahaja dan tidak boleh digabungkan lagi.',
    confirmDiscardAll:
      'Kesemua {{count}} dokumen yang diubah pada cawangan ini akan dikembalikan kepada keadaannya di main. Tindakan ini tidak boleh dibatalkan.',
    confirmDiscardSelected:
      '{{count}} dokumen yang diubah akan dikembalikan kepada keadaannya di main. Tindakan ini tidak boleh dibatalkan.',
    createAndSwitch: 'Cipta dan tukar',
    createNewBranch: 'Cipta cawangan baharu',
    currentChanges: 'Perubahan semasa',
    defaultBranch: 'lalai',
    discardAll: 'Buang semua ({{count}})',
    discardChanges: 'Buang perubahan',
    discardedCount: '{{count}} perubahan dibuang.',
    discarding: 'Membuang…',
    discardSelected: 'Buang yang dipilih ({{count}})',
    historyPageOf: 'Halaman {{page}} daripada {{total}}',
    manage: 'စီမံခန့်ခွဲရန်',
    manageBranches: 'Urus cawangan…',
    merge: 'ပေါင်းစည်းရန်',
    mergeAllChanges: 'Semua perubahan pada cawangan ini akan digunakan.',
    mergeAllCount: 'Kesemua {{count}} dokumen yang diubah pada cawangan ini akan digunakan.',
    mergeBranchInto: 'Gabungkan {{branch}} ke dalam {{target}}',
    mergeChanges: 'အပြောင်းအလဲများ ပေါင်းစည်းရန်',
    mergeComplete: 'Penggabungan selesai',
    merged: 'Digabungkan',
    mergedByCount: '{{count}} dokumen oleh {{user}}',
    mergedCount: '{{count}} perubahan digabungkan.',
    mergedOfTotal: '{{current}} daripada {{total}} digabungkan',
    mergedOn: 'Digabungkan pada {{date}}',
    mergeHistory: 'Sejarah penggabungan',
    mergeInterrupted: 'Penggabungan terganggu dan tiada apa yang digunakan. Cuba lagi.',
    mergeNow: 'Gabungkan sekarang',
    mergeOnlySelected: 'Pilih perubahan yang hendak digabungkan',
    mergeScheduledFor: 'Penggabungan dijadualkan pada {{date}}.',
    mergeSelectedOfTotal: '{{selected}} daripada {{total}} dokumen yang diubah akan digunakan.',
    mergeStarting: 'Memulakan penggabungan…',
    merging: 'Menggabungkan…',
    mergingProgress: 'Menggabungkan {{current}} daripada {{total}}',
    noChangesYet: 'Tiada perubahan pada cawangan ini lagi.',
    operation_create: 'Dicipta',
    operation_delete: 'Dipadam',
    operation_update: 'Dikemas kini',
    reviewingChangedDocuments: 'ပြောင်းလဲထားသော စာရွက်စာတမ်းများကို ပြန်လည်သုံးသပ်ခြင်း',
    scheduleAnotherMerge: 'Jadualkan penggabungan lain',
    scheduleCancelled: 'Penggabungan berjadual dibatalkan.',
    scheduleCount: '{{count}} berjadual',
    scheduledMerges: 'Penggabungan berjadual',
    scheduledToMerge: 'Penggabungan dijadualkan',
    scheduledToMergeOn: 'Cawangan ini dijadualkan untuk digabungkan pada {{date}}.',
    scheduleHasNothingLeft:
      'Tiada apa lagi untuk digunakan — perubahan ini dibuang atau sudah digabungkan.',
    scheduleMerge: 'Jadualkan penggabungan',
    scheduleMergeHelp:
      'Penggabungan berjalan pada masa yang anda pilih, dan kebenaran anda diperiksa semula ketika itu.',
    scheduleWillApplyAll: 'Akan menggunakan semua yang menunggu ({{count}})',
    scheduleWillApplySelected: 'Akan menggunakan {{count}} perubahan dipilih',
    scheduling: 'Menjadualkan…',
    searchBranches: 'Cari cawangan',
    selectBranch: 'Pilih cawangan',
    untouchedDocumentsNote:
      'ဤ branch တွင် သင် မပြောင်းလဲထားသေးသော Document များတွင်၊ branch တည်ဆောက်သောအချိန်က snapshot ဖြစ်ရန်မဟုတ်ဘဲ main တွင်ရှိသော လက်ရှိအကြောင်းအရာများကို ပြသပါသည်။',
  },
  commandPalette: {
