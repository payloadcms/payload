...
export const hyTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    draftsHint: 'Ձեր վերջին սևագրերը կհայտնվեն այստեղ',
    dropFiles: 'Բաց թողեք ֆայլերը՝ վերբեռնելու համար',
    editDashboard: 'Փոփոխել վահանակը',
    editingDashboard: 'Խմբագրման Վահանակ',
    gridView: 'Ցանցային տեսք',
    listView: 'Ցուցակի տեսք',
    loadError: 'Որոշ փաստաթղթեր չհաջողվեց բեռնել։ Թարմացրեք էջը։',
    noDrafts: 'Վերջին սևագրեր չկան',
    noItems: 'Ձեր վահագործի վրա վիջեթներ չկան։ Դուք կարող եք ավելացնել դրանք "Վահագործ" մենյուից',
    noPinned: 'Ամրացված փաստաթղթեր չկան',
    noRecents: 'Վերջերս դիտված փաստաթղթեր չկան',
    pinDocument: 'Ամրացնել {{title}}',
    pinned: 'Ամրացված',
    pinnedHint: 'Ամրացված փաստաթղթերը կհայտնվեն այստեղ',
    recentDrafts: 'Վերջին սևագրերը',
    recentlyViewed: 'Վերջերս դիտված',
    recentsHint: 'Դիտված փաստաթղթերը կհայտնվեն այստեղ',
    resetLayout: 'Վերադասավորել Կառուցվածքը',
    saveError: 'Չհաջողվեց պահպանել վահանակի կարգավորումը։ Փորձեք կրկին։',
    searchWidgets: 'Որոնել վիջեթներ...',
    unpinDocument: 'Ապամրացնել {{title}}',
    updatedBy: 'Թարմացնող',
    uploadDropzone: 'Վերբեռնման գոտի',
    uploadFiles: 'Վերբեռնել ֆայլեր',
    uploadHint: 'Քաշեք ֆայլերը համակարգչից կամ սեղմեք ստորև նշված կոճակը',
    viewMode: 'Փաստաթղթերի տեսք',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Հավասարեցնել վերնագիրն ու կառավարման տարրերը',
    all: 'Բոլորը',
    ...
    editViewWidth: 'Խմբագրման տեսքի լայնություն',
    editViewWidthFull: 'Ամբողջական',
    email: 'Էլ. փոստ',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Տեքստի չափեր',
    typeSizeSmall: 'Ընթացիկ',
