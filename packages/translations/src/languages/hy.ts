...
export const hyTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Այս գործողությունը կկողպի ձեզ այս նախադրված կարգավորումից։',
    attachmentContentInvalid: 'Կցված ֆայլի բովանդակությունը պետք է լինի տեքստ կամ բուֆեր',
    attachmentMissingContentAndPath: 'Կցված ֆայլում բացակայում է և՛ բովանդակությունը, և՛ ուղին',
    attachmentMissingFilename: 'Կցված ֆայլում բացակայում է ֆայլի անունը',
    authenticationRequiredForExport:
      'Արտահանումներ ստեղծելու համար անհրաժեշտ է օգտատիրոջ նույնականացում։',
    autosaving: 'Այս փաստաթղթի ավտոմատ պահպանման ժամանակ խնդիր է առաջացել։',
    busboyMultipartError: 'Busboy սխալ՝ բազմամասնյա հայտը վերլուծելիս',
    collectionSlugRequired: 'Հավաքածուի slug-ը պարտադիր է',
    contentTypeExpectedJSON: 'Content-Type-ը պետք է լինի application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Պետք է փոխանցել կամ հավաքածու, կամ globalSlug։',
    emailOrPasswordIncorrect: 'Տրամադրված էլ. փոստը կամ գաղտնաբառը սխալ է։',
    expectedResponseFromUploadHandler: 'Ակնկալվում է պատասխան վերբեռնման մշակիչից։',
    failedToFetchFromURL: 'Չհաջողվեց ներբեռնել ֆայլը տրամադրված URL-ից։',
    failedToResetLayout: 'Հաջողվել է դասավորությունը վերակայել:',
    failedToSaveLayout: 'Չհաջողվեց հիմնադրել ձևավորումը:',
    fieldMustBeSpecified: 'Դաշտը պետք է նշված լինի',
    fieldsNotInitialized: 'Դաշտերը նախապատրաստված չեն։',
    filenameRequired: 'Ֆայլի անունը պարտադիր է։',
    ...
    invalidFilename: 'Անվավեր ֆայլի անուն',
    invalidFileType: 'Անվավեր ֆայլի տեսակ',
    invalidFileTypeValue: 'Անվավեր ֆայլի տեսակ՝ {{value}}',
    invalidFileURL: 'Անվավեր ֆայլի URL',
    invalidJSON: 'Անվավեր JSON',
    invalidJSONFormat: 'Անվավեր JSON ձևաչափ',
    invalidRequestArgs: 'Հայտում փոխանցված անվավեր արգումենտներ՝ {{args}}',
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Join դաշտերը չեն կարող ավելացվել զանգվածներին, բլոկներին կամ գլոբալներին։',
    ...
    missingIDOfVersionToRestore: 'Վերականգնվող տարբերակի ID-ն բացակայում է։',
    missingRequiredData: 'Պահանջվող տվյալները բացակայում են։',
    noConnectionToDatabase: 'beginTransaction կանչը կատարվել է առանց տվյալների բազայի կապի',
    noFileDataForImport: 'Ներմուծման համար ֆայլի տվյալներ չեն տրամադրվել',
    noFilesUploaded: 'Ֆայլեր չեն վերբեռնվել։',
    noMatchedField: '"{{label}}"-ի համար համապատասխան դաշտ չի գտնվել',
    noPayloadProvided: 'Payload-ը տրամադրված չէ',
    ...
    notSupported: 'Չի աջակցվում',
    noUser: 'Օգտատեր չկա',
    orderableJoinsMustTargetSingleCollection:
      'Դասավորվող join-երը պետք է ուղղված լինեն մեկ հավաքածուին',
    pastingFromURLNotEnabled: 'URL-ից տեղադրումը միացված չէ այս հավաքածուի համար։',
    ...
    redirectTargetNotAllowed: 'Վերահղման թիրախը թույլատրված չէ։',
    relationshipFieldNotFound: 'Հարաբերության դաշտը չի գտնվել',
    relationshipNotFound: 'Հարաբերությունը չի գտնվել',
    requestDataRequired: 'Հայտի տվյալները պարտադիր են։',
    requestNotEligibleForFileUpload: 'Հայտը չի համապատասխանում ֆայլի վերբեռնման պահանջներին',
    requestURLMissing: 'Հայտի URL-ը բացակայում է։',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug:
      'Անսպասելի collectionSlug զանգված, parent-ը պետք է տրամադրված լինի',
    unknown: 'Անհայտ սխալ է տեղի ունեցել։',
    unPublishingDocument: 'Այս փաստաթուղթը չհրապարակված դարձնելու ժամանակ խնդիր է առաջացել։',
    unreachable: 'Անհասանելի',
    unspecific: 'Սխալ է տեղի ունեցել։',
    unverifiedEmail: 'Խնդրում ենք հաստատել Ձեր էլ. փոստը նախքան մուտք գործելը։',
    uploadConfigHandlersMissing: 'uploadConfig.handlers բացակայում է {{collection}}-ի համար',
    uploadthingUnknownError: 'Սխալ՝ uploadthing-ով ֆայլ վերբեռնելիս՝ Անհայտ սխալ',
    urlNotAllowed: 'Տրամադրված URL-ը թույլատրված չէ։',
    ...
    userRequiredForImport: 'Օգտատերը պարտադիր է ներմուծման գործողությունների համար',
    validURLRequired: 'Անհրաժեշտ է վավեր URL տող։',
    valueMustBeUnique: 'Արժեքը պետք է եզակի լինի',
    vercelBlobUploadError: 'storage-vercel-blob հաճախորդի վերբեռնման երթուղու սխալ',
