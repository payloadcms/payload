...
export const hyTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting:
      'Էլ․ հասցեն հաջողությամբ հաստատվեց։ Դիմումը ձեզ կվերաուղղի մուտքի էջ։',
  ...
  branching: {
    andMoreChanges: 'ևս {{count}} փոփոխություն',
    branch: 'Ճյուղ',
    branchClosed: 'Այս ճյուղը փակ է։ Պահվում է որպես գրառում այն մասին, թե ինչ է միաձուլվել։',
    branchDescription: 'Ճյուղի նկարագրությունը',
    branchedFrom: 'Ճյուղավորված է',
    branches: 'Ճյուղեր',
    branchHistory: 'Ճյուղի պատմություն',
    branchMerging: 'Միաձուլվում է',
    branchName: 'Ճյուղի անվանումը',
    branchSettings: 'Ճյուղի կարգավորումներ',
    cancelSchedule: 'Չեղարկել միաձուլումը',
    changedDocuments: 'Փոփոխված փաստաթղթեր',
    changesTo: 'Փոփոխություններ՝ {{summary}}',
    closeBranchAfterMerge: 'Փակել այս ճյուղը միաձուլումից հետո',
    closeBranchHelpOff:
      'Ճյուղը մնում է բաց, այնպես որ կարող եք շարունակել աշխատել դրա վրա և ավելի ուշ նորից միաձուլել։',
    closeBranchHelpOn: 'Ճյուղը կդառնա միայն կարդալու համար և այլևս հնարավոր չի լինի միաձուլել։',
    confirmDiscardAll:
      'Այս ճյուղի բոլոր {{count}} փոփոխված փաստաթղթերը կվերադարձվեն main-ում իրենց վիճակին։ Այս գործողությունը հետ շրջել հնարավոր չէ։',
    confirmDiscardSelected:
      '{{count}} փոփոխված փաստաթուղթ կվերադարձվի main-ում իր վիճակին։ Այս գործողությունը հետ շրջել հնարավոր չէ։',
    createAndSwitch: 'Ստեղծել և անցնել',
    createNewBranch: 'Ստեղծել նոր ճյուղ',
    currentChanges: 'Ընթացիկ փոփոխություններ',
    defaultBranch: 'լռելյայն',
    discardAll: 'Չեղարկել բոլորը ({{count}})',
    discardChanges: 'Չեղարկել փոփոխությունները',
    discardedCount: 'Չեղարկվել է {{count}} փոփոխություն։',
    discarding: 'Չեղարկվում է…',
    discardSelected: 'Չեղարկել ընտրվածները ({{count}})',
    historyPageOf: 'Էջ {{page}}՝ {{total}}-ից',
    manage: 'Կառավարել',
    manageBranches: 'Կառավարել ճյուղերը…',
    merge: 'Միաձուլել',
    mergeAllChanges: 'Կկիրառվեն այս ճյուղի բոլոր փոփոխությունները։',
    mergeAllCount: 'Կկիրառվեն այս ճյուղի բոլոր {{count}} փոփոխված փաստաթղթերը։',
    mergeBranchInto: 'Միաձուլել {{branch}}-ը {{target}}-ի հետ',
    mergeChanges: 'Միաձուլել փոփոխությունները',
    mergeComplete: 'Միաձուլումն ավարտված է',
    merged: 'Միաձուլված',
    mergedByCount: '{{count}} փաստաթուղթ՝ {{user}}',
    mergedCount: 'Միաձուլվել է {{count}} փոփոխություն։',
    mergedOfTotal: 'Միաձուլվել է {{current}}՝ {{total}}-ից',
    mergedOn: 'Միաձուլվել է {{date}}',
    mergeHistory: 'Միաձուլումների պատմություն',
    mergeInterrupted: 'Միաձուլումը ընդհատվեց, և ոչինչ չկիրառվեց։ Փորձեք նորից։',
    mergeNow: 'Միաձուլել հիմա',
    mergeOnlySelected: 'Ընտրեք, թե որ փոփոխությունները միաձուլել',
    mergeScheduledFor: 'Միաձուլումը նախատեսված է {{date}}։',
    mergeSelectedOfTotal: 'Կկիրառվի {{total}} փոփոխված փաստաթղթից {{selected}}-ը։',
    mergeStarting: 'Միաձուլումը սկսվում է…',
    merging: 'Միաձուլվում է…',
    mergingProgress: 'Միաձուլվում է {{current}}՝ {{total}}-ից',
    noChangesYet: 'Այս ճյուղում դեռ փոփոխություններ չկան։',
    operation_create: 'Ստեղծված',
    operation_delete: 'Ջնջված',
    operation_update: 'Թարմացված',
    reviewingChangedDocuments: 'Փոփոխված փաստաթղթերի վերանայում',
    scheduleAnotherMerge: 'Ժամանակացույցել ևս մեկ միաձուլում',
    scheduleCancelled: 'Ժամանակացույցով միաձուլումը չեղարկվեց։',
    scheduleCount: '{{count}} ժամանակացույցված',
    scheduledMerges: 'Ժամանակացույցված միաձուլումներ',
    scheduledToMerge: 'Միաձուլումը ժամանակացույցված է',
    scheduledToMergeOn: 'Այս ճյուղը ժամանակացույցված է միաձուլման {{date}}։',
    scheduleHasNothingLeft:
      'Կիրառելու բան չի մնացել — այս փոփոխությունները չեղարկվել են կամ արդեն միաձուլվել։',
    scheduleMerge: 'Ժամանակացույցով միաձուլում',
    scheduleMergeHelp:
      'Միաձուլումը կատարվում է ձեր ընտրած ժամին, և ձեր իրավունքները ստուգվում են կրկին այդ պահին։',
    scheduleWillApplyAll: 'Կկիրառի սպասող ամեն ինչ ({{count}})',
    scheduleWillApplySelected: 'Կկիրառի {{count}} ընտրված փոփոխություն',
    scheduling: 'Ժամանակացույցվում է…',
    searchBranches: 'Փնտրել ճյուղեր',
    selectBranch: 'Ընտրել ճյուղ',
    untouchedDocumentsNote:
      'Այն փաստաթղթերը, որոնք դուք այս ճյուղում չեք փոփոխել, ցուցադրում են main-ի ներկա բովանդակությունը, ոչ թե ճյուղի ստեղծման պահի պատկերը:',
  },
  commandPalette: {
  ...
  error: {
    ...
    fileFetchFailed: 'Չհաջողվեց ստանալ ֆայլը։',
    ...
    noFileFoundInClipboard: 'Պահոցում ֆայլ չի գտնվել։',
    ...
    unableToReadClipboard: 'Չհաջողվեց կարդալ սղագրատախտակից։',
    ...
    urlNotAllowed: 'Մատակարարված URL-ը թույլատրելի չէ:',
  ...
  fields: {
    ...
    hidePassword: 'Գաղտնաբառը թաքցնել',
  ...
  general: {
    ...
    editColumns: 'Խմբագրել Սյունակները',
  ...
  upload: {
    ...
    fromURL: 'Վերբեռնել ֆայլը URL-ով',
    height: 'Բարձրություն',
