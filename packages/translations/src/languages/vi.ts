...
export const viTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Tài liệu',
    draftsHint: 'Bản nháp gần đây của bạn sẽ xuất hiện ở đây',
    dropFiles: 'Thả tệp để tải lên',
    ...
    loadError: 'Không thể tải một số tài liệu. Vui lòng làm mới trang để thử lại.',
    noDrafts: 'Không có bản nháp gần đây',
    noItems:
      'Trên bảng điều khiển của bạn không có tiện ích nào. Bạn có thể thêm chúng từ menu "Bảng điều khiển" nằm ở thanh trên cùng.',
    noPinned: 'Không có tài liệu đã ghim',
    noRecents: 'Không có tài liệu đã xem gần đây',
    pinDocument: 'Ghim {{title}}',
    pinned: 'Đã ghim',
    pinnedHint: 'Tài liệu bạn ghim sẽ xuất hiện ở đây',
    recentDrafts: 'Bản nháp gần đây',
    recentlyViewed: 'Đã xem gần đây',
    recentsHint: 'Tài liệu bạn xem sẽ xuất hiện ở đây',
    resetLayout: 'Đặt lại Bố cục',
    saveError: 'Không thể lưu tùy chọn bảng điều khiển. Vui lòng thử lại.',
    searchWidgets: 'Tìm kiếm các widget...',
    unpinDocument: 'Bỏ ghim {{title}}',
    updatedBy: 'Cập nhật bởi',
    uploadDropzone: 'Vùng tải lên',
    uploadFiles: 'Tải tệp lên',
    uploadHint: 'Kéo thả tệp từ máy tính hoặc nhấp vào nút bên dưới',
    viewMode: 'Chế độ xem tài liệu',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Căn chỉnh tiêu đề và các điều khiển',
    all: 'Tất cả',
    ...
    editViewWidth: 'Chiều rộng giao diện chỉnh sửa',
    editViewWidthFull: 'Toàn bộ',
    email: 'Email',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Kích thước chữ',
    typeSizeSmall: 'Hiện tại',
