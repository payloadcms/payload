...
export const viTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Lỗi - Hành động này sẽ khóa bạn khỏi cài đặt này.',
    attachmentContentInvalid: 'Lỗi - Nội dung tệp đính kèm phải là một chuỗi hoặc buffer',
    attachmentMissingContentAndPath: 'Lỗi - Tệp đính kèm thiếu cả nội dung và đường dẫn',
    attachmentMissingFilename: 'Lỗi - Tệp đính kèm thiếu tên tệp',
    authenticationRequiredForExport: 'Lỗi - Cần xác thực người dùng để tạo các tệp xuất.',
    autosaving: 'Lỗi - Đã xảy ra vấn đề khi tự động sao lưu bản tài liệu này.',
    busboyMultipartError: 'Lỗi - Lỗi Busboy khi phân tích yêu cầu multipart',
    collectionSlugRequired: 'Lỗi - Slug bộ sưu tập là bắt buộc',
    contentTypeExpectedJSON: 'Lỗi - Content-Type dự kiến là application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Lỗi - Bộ sưu tập hoặc globalSlug phải được truyền.',
    emailOrPasswordIncorrect: 'Lỗi - Email hoặc mật khẩu không chính xác.',
    expectedResponseFromUploadHandler: 'Lỗi - Dự kiến phản hồi từ trình xử lý tải lên.',
    failedToFetchFromURL: 'Lỗi - Không thể tải tệp từ URL được cung cấp.',
    failedToResetLayout: 'Không thể đặt lại bố cục.',
    failedToSaveLayout: 'Không thể lưu bố cục.',
    fieldMustBeSpecified: 'Lỗi - field phải được chỉ định',
    fieldsNotInitialized: 'Lỗi - Các trường chưa được khởi tạo.',
    filenameRequired: 'Lỗi - Tên tệp là bắt buộc.',
    ...
    missingIDOfVersionToRestore: 'Lỗi - Thiếu ID của phiên bản cần khôi phục.',
    missingRequiredData: 'Lỗi - Thiếu dữ liệu cần thiết.',
    noConnectionToDatabase:
      'Lỗi - beginTransaction được gọi khi không có kết nối đến cơ sở dữ liệu',
    noFileDataForImport: 'Lỗi - Không có dữ liệu tệp được cung cấp để nhập',
    noFilesUploaded: 'Lỗi - File chưa được tải lên.',
    noMatchedField: 'Lỗi - Không tìm thấy field trùng với "{{label}}".',
    noPayloadProvided: 'Lỗi - Không có payload được cung cấp',
    ...
    notSupported: 'Lỗi - Không được hỗ trợ',
    noUser: 'Lỗi - Yêu cầu thiếu thông tin người dùng.',
    orderableJoinsMustTargetSingleCollection:
      'Lỗi - Các join có thể sắp xếp phải nhắm đến một bộ sưu tập duy nhất',
    pastingFromURLNotEnabled: 'Lỗi - Dán từ URL không được bật cho bộ sưu tập này.',
    ...
    redirectTargetNotAllowed: 'Lỗi - Mục tiêu chuyển hướng không được phép.',
    relationshipFieldNotFound: 'Lỗi - Không tìm thấy trường quan hệ',
    relationshipNotFound: 'Lỗi - Không tìm thấy quan hệ',
    requestDataRequired: 'Lỗi - Dữ liệu yêu cầu là bắt buộc.',
    requestNotEligibleForFileUpload: 'Lỗi - Yêu cầu không đủ điều kiện để tải lên tệp',
    requestURLMissing: 'Lỗi - URL yêu cầu bị thiếu.',
    restoringTitle:
    ...
    unexpectedArrayCollectionSlug:
      'Lỗi - Mảng collectionSlug không mong đợi, parent phải được cung cấp',
    unknown: 'Lỗi - Không xác định (unknown error).',
    unPublishingDocument: 'Lỗi - Đã xảy ra vấn để khi ẩn bản tài liệu.',
    unreachable: 'Lỗi - Không thể tiếp cận',
    unspecific: 'Lỗi - Đã xảy ra (unspecific error).',
    unverifiedEmail: 'Vui lòng xác minh email trước khi đăng nhập.',
    uploadConfigHandlersMissing: 'Lỗi - uploadConfig.handlers không có cho {{collection}}',
    uploadthingUnknownError: 'Lỗi - Lỗi tải tệp lên với uploadthing: Lỗi không xác định',
    urlNotAllowed: 'Lỗi - URL được cung cấp không được phép.',
    ...
    userRequiredForImport: 'Lỗi - Người dùng là bắt buộc cho các thao tác nhập',
    validURLRequired: 'Lỗi - Một chuỗi URL hợp lệ là bắt buộc.',
    valueMustBeUnique: 'Lỗi - Giá trị không được trùng lặp.',
    vercelBlobUploadError: 'Lỗi - Lỗi route tải lên storage-vercel-blob client',
