...
export const viTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: '{{count}} thay đổi khác',
    branch: 'Nhánh',
    branchClosed: 'Nhánh này đã đóng. Nhánh được giữ lại như bản ghi về những gì đã hợp nhất.',
    branchDescription: 'Mô tả nhánh',
    branchedFrom: 'Tách từ',
    branches: 'Nhánh',
    branchHistory: 'Lịch sử nhánh',
    branchMerging: 'Đang hợp nhất',
    branchName: 'Tên nhánh',
    branchSettings: 'Cài đặt nhánh',
    cancelSchedule: 'Hủy hợp nhất',
    changedDocuments: 'Tài liệu đã thay đổi',
    changesTo: 'Thay đổi trong {{summary}}',
    closeBranchAfterMerge: 'Đóng nhánh này sau khi hợp nhất',
    closeBranchHelpOff:
      'Nhánh vẫn mở, nên bạn có thể tiếp tục làm việc trên nhánh và hợp nhất lại sau.',
    closeBranchHelpOn: 'Nhánh sẽ chuyển sang chỉ đọc và không thể hợp nhất lại.',
    confirmDiscardAll:
      'Toàn bộ {{count}} tài liệu đã thay đổi trên nhánh này sẽ được đưa về trạng thái trên main. Không thể hoàn tác.',
    confirmDiscardSelected:
      '{{count}} tài liệu đã thay đổi sẽ được đưa về trạng thái trên main. Không thể hoàn tác.',
    createAndSwitch: 'Tạo và chuyển',
    createNewBranch: 'Tạo nhánh mới',
    currentChanges: 'Thay đổi hiện tại',
    defaultBranch: 'mặc định',
    discardAll: 'Hủy tất cả ({{count}})',
    discardChanges: 'Hủy thay đổi',
    discardedCount: 'Đã hủy {{count}} thay đổi.',
    discarding: 'Đang hủy…',
    discardSelected: 'Hủy phần đã chọn ({{count}})',
    historyPageOf: 'Trang {{page}} trên {{total}}',
    manage: 'Quản lý',
    manageBranches: 'Quản lý nhánh…',
    merge: 'Hợp nhất',
    mergeAllChanges: 'Mọi thay đổi trên nhánh này sẽ được áp dụng.',
    mergeAllCount: 'Toàn bộ {{count}} tài liệu đã thay đổi trên nhánh này sẽ được áp dụng.',
    mergeBranchInto: 'Hợp nhất {{branch}} vào {{target}}',
    mergeChanges: 'Hợp nhất thay đổi',
    mergeComplete: 'Đã hợp nhất xong',
    merged: 'Đã hợp nhất',
    mergedByCount: '{{count}} tài liệu bởi {{user}}',
    mergedCount: 'Đã hợp nhất {{count}} thay đổi.',
    mergedOfTotal: 'Đã hợp nhất {{current}} trên {{total}}',
    mergedOn: 'Đã hợp nhất vào {{date}}',
    mergeHistory: 'Lịch sử hợp nhất',
    mergeInterrupted: 'Quá trình hợp nhất bị ngắt và không có gì được áp dụng. Hãy thử lại.',
    mergeNow: 'Hợp nhất ngay',
    mergeOnlySelected: 'Chọn những thay đổi cần hợp nhất',
    mergeScheduledFor: 'Đã lên lịch hợp nhất vào {{date}}.',
    mergeSelectedOfTotal: '{{selected}} trên {{total}} tài liệu đã thay đổi sẽ được áp dụng.',
    mergeStarting: 'Đang bắt đầu hợp nhất…',
    merging: 'Đang hợp nhất…',
    mergingProgress: 'Đang hợp nhất {{current}} trên {{total}}',
    noChangesYet: 'Chưa có thay đổi nào trên nhánh này.',
    operation_create: 'Đã tạo',
    operation_delete: 'Đã xóa',
    operation_update: 'Đã cập nhật',
    reviewingChangedDocuments: 'Xem xét tài liệu đã thay đổi',
    scheduleAnotherMerge: 'Lên lịch hợp nhất khác',
    scheduleCancelled: 'Đã hủy lịch hợp nhất.',
    scheduleCount: '{{count}} đã lên lịch',
    scheduledMerges: 'Hợp nhất đã lên lịch',
    scheduledToMerge: 'Đã lên lịch hợp nhất',
    scheduledToMergeOn: 'Nhánh này được lên lịch hợp nhất vào {{date}}.',
    scheduleHasNothingLeft:
      'Không còn gì để áp dụng — các thay đổi này đã bị hủy hoặc đã hợp nhất.',
    scheduleMerge: 'Lên lịch hợp nhất',
    scheduleMergeHelp:
      'Việc hợp nhất chạy vào thời điểm bạn chọn, và quyền của bạn được kiểm tra lại khi đó.',
    scheduleWillApplyAll: 'Sẽ áp dụng mọi thứ đang chờ ({{count}})',
    scheduleWillApplySelected: 'Sẽ áp dụng {{count}} thay đổi đã chọn',
    scheduling: 'Đang lên lịch…',
    searchBranches: 'Tìm kiếm nhánh',
    selectBranch: 'Chọn nhánh',
    untouchedDocumentsNote:
      'Các tài liệu mà bạn chưa thay đổi trên nhánh này sẽ hiển thị nội dung hiện tại của main, chứ không phải là ảnh chụp nhanh từ thời điểm nhánh được tạo ra.',
  },
  commandPalette: {
    actions: 'Hành động',
    createNew: 'Tạo Mới',
  ...
  error: {
    ...
    fileFetchFailed: 'Không thể lấy tệp.',
    ...
    noFileFoundInClipboard: 'Không tìm thấy tệp nào trong khay nhớ tạm.',
    ...
    unableToReadClipboard: 'Không thể đọc từ bộ nhớ tạm.',
    ...
    urlNotAllowed: 'URL được cung cấp không được phép.',
  ...
  general: {
    ...
    delete: 'Xóa',
    deleted: 'Đã xóa',
    deletedAgo: 'Đã xóa cách đây {{distance}}',
    ...
    notShownInTable: 'Không hiển thị trong bảng',
