...
export const svTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'E-post verifierad framgångsrikt. Omdirigerar dig till inloggning...',
  ...
  branching: {
    andMoreChanges: '{{count}} ändringar till',
    branch: 'Gren',
    branchClosed:
      'Den här grenen är stängd. Den behålls som ett register över vad den slog samman.',
    branchDescription: 'Beskrivning av gren',
    branchedFrom: 'Förgrenad från',
    branches: 'Grenar',
    branchHistory: 'Grenhistorik',
    branchMerging: 'Slår samman',
    branchName: 'Namn på gren',
    branchSettings: 'Greninställningar',
    cancelSchedule: 'Avbryt sammanslagning',
    changedDocuments: 'Ändrade dokument',
    changesTo: 'Ändringar i {{summary}}',
    closeBranchAfterMerge: 'Stäng den här grenen efter sammanslagningen',
    closeBranchHelpOff:
      'Grenen förblir öppen, så du kan fortsätta arbeta i den och slå samman igen senare.',
    closeBranchHelpOn: 'Grenen blir skrivskyddad och kan inte slås samman igen.',
    confirmDiscardAll:
      'Alla {{count}} ändrade dokument i den här grenen återställs till sitt tillstånd på main. Det kan inte ångras.',
    confirmDiscardSelected:
      '{{count}} ändrade dokument återställs till sitt tillstånd på main. Det kan inte ångras.',
    createAndSwitch: 'Skapa och byt',
    createNewBranch: 'Skapa ny gren',
    currentChanges: 'Aktuella ändringar',
    defaultBranch: 'standard',
    discardAll: 'Ta bort alla ({{count}})',
    discardChanges: 'Ta bort ändringar',
    discardedCount: '{{count}} ändringar togs bort.',
    discarding: 'Tar bort…',
    discardSelected: 'Ta bort valda ({{count}})',
    historyPageOf: 'Sida {{page}} av {{total}}',
    manage: 'Hantera',
    manageBranches: 'Hantera grenar…',
    merge: 'Slå samman',
    mergeAllChanges: 'Alla ändringar i den här grenen tillämpas.',
    mergeAllCount: 'Alla {{count}} ändrade dokument i den här grenen tillämpas.',
    mergeBranchInto: 'Slå samman {{branch}} med {{target}}',
    mergeChanges: 'Slå samman ändringar',
    mergeComplete: 'Sammanslagning klar',
    merged: 'Sammanslagen',
    mergedByCount: '{{count}} dokument av {{user}}',
    mergedCount: '{{count}} ändringar sammanslagna.',
    mergedOfTotal: '{{current}} av {{total}} sammanslagna',
    mergedOn: 'Sammanslagen den {{date}}',
    mergeHistory: 'Sammanslagningshistorik',
    mergeInterrupted: 'Sammanslagningen avbröts och inget tillämpades. Försök igen.',
    mergeNow: 'Slå samman nu',
    mergeOnlySelected: 'Välj vilka ändringar som ska slås samman',
    mergeScheduledFor: 'Sammanslagning schemalagd till {{date}}.',
    mergeSelectedOfTotal: '{{selected}} av {{total}} ändrade dokument tillämpas.',
    mergeStarting: 'Startar sammanslagning…',
    merging: 'Slår samman…',
    mergingProgress: 'Slår samman {{current}} av {{total}}',
    noChangesYet: 'Inga ändringar i den här grenen ännu.',
    operation_create: 'Skapad',
    operation_delete: 'Borttagen',
    operation_update: 'Uppdaterad',
    reviewingChangedDocuments: 'Granskning av ändrade dokument',
    scheduleAnotherMerge: 'Schemalägg ännu en sammanslagning',
    scheduleCancelled: 'Schemalagd sammanslagning avbruten.',
    scheduleCount: '{{count}} schemalagda',
    scheduledMerges: 'Schemalagda sammanslagningar',
    scheduledToMerge: 'Sammanslagning schemalagd',
    scheduledToMergeOn: 'Den här grenen är schemalagd att slås samman den {{date}}.',
    scheduleHasNothingLeft:
      'Det finns inget kvar att tillämpa — dessa ändringar togs bort eller har redan slagits samman.',
    scheduleMerge: 'Schemalägg sammanslagning',
    scheduleMergeHelp:
      'Sammanslagningen körs vid den tid du väljer, och dina behörigheter kontrolleras igen då.',
    scheduleWillApplyAll: 'Tillämpar allt som väntar ({{count}})',
    scheduleWillApplySelected: 'Tillämpar {{count}} valda ändringar',
    scheduling: 'Schemalägger…',
    searchBranches: 'Sök grenar',
    selectBranch: 'Välj gren',
    untouchedDocumentsNote:
      'Dokument som du inte har ändrat på denna gren visar det aktuella innehållet i main, inte en ögonblicksbild från när grenen skapades.',
  },
  commandPalette: {
    actions: 'Åtgärder',
    createNew: 'Skapa ny',
  ...
  error: {
    ...
    fileFetchFailed: 'Det gick inte att hämta filen.',
    ...
    noFileFoundInClipboard: 'Ingen fil hittades i urklipp.',
    ...
    unableToReadClipboard: 'Det gick inte att läsa från urklipp.',
    ...
    urlNotAllowed: 'Den angivna URL:en är inte tillåten.',
  ...
  general: {
    ...
    delete: 'Ta bort',
    deleted: 'Raderad',
    deletedAgo: 'Raderades för {{distance}} sedan',
    ...
    notShownInTable: 'Visas inte i tabellen',
  ...
  upload: {
    ...
    fromURL: 'Ladda upp fil från URL',
    height: 'Höjd',
