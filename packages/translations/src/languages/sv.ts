...
export const svTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'Kunde inte läsa den uppladdade filen för typidentifiering.',
    couldNotReadFileForValidation: 'Det gick inte att läsa den uppladdade filen för validering.',
    crop: 'Beskär',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'Filtypen {{mimeType}} (från filtillägget {{extension}}) är inte tillåten.',
    focalPoint: 'Fokuspunkt',
    focalPointDescription:
      'Dra fokuspunkten direkt på förhandsgranskningen eller justera värdena nedan.',
    height: 'Höjd',
    invalidMimeType: 'Ogiltig MIME-typ: {{mimeType}}.',
    invalidOrCorruptedPDF: 'Ogiltig eller korrupt PDF-fil.',
    ...
    restrictedFileType:
      "Filtypen '{{mimeType}}' är inte tillåten för {{fileName}}: otillåten filtyp upptäckt — ställ in 'allowRestrictedFileTypes' till true för att hoppa över denna kontroll för denna Collection.",
    ...
    svgHarmfulContent: 'SVG-fil innehåller potentiellt skadligt innehåll.',
    width: 'Bredd',
  },
  validation: {
