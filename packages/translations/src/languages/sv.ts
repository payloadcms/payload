...
export const svTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Denna åtgärd kommer att låsa dig ute från denna förinställning.',
    attachmentContentInvalid: 'Bilagans innehåll måste vara en sträng eller buffert',
    attachmentMissingContentAndPath: 'Bilagan saknar både innehåll och sökväg',
    attachmentMissingFilename: 'Bilagan saknar filnamn',
    authenticationRequiredForExport: 'Användarautentisering krävs för att skapa exporter.',
    autosaving: 'Det uppstod ett problem när det här dokumentet skulle sparas automatiskt.',
    busboyMultipartError: 'Busboy multipart-begäran parsningsfel',
    collectionSlugRequired: 'Samlingsslug krävs',
    contentTypeExpectedJSON: 'Content-Type förväntas vara application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Antingen collection eller globalSlug måste skickas.',
    emailOrPasswordIncorrect: 'E-postadressen eller lösenordet som angivits är felaktigt.',
    expectedResponseFromUploadHandler: 'Förväntat svar från uppladdningshanteraren.',
    failedToFetchFromURL: 'Det gick inte att hämta filen från den angivna URL:en.',
    failedToResetLayout: 'Misslyckades med att återställa layouten.',
    failedToSaveLayout: 'Det gick inte att spara layouten.',
    fieldMustBeSpecified: 'fält måste anges',
    fieldsNotInitialized: 'Fälten är inte initierade.',
    filenameRequired: 'Filnamn krävs.',
    ...
    invalidFileURL: 'Ogiltig fil-URL',
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Join-fält är inte tillåtna i arrayer, block eller globaler.',
    ...
    missingIDOfVersionToRestore: 'Versions-ID att återställa saknas.',
    missingRequiredData: 'Obligatorisk data saknas.',
    noConnectionToDatabase: 'beginTransaction anropades utan databasanslutning',
    noFileDataForImport: 'Ingen fildata tillhandahölls för import',
    noFilesUploaded: 'Inga filer laddades upp.',
    noMatchedField: 'Inget matchande fält hittades för "{{label}}"',
    noPayloadProvided: 'Ingen Payload tillhandahölls',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Sorteringsbara joins måste rikta sig mot en enda samling',
    pastingFromURLNotEnabled: 'Inklistring från URL är inte aktiverad för denna samling.',
    ...
    redirectTargetNotAllowed: 'Omdirigeringsmål är inte tillåtet.',
    relationshipFieldNotFound: 'Relationsfältet hittades inte',
    relationshipNotFound: 'Relationen hittades inte',
    requestDataRequired: 'Begärandata krävs.',
    requestNotEligibleForFileUpload: 'Begäran är inte berättigad till filuppladdning',
    requestURLMissing: 'Begärans URL saknas.',
    restoringTitle:
    ...
    tooManyRedirects: 'För många omdirigeringar.',
    ...
    unexpectedArrayCollectionSlug: 'Oväntad array-samlingsslug',
    ...
    uploadConfigHandlersMissing: 'Uppladdningskonfigurationshanterare saknas',
    uploadthingUnknownError: 'Uploadthing okänt fel',
    urlNotAllowed: 'URL är inte tillåten',
    ...
    userRequiredForImport: 'Användare krävs för import',
    validURLRequired: 'Giltig URL krävs',
    valueMustBeUnique: 'Värdet måste vara unikt',
    vercelBlobUploadError: 'Vercel Blob-uppladdningsfel',
