...
export const svTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Dokument',
    draftsHint: 'Dina senaste utkast visas här',
    dropFiles: 'Släpp filer för att ladda upp',
    editDashboard: 'Redigera instrumentpanel',
    editingDashboard: 'Redigeringspanel',
    gridView: 'Rutnätsvy',
    listView: 'Listvy',
    loadError: 'Vissa dokument kunde inte läsas in. Uppdatera för att försöka igen.',
    noDrafts: 'Inga senaste utkast',
    noItems:
    ...
    noPinned: 'Inga fästa dokument',
    noRecents: 'Inga nyligen visade dokument',
    pinDocument: 'Fäst {{title}}',
    pinned: 'Fästa',
    pinnedHint: 'Dokument du fäster visas här',
    recentDrafts: 'Senaste utkast',
    recentlyViewed: 'Senast visade',
    recentsHint: 'Dokument du visar visas här',
    resetLayout: 'Återställ layout',
    saveError: 'Det gick inte att spara inställningen för översikten. Försök igen.',
    searchWidgets: 'Sök efter widget...',
    unpinDocument: 'Lossa {{title}}',
    updatedBy: 'Uppdaterad av',
    uploadDropzone: 'Uppladdningsområde',
    uploadFiles: 'Ladda upp filer',
    uploadHint: 'Dra filer från datorn eller klicka på knappen nedan',
    viewMode: 'Dokumentvy',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Justera sidhuvud och kontroller',
    all: 'Alla',
    ...
    editViewWidth: 'Redigeringsvyns bredd',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Textstorlekar',
    typeSizeSmall: 'Nuvarande',
