...
export const bnBdTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting:
      'ইমেইল সফলভাবে যাচাইকরণ হয়েছে। আপনাকে লগইন করার জন্য পুনঃনির্দেশিত করা হচ্ছে...',
    ...
    verificationFailedRequestNew:
      'আমরা আপনার অ্যাকাউন্ট যাচাই করতে পারিনি। একটি নতুন যাচাইকরণ ইমেইল অনুরোধ করুন এবং আবার চেষ্টা করুন।',
    verified: 'যাচাইকৃত',
  ...
  branching: {
    andMoreChanges: 'আরও {{count}}টি পরিবর্তন',
    branch: 'ব্রাঞ্চ',
    branchClosed: 'এই ব্রাঞ্চটি বন্ধ করা হয়েছে। কী মার্জ করা হয়েছিল তার নথি হিসেবে এটি রাখা হয়।',
    branchDescription: 'ব্রাঞ্চের বিবরণ',
    branchedFrom: 'যে ব্রাঞ্চ থেকে তৈরি',
    branches: 'ব্রাঞ্চসমূহ',
    branchHistory: 'ব্রাঞ্চের ইতিহাস',
    branchMerging: 'মার্জ হচ্ছে',
    branchName: 'ব্রাঞ্চের নাম',
    branchSettings: 'ব্রাঞ্চ সেটিংস',
    cancelSchedule: 'মার্জ বাতিল করুন',
    changedDocuments: 'পরিবর্তিত ডকুমেন্ট',
    changesTo: '{{summary}}-এ পরিবর্তন',
    closeBranchAfterMerge: 'মার্জ করার পর এই ব্রাঞ্চটি বন্ধ করুন',
    closeBranchHelpOff:
      'ব্রাঞ্চটি খোলা থাকবে, তাই আপনি এতে কাজ চালিয়ে যেতে এবং পরে আবার মার্জ করতে পারবেন।',
    closeBranchHelpOn: 'ব্রাঞ্চটি শুধু-পঠনযোগ্য হয়ে যাবে এবং আর মার্জ করা যাবে না।',
    confirmDiscardAll:
      'এই ব্রাঞ্চের সব {{count}}টি পরিবর্তিত ডকুমেন্ট main-এর অবস্থায় ফিরে যাবে। এটি ফেরানো যাবে না।',
    confirmDiscardSelected:
      '{{count}}টি পরিবর্তিত ডকুমেন্ট main-এর অবস্থায় ফিরে যাবে। এটি ফেরানো যাবে না।',
    createAndSwitch: 'তৈরি করে স্যুইচ করুন',
    createNewBranch: 'নতুন ব্রাঞ্চ তৈরি করুন',
    currentChanges: 'বর্তমান পরিবর্তন',
    defaultBranch: 'ডিফল্ট',
    discardAll: 'সব বাতিল করুন ({{count}})',
    discardChanges: 'পরিবর্তন বাতিল করুন',
    discardedCount: '{{count}}টি পরিবর্তন বাতিল করা হয়েছে।',
    discarding: 'বাতিল করা হচ্ছে…',
    discardSelected: 'নির্বাচিতগুলি বাতিল করুন ({{count}})',
    historyPageOf: 'পৃষ্ঠা {{page}} / {{total}}',
    manage: 'পরিচালনা',
    manageBranches: 'ব্রাঞ্চ পরিচালনা করুন…',
    merge: 'মার্জ',
    mergeAllChanges: 'এই ব্রাঞ্চের সব পরিবর্তন প্রয়োগ করা হবে।',
    mergeAllCount: 'এই ব্রাঞ্চের সব {{count}}টি পরিবর্তিত ডকুমেন্ট প্রয়োগ করা হবে।',
    mergeBranchInto: '{{branch}} কে {{target}}-এ মার্জ করুন',
    mergeChanges: 'পরিবর্তনগুলি মার্জ করুন',
    mergeComplete: 'মার্জ সম্পন্ন',
    merged: 'মার্জ করা',
    mergedByCount: '{{count}}টি ডকুমেন্ট – {{user}}',
    mergedCount: '{{count}}টি পরিবর্তন মার্জ করা হয়েছে।',
    mergedOfTotal: '{{total}}টির মধ্যে {{current}}টি মার্জ হয়েছে',
    mergedOn: '{{date}}-এ মার্জ করা হয়েছে',
    mergeHistory: 'মার্জের ইতিহাস',
    mergeInterrupted: 'মার্জ বাধাগ্রস্ত হয়েছে এবং কিছুই প্রয়োগ হয়নি। আবার চেষ্টা করুন।',
    mergeNow: 'এখনই মার্জ করুন',
    mergeOnlySelected: 'কোন পরিবর্তনগুলি মার্জ করবেন তা বেছে নিন',
    mergeScheduledFor: '{{date}}-এ মার্জের সময়সূচি করা হয়েছে।',
    mergeSelectedOfTotal: '{{total}}টি পরিবর্তিত ডকুমেন্টের মধ্যে {{selected}}টি প্রয়োগ করা হবে।',
    mergeStarting: 'মার্জ শুরু হচ্ছে…',
    merging: 'মার্জ করা হচ্ছে…',
    mergingProgress: '{{total}}টির মধ্যে {{current}}টি মার্জ করা হচ্ছে',
    noChangesYet: 'এই ব্রাঞ্চে এখনও কোনো পরিবর্তন নেই।',
    operation_create: 'তৈরি',
    operation_delete: 'মুছে ফেলা',
    operation_update: 'হালনাগাদ',
    reviewingChangedDocuments: 'পরিবর্তিত নথি পর্যালোচনা',
    scheduleAnotherMerge: 'আরেকটি মার্জ সময়সূচি করুন',
    scheduleCancelled: 'সময়সূচি করা মার্জ বাতিল করা হয়েছে।',
    scheduleCount: '{{count}}টি সময়সূচিতে',
    scheduledMerges: 'সময়সূচি করা মার্জ',
    scheduledToMerge: 'মার্জের সময়সূচি করা',
    scheduledToMergeOn: 'এই ব্রাঞ্চটি {{date}}-এ মার্জ করার সময়সূচি করা হয়েছে।',
    scheduleHasNothingLeft:
      'প্রয়োগ করার কিছু বাকি নেই — এই পরিবর্তনগুলি বাতিল বা ইতিমধ্যে মার্জ করা হয়েছে।',
    scheduleMerge: 'মার্জ সময়সূচি করুন',
    scheduleMergeHelp:
      'আপনি যে সময় বেছে নেবেন তখনই মার্জ চলবে, এবং তখন আপনার অনুমতি আবার যাচাই করা হবে।',
    scheduleWillApplyAll: 'অপেক্ষমাণ সবকিছু প্রয়োগ করবে ({{count}})',
    scheduleWillApplySelected: 'নির্বাচিত {{count}}টি পরিবর্তন প্রয়োগ করবে',
    scheduling: 'সময়সূচি করা হচ্ছে…',
    searchBranches: 'ব্রাঞ্চ খুঁজুন',
    selectBranch: 'ব্রাঞ্চ নির্বাচন করুন',
    untouchedDocumentsNote:
      'আপনি এই ব্রাঞ্চে যেসব Document পরিবর্তন করেননি, সেগুলোতে এই মুহূর্তে main-এর বর্তমান কনটেন্ট দেখানো হয়, ব্রাঞ্চটি তৈরি করার সময়ের একটি স্ন্যাপশট নয়।',
  },
  commandPalette: {
    actions: 'কার্যক্রমসমূহ',
    createNew: 'নতুন তৈরি করুন',
    favorites: 'প্রিয়সমূহ',
    hintActions: 'কর্মসমূহ',
    hintClose: 'বন্ধ করুন',
    hintCreate: 'নতুন তৈরি করুন',
    hintNavigate: 'পরিচালনা করুন',
    hintSelect: 'খুলুন',
    noResults: 'কোন ফলাফল পাওয়া যায়নি',
    pinToFavorites: 'প্রিয় তালিকায় পিন করুন',
    placeholder: 'একটি কমান্ড টাইপ করুন বা অনুসন্ধান করুন…',
    recentlyVisited: 'সাম্প্রতিক পরিদর্শিত',
  ...
  error: {
    ...
    fileFetchFailed: 'ফাইলটি আনতে ব্যর্থ হয়েছে।',
    ...
    noFileFoundInClipboard: 'ক্লিপবোর্ডে কোনো ফাইল পাওয়া যায়নি।',
    ...
    unableToReadClipboard: 'ক্লিপবোর্ড থেকে পড়া সম্ভব নয়।',
    ...
    urlNotAllowed: 'প্রদত্ত URL অনুমোদিত নয়।',
