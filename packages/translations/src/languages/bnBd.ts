...
export const bnBdTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'এই ক্রিয়াটি আপনাকে এই প্রিসেট থেকে লক আউট করবে।',
    attachmentContentInvalid: 'সংযুক্তির বিষয়বস্তু একটি স্ট্রিং বা বাফার হতে হবে',
    attachmentMissingContentAndPath: 'সংযুক্তিতে বিষয়বস্তু এবং পাথ উভয়ই নেই',
    attachmentMissingFilename: 'সংযুক্তিতে ফাইলের নাম নেই',
    authenticationRequiredForExport: 'এক্সপোর্ট তৈরি করতে ব্যবহারকারী প্রমাণীকরণ প্রয়োজন।',
    autosaving: 'এই ডকুমেন্টটি স্বয়ংক্রিয়ভাবে সংরক্ষণ করার সময় একটি সমস্যা হয়েছে।',
    busboyMultipartError: 'Busboy মাল্টিপার্ট অনুরোধ পার্স করতে ত্রুটি',
    collectionSlugRequired: 'সংগ্রহ স্লাগ প্রয়োজন',
    contentTypeExpectedJSON: 'Content-Type application/json হবে বলে প্রত্যাশিত',
    ...
    eitherCollectionOrGlobalRequired: 'সংগ্রহ বা globalSlug এর যেকোনো একটি পাস করতে হবে।',
    emailOrPasswordIncorrect: 'প্রদত্ত ইমেইল বা পাসওয়ার্ড ভুল।',
    expectedResponseFromUploadHandler: 'আপলোড হ্যান্ডলার থেকে প্রতিক্রিয়া প্রত্যাশিত।',
    failedToFetchFromURL: 'প্রদত্ত URL থেকে ফাইল আনতে ব্যর্থ হয়েছে।',
    failedToResetLayout: 'লেআউট রিসেট করতে ব্যর্থ হয়েছে।',
    failedToSaveLayout: 'লেআউট সংরক্ষণ করতে ব্যর্থ হয়েছে।',
    fieldMustBeSpecified: 'ক্ষেত্র নির্দিষ্ট করতে হবে',
    fieldsNotInitialized: 'ক্ষেত্রগুলি আরম্ভ করা হয়নি।',
    filenameRequired: 'একটি ফাইলের নাম প্রয়োজন।',
    ...
    missingIDOfVersionToRestore: 'পুনরুদ্ধার করার জন্য সংস্করণের আইডি নেই।',
    missingRequiredData: 'প্রয়োজনীয় ডেটা নেই।',
    noConnectionToDatabase: 'ডাটাবেসের সাথে কোনো সংযোগ না থাকলে beginTransaction কল করা হয়েছে',
    noFileDataForImport: 'ইম্পোর্টের জন্য কোনো ফাইল ডেটা প্রদান করা হয়নি',
    noFilesUploaded: 'কোনো ফাইল আপলোড করা হয়নি।',
    noMatchedField: '"{{label}}" এর জন্য কোনো মিল পাওয়া যায়নি',
    noPayloadProvided: 'কোনো পেলোড প্রদান করা হয়নি',
    ...
    orderableJoinsMustTargetSingleCollection:
      'ক্রমবদ্ধযোগ্য জয়েনগুলিকে একটি একক সংগ্রহ টার্গেট করতে হবে',
    pastingFromURLNotEnabled: 'এই সংগ্রহের জন্য URL থেকে পেস্ট করা সক্ষম নয়।',
    previewing: 'এই ডকুমেন্টটি প্রিভিউ করতে একটি সমস্যা হয়েছে।',
    problemUploadingFile: 'ফাইল আপলোড করতে একটি সমস্যা হয়েছে।',
    redirectTargetNotAllowed: 'রিডাইরেক্ট টার্গেট অনুমোদিত নয়।',
    relationshipFieldNotFound: 'সম্পর্ক ক্ষেত্র পাওয়া যায়নি',
    relationshipNotFound: 'সম্পর্ক পাওয়া যায়নি',
    requestDataRequired: 'অনুরোধ ডেটা প্রয়োজন।',
    requestNotEligibleForFileUpload: 'অনুরোধ ফাইল আপলোডের জন্য যোগ্য নয়',
    requestURLMissing: 'অনুরোধ URL নেই।',
    restoringTitle:
    ...
    tooManyRedirects: 'অত্যধিক রিডাইরেক্ট।',
    ...
    unexpectedArrayCollectionSlug:
      'collectionSlug এর অপ্রত্যাশিত অ্যারে, প্যারেন্ট প্রদান করতে হবে',
    unknown: 'একটি অজানা ত্রুটি হয়েছে।',
    unPublishingDocument: 'এই ডকুমেন্টটি আনপাবলিশ করতে একটি সমস্যা হয়েছে।',
    unreachable: 'পৌঁছানো যায় না',
    unspecific: 'একটি ত্রুটি হয়েছে।',
    unverifiedEmail: 'লগইন করার আগে আপনার ইমেইল যাচাই করুন।',
    uploadConfigHandlersMissing: '{{collection}} এর জন্য uploadConfig.handlers উপস্থিত নেই',
    uploadthingUnknownError: 'uploadthing দিয়ে ফাইল আপলোড করতে ত্রুটি: অজানা ত্রুটি',
    ...
    userRequiredForImport: 'ইম্পোর্ট অপারেশনের জন্য ব্যবহারকারী প্রয়োজন',
    validURLRequired: 'একটি বৈধ URL স্ট্রিং প্রয়োজন।',
    valueMustBeUnique: 'মানটি অনন্য হতে হবে',
    vercelBlobUploadError: 'storage-vercel-blob ক্লায়েন্ট আপলোড রুট ত্রুটি',
