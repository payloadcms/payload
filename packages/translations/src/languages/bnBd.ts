...
export const bnBdTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'টাইপ সনাক্তকরণের জন্য আপলোডকৃত ফাইলটি পড়া যায়নি।',
    couldNotReadFileForValidation: 'যাচাইয়ের জন্য আপলোড করা ফাইলটি পড়া যায়নি।',
    crop: 'ক্রপ করুন',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'ফাইলের ধরন {{mimeType}} (এক্সটেনশন {{extension}} থেকে) অনুমোদিত নয়।',
    focalPoint: 'ফোকাল পয়েন্ট',
    focalPointDescription: 'প্রিভিউতে সরাসরি ফোকাল পয়েন্ট টানুন বা নিচের মানগুলি সামঞ্জস্য করুন।',
    height: 'উচ্চতা',
    invalidMimeType: 'অবৈধ MIME ধরন: {{mimeType}}.',
    invalidOrCorruptedPDF: 'অবৈধ অথবা দুর্নীতিগ্রস্ত PDF ফাইল।',
    lessInfo: 'কম তথ্য',
    moreInfo: 'আরও তথ্য',
    ...
    restrictedFileType:
      "ফাইল টাইপ '{{mimeType}}' {{fileName}}-এর জন্য অনুমোদিত নয়: সীমাবদ্ধ ফাইল টাইপ শনাক্ত করা হয়েছে — এই collection-এর জন্য এই যাচাই এড়ানোর জন্য 'allowRestrictedFileTypes'কে true হিসেবে নির্ধারণ করুন।",
    ...
    svgHarmfulContent: 'SVG ফাইলে সম্ভাব্য ক্ষতিকর বিষয়বস্তু রয়েছে।',
    width: 'প্রস্থ',
  },
  validation: {
