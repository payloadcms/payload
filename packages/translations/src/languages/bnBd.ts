...
export const bnBdTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'নথি',
    draftsHint: 'আপনার সাম্প্রতিক খসড়াগুলো এখানে দেখাবে',
    dropFiles: 'আপলোড করতে ফাইল ছেড়ে দিন',
    editDashboard: 'ড্যাশবোর্ড সম্পাদনা করুন',
    editingDashboard: 'ড্যাশবোর্ড সম্পাদনা করুন',
    gridView: 'গ্রিড দৃশ্য',
    listView: 'তালিকা দৃশ্য',
    loadError: 'কিছু নথি লোড করা যায়নি। আবার চেষ্টা করতে পৃষ্ঠা রিফ্রেশ করুন।',
    noDrafts: 'কোনো সাম্প্রতিক খসড়া নেই',
    noItems:
      'আপনার ড্যাশবোর্ডে কোনো উইজেট নেই। আপনি তা শীর্ষ বারে অবস্থিত "ড্যাশবোর্ড" মেনু থেকে যোগ করতে পারেন।',
    noPinned: 'কোনো পিন করা নথি নেই',
    noRecents: 'সম্প্রতি দেখা কোনো নথি নেই',
    pinDocument: '{{title}} পিন করুন',
    pinned: 'পিন করা',
    pinnedHint: 'আপনার পিন করা নথিগুলো এখানে দেখাবে',
    recentDrafts: 'সাম্প্রতিক খসড়া',
    recentlyViewed: 'সম্প্রতি দেখা',
    recentsHint: 'আপনার দেখা নথিগুলো এখানে দেখাবে',
    resetLayout: 'লেআউট রিসেট করুন',
    saveError: 'ড্যাশবোর্ডের পছন্দ সংরক্ষণ করা যায়নি। আবার চেষ্টা করুন।',
    searchWidgets: 'উইজেটগুলি অনুসন্ধান করুন...',
    unpinDocument: '{{title}} আনপিন করুন',
    updatedBy: 'হালনাগাদ করেছেন',
    uploadDropzone: 'আপলোড এলাকা',
    uploadFiles: 'ফাইল আপলোড করুন',
    uploadHint: 'কম্পিউটার থেকে ফাইল টেনে আনুন অথবা নিচের বোতামে ক্লিক করুন',
    viewMode: 'নথির দৃশ্য',
  ...
  general: {
    ...
    alignHeaderAndControls: 'হেডার ও নিয়ন্ত্রণগুলো সারিবদ্ধ করুন',
    all: 'সমস্ত',
    ...
    editViewWidth: 'সম্পাদনা দৃশ্যের প্রস্থ',
    editViewWidthFull: 'পূর্ণ',
    email: 'ইমেইল',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'লেখার আকার',
    typeSizeSmall: 'বর্তমান',
