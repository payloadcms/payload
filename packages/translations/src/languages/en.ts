...
export const enTranslations = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'Email verified successfully. Redirecting you to log in...',
  ...
  branching: {
    andMoreChanges: '{{count}} more change(s)',
    branch: 'Branch',
    branchClosed: 'This branch is closed. It is kept as a record of what it merged.',
    ...
    cancelSchedule: 'Cancel merge',
    changedDocuments: 'Changed documents',
    changesTo: 'Changes to {{summary}}',
    closeBranchAfterMerge: 'Close this branch after merging',
    closeBranchHelpOff:
      'The branch stays open, so you can keep working on it and merge again later.',
    closeBranchHelpOn: 'The branch becomes read-only and cannot be merged again.',
    confirmDiscardAll:
      'All {{count}} changed document(s) on this branch will be reverted to their state on main. This cannot be undone.',
    confirmDiscardSelected:
      '{{count}} changed document(s) will be reverted to their state on main. This cannot be undone.',
    createAndSwitch: 'Create and switch',
    createNewBranch: 'Create new branch',
    currentChanges: 'Current changes',
    defaultBranch: 'default',
    discardAll: 'Discard all ({{count}})',
    discardChanges: 'Discard changes',
    discardedCount: '{{count}} change(s) discarded.',
    discarding: 'Discarding…',
    discardSelected: 'Discard selected ({{count}})',
    historyPageOf: 'Page {{page}} of {{total}}',
    manage: 'Manage',
    manageBranches: 'Manage branches…',
    merge: 'Merge',
    mergeAllChanges: 'Every change on this branch will be applied.',
    mergeAllCount: 'All {{count}} changed document(s) on this branch will be applied.',
    mergeBranchInto: 'Merge {{branch}} into {{target}}',
    mergeChanges: 'Merge changes',
    mergeComplete: 'Merge complete',
    merged: 'Merged',
    mergedByCount: '{{count}} document(s) by {{user}}',
    mergedCount: '{{count}} change(s) merged.',
    mergedOfTotal: '{{current}} of {{total}} merged',
    mergedOn: 'Merged on {{date}}',
    mergeHistory: 'Merge history',
    mergeInterrupted: 'The merge was interrupted and nothing was applied. Try again.',
    mergeNow: 'Merge now',
    mergeOnlySelected: 'Choose which changes to merge',
    mergeScheduledFor: 'Merge scheduled for {{date}}.',
    mergeSelectedOfTotal: '{{selected}} of {{total}} changed document(s) will be applied.',
    mergeStarting: 'Starting merge…',
    merging: 'Merging…',
    mergingProgress: 'Merging {{current}} of {{total}}',
    noChangesYet: 'No changes on this branch yet.',
    operation_create: 'Created',
    operation_delete: 'Deleted',
    operation_update: 'Updated',
    reviewingChangedDocuments: 'Reviewing changed documents',
    scheduleAnotherMerge: 'Schedule another merge',
    scheduleCancelled: 'Scheduled merge cancelled.',
    scheduleCount: '{{count}} scheduled',
    scheduledMerges: 'Scheduled merges',
    scheduledToMerge: 'Scheduled to merge',
    scheduledToMergeOn: 'This branch is scheduled to merge on {{date}}.',
    scheduleHasNothingLeft:
      'Nothing is left to apply — these changes were discarded or already merged.',
    scheduleMerge: 'Schedule merge',
    scheduleMergeHelp:
      'The merge runs at the time you choose, with your permissions checked again then.',
    scheduleWillApplyAll: 'Will apply everything pending ({{count}})',
    scheduleWillApplySelected: 'Will apply {{count}} selected change(s)',
    scheduling: 'Scheduling…',
    searchBranches: 'Search branches',
    selectBranch: 'Select branch',
    untouchedDocumentsNote:
      "Documents you haven't changed on this branch show main's current content, not a snapshot from when the branch was created.",
  },
  commandPalette: {
    actions: 'Actions',
  ...
  error: {
    ...
    fileFetchFailed: 'Failed to fetch the file.',
    ...
    noFileFoundInClipboard: 'No file found in clipboard.',
    ...
    unableToReadClipboard: 'Unable to read from clipboard.',
  ...
  general: {
    ...
    delete: 'Delete',
    deleted: 'Deleted',
    deletedAgo: 'Deleted {{distance}} ago',
  ...
  version: {
    ...
    lastSavedAgo: 'Saved {{distance}} ago',
