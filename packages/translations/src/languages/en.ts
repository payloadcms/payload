...
export const enTranslations = {
  ...
  dashboard: {
    ...
    documents: 'Documents',
    draftsHint: 'Your recent drafts will appear here',
    dropFiles: 'Drop files to upload',
    editDashboard: 'Edit Dashboard',
    editingDashboard: 'Editing Dashboard',
    gridView: 'Grid view',
    listView: 'List view',
    loadError: 'Some documents could not be loaded. Please refresh to try again.',
    noDrafts: 'No recent drafts',
    noItems:
      'There are no widgets on your dashboard. You can add them from the "Dashboard" menu located in the top bar.',
    noPinned: 'No pinned documents',
    noRecents: 'No recently viewed documents',
    pinDocument: 'Pin {{title}}',
    pinned: 'Pinned',
    pinnedHint: 'Documents you pin will appear here',
    recentDrafts: 'Recent drafts',
    recentlyViewed: 'Recently viewed',
    recentsHint: 'Documents you view will appear here',
    resetLayout: 'Reset Layout',
    saveError: 'Your dashboard preference could not be saved. Please try again.',
    searchWidgets: 'Search widgets...',
    unpinDocument: 'Unpin {{title}}',
    updatedBy: 'Updated by',
    uploadDropzone: 'Upload dropzone',
    uploadFiles: 'Upload files',
    uploadHint: 'Upload from your computer via drag-and-drop, or click the button below',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Align header and controls',
    all: 'All',
