...
export const enTranslations = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'Could not read uploaded file for type detection.',
    couldNotReadFileForValidation: 'Could not read uploaded file for validation.',
    crop: 'Crop',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'File type {{mimeType}} (from extension {{extension}}) is not allowed.',
    focalPoint: 'Focal Point',
    focalPointDescription:
      'Drag the focal point directly on the preview or adjust the values below.',
    height: 'Height',
    invalidMimeType: 'Invalid MIME type: {{mimeType}}.',
    invalidOrCorruptedPDF: 'Invalid or corrupted PDF file.',
    lessInfo: 'Less info',
    moreInfo: 'More info',
    noFile: 'No file',
    pasteURL: 'Paste URL',
    ...
    restrictedFileType:
      "File type '{{mimeType}}' not allowed for {{fileName}}: restricted file type detected — set 'allowRestrictedFileTypes' to true to skip this check for this collection.",
    ...
    svgHarmfulContent: 'SVG file contains potentially harmful content.',
    width: 'Width',
  },
  validation: {
