...
export const zhTwTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    addFiles: '新增多個檔案',
    bulkUpload: '大量上傳',
    couldNotReadFileForTypeDetection: '無法讀取上傳的檔案以進行類型檢測。',
    couldNotReadFileForValidation: '無法讀取上傳的檔案以進行驗證。',
    crop: '裁剪',
    ...
    fileToUpload: '待上傳的檔案',
    fileTypeNotAllowed: '檔案類型 {{mimeType}}（自副檔名 {{extension}} 判斷）不被允許。',
    focalPoint: '對焦點',
    focalPointDescription: '直接在預覽圖上拖曳以設定對焦點，或調整下方數值。',
    height: '高度',
    invalidMimeType: '無效的 MIME 類型：{{mimeType}}。',
    invalidOrCorruptedPDF: '無效或損壞的 PDF 檔案。',
    lessInfo: '顯示較少資訊',
    moreInfo: '顯示更多資訊',
    noFile: '無檔案',
    pasteURL: '貼上網址',
    previewSizes: '預覽尺寸',
    restrictedFileType:
      "檔案類型 '{{mimeType}}' 不允許用於 {{fileName}}：偵測到受限制的檔案類型—請將 'allowRestrictedFileTypes' 設為 true，以略過此 Collection 的此檢查。",
    ...
    sizes: '尺寸',
    sizesFor: '{{label}} 的尺寸',
    svgHarmfulContent: 'SVG 檔案包含可能有害的內容。',
    width: '寬度',
  },
  validation: {
