...
export const zhTwTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: '此操作將使您無法存取此預設設定。',
    attachmentContentInvalid: '附件內容必須是字串或緩衝區',
    attachmentMissingContentAndPath: '附件缺少內容和路徑',
    attachmentMissingFilename: '附件缺少檔案名稱',
    authenticationRequiredForExport: '建立匯出需要使用者驗證。',
    autosaving: '自動儲存文件時發生問題。',
    busboyMultipartError: 'Busboy 解析 multipart 請求時發生錯誤',
    collectionSlugRequired: '需要 Collection slug',
    contentTypeExpectedJSON: 'Content-Type 應為 application/json',
    ...
    eitherCollectionOrGlobalRequired: '必須傳遞 collection 或 globalSlug。',
    emailOrPasswordIncorrect: '電子郵件或密碼錯誤。',
    expectedResponseFromUploadHandler: '預期從上傳處理程序獲得回應。',
    failedToFetchFromURL: '無法從提供的網址擷取檔案。',
    failedToResetLayout: '無法重設版面配置。',
    failedToSaveLayout: '保存布局失败。',
    fieldMustBeSpecified: '必須指定欄位',
    fieldsNotInitialized: '欄位尚未初始化。',
    filenameRequired: '需要檔案名稱。',
    ...
    invalidFileURL: '檔案網址無效',
    invalidJSON: '無效的 JSON',
    invalidJSONFormat: '無效的 JSON 格式',
    invalidRequestArgs: '請求中傳入的參數無效：{{args}}',
    joinFieldsNotAllowedInArraysBlocksOrGlobals: 'Join 欄位無法加入陣列、區塊或全域。',
    ...
    missingIDOfVersionToRestore: '缺少要還原的版本 ID。',
    missingRequiredData: '缺少必要資料。',
    noConnectionToDatabase: 'beginTransaction 被呼叫時沒有連線到資料庫',
    noFileDataForImport: '未提供匯入檔案資料',
    noFilesUploaded: '尚未上傳任何檔案。',
    noMatchedField: '找不到對應欄位：「{{label}}」',
    noPayloadProvided: '未提供 payload',
    notAllowedToAccessPage: '您沒有權限存取此頁面。',
    notAllowedToPerformAction: '您沒有執行此操作的權限。',
    notFound: '找不到所請求的資源。',
    notSupported: '不支援',
    noUser: '找不到使用者',
    orderableJoinsMustTargetSingleCollection: '可排序的 join 必須針對單一 collection',
    pastingFromURLNotEnabled: '此 collection 未啟用從網址貼上。',
    previewing: '預覽文件時發生問題。',
    problemUploadingFile: '上傳檔案時發生問題。',
    redirectTargetNotAllowed: '不允許重新導向目標。',
    relationshipFieldNotFound: '找不到關聯欄位',
    relationshipNotFound: '找不到關聯',
    requestDataRequired: '需要請求資料。',
    requestNotEligibleForFileUpload: '請求不符合檔案上傳資格',
    requestURLMissing: '請求網址缺少。',
    ...
    unexpectedArrayCollectionSlug: '非預期的陣列 collection slug',
    unknown: '發生未知錯誤。',
    unPublishingDocument: '取消發佈文件時發生問題。',
    unreachable: '無法存取',
    unspecific: '發生錯誤。',
    unverifiedEmail: '請先完成電子郵件驗證後再登入。',
    uploadConfigHandlersMissing: '上傳設定處理程序缺少',
    uploadthingUnknownError: 'Uploadthing 發生未知錯誤',
    urlNotAllowed: '不允許此網址',
    ...
    userRequiredForImport: '匯入需要使用者',
    validURLRequired: '需要有效的網址',
    valueMustBeUnique: '此欄位的值必須是唯一的',
    vercelBlobUploadError: 'Vercel Blob 上傳錯誤',
