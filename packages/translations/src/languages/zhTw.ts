...
export const zhTwTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    discardTitle: '放棄變更？',
    documents: '文件',
    draftsHint: '最近的草稿將顯示在這裡',
    dropFiles: '將檔案拖放到此處上傳',
    editDashboard: '編輯儀表板',
    editingDashboard: '編輯儀表板',
    gridView: '格狀檢視',
    listView: '清單檢視',
    loadError: '部分文件無法載入。請重新整理頁面後再試。',
    noDrafts: '沒有最近的草稿',
    noItems: '您的儀表板上沒有小工具。您可以從頂部工具欄中的"儀表板"選單添加它們。',
    noPinned: '沒有釘選的文件',
    noRecents: '沒有最近瀏覽的文件',
    pinDocument: '釘選 {{title}}',
    pinned: '已釘選',
    pinnedHint: '釘選的文件將顯示在這裡',
    recentDrafts: '最近草稿',
    recentlyViewed: '最近瀏覽',
    recentsHint: '瀏覽過的文件將顯示在這裡',
    resetLayout: '重設版面配置',
    saveError: '無法儲存儀表板偏好設定。請再試一次。',
    searchWidgets: '搜索小工具...',
    unpinDocument: '取消釘選 {{title}}',
    updatedBy: '更新者',
    uploadDropzone: '上傳區域',
    uploadFiles: '上傳檔案',
    uploadHint: '從電腦拖放檔案，或點擊下方按鈕',
    viewMode: '文件檢視',
  ...
  general: {
    ...
    addFilter: '新增篩選條件',
    adminTheme: '管理主題',
    alignHeaderAndControls: '對齊標題與控制項',
    all: '全部',
    allCollections: '所有集合',
    allLocales: '所有語言地區',
    and: '與',
    ...
    editLabel: '編輯 {{label}}',
    editViewWidth: '編輯檢視寬度',
    editViewWidthFull: '全寬',
    email: '電子郵件',
    emailAddress: '電子郵件地址',
    emptyTrash: '清空垃圾桶',
