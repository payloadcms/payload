...
export const zhTwTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    discardMessage: '您的儀表板版面配置有尚未儲存的變更。確定要捨棄這些變更嗎？',
    discardTitle: '捨棄變更？',
    editDashboard: '編輯儀表板',
    editingDashboard: '編輯儀表板',
    noItems: '您的儀表板上沒有小工具。您可以從頂端工具列的「儀表板」選單新增小工具。',
    resetLayout: '重設版面配置',
    searchWidgets: '搜尋小工具…',
    widgetCollectionRequired: 'Collection 為必填項目。',
    widgetConfigurationError: '小工具設定錯誤',
  ...
  general: {
    ...
    expand: '展開',
    export: '匯出',
    fallbackToDefaultLocale: '改用預設語言地區',
    false: '否',
    field: '欄位',
    filter: '篩選',
    filters: '篩選條件',
    ...
    noResultsDescription: '可能尚無任何項目，或沒有項目符合上方指定的篩選條件。',
    noResultsFound: '沒有結果。',
    notFound: '找不到',
    nothingFound: '查無資料',
    ...
    sortByOrderToReorder: '若要重新排列各列，請先依「順序」欄位排序。',
  ...
  localization: {
    ...
    selectedLocales: '已選取的語言地區',
    selectLocaleToCopy: '選取要複製的語言地區',
    selectLocaleToDuplicate: '選取要複製的語言地區',
  },
  operators: {
    contains: '包含',
    equals: '等於',
  ...
  version: {
    ...
    aboutToUnpublishIn: '您即將在 {{locale}} 中取消發佈此文件。確定要繼續？',
    ...
    revertUnsuccessful: '還原失敗。找不到先前已發佈的版本。',
    saveDraft: '儲存草稿',
