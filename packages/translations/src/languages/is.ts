...
export const isTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Þessi aðgerð mun loka þig úr þessari forstillingu.',
    attachmentContentInvalid: 'Innihald viðhengis verður að vera strengur eða biðminni',
    attachmentMissingContentAndPath: 'Viðhengi vantar bæði innihald og slóð',
    attachmentMissingFilename: 'Viðhengi vantar skráarheiti',
    authenticationRequiredForExport: 'Notendaauðkenning er nauðsynleg til að búa til útflutning.',
    autosaving: 'Villa kom upp við sjálfvirka vistun á færslu.',
    busboyMultipartError: 'Busboy villa við að þátta multipart beiðni',
    collectionSlugRequired: 'Safn slug er nauðsynlegt',
    contentTypeExpectedJSON: 'Content-Type ætti að vera application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Annað hvort collection eða globalSlug verður að vera sent.',
    emailOrPasswordIncorrect: 'Netfangið eða lykilorðið sem gefið var upp er rangt.',
    expectedResponseFromUploadHandler: 'Átti von á svari frá upphleðslustjórnanda.',
    failedToFetchFromURL: 'Mistókst að sækja skrá frá uppgefinni URL.',
    failedToResetLayout: 'Mistókst við að endurstilla útlit.',
    failedToSaveLayout: 'Mistókst við að vista útlag.',
    fieldMustBeSpecified: 'reitur verður að vera tilgreindur',
    fieldsNotInitialized: 'Reitir eru ekki frumstilltir.',
    filenameRequired: 'Skráarheiti er nauðsynlegt.',
    ...
    missingIDOfVersionToRestore: 'Vantar auðkenni útgáfu til að endurheimta.',
    missingRequiredData: 'Vantar nauðsynleg gögn.',
    noConnectionToDatabase:
      'beginTransaction kallað á meðan engin tenging við gagnagrunn er til staðar',
    noFileDataForImport: 'Engin skráargögn gefin upp fyrir innflutning',
    noFilesUploaded: 'Engum skrám var hlaðið upp.',
    noMatchedField: 'Ekkert samsvarandi svæði fannst fyrir "{{label}}"',
    noPayloadProvided: 'Engin Payload var gefin upp',
    ...
    orderableJoinsMustTargetSingleCollection: 'Raðanlegar tengingar verða að miða á eitt safn',
    pastingFromURLNotEnabled: 'Að líma frá URL er ekki virkt fyrir þetta safn.',
    previewing: 'Vandamál kom upp við að forskoða þessa færslu.',
    problemUploadingFile: 'Vandamál kom upp við að hlaða upp skránni.',
    redirectTargetNotAllowed: 'Áframsendingarhlutur er ekki leyfður.',
    relationshipFieldNotFound: 'Tengingarreitur fannst ekki',
    relationshipNotFound: 'Tenging fannst ekki',
    requestDataRequired: 'Beiðnigögn eru nauðsynleg.',
    requestNotEligibleForFileUpload: 'Beiðni uppfyllir ekki skilyrði fyrir skráarupphleðslu',
    requestURLMissing: 'Beiðni URL vantar.',
    restoringTitle:
    ...
    tooManyRedirects: 'Of margar áframsendingar.',
    ...
    unexpectedArrayCollectionSlug:
      'Óvænt fylki af collectionSlug, foreldri verður að vera gefið upp',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers er ekki til staðar fyrir {{collection}}',
    uploadthingUnknownError: 'Villa við að hlaða upp skrá með uploadthing: Óþekkt villa',
    urlNotAllowed: 'Uppgefin URL er ekki leyfð.',
    ...
    userRequiredForImport: 'Notandi er nauðsynlegur fyrir innflutningsaðgerðir',
    validURLRequired: 'Gildur URL strengur er nauðsynlegur.',
    valueMustBeUnique: 'Gildi verður að vera einstakt',
    vercelBlobUploadError: 'storage-vercel-blob villa á upphleðsluslóð biðlara',
