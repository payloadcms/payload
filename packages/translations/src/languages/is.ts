...
export const isTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: '{{count}} breytingar til viðbótar',
    branch: 'Grein',
    branchClosed:
      'Þessi grein er lokuð. Henni er haldið til haga sem skrá yfir það sem hún sameinaði.',
    branchDescription: 'Lýsing greinar',
    branchedFrom: 'Greint frá',
    branches: 'Greinar',
    branchHistory: 'Ferill greinar',
    branchMerging: 'Sameinar',
    branchName: 'Nafn greinar',
    branchSettings: 'Stillingar greinar',
    cancelSchedule: 'Hætta við sameiningu',
    changedDocuments: 'Breytt skjöl',
    changesTo: 'Breytingar á {{summary}}',
    closeBranchAfterMerge: 'Loka þessari grein eftir sameiningu',
    closeBranchHelpOff:
      'Greinin er áfram opin, svo þú getur haldið áfram að vinna í henni og sameinað aftur síðar.',
    closeBranchHelpOn: 'Greinin verður aðeins til lestrar og verður ekki sameinuð aftur.',
    confirmDiscardAll:
      'Öll {{count}} breytt skjöl í þessari grein færast til baka í stöðu sína á main. Þetta er ekki afturkræft.',
    confirmDiscardSelected:
      '{{count}} breytt skjöl færast til baka í stöðu sína á main. Þetta er ekki afturkræft.',
    createAndSwitch: 'Búa til og skipta',
    createNewBranch: 'Búa til nýja grein',
    currentChanges: 'Núverandi breytingar',
    defaultBranch: 'sjálfgefið',
    discardAll: 'Hafna öllum ({{count}})',
    discardChanges: 'Hafna breytingum',
    discardedCount: '{{count}} breytingum hafnað.',
    discarding: 'Hafnar…',
    discardSelected: 'Hafna völdum ({{count}})',
    historyPageOf: 'Síða {{page}} af {{total}}',
    manage: 'Stjórna',
    manageBranches: 'Stjórna greinum…',
    merge: 'Sameina',
    mergeAllChanges: 'Allar breytingar í þessari grein verða settar inn.',
    mergeAllCount: 'Öll {{count}} breytt skjöl í þessari grein verða sett inn.',
    mergeBranchInto: 'Sameina {{branch}} við {{target}}',
    mergeChanges: 'Sameina breytingar',
    mergeComplete: 'Sameiningu lokið',
    merged: 'Sameinuð',
    mergedByCount: '{{count}} skjöl eftir {{user}}',
    mergedCount: '{{count}} breytingar sameinaðar.',
    mergedOfTotal: '{{current}} af {{total}} sameinuð',
    mergedOn: 'Sameinað {{date}}',
    mergeHistory: 'Ferill sameininga',
    mergeInterrupted: 'Sameiningin var stöðvuð og ekkert var sett inn. Prófaðu aftur.',
    mergeNow: 'Sameina núna',
    mergeOnlySelected: 'Veldu hvaða breytingar á að sameina',
    mergeScheduledFor: 'Sameining tímasett {{date}}.',
    mergeSelectedOfTotal: '{{selected}} af {{total}} breyttum skjölum verða sett inn.',
    mergeStarting: 'Sameining hefst…',
    merging: 'Sameinar…',
    mergingProgress: 'Sameinar {{current}} af {{total}}',
    noChangesYet: 'Engar breytingar á þessari grein enn.',
    operation_create: 'Stofnað',
    operation_delete: 'Eytt',
    operation_update: 'Uppfært',
    reviewingChangedDocuments: 'Yfirferð breyttra skjala',
    scheduleAnotherMerge: 'Tímasetja aðra sameiningu',
    scheduleCancelled: 'Tímasettri sameiningu hætt.',
    scheduleCount: '{{count}} tímasettar',
    scheduledMerges: 'Tímasettar sameiningar',
    scheduledToMerge: 'Sameining tímasett',
    scheduledToMergeOn: 'Þessi grein er tímasett til sameiningar {{date}}.',
    scheduleHasNothingLeft:
      'Ekkert er eftir til að setja inn — þessum breytingum var hafnað eða þær hafa þegar verið sameinaðar.',
    scheduleMerge: 'Tímasetja sameiningu',
    scheduleMergeHelp:
      'Sameiningin fer fram á valdri tímasetningu og réttindi þín eru athuguð aftur þá.',
    scheduleWillApplyAll: 'Setur inn allt sem bíður ({{count}})',
    scheduleWillApplySelected: 'Setur inn {{count}} valdar breytingar',
    scheduling: 'Tímasetur…',
    searchBranches: 'Leita í greinum',
    selectBranch: 'Velja grein',
    untouchedDocumentsNote:
      'Skjöl sem þú hefur ekki breytt á þessari greinin sýna núverandi innihald main, ekki smámynd frá því greinin var stofnuð.',
  },
  commandPalette: {
    actions: 'Aðgerðir',
    createNew: 'Búa til nýtt',
    favorites: 'Uppáhalds',
    hintActions: 'Aðgerðir',
    hintClose: 'Loka',
    hintCreate: 'Búa til nýtt',
    hintNavigate: 'Fara yfir',
    hintSelect: 'Opið',
    noResults: 'Engin niðurstaða fannst',
    pinToFavorites: 'Festa á uppáhalds',
    placeholder: 'Sláðu inn skipun eða leitaðu…',
    recentlyVisited: 'Nýlega heimsótt',
  ...
  error: {
    ...
    fileFetchFailed: 'Mistókst að ná í skjalið.',
    ...
    noFileFoundInClipboard: 'Engin skrá fannst á klippispjaldinu.',
    ...
    unableToReadClipboard: 'Ekki tókst að lesa úr klippispjaldinu.',
    ...
    urlNotAllowed: 'Uppgefin vefslóð er ekki leyfð.',
  ...
  general: {
    ...
    delete: 'Eyða',
    deleted: 'Eytt',
    deletedAgo: 'Eydduð fyrir {{distance}} síðan',
    deletedAt: 'Eytt',
  ...
  upload: {
    ...
    fromURL: 'Hladdu inn skrá úr slóð',
    height: 'Hæð',
  ...
  version: {
    ...
    lastSavedAgo: 'Vistað {{distance}} síðan',
