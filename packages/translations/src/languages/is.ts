...
export const isTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Skjöl',
    draftsHint: 'Nýleg drög þín birtast hér',
    dropFiles: 'Slepptu skrám til að hlaða upp',
    editDashboard: 'Breyta mælaborði',
    editingDashboard: 'Breytaborð Breytingar',
    gridView: 'Reitasýn',
    listView: 'Listasýn',
    loadError: 'Ekki tókst að hlaða sumum skjölum. Endurhladdu til að reyna aftur.',
    noDrafts: 'Engin nýleg drög',
    noItems:
      'Það eru engar flísar á mælaborðinu þínu. Þú getur bætt þeim við úr "Mælaborði" valmyndinni sem er staðsett í efsta stikanum.',
    noPinned: 'Engin fest skjöl',
    noRecents: 'Engin nýlega skoðuð skjöl',
    pinDocument: 'Festa {{title}}',
    pinned: 'Fest',
    pinnedHint: 'Skjöl sem þú festir birtast hér',
    recentDrafts: 'Nýleg drög',
    recentlyViewed: 'Nýlega skoðað',
    recentsHint: 'Skjöl sem þú skoðar birtast hér',
    resetLayout: 'Endurstilla útlit',
    saveError: 'Ekki tókst að vista stillingu stjórnborðsins. Reyndu aftur.',
    searchWidgets: 'Leita að græjum...',
    unpinDocument: 'Losa {{title}}',
    updatedBy: 'Uppfært af',
    uploadDropzone: 'Upphleðslusvæði',
    uploadFiles: 'Hlaða upp skrám',
    uploadHint: 'Dragðu skrár úr tölvunni eða smelltu á hnappinn hér að neðan',
    viewMode: 'Skjalasýn',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Jafna haus og stýringar',
    all: 'Allt',
    ...
    editViewWidth: 'Breidd breytingasýnar',
    editViewWidthFull: 'Full breidd',
    email: 'Tölvupóstur',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Textastærðir',
    typeSizeSmall: 'Núverandi',
