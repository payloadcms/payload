...
export const skTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Kopírovanie',
    copyWarning:
      'Chystáte sa kopírovať údaje z {{from}} do {{to}}. Tým prepíšete akékoľvek existujúce údaje {{to}} a presmeruje vás na pokračovanie v úprave tohto miestneho nastavenia. Ste si istý, že chcete pokračovať?',
    create: 'Vytvoriť',
    created: 'Vytvořeno',
