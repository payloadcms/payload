...
export const skTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Dokumenty',
    draftsHint: 'Tu sa zobrazia vaše nedávne koncepty',
    dropFiles: 'Pustite súbory na nahratie',
    editDashboard: 'Upraviť Nástenku',
    editingDashboard: 'Úprava Ovládacieho Panela',
    gridView: 'Mriežka',
    listView: 'Zoznam',
    loadError: 'Niektoré dokumenty sa nepodarilo načítať. Obnovte stránku a skúste to znova.',
    noDrafts: 'Žiadne nedávne koncepty',
    noItems:
      'Na vašej nástenke nie sú žiadne miniaplikácie. Môžete ich pridať z menu "Nástenka", ktoré sa nachádza v hornej lište.',
    noPinned: 'Žiadne pripnuté dokumenty',
    noRecents: 'Žiadne nedávno zobrazené dokumenty',
    pinDocument: 'Pripnúť {{title}}',
    pinned: 'Pripnuté',
    pinnedHint: 'Tu sa zobrazia pripnuté dokumenty',
    recentDrafts: 'Nedávne koncepty',
    recentlyViewed: 'Nedávno zobrazené',
    recentsHint: 'Tu sa zobrazia prezerané dokumenty',
    resetLayout: 'Resetovať rozloženie',
    saveError: 'Nastavenie prehľadu sa nepodarilo uložiť. Skúste to znova.',
    searchWidgets: 'Hľadať doplnky...',
    unpinDocument: 'Odopnúť {{title}}',
    updatedBy: 'Aktualizoval',
    uploadDropzone: 'Oblasť nahrávania',
    uploadFiles: 'Nahrať súbory',
    uploadHint: 'Presuňte súbory z počítača alebo kliknite na tlačidlo nižšie',
    viewMode: 'Zobrazenie dokumentov',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Zarovnať hlavičku a ovládacie prvky',
    all: 'Všetko',
    ...
    editViewWidth: 'Šírka zobrazenia úprav',
    editViewWidthFull: 'Plná',
    email: 'E-mail',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Veľkosti textu',
    typeSizeSmall: 'Aktuálne',
