...
export const skTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Táto akcia vás zablokuje z tohto predvolenia.',
    attachmentContentInvalid: 'Obsah prílohy musí byť reťazec alebo buffer',
    attachmentMissingContentAndPath: 'Príloha nemá ani obsah, ani cestu',
    attachmentMissingFilename: 'Prílohe chýba názov súboru',
    authenticationRequiredForExport:
      'Na vytvorenie exportov je potrebná autentifikácia používateľa.',
    autosaving: 'Pri automatickom ukladaní tohto dokumentu došlo k chybe.',
    busboyMultipartError: 'Chyba Busboy pri spracovaní multipart požiadavky',
    collectionSlugRequired: 'Slug kolekcie je povinný',
    contentTypeExpectedJSON: 'Content-Type očakávaný ako application/json',
    ...
    eitherCollectionOrGlobalRequired: 'Musí byť zadaná buď kolekcia, alebo globalSlug.',
    emailOrPasswordIncorrect: 'Zadaný email alebo heslo nie je správne.',
    expectedResponseFromUploadHandler: 'Očakávaná odpoveď od handlera nahrávania.',
    failedToFetchFromURL: 'Nepodarilo sa načítať súbor z poskytnutej URL.',
    failedToResetLayout: 'Nepodarilo sa obnoviť rozloženie.',
    failedToSaveLayout: 'Nepodarilo sa uložiť rozloženie.',
    fieldMustBeSpecified: 'pole musí byť špecifikované',
    fieldsNotInitialized: 'Polia nie sú inicializované.',
    filenameRequired: 'Názov súboru je povinný.',
    ...
    invalidFileURL: 'Neplatné URL súboru',
    invalidJSON: 'Neplatný JSON',
    invalidJSONFormat: 'Neplatný formát JSON',
    invalidRequestArgs: 'Neplatné argumenty odoslané v požiadavke: {{args}}',
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Join polia nemôžu byť pridané do polí, blokov alebo globálnych premenných.',
    ...
    missingIDOfVersionToRestore: 'Chýba ID verzie na obnovenie.',
    missingRequiredData: 'Chýbajú požadované údaje.',
    noConnectionToDatabase: 'beginTransaction zavolané bez existujúceho pripojenia k databáze',
    noFileDataForImport: 'Neboli poskytnuté žiadne údaje súboru na import',
    noFilesUploaded: 'Nenahrali sa žiadne súbory.',
    noMatchedField: 'Pre "{{label}}" nebolo nájdené žiadne zodpovedajúce pole',
    noPayloadProvided: 'Nebolo poskytnuté žiadne payload',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Usporiadateľné join polia musia cieliť na jednu kolekciu',
    pastingFromURLNotEnabled: 'Vkladanie z URL nie je povolené pre túto kolekciu.',
    previewing: 'Pri náhľade tohto dokumentu došlo k chybe.',
    problemUploadingFile: 'Pri nahrávaní súboru došlo k chybe.',
    redirectTargetNotAllowed: 'Cieľ presmerovania nie je povolený.',
    relationshipFieldNotFound: 'Pole vzťahu nebolo nájdené',
    relationshipNotFound: 'Vzťah nebol nájdený',
    requestDataRequired: 'Údaje požiadavky sú povinné.',
    requestNotEligibleForFileUpload: 'Požiadavka nie je oprávnená na nahrávanie súborov',
    requestURLMissing: 'URL požiadavky chýba.',
    restoringTitle:
    ...
    tooManyRedirects: 'Príliš veľa presmerovaní.',
    ...
    unexpectedArrayCollectionSlug: 'Neočakávané pole collectionSlug, musí byť poskytnutý rodič',
    ...
    uploadConfigHandlersMissing: 'uploadConfig.handlers nie je prítomné pre {{collection}}',
    uploadthingUnknownError: 'Chyba pri nahrávaní súboru s uploadthing: Neznáma chyba',
    urlNotAllowed: 'Poskytnuté URL nie je povolené.',
    ...
    userRequiredForImport: 'Používateľ je povinný pre importné operácie',
    validURLRequired: 'Platný reťazec URL je povinný.',
    valueMustBeUnique: 'Hodnota musí byť jedinečná',
    vercelBlobUploadError: 'Chyba nahrávania storage-vercel-blob klienta',
