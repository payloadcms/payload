...
export const skTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'E-mail bol úspešne overený. Presmerovávame vás na prihlásenie...',
  ...
  branching: {
    andMoreChanges: 'a ďalších {{count}} zmien',
    branch: 'Vetva',
    branchClosed: 'Táto vetva je uzavretá. Zostáva zachovaná ako záznam o tom, čo zlúčila.',
    branchDescription: 'Popis vetvy',
    branchedFrom: 'Odvetvené z',
    branches: 'Vetvy',
    branchHistory: 'História vetvy',
    branchMerging: 'Zlučuje sa',
    branchName: 'Názov vetvy',
    branchSettings: 'Nastavenia vetvy',
    cancelSchedule: 'Zrušiť zlúčenie',
    changedDocuments: 'Zmenené dokumenty',
    changesTo: 'Zmeny v {{summary}}',
    closeBranchAfterMerge: 'Po zlúčení túto vetvu uzavrieť',
    closeBranchHelpOff:
      'Vetva zostane otvorená, takže na nej môžete ďalej pracovať a neskôr ju zlúčiť znova.',
    closeBranchHelpOn: 'Vetva bude len na čítanie a už ju nebude možné zlúčiť.',
    confirmDiscardAll:
      'Všetkých {{count}} zmenených dokumentov v tejto vetve sa vráti do stavu na main. Túto akciu nie je možné vrátiť.',
    confirmDiscardSelected:
      '{{count}} zmenených dokumentov sa vráti do stavu na main. Túto akciu nie je možné vrátiť.',
    createAndSwitch: 'Vytvoriť a prepnúť',
    createNewBranch: 'Vytvoriť novú vetvu',
    currentChanges: 'Aktuálne zmeny',
    defaultBranch: 'predvolená',
    discardAll: 'Zahodiť všetko ({{count}})',
    discardChanges: 'Zahodiť zmeny',
    discardedCount: 'Zahodených {{count}} zmien.',
    discarding: 'Zahadzuje sa…',
    discardSelected: 'Zahodiť vybrané ({{count}})',
    historyPageOf: 'Strana {{page}} z {{total}}',
    manage: 'Spravovať',
    manageBranches: 'Správa vetiev…',
    merge: 'Zlúčiť',
    mergeAllChanges: 'Použijú sa všetky zmeny v tejto vetve.',
    mergeAllCount: 'Použije sa všetkých {{count}} zmenených dokumentov v tejto vetve.',
    mergeBranchInto: 'Zlúčiť {{branch}} do {{target}}',
    mergeChanges: 'Zlúčiť zmeny',
    mergeComplete: 'Zlúčenie dokončené',
    merged: 'Zlúčená',
    mergedByCount: '{{count}} dokumentov od {{user}}',
    mergedCount: 'Zlúčených {{count}} zmien.',
    mergedOfTotal: 'Zlúčených {{current}} z {{total}}',
    mergedOn: 'Zlúčené {{date}}',
    mergeHistory: 'História zlúčení',
    mergeInterrupted: 'Zlúčenie bolo prerušené a nič sa nepoužilo. Skúste to znova.',
    mergeNow: 'Zlúčiť teraz',
    mergeOnlySelected: 'Vyberte, ktoré zmeny zlúčiť',
    mergeScheduledFor: 'Zlúčenie naplánované na {{date}}.',
    mergeSelectedOfTotal: 'Použije sa {{selected}} z {{total}} zmenených dokumentov.',
    mergeStarting: 'Zlúčenie sa spúšťa…',
    merging: 'Zlučuje sa…',
    mergingProgress: 'Zlučuje sa {{current}} z {{total}}',
    noChangesYet: 'V tejto vetve zatiaľ nie sú žiadne zmeny.',
    operation_create: 'Vytvorené',
    operation_delete: 'Odstránené',
    operation_update: 'Aktualizované',
    reviewingChangedDocuments: 'Kontrola zmenených dokumentov',
    scheduleAnotherMerge: 'Naplánovať ďalšie zlúčenie',
    scheduleCancelled: 'Naplánované zlúčenie zrušené.',
    scheduleCount: '{{count}} naplánovaných',
    scheduledMerges: 'Naplánované zlúčenia',
    scheduledToMerge: 'Zlúčenie naplánované',
    scheduledToMergeOn: 'Táto vetva má byť zlúčená {{date}}.',
    scheduleHasNothingLeft:
      'Nezostáva nič na použitie — tieto zmeny boli zahodené alebo už sú zlúčené.',
    scheduleMerge: 'Naplánovať zlúčenie',
    scheduleMergeHelp:
      'Zlúčenie sa vykoná vo zvolenom čase a vaše oprávnenia sa vtedy skontrolujú znova.',
    scheduleWillApplyAll: 'Použije všetko čakajúce ({{count}})',
    scheduleWillApplySelected: 'Použije {{count}} vybraných zmien',
    scheduling: 'Plánuje sa…',
    searchBranches: 'Hľadať vetvy',
    selectBranch: 'Vybrať vetvu',
    untouchedDocumentsNote:
      'Dokumenty, ktoré ste v tejto vetve nezmenili, zobrazujú aktuálny obsah v main, nie snímku z času, keď bola vetva vytvorená.',
  },
  commandPalette: {
    actions: 'Akcie',
  ...
  error: {
    ...
    fileFetchFailed: 'Nepodarilo sa načítať súbor.',
    ...
    noFileFoundInClipboard: 'V schránke nebol nájdený žiadny súbor.',
    ...
    unableToReadClipboard: 'Nie je možné čítať zo schránky.',
    ...
    urlNotAllowed: 'Poskytnutá URL adresa nie je povolená.',
  ...
  general: {
    ...
    dark: 'Tmavý',
    dashboard: 'Nástenka',
    decrement: 'Decrementovať',
    delete: 'Odstrániť',
    deleted: 'Vymazané',
    deletedAgo: 'Odstránené pred {{distance}}',
    ...
    searchColumns: 'Vyhľadávacie stĺpce',
    select: 'Vyberte',
  ...
  upload: {
    ...
    fromURL: 'Nahrať súbor z URL adresy',
    height: 'Výška',
  ...
  version: {
    ...
    lastSavedAgo: 'Uložené pred {{distance}}',
