...
export const azTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Bu əməliyyat sizi bu preset-dən kənarlaşdıracaq.',
    attachmentContentInvalid: 'Əlavə məzmunu string və ya bufer olmalıdır',
    attachmentMissingContentAndPath: 'Əlavədə həm məzmun, həm də yol çatışmır',
    attachmentMissingFilename: 'Əlavədə fayl adı çatışmır',
    authenticationRequiredForExport: 'İxrac yaratmaq üçün istifadəçi doğrulaması tələb olunur.',
    autosaving: 'Bu sənədin avto yadda saxlanılması zamanı problem yarandı.',
    busboyMultipartError: 'Çoxhissəli sorğunun təhlilində Busboy xətası',
    collectionSlugRequired: 'Kolleksiya slug-u tələb olunur',
    contentTypeExpectedJSON: 'Content-Type application/json olmalıdır',
    ...
    eitherCollectionOrGlobalRequired: 'Ya kolleksiya, ya da globalSlug ötürülməlidir.',
    emailOrPasswordIncorrect: 'Təqdim olunan e-poçt və ya şifrə yanlışdır.',
    expectedResponseFromUploadHandler: 'Yükləmə idarəçisindən cavab gözlənilirdi.',
    failedToFetchFromURL: 'Təqdim edilən URL-dən faylı əldə etmək alınmadı.',
    failedToResetLayout: 'Düzeni sıfırlamaq uğursuz oldu.',
    failedToSaveLayout: 'Dizaynı saxlamaq alınmadı.',
    fieldMustBeSpecified: 'sahə təyin edilməlidir',
    fieldsNotInitialized: 'Sahələr inisializasiya olunmayıb.',
    filenameRequired: 'Fayl adı tələb olunur.',
    ...
    missingIDOfVersionToRestore: 'Bərpa ediləcək versiyanın ID-si çatışmır.',
    missingRequiredData: 'Tələb olunan məlumat çatışmır.',
    noConnectionToDatabase: 'Verilənlər bazasına əlaqə olmadıqda beginTransaction çağırılıb',
    noFileDataForImport: 'İdxal üçün fayl məlumatı təqdim edilməyib',
    noFilesUploaded: 'Heç bir fayl yüklənilməyib.',
    noMatchedField: '"{{label}}" üçün uyğun sahə tapılmadı',
    noPayloadProvided: 'Heç bir payload təqdim edilməyib',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Sıralana bilən join-lar tək kolleksiyaya yönəlməlidir',
    pastingFromURLNotEnabled: 'URL-dən yapışdırma bu kolleksiya üçün aktivləşdirilməyib.',
    previewing: 'Bu sənədin ön baxışı zamanı problem yarandı.',
    problemUploadingFile: 'Faylın yüklənməsi zamanı problem yarandı.',
    redirectTargetNotAllowed: 'Yönləndirmə hədəfinə icazə verilmir.',
    relationshipFieldNotFound: 'Relationship sahəsi tapılmadı',
    relationshipNotFound: 'Relationship tapılmadı',
    requestDataRequired: 'Sorğu məlumatı tələb olunur.',
    requestNotEligibleForFileUpload: 'Sorğu fayl yükləməsi üçün uyğun deyil',
    requestURLMissing: 'Sorğu URL-i çatışmır.',
    restoringTitle:
    ...
    tooManyRedirects: 'Həddindən artıq yönləndirmə.',
    ...
    unexpectedArrayCollectionSlug: 'Gözlənilməz collectionSlug massivi, parent təqdim edilməlidir',
    ...
    uploadConfigHandlersMissing: '{{collection}} üçün uploadConfig.handlers mövcud deyil',
    uploadthingUnknownError: 'uploadthing ilə fayl yükləmə xətası: Naməlum xəta',
    urlNotAllowed: 'Təqdim edilən URL-ə icazə verilmir.',
    ...
    userRequiredForImport: 'İdxal əməliyyatları üçün istifadəçi tələb olunur',
    validURLRequired: 'Etibarlı URL string-i tələb olunur.',
    valueMustBeUnique: 'Dəyər təkrar olmamalıdır',
    vercelBlobUploadError: 'storage-vercel-blob client yükləmə marşrutu xətası',
