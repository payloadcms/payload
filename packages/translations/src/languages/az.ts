...
export const azTranslations: DefaultTranslationsObject = {
  authentication: {
    ...
    emailVerifiedRedirecting: 'E-poçt uğurla təsdiqləndi. Sizi daxil olmağa yönləndiririk...',
  ...
  branching: {
    andMoreChanges: 'daha {{count}} dəyişiklik',
    branch: 'Qol',
    branchClosed: 'Bu qol bağlıdır. Nəyi birləşdirdiyinin qeydi olaraq saxlanılır.',
    branchDescription: 'Qolun təsviri',
    branchedFrom: 'Haradan ayrıldı',
    branches: 'Qollar',
    branchHistory: 'Qol tarixçəsi',
    branchMerging: 'Birləşdirilir',
    branchName: 'Qolun adı',
    branchSettings: 'Qol parametrləri',
    cancelSchedule: 'Birləşməni ləğv et',
    changedDocuments: 'Dəyişdirilmiş sənədlər',
    changesTo: '{{summary}} üzərində dəyişikliklər',
    closeBranchAfterMerge: 'Birləşdirmədən sonra bu qolu bağla',
    closeBranchHelpOff:
      'Qol açıq qalır, buna görə onun üzərində işləməyə davam edib sonra yenidən birləşdirə bilərsiniz.',
    closeBranchHelpOn: 'Qol yalnız oxunaqlı olacaq və yenidən birləşdirilə bilməyəcək.',
    confirmDiscardAll:
      'Bu qoldaki bütün {{count}} dəyişdirilmiş sənəd main-dəki vəziyyətinə qaytarılacaq. Bu geri alına bilməz.',
    confirmDiscardSelected:
      '{{count}} dəyişdirilmiş sənəd main-dəki vəziyyətinə qaytarılacaq. Bu geri alına bilməz.',
    createAndSwitch: 'Yarat və keç',
    createNewBranch: 'Yeni qol yarat',
    currentChanges: 'Cari dəyişikliklər',
    defaultBranch: 'defolt',
    discardAll: 'Hamısını ləğv et ({{count}})',
    discardChanges: 'Dəyişiklikləri ləğv et',
    discardedCount: '{{count}} dəyişiklik ləğv edildi.',
    discarding: 'Ləğv edilir…',
    discardSelected: 'Seçilmişləri ləğv et ({{count}})',
    historyPageOf: 'Səhifə {{page}} / {{total}}',
    manage: 'İdarə et',
    manageBranches: 'Qolları idarə et…',
    merge: 'Birləşdir',
    mergeAllChanges: 'Bu qoldaki bütün dəyişikliklər tətbiq olunacaq.',
    mergeAllCount: 'Bu qoldaki bütün {{count}} dəyişdirilmiş sənəd tətbiq olunacaq.',
    mergeBranchInto: '{{branch}} qolunu {{target}} ilə birləşdir',
    mergeChanges: 'Dəyişiklikləri birləşdir',
    mergeComplete: 'Birləşdirmə tamamlandı',
    merged: 'Birləşdirilmiş',
    mergedByCount: '{{count}} sənəd – {{user}}',
    mergedCount: '{{count}} dəyişiklik birləşdirildi.',
    mergedOfTotal: '{{total}} sənəddən {{current}} birləşdirildi',
    mergedOn: '{{date}} tarixində birləşdirildi',
    mergeHistory: 'Birləşdirmə tarixçəsi',
    mergeInterrupted: 'Birləşdirmə dayandırıldı və heç nə tətbiq olunmadı. Yenidən cəhd edin.',
    mergeNow: 'İndi birləşdir',
    mergeOnlySelected: 'Hansı dəyişikliklərin birləşdiriləcəyini seçin',
    mergeScheduledFor: 'Birləşdirmə {{date}} tarixinə planlaşdırıldı.',
    mergeSelectedOfTotal: '{{total}} dəyişdirilmiş sənəddən {{selected}} tətbiq olunacaq.',
    mergeStarting: 'Birləşdirmə başlayır…',
    merging: 'Birləşdirilir…',
    mergingProgress: '{{total}} sənəddən {{current}} birləşdirilir',
    noChangesYet: 'Bu qolda hələ dəyişiklik yoxdur.',
    operation_create: 'Yaradıldı',
    operation_delete: 'Silindi',
    operation_update: 'Yeniləndi',
    reviewingChangedDocuments: 'Dəyişdirilmiş sənədlərə baxış',
    scheduleAnotherMerge: 'Başqa birləşdirmə planlaşdır',
    scheduleCancelled: 'Planlaşdırılmış birləşdirmə ləğv edildi.',
    scheduleCount: '{{count}} planlaşdırılmış',
    scheduledMerges: 'Planlaşdırılmış birləşdirmələr',
    scheduledToMerge: 'Birləşdirmə planlaşdırılıb',
    scheduledToMergeOn: 'Bu qol {{date}} tarixində birləşdirilməsi planlaşdırılıb.',
    scheduleHasNothingLeft:
      'Tətbiq edilməli heç nə qalmadı — bu dəyişikliklər ləğv edildi və ya artıq birləşdirildi.',
    scheduleMerge: 'Birləşdirməni planlaşdır',
    scheduleMergeHelp:
      'Birləşdirmə seçdiyiniz vaxtda işə düşür və icazələriniz o zaman yenidən yoxlanılır.',
    scheduleWillApplyAll: 'Gözləyən hər şeyi tətbiq edəcək ({{count}})',
    scheduleWillApplySelected: '{{count}} seçilmiş dəyişikliyi tətbiq edəcək',
    scheduling: 'Planlaşdırılır…',
    searchBranches: 'Qollarda axtar',
    selectBranch: 'Qol seçin',
    untouchedDocumentsNote:
      'Bu filialda dəyişiklik etmədiyiniz sənədlər, filial yaradılan andakı görüntünü deyil, əsas (main) filialının cari məzmununu göstərir.',
  },
  commandPalette: {
  ...
  error: {
    ...
    fileFetchFailed: 'Faylı əldə etmək mümkün olmadı.',
    ...
    noFileFoundInClipboard: 'Mübadilə yaddaşında heç bir fayl tapılmadı.',
    ...
    unableToReadClipboard: 'Mübadilə buferindən oxumaq mümkün deyil.',
    ...
    urlNotAllowed: 'Təqdim olunan URL-ə icazə verilmir.',
