...
export const azTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    confirm: 'Təsdiqlə',
    confirmCopy: 'Köçürməni təsdiqləyin',
    ...
    copying: 'Kopyalama',
    copyWarning:
      'Siz {{from}}-dən {{to}}-ya məlumatlarını kopyalamaq üzrəsiniz. Bu, mövcud olan {{to}} məlumatlarını silib yeni locale redaktə etməyə yönləndirəcək. Davam etməyə əminsiniz?',
    create: 'Yarat',
    created: 'Yaradıldı',
