...
export const azTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Sənədlər',
    draftsHint: 'Son qaralamalarınız burada görünəcək',
    dropFiles: 'Yükləmək üçün faylları buraxın',
    editDashboard: 'İdarə Panelini Redaktə Et',
    editingDashboard: 'Redaktə Paneli',
    gridView: 'Tor görünüşü',
    listView: 'Siyahı görünüşü',
    loadError: 'Bəzi sənədləri yükləmək mümkün olmadı. Səhifəni yeniləyin.',
    noDrafts: 'Son qaralama yoxdur',
    noItems:
      'Sizin panelinizdə heç bir vidjet yoxdur. Siz onları yuxarıdaki çubuqda yerləşən "Panel" menyusundan əlavə edə bilərsiniz.',
    noPinned: 'Bərkidilmiş sənəd yoxdur',
    noRecents: 'Son baxılan sənəd yoxdur',
    pinDocument: '{{title}} sənədini bərkit',
    pinned: 'Bərkidilmişlər',
    pinnedHint: 'Bərkitdiyiniz sənədlər burada görünəcək',
    recentDrafts: 'Son qaralamalar',
    recentlyViewed: 'Son baxılanlar',
    recentsHint: 'Baxdığınız sənədlər burada görünəcək',
    resetLayout: 'Düzəni sıfırlama',
    saveError: 'Panel seçimini saxlamaq mümkün olmadı. Yenidən cəhd edin.',
    searchWidgets: 'Widgetləri axtarın...',
    unpinDocument: '{{title}} sənədinin bərkidilməsini ləğv et',
    updatedBy: 'Yeniləyən',
    uploadDropzone: 'Yükləmə sahəsi',
    uploadFiles: 'Faylları yüklə',
    uploadHint: 'Faylları kompüterinizdən sürükləyin və ya aşağıdakı düyməyə klikləyin',
    viewMode: 'Sənəd görünüşü',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Başlığı və idarəetmə elementlərini hizala',
    all: 'Hamısı',
    ...
    editViewWidth: 'Redaktə görünüşünün eni',
    editViewWidthFull: 'Tam',
    email: 'Elektron poçt',
