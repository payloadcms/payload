...
export const trTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Belgeler',
    draftsHint: 'Son taslaklarınız burada görünür',
    dropFiles: 'Yüklemek için dosyaları bırakın',
    editDashboard: 'Gösterge Panelini Düzenle',
    editingDashboard: 'Gösterge Tablosunu Düzenleme',
    gridView: 'Izgara görünümü',
    listView: 'Liste görünümü',
    loadError: 'Bazı belgeler yüklenemedi. Tekrar denemek için sayfayı yenileyin.',
    noDrafts: 'Son taslak yok',
    noItems:
      'Panoda hiç widgetiniz yok. Bunları, üst çubukta yer alan "Gösterge Tablosu" menüsünden ekleyebilirsiniz.',
    noPinned: 'Sabitlenmiş belge yok',
    noRecents: 'Son görüntülenen belge yok',
    pinDocument: '{{title}} belgesini sabitle',
    pinned: 'Sabitlenenler',
    pinnedHint: 'Sabitlediğiniz belgeler burada görünür',
    recentDrafts: 'Son taslaklar',
    recentlyViewed: 'Son görüntülenenler',
    recentsHint: 'Görüntülediğiniz belgeler burada görünür',
    resetLayout: 'Düzeni Sıfırla',
    saveError: 'Panel tercihi kaydedilemedi. Lütfen tekrar deneyin.',
    searchWidgets: "Arama widget'ları...",
    unpinDocument: '{{title}} belgesinin sabitlemesini kaldır',
    updatedBy: 'Güncelleyen',
    uploadDropzone: 'Yükleme alanı',
    uploadFiles: 'Dosya yükle',
    uploadHint: 'Bilgisayarınızdan dosyaları sürükleyin veya aşağıdaki düğmeye tıklayın',
    viewMode: 'Belge görünümü',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Başlığı ve denetimleri hizala',
    all: 'Tüm',
    ...
    editViewWidth: 'Düzenleme görünümü genişliği',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Metin boyutları',
    typeSizeSmall: 'Geçerli',
