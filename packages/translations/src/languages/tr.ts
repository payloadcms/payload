...
export const trTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    copying: 'Kopyalama',
    copyWarning:
      "{{from}}'dan {{to}}'ya veri kopyalamak üzeresiniz. Bu, var olan {{to}} verilerinin üzerine yazacak ve sizi bu lokasyonu düzenlemeye devam etmek için yönlendirecektir. Devam etmek istediğinizden emin misiniz?",
    create: 'Oluştur',
