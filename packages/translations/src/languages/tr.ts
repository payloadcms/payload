...
export const trTranslations: DefaultTranslationsObject = {
  ...
  version: {
    ...
    aboutToUnpublishIn: 'Bu belgeyi {{locale}} olarak yayından kaldırmak üzeresiniz. Emin misiniz?',
    ...
    revertUnsuccessful: 'Geri almada başarısız. Daha önce yayınlanmış bir versiyon bulunamadı.',
