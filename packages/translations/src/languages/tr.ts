...
export const trTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: '{{count}} değişiklik daha',
    branch: 'Dal',
    branchClosed: 'Bu dal kapatıldı. Neyi birleştirdiğinin kaydı olarak saklanıyor.',
    branchDescription: 'Dal açıklaması',
    branchedFrom: 'Şu daldan ayrıldı',
    branches: 'Dallar',
    branchHistory: 'Dal geçmişi',
    branchMerging: 'Birleştiriliyor',
    branchName: 'Dal adı',
    branchSettings: 'Dal ayarları',
    cancelSchedule: 'Birleştirmeyi iptal et',
    changedDocuments: 'Değişen belgeler',
    changesTo: '{{summary}} üzerinde değişiklikler',
    closeBranchAfterMerge: 'Birleştirmeden sonra bu dalı kapat',
    closeBranchHelpOff:
      'Dal açık kalır, böylece üzerinde çalışmaya devam edip daha sonra yeniden birleştirebilirsiniz.',
    closeBranchHelpOn: 'Dal salt okunur hâle gelir ve bir daha birleştirilemez.',
    confirmDiscardAll:
      'Bu daldaki {{count}} değişen belgenin tamamı main üzerindeki durumuna döndürülecek. Bu geri alınamaz.',
    confirmDiscardSelected:
      '{{count}} değişen belge main üzerindeki durumuna döndürülecek. Bu geri alınamaz.',
    createAndSwitch: 'Oluştur ve geç',
    createNewBranch: 'Yeni dal oluştur',
    currentChanges: 'Mevcut değişiklikler',
    defaultBranch: 'varsayılan',
    discardAll: 'Tümünü sil ({{count}})',
    discardChanges: 'Değişiklikleri sil',
    discardedCount: '{{count}} değişiklik silindi.',
    discarding: 'Siliniyor…',
    discardSelected: 'Seçilenleri sil ({{count}})',
    historyPageOf: 'Sayfa {{page}} / {{total}}',
    manage: 'Yönet',
    manageBranches: 'Dalları yönet…',
    merge: 'Birleştir',
    mergeAllChanges: 'Bu daldaki tüm değişiklikler uygulanacak.',
    mergeAllCount: 'Bu daldaki {{count}} değişen belgenin tamamı uygulanacak.',
    mergeBranchInto: '{{branch}} dalını {{target}} ile birleştir',
    mergeChanges: 'Değişiklikleri birleştir',
    mergeComplete: 'Birleştirme tamamlandı',
    merged: 'Birleştirildi',
    mergedByCount: '{{count}} belge – {{user}}',
    mergedCount: '{{count}} değişiklik birleştirildi.',
    mergedOfTotal: '{{total}} belgeden {{current}} birleştirildi',
    mergedOn: '{{date}} tarihinde birleştirildi',
    mergeHistory: 'Birleştirme geçmişi',
    mergeInterrupted: 'Birleştirme kesintiye uğradı ve hiçbir şey uygulanmadı. Yeniden deneyin.',
    mergeNow: 'Şimdi birleştir',
    mergeOnlySelected: 'Hangi değişikliklerin birleştirileceğini seçin',
    mergeScheduledFor: 'Birleştirme {{date}} için zamanlandı.',
    mergeSelectedOfTotal: '{{total}} değişen belgeden {{selected}} tanesi uygulanacak.',
    mergeStarting: 'Birleştirme başlatılıyor…',
    merging: 'Birleştiriliyor…',
    mergingProgress: '{{total}} belgeden {{current}} birleştiriliyor',
    noChangesYet: 'Bu dalda henüz değişiklik yok.',
    operation_create: 'Oluşturuldu',
    operation_delete: 'Silindi',
    operation_update: 'Güncellendi',
    reviewingChangedDocuments: 'Değiştirilen belgeler inceleniyor',
    scheduleAnotherMerge: 'Başka bir birleştirme zamanla',
    scheduleCancelled: 'Zamanlanmış birleştirme iptal edildi.',
    scheduleCount: '{{count}} zamanlanmış',
    scheduledMerges: 'Zamanlanmış birleştirmeler',
    scheduledToMerge: 'Birleştirme zamanlandı',
    scheduledToMergeOn: 'Bu dalın {{date}} tarihinde birleştirilmesi zamanlandı.',
    scheduleHasNothingLeft:
      'Uygulanacak bir şey kalmadı — bu değişiklikler silindi veya zaten birleştirildi.',
    scheduleMerge: 'Birleştirmeyi zamanla',
    scheduleMergeHelp:
      'Birleştirme seçtiğiniz saatte çalışır ve izinleriniz o anda yeniden denetlenir.',
    scheduleWillApplyAll: 'Bekleyen her şeyi uygulayacak ({{count}})',
    scheduleWillApplySelected: '{{count}} seçili değişikliği uygulayacak',
    scheduling: 'Zamanlanıyor…',
    searchBranches: 'Dallarda ara',
    selectBranch: 'Dal seç',
    untouchedDocumentsNote:
      "Bu dalda değiştirmediğiniz Dökümanlar, dal oluşturulduğunda alınan bir anlık görüntüyü değil, main'in mevcut içeriğini gösterir.",
  },
  commandPalette: {
    actions: 'Eylemler',
  ...
  general: {
    ...
    delete: 'Sil',
    deleted: 'Silindi',
    deletedAgo: '{{distance}} önce silindi',
