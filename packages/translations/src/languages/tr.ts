...
export const trTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    actionWillLockoutPreset: 'Bu işlem, bu ön ayara erişiminizi engelleyecektir.',
    attachmentContentInvalid: 'Ek içeriği bir dize veya arabellek olmalıdır',
    attachmentMissingContentAndPath: 'Ek, hem içerik hem de yol eksik',
    attachmentMissingFilename: 'Ek dosya adı eksik',
    authenticationRequiredForExport:
      'Dışa aktarmalar oluşturmak için kullanıcı kimlik doğrulaması gereklidir.',
    autosaving: 'Otomatik kaydetme başarısız oldu',
    busboyMultipartError: 'Busboy multipart isteğini ayrıştırma hatası',
    collectionSlugRequired: 'Collection slug gereklidir',
    contentTypeExpectedJSON: "Content-Type'ın application/json olması bekleniyor",
    ...
    eitherCollectionOrGlobalRequired: 'Collection veya globalSlug aktarılmalıdır.',
    emailOrPasswordIncorrect: 'Girilen e-posta veya parola hatalı',
    expectedResponseFromUploadHandler: 'Yükleme işleyicisinden yanıt bekleniyor.',
    failedToFetchFromURL: "Sağlanan URL'den dosya getirilemedi.",
    failedToResetLayout: 'Yerleşimi sıfırlama başarısız oldu.',
    failedToSaveLayout: 'Düzeni kaydetme başarısız oldu.',
    fieldMustBeSpecified: 'alan belirtilmelidir',
    fieldsNotInitialized: 'Alanlar başlatılmamış.',
    filenameRequired: 'Dosya adı gereklidir.',
    ...
    invalidFileURL: "Geçersiz dosya URL'si",
    ...
    joinFieldsNotAllowedInArraysBlocksOrGlobals:
      'Join alanları dizilere, bloklara veya globallere eklenemez.',
    ...
    missingIDOfVersionToRestore: "Geri yüklenecek sürümün ID'si eksik.",
    missingRequiredData: 'Gerekli veri eksik.',
    noConnectionToDatabase: 'Veritabanına bağlantı olmadığında beginTransaction çağrıldı',
    noFileDataForImport: 'İçe aktarım için dosya verisi sağlanmadı',
    noFilesUploaded: 'Yüklenen dosya yok',
    noMatchedField: '"{{label}}" ile eşleşen alan bulunamadı.',
    noPayloadProvided: 'Payload sağlanmadı',
    ...
    orderableJoinsMustTargetSingleCollection:
      'Sıralanabilir joinler tek bir collection hedeflemeli',
    pastingFromURLNotEnabled: "Bu collection için URL'den yapıştırma etkin değil.",
    previewing: 'Önizleme başarısız oldu',
    problemUploadingFile: 'Dosya yüklenirken bir sorun oluştu.',
    redirectTargetNotAllowed: 'Yönlendirme hedefine izin verilmiyor.',
    relationshipFieldNotFound: 'İlişki alanı bulunamadı',
    relationshipNotFound: 'İlişki bulunamadı',
    requestDataRequired: 'İstek verisi gereklidir.',
    requestNotEligibleForFileUpload: 'İstek dosya yükleme için uygun değil',
    requestURLMissing: "İstek URL'si eksik.",
    restoringTitle:
    ...
    tooManyRedirects: 'Çok fazla yönlendirme.',
    ...
    unexpectedArrayCollectionSlug: 'Beklenmeyen dizi collection slug',
    ...
    uploadConfigHandlersMissing: 'Yükleme yapılandırma işleyicileri eksik',
    uploadthingUnknownError: 'Uploadthing bilinmeyen hata',
    urlNotAllowed: "URL'ye izin verilmiyor",
    ...
    userRequiredForImport: 'İçe aktarım için kullanıcı gereklidir',
    validURLRequired: 'Geçerli bir URL gereklidir',
    valueMustBeUnique: 'Değer benzersiz olmalıdır',
    vercelBlobUploadError: 'Vercel Blob yükleme hatası',
