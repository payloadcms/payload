...
export const lvTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    couldNotReadFileForTypeDetection: 'Neizdevās nolasīt augšupielādēto failu tipa noteikšanai.',
    couldNotReadFileForValidation: 'Neizdevās nolasīt augšupielādēto failu validācijai.',
    crop: 'Apgriezt',
    cropToolDescription:
    ...
    fileTypeNotAllowed: 'Faila tips {{mimeType}} (no paplašinājuma {{extension}}) nav atļauts.',
    focalPoint: 'Fokusa punkts',
    focalPointDescription:
      'Velciet fokusa punktu tieši priekšskatījumā vai pielāgojiet vērtības zemāk.',
    height: 'Augstums',
    invalidMimeType: 'Nederīgs MIME tips: {{mimeType}}.',
    invalidOrCorruptedPDF: 'Nederīgs vai bojāts PDF fails.',
    ...
    restrictedFileType:
      'Faila tips "{{mimeType}}" nav atļauts failam {{fileName}}: konstatēts ierobežots faila tips — iestatiet “allowRestrictedFileTypes” uz “true”, lai izlaistu šo pārbaudi šai Collection.',
    ...
    svgHarmfulContent: 'SVG fails datne potenciāli kaitīgu saturu.',
    width: 'Platums',
  },
  validation: {
