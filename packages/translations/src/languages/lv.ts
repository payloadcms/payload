...
export const lvTranslations: DefaultTranslationsObject = {
  ...
  branching: {
    andMoreChanges: 'vēl {{count}} izmaiņas',
    branch: 'Zars',
    branchClosed: 'Šis zars ir slēgts. Tas tiek saglabāts kā ieraksts par to, kas tika apvienots.',
    branchDescription: 'Zara apraksts',
    branchedFrom: 'Atzarots no',
    branches: 'Zari',
    branchHistory: 'Zara vēsture',
    branchMerging: 'Apvieno',
    branchName: 'Zara nosaukums',
    branchSettings: 'Zara iestatījumi',
    cancelSchedule: 'Atcelt apvienošanu',
    changedDocuments: 'Mainītie dokumenti',
    changesTo: 'Izmaiņas: {{summary}}',
    closeBranchAfterMerge: 'Slēgt šo zaru pēc apvienošanas',
    closeBranchHelpOff:
      'Zars paliek atvērts, tāpēc varat turpināt tajā strādāt un vēlāk apvienot vēlreiz.',
    closeBranchHelpOn: 'Zars kļūs tikai lasāms, un to vairs nevarēs apvienot.',
    confirmDiscardAll:
      'Visi {{count}} mainītie dokumenti šajā zarā tiks atgriezti to stāvoklī main. To nevar atsaukt.',
    confirmDiscardSelected:
      '{{count}} mainītie dokumenti tiks atgriezti to stāvoklī main. To nevar atsaukt.',
    createAndSwitch: 'Izveidot un pārslēgties',
    createNewBranch: 'Izveidot jaunu zaru',
    currentChanges: 'Pašreizējās izmaiņas',
    defaultBranch: 'noklusējuma',
    discardAll: 'Atmest visus ({{count}})',
    discardChanges: 'Atmest izmaiņas',
    discardedCount: 'Atmestas izmaiņas: {{count}}.',
    discarding: 'Atmet…',
    discardSelected: 'Atmest atlasītos ({{count}})',
    historyPageOf: '{{page}}. lappuse no {{total}}',
    manage: 'Pārvaldīt',
    manageBranches: 'Pārvaldīt zarus…',
    merge: 'Apvienot',
    mergeAllChanges: 'Tiks piemērotas visas šī zara izmaiņas.',
    mergeAllCount: 'Tiks piemēroti visi {{count}} mainītie šī zara dokumenti.',
    mergeBranchInto: 'Apvienot {{branch}} ar {{target}}',
    mergeChanges: 'Apvienot izmaiņas',
    mergeComplete: 'Apvienošana pabeigta',
    merged: 'Apvienots',
    mergedByCount: '{{count}} dokumenti – {{user}}',
    mergedCount: 'Apvienotas izmaiņas: {{count}}.',
    mergedOfTotal: 'Apvienoti {{current}} no {{total}}',
    mergedOn: 'Apvienots {{date}}',
    mergeHistory: 'Apvienošanu vēsture',
    mergeInterrupted: 'Apvienošana tika pārtraukta, un nekas netika piemērots. Mēģiniet vēlreiz.',
    mergeNow: 'Apvienot tagad',
    mergeOnlySelected: 'Izvēlieties, kuras izmaiņas apvienot',
    mergeScheduledFor: 'Apvienošana ieplānota uz {{date}}.',
    mergeSelectedOfTotal: 'Tiks piemēroti {{selected}} no {{total}} mainītajiem dokumentiem.',
    mergeStarting: 'Sākas apvienošana…',
    merging: 'Apvieno…',
    mergingProgress: 'Apvieno {{current}} no {{total}}',
    noChangesYet: 'Šajā zarā vēl nav izmaiņu.',
    operation_create: 'Izveidots',
    operation_delete: 'Dzēsts',
    operation_update: 'Atjaunināts',
    reviewingChangedDocuments: 'Mainīto dokumentu pārskatīšana',
    scheduleAnotherMerge: 'Ieplānot vēl vienu apvienošanu',
    scheduleCancelled: 'Ieplānotā apvienošana atcelta.',
    scheduleCount: 'Ieplānotas: {{count}}',
    scheduledMerges: 'Ieplānotās apvienošanas',
    scheduledToMerge: 'Apvienošana ieplānota',
    scheduledToMergeOn: 'Šis zars ir ieplānots apvienošanai {{date}}.',
    scheduleHasNothingLeft:
      'Vairs nav ko piemērot — šīs izmaiņas tika atmestas vai jau apvienotas.',
    scheduleMerge: 'Ieplānot apvienošanu',
    scheduleMergeHelp:
      'Apvienošana notiks izvēlētajā laikā, un jūsu atļaujas tad tiks pārbaudītas vēlreiz.',
    scheduleWillApplyAll: 'Piemēros visu, kas gaida ({{count}})',
    scheduleWillApplySelected: 'Piemēros {{count}} atlasītās izmaiņas',
    scheduling: 'Plāno…',
    searchBranches: 'Meklēt zarus',
    selectBranch: 'Izvēlēties zaru',
    untouchedDocumentsNote:
      'Dokumenti, kurus šajā atzarā neesat mainījis, rāda aktuālo Main saturu, nevis momentuzņēmumu no brīža, kad atzars tika izveidots.',
  },
  commandPalette: {
    actions: 'Darbības',
  ...
  error: {
    ...
    fileFetchFailed: 'Neizdevās iegūt failu.',
    ...
    noFileFoundInClipboard: 'Nav neviens fails starpliktuvē atrasts.',
    ...
    unableToReadClipboard: 'Neizdodas nolasīt datus no starpliktuves.',
    ...
    urlNotAllowed: 'Norādītā URL nav atļauta.',
  ...
  upload: {
    ...
    fromURL: 'Augšupielādēt failu no URL',
    height: 'Augstums',
