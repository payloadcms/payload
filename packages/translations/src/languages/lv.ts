...
export const lvTranslations: DefaultTranslationsObject = {
  ...
  dashboard: {
    ...
    documents: 'Dokumenti',
    draftsHint: 'Jūsu jaunākie melnraksti parādīsies šeit',
    dropFiles: 'Nometiet failus, lai augšupielādētu',
    editDashboard: 'Rediģēt informācijas paneli',
    editingDashboard: 'Rediģēšanas panelis',
    gridView: 'Režģa skats',
    listView: 'Saraksta skats',
    loadError: 'Dažus dokumentus neizdevās ielādēt. Atsvaidziniet lapu.',
    noDrafts: 'Nav jaunāko melnrakstu',
    noItems:
      'Jūsu informācijas panelī nav logrīku. Tos varat pievienot no izvēlnes "Informācijas panelis", kas atrodas augšējā josla.',
    noPinned: 'Nav piespraustu dokumentu',
    noRecents: 'Nav nesen skatītu dokumentu',
    pinDocument: 'Piespraust {{title}}',
    pinned: 'Piespraustie',
    pinnedHint: 'Piespraustie dokumenti parādīsies šeit',
    recentDrafts: 'Jaunākie melnraksti',
    recentlyViewed: 'Nesen skatītie',
    recentsHint: 'Skatītie dokumenti parādīsies šeit',
    resetLayout: 'Atiestatīt Izkārtojumu',
    saveError: 'Neizdevās saglabāt paneļa iestatījumu. Mēģiniet vēlreiz.',
    searchWidgets: 'Meklēt logrīkus...',
    unpinDocument: 'Atspraust {{title}}',
    updatedBy: 'Atjaunināja',
    uploadDropzone: 'Augšupielādes zona',
    uploadFiles: 'Augšupielādēt failus',
    uploadHint: 'Velciet failus no datora vai noklikšķiniet uz pogas zemāk',
    viewMode: 'Dokumentu skats',
  ...
  general: {
    ...
    alignHeaderAndControls: 'Līdzināt galveni un vadīklas',
    all: 'Visi',
    ...
    editViewWidth: 'Rediģēšanas skata platums',
    editViewWidthFull: 'Pilns platums',
    email: 'E-pasts',
    ...
    typeSizeDefault: '+1',
    typeSizeLarge: '+2',
    typeSizes: 'Teksta izmēri',
    typeSizeSmall: 'Pašreizējais',
