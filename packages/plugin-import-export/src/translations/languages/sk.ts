...
export const skTranslations: PluginDefaultTranslationsObject = {
  'plugin-import-export': {
    ...
    limitCapped: 'Limit obmedzený na maximum {{limit}}',
    limitExceededExport: 'Export je obmedzený na {{limit}} dokumentov',
    limitExceededImport: 'Súbor na import obsahuje {{count}} dokumentov, ale limit je {{limit}}',
