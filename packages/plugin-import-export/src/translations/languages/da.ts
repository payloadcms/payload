...
export const daTranslations: PluginDefaultTranslationsObject = {
  'plugin-import-export': {
    ...
    limitCapped: 'Grænse begrænset til maksimum {{limit}}',
    limitExceededExport: 'Eksport begrænset til {{limit}} dokumenter',
    limitExceededImport: 'Importfilen indeholder {{count}} dokumenter, men grænsen er {{limit}}',
    matchBy: 'Match af',
    mode: 'Tilstand',
