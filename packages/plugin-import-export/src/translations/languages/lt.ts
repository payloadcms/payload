...
export const ltTranslations: PluginDefaultTranslationsObject = {
  'plugin-import-export': {
    ...
    limitCapped: 'Limitas apribotas iki maksimalaus {{limit}}',
    limitExceededExport: 'Eksportas ribojamas iki {{limit}} dokumentų',
    limitExceededImport: 'Importuojamas failas turi {{count}} dokumentų, bet riba yra {{limit}}',
