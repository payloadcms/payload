...
export const myTranslations: PluginDefaultTranslationsObject = {
  'plugin-import-export': {
    ...
    limitCapped: 'Had dihadkan kepada maksimum {{limit}}',
    limitExceededExport: 'Pengeksportan dibataskan kepada {{limit}} dokumen',
    limitExceededImport: 'Fail import mengandungi {{count}} dokumen tetapi had ialah {{limit}}',
