...
export const viTranslations: PluginDefaultTranslationsObject = {
  'plugin-import-export': {
    ...
    limitCapped: 'Giới hạn tối đa {{limit}}',
    limitExceededExport: 'Xuất khẩu giới hạn đến {{limit}} tài liệu',
    limitExceededImport: 'Tệp nhập khẩu chứa {{count}} tài liệu nhưng giới hạn là {{limit}}',
