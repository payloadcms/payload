...
export const thTranslations: PluginDefaultTranslationsObject = {
  'plugin-import-export': {
    ...
    limitCapped: 'จำกัดสูงสุดที่ {{limit}}',
    limitExceededExport: 'การส่งออกจำกัดอยู่ที่ {{limit}} เอกสาร',
    limitExceededImport: 'ไฟล์นำเข้ามีเอกสาร {{count}} แต่จำกัดอยู่ที่ {{limit}}',
    matchBy: 'ตรงตาม',
    mode: 'โหมด',
