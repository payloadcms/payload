...
export const csTranslations: PluginDefaultTranslationsObject = {
  'plugin-import-export': {
    ...
    limitCapped: 'Limit omezen na maximum {{limit}}',
    limitExceededExport: 'Export je omezen na {{limit}} dokumentů.',
    limitExceededImport: 'Importní soubor obsahuje {{count}} dokumentů, ale limit je {{limit}}',
    matchBy: 'Shoda podle',
    mode: 'Mód',
