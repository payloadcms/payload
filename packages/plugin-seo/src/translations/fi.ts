...
export const fi: GenericTranslationsObject = {
  ...
  'plugin-seo': {
    ...
    checksPassing: '{{current}}/{{max}} tarkistukset menevät läpi',
    good: 'Hyvä',
    imageAutoGenerationTip: 'Automaattinen generointi hakee valitun hero-kuvan.',
    lengthTipDescription:
      'Tämän tulisi olla {{minLength}} merkin ja {{maxLength}} merkin välillä. Lisätietoja laadukkaiden meta-kuvauksien kirjoittamisesta löytyy täältä ',
    lengthTipTitle:
      'Tämän tulisi olla {{minLength}} merkin ja {{maxLength}} merkin välillä. Lisätietoja laadukkaiden meta-otsikkojen kirjoittamisesta löytyy täältä ',
    missing: 'Puuttuu',
    noImage: 'Ei kuvaa',
    preview: 'Esikatselu',
    previewDescription:
