...
export const viTranslations = {
  'plugin-mcp': {
    apiKeyDescription:
      'Khóa API kiểm soát các bộ sưu tập, tài nguyên, công cụ và prompt mà client MCP có thể truy cập.',
    apiKeys: 'Khóa API',
    ...
    keyPrivateDescription:
      'Khóa này cấp cho MCP quyền truy cập nội dung của bạn. Đừng chia sẻ với người khác!',
    ...
    overrideAccessDescription:
      'Khi bật, khóa này bỏ qua kiểm soát truy cập của Payload trong mọi thao tác. Hãy để tắt trừ khi bạn có lý do cụ thể.',
    permissions: 'Quyền',
    permissionsDescription:
      'Cho phép client MCP truy cập các bộ sưu tập, công cụ, tài nguyên và prompt sau.',
    prompts: 'Prompt',
