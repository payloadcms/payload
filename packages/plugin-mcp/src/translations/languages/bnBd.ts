...
export const bnBdTranslations = {
  'plugin-mcp': {
    apiKeyDescription:
      'API কী নির্ধারণ করে MCP ক্লায়েন্ট কোন সংগ্রহ, রিসোর্স, টুল এবং প্রম্পটে প্রবেশ করতে পারবে।',
    apiKeys: 'API কীসমূহ',
    ...
    keyPrivateDescription:
      'এই কী MCP-কে আপনার কনটেন্টে প্রবেশাধিকার দেয়। এটি অন্যদের সাথে শেয়ার করবেন না!',
    ...
    overrideAccessDescription:
      'চালু থাকলে, এই কী প্রতিটি অপারেশনে Payload অ্যাক্সেস নিয়ম অগ্রাহ্য করবে। নির্দিষ্ট কারণ না থাকলে বন্ধ রাখুন।',
    permissions: 'অনুমতিসমূহ',
    permissionsDescription:
      'MCP ক্লায়েন্টকে নিচের সংগ্রহ, টুল, রিসোর্স এবং প্রম্পটে প্রবেশের অনুমতি দিন।',
    prompts: 'প্রম্পটসমূহ',
