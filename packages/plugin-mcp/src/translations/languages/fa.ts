...
export const faTranslations = {
  'plugin-mcp': {
    apiKeyDescription:
      'کلیدهای API کنترل می‌کنند کلاینت‌های MCP به کدام مجموعه‌ها، منابع، ابزارها و پرامپت‌ها دسترسی داشته باشند.',
    apiKeys: 'کلیدهای API',
    ...
    keyPrivateDescription:
      'این کلید به MCP دسترسی به محتوای شما می‌دهد. آن را با دیگران به اشتراک نگذارید!',
    ...
    overrideAccessDescription:
      'در صورت فعال بودن، این کلید در هر عملیاتی کنترل دسترسی Payload را دور می‌زند. مگر با دلیل مشخص، آن را غیرفعال نگه دارید.',
    permissions: 'مجوزها',
    permissionsDescription:
      'به کلاینت‌های MCP اجازه دهید به مجموعه‌ها، ابزارها، منابع و پرامپت‌های زیر دسترسی داشته باشند.',
    prompts: 'پرامپت‌ها',
    resources: 'منابع',
    server: 'سرور',
    title: 'عنوان',
