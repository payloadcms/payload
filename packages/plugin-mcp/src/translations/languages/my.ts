...
export const myTranslations = {
  'plugin-mcp': {
    apiKeyDescription:
      'API key များသည် MCP client များ ဝင်ရောက်နိုင်သော collection, resource, tool နှင့် prompt များကို ထိန်းချုပ်သည်။',
    ...
    keyPrivateDescription:
      'ဤ key သည် MCP ကို သင့် content သို့ ဝင်ရောက်ခွင့်ပေးသည်။ အခြားသူများနှင့် မမျှဝေပါနှင့်!',
    ...
    overrideAccessDescription:
      'ဖွင့်ထားပါက ဤ key သည် ပြုလုပ်သော လုပ်ဆောင်ချက်တိုင်းတွင် Payload access control ကို ကျော်လွန်မည်။ အကြောင်းပြချက်တိကျ မရှိပါက မဖွင့်ပါနှင့်။',
    permissions: 'ခွင့်ပြုချက်များ',
    permissionsDescription:
      'MCP client များအား အောက်ပါ collection, tool, resource နှင့် prompt များကို ဝင်ရောက်ခွင့်ပြုပါ။',
    prompts: 'Prompt များ',
