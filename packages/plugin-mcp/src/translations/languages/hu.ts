...
export const huTranslations = {
  'plugin-mcp': {
    apiKeyDescription:
      'Az API-kulcsok szabályozzák, hogy az MCP-kliensek mely gyűjteményekhez, erőforrásokhoz, eszközökhöz és promptokhoz férhetnek hozzá.',
    apiKeys: 'API-kulcsok',
    ...
    keyPrivateDescription:
      'Ez a kulcs hozzáférést ad az MCP-nek a tartalmadhoz. Ne oszd meg másokkal!',
    ...
    overrideAccessDescription:
      'Ha be van jelölve, ez a kulcs minden műveletnél megkerüli a Payload hozzáférési szabályait. Hagyd kikapcsolva, hacsak nincs konkrét okod.',
    permissions: 'Jogosultságok',
    permissionsDescription:
      'Engedélyezd az MCP-klienseknek az alábbi gyűjtemények, eszközök, erőforrások és promptok elérését.',
    prompts: 'Promptok',
