...
export const hyTranslations = {
  'plugin-mcp': {
    apiKeyDescription:
      'API բանալիները կառավարում են, թե MCP հաճախորդները որ հավաքածուներին, ռեսուրսներին, գործիքներին և prompt-երին կարող են մուտք ունենալ։',
    ...
    keyPrivateDescription:
      'Այս բանալին MCP-ին հասանելիություն է տալիս ձեր բովանդակությանը։ Մի՛ կիսվեք այն ուրիշների հետ։',
    ...
    overrideAccessDescription:
      'Միացված լինելու դեպքում այս բանալին շրջանցում է Payload-ի հասանելիության կանոնները յուրաքանչյուր գործողության ժամանակ։ Թողեք անջատված, եթե հատուկ պատճառ չունեք։',
    permissions: 'Թույլտվություններ',
    permissionsDescription:
      'Թույլ տվեք MCP հաճախորդներին մուտք ունենալ հետևյալ հավաքածուներին, գործիքներին, ռեսուրսներին և prompt-երին։',
    prompts: 'Prompt-եր',
