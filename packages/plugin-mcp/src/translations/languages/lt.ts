...
export const ltTranslations = {
  'plugin-mcp': {
    apiKeyDescription:
      'API raktai valdo, prie kurių kolekcijų, išteklių, įrankių ir promptų gali prisijungti MCP klientai.',
    apiKeys: 'API raktai',
    ...
    keyPrivateDescription:
      'Šis raktas suteikia MCP prieigą prie jūsų turinio. Nesidalykite juo su kitais!',
    ...
    overrideAccessDescription:
      'Pažymėjus, šis raktas apeina Payload prieigos kontrolę kiekvienoje operacijoje. Palikite nepažymėta, nebent turite konkrečią priežastį.',
    permissions: 'Leidimai',
    permissionsDescription:
      'Leiskite MCP klientams pasiekti šias kolekcijas, įrankius, išteklius ir promptus.',
    prompts: 'Promptai',
    resources: 'Ištekliai',
    server: 'Serveris',
    title: 'Pavadinimas',
