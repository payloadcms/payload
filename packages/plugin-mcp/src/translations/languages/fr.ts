...
export const frTranslations = {
  'plugin-mcp': {
    apiKeyDescription:
      'Les clés API contrôlent les collections, ressources, outils et prompts auxquels les clients MCP peuvent accéder.',
    apiKeys: 'Clés API',
    ...
    keyPrivateDescription:
      'Cette clé donne à MCP accès à votre contenu. Ne la partagez pas avec d’autres personnes !',
    ...
    overrideAccessDescription:
      'Lorsque cette option est activée, cette clé ignore le contrôle d’accès de Payload pour chaque opération. Laissez-la désactivée sauf raison précise.',
    permissions: 'Autorisations',
    permissionsDescription:
      'Autorisez les clients MCP à accéder aux collections, outils, ressources et prompts suivants.',
    prompts: 'Prompts',
