...
export const csTranslations = {
  'plugin-mcp': {
    apiKeyDescription:
      'Klíče API určují, ke kterým kolekcím, zdrojům, nástrojům a promptům mají klienti MCP přístup.',
    apiKeys: 'Klíče API',
    ...
    keyPrivateDescription:
      'Tento klíč dává MCP přístup k vašemu obsahu. Nesdílejte ho s ostatními!',
    ...
    overrideAccessDescription:
      'Je-li zaškrtnuto, tento klíč obejde řízení přístupu Payload při každé operaci. Nechte nezaškrtnuté, pokud k tomu nemáte konkrétní důvod.',
    permissions: 'Oprávnění',
    permissionsDescription:
      'Povolte klientům MCP přístup k následujícím kolekcím, nástrojům, zdrojům a promptům.',
    prompts: 'Prompty',
    resources: 'Zdroje',
    server: 'Server',
    title: 'Název',
