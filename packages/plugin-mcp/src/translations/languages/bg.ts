...
export const bgTranslations = {
  'plugin-mcp': {
    apiKeyDescription:
      'API ключовете контролират до кои колекции, ресурси, инструменти и подкани имат достъп MCP клиентите.',
    apiKeys: 'API ключове',
    ...
    keyPrivateDescription:
      'Този ключ дава на MCP достъп до съдържанието ви. Не го споделяйте с други!',
    ...
    overrideAccessDescription:
      'Когато е отметнато, този ключ заобикаля контрола за достъп на Payload при всяка операция. Оставете изключено, освен ако нямате конкретна причина.',
    permissions: 'Разрешения',
    permissionsDescription:
      'Разрешете на MCP клиентите достъп до следните колекции, инструменти, ресурси и подкани.',
    prompts: 'Подкани',
    resources: 'Ресурси',
    rotate: 'Rotate',
