...
const DEFAULT_DESCRIPTION =
  'Create multiple documents with different data or files in one collection. Files can use a URL, base64, or an upload prepared by getUploadInstructions. Use createDocument for one document.'
...
export const createDocumentsTool = defineCollectionTool({
  ...
  try {
    ...
    return {
      ...
      doc: batchResult as unknown as Record<string, unknown>,
