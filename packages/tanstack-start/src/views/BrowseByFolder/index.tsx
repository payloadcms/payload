...
import { buildRenderBrowseFolderArgs } from '../buildRenderViewArgs.js'
import { getRedirectURL, isNotFoundError, UnsupportedView } from '../shared.js'

export function BrowseByFolderView({ pageState }: { pageState: SerializablePageState }) {
    ...
    const run = async () => {
      try {
        const result = (await serverFunction({
          name: 'render-browse-folder',
          args: buildRenderBrowseFolderArgs({ pageState }),
        ...
        setFolderView(
          <UnsupportedView
            description="TanStack browse-by-folder view failed to render."
