...
export const unwrapList = (editor, atPath)=>{
    ...
    Transforms.setNodes(editor, {
        ...
        match: (node, path)=>{
            ...
            const matches = !Editor.isEditor(node) && Element.isElement(node) && !childrenAreAllElements && node.type === 'li' && path.length === atPath.length + 1;
            return matches;
        }
    });
