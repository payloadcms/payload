import type { ApplyDisableErrors, CollectionSlug, PayloadTypesShape, SelectType, TypedLocale } from 'payload';
import type { PayloadSDK } from '../index.js';
import type { JoinQuery, PopulateType, TransformCollectionWithSelect } from '../types.js';
export type FindByIDOptions<T extends PayloadTypesShape, TSlug extends CollectionSlug<T>, TDisableErrors extends boolean, TSelect extends SelectType> = {
    /**
