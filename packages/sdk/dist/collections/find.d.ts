import type { CollectionSlug, PaginatedDocs, PayloadTypesShape, SelectType, Sort, TypedLocale, Where } from 'payload';
import type { PayloadSDK } from '../index.js';
import type { JoinQuery, PopulateType, TransformCollectionWithSelect } from '../types.js';
export type FindOptions<T extends PayloadTypesShape, TSlug extends CollectionSlug<T>, TSelect extends SelectType> = {
    /**
...
export declare function find<T extends PayloadTypesShape, TSlug extends CollectionSlug<T>, TSelect extends SelectType>(sdk: PayloadSDK<T>, options: FindOptions<T, TSlug, TSelect>, init?: RequestInit): Promise<PaginatedDocs<TransformCollectionWithSelect<T, TSlug, TSelect>>>;
