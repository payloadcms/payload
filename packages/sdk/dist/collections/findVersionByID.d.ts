import type { ApplyDisableErrors, CollectionSlug, PayloadTypesShape, SelectType, TypedLocale, TypeWithVersion } from 'payload';
import type { PayloadSDK } from '../index.js';
import type { DataFromCollectionSlug, PopulateType } from '../types.js';
export type FindVersionByIDOptions<T extends PayloadTypesShape, TSlug extends CollectionSlug<T>, TDisableErrors extends boolean> = {
    /**
