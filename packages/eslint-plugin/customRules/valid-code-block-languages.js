/**
 * Validates that code block languages in MDX/MD files are supported by the syntax highlighter.
 *
 * prism-react-renderer includes these languages by default:
...
const SUPPORTED_LANGUAGES = [
  // Built-in prism-react-renderer languages
  'markup',
  'html',
  'xml',
  'svg',
  ...
  // Common aliases and additional languages typically configured
  'javascript',
  'js',
  'typescript',
  'ts',
  ...
  // Plain text variants (always safe)
  'text',
  'plaintext',
  'txt',
  'plain',
