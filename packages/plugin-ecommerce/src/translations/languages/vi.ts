...
export const viTranslations = {
  ...
  'plugin-ecommerce': {
    ...
    cartsCollectionDescription:
      'Giỏ hàng đại diện cho việc chọn sản phẩm mà khách hàng dự định mua. Chúng được liên kết với khách hàng khi có thể và người dùng khách không có khách hàng được liên kết.',
    ...
    ordersCollectionDescription:
      'Đơn hàng đại diện cho ý định của khách hàng mua sản phẩm từ cửa hàng của bạn. Chúng bao gồm các chi tiết như sản phẩm đã đặt, số lượng, giá, thông tin khách hàng và trạng thái đơn hàng.',
    ...
    transactionsCollectionDescription:
      'Giao dịch đại diện cho các lần thử thanh toán cho đơn hàng. Một đơn hàng có thể có nhiều giao dịch liên quan, chẳng hạn như lần thử thanh toán ban đầu và các lần hoàn tiền hoặc điều chỉnh tiếp theo.',
    variant: 'Biến thể',
    variantOption: 'Tùy chọn biến thể',
    variantOptions: 'Tùy chọn biến thể',
    variantOptionsAlreadyExists:
      'Tổ hợp biến thể này đã được sử dụng bởi biến thể khác. Vui lòng chọn các tùy chọn khác.',
    variantOptionsCollectionDescription:
      'Tùy chọn biến thể xác định các tùy chọn mà loại biến thể có thể có, chẳng hạn như đỏ hoặc trắng cho màu sắc.',
    ...
    variantsCollectionDescription:
      'Biến thể sản phẩm cho phép bạn cung cấp các phiên bản khác nhau của sản phẩm, chẳng hạn như biến thể kích thước hoặc màu sắc. Chúng tham chiếu đến các tùy chọn biến thể của sản phẩm dựa trên các loại biến thể được phê duyệt.',
    variantType: 'Loại biến thể',
    variantTypes: 'Loại biến thể',
    variantTypesCollectionDescription:
      'Loại biến thể được sử dụng để xác định các loại biến thể khác nhau mà sản phẩm của bạn có thể có, chẳng hạn như kích thước hoặc màu sắc. Mỗi loại biến thể có thể có nhiều tùy chọn liên quan.',
  },
}
