...
import { renderListView } from '../views.js'

/**
 * Server-function wrapper that prepares the list-render arguments and
 * delegates to the shared `renderListView` helper.
 *
 * Wired into the next `handleServerFunctions` registry under `'render-list'`.
 */
