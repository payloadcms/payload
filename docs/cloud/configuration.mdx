...
| **Install Command**  | The command used to install your modules, for example: `pnpm install` or `npm install`                                                                            |
| **Build Command**    | The command used to build your application, for example: `pnpm build` or `npm run build`                                                                          |
| **Serve Command**    | The command used to serve your application, for example: `pnpm serve` or `npm run serve`                                                                          |
