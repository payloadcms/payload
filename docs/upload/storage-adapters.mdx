...
This avoids sending large files through the document request. If upload instructions are not enabled, the Admin continues to include the file in the normal create or update request.
