...
| **`restrictedFileTypes`**      | Set to `true` to allow restricted file types. Defaults to `false`. [More](#restricted-file-types)                                                                                                                                                  |
...
If your Collection has defined `mimeTypes` or has set `restrictedFileTypes` to `true`, restricted file verification will be skipped.

The default restricted file types and extensions are:
