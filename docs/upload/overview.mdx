...
| **`allowRemoteUpload`**        | Allows users to upload files using a remote URL. When enabled, an input field for entering a URL will be provided, and files can be added directly from the specified URL.                                                            |
