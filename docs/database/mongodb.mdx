...
| `collation`          | Enable language-specific string comparison with customizable strength levels. Available on MongoDB 3.4+. Defaults locale to "en". Example: `{ enabled: true, strength: 3 }`.                                                                                                                  |                                                                                                                                                                                                                                                                     |
