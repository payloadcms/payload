...
| `bulkOperationsSingleTransaction` | When `true`, bulk update and delete operations in separate transactions. Useful for avoiding transaction limitations with large datasets in DocumentDB and Cosmos DB. Defaults to `false`.                                                                                                                   |
