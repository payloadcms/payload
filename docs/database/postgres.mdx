...
| `query.operatorHandlers`         | Customize how Payload's `contains`, `like`, and `not_like` query operators are built, for example to make text matching accent-insensitive. [More details](#custom-query-operators).                                                                                                                                                                      |
