...
You can see our [Cloudflare D1 template](https://github.com/payloadcms/payload/tree/3.x/templates/with-cloudflare-d1) for a full example of how to set this up.
