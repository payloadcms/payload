...
Payload adds an API key collection that allows admins to manage MCP capabilities:
...
You can create your own MCP access strategy using the `overrideAuth` option:
