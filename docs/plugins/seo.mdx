...
<Banner type="info">
  ...
  here](https://github.com/payloadcms/payload/tree/3.x/packages/plugin-seo). If
...
The [Templates Directory](https://github.com/payloadcms/payload/tree/3.x/templates) contains an official [Website Template](https://github.com/payloadcms/payload/tree/3.x/templates/website) and [E-commerce Template](https://github.com/payloadcms/payload/tree/3.x/templates/ecommerce) which demonstrates exactly how to configure this plugin in Payload and implement it on your front-end.
