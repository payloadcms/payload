...
<Banner type="success">
  Sentry does smart stuff with error data to make bugs easier to find
  and fix. - [sentry.io](https://sentry.io/)
</Banner>
...
<Banner type="warning">
  Make sure to complete the [Sentry for Next.js
  Setup](#sentry-for-nextjs-setup) before.
</Banner>
