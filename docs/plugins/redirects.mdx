...
<Banner type="info">
  ...
  here](https://github.com/payloadcms/payload/tree/3.x/packages/plugin-redirects).
...
A good example of how to implement this can be found in the [Website Template](https://github.com/payloadcms/payload/tree/3.x/templates/website).
...
The [Templates Directory](https://github.com/payloadcms/payload/tree/3.x/templates) also contains an official [Website Template](https://github.com/payloadcms/payload/tree/3.x/templates/website) and [E-commerce Template](https://github.com/payloadcms/payload/tree/3.x/templates/ecommerce), both of which use this plugin.
