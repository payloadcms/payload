...
| -------------------------- | --------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `collections`              | string[]        | All collections | Collections to include Import/Export controls in. Defaults to all collections.                                                       |
| `debug`                    | boolean         | false           | If true, enables debug logging.                                                                                                      |
| `disableDownload`          | boolean         | false           | If true, disables the download button in the export preview UI.                                                                      |
| `disableJobsQueue`         | boolean         | false           | If true, forces the export to run synchronously.                                                                                     |
| `disableSave`              | boolean         | false           | If true, disables the save button in the export preview UI.                                                                          |
| `format`                   | 'csv' \| 'json' | undefined       | Forces a specific export format (`csv` or `json`), hides the format dropdown, and prevents the user from choosing the export format. |
| `overrideExportCollection` | function        | undefined       | Function to override the default export collection; takes the default export collection and allows you to modify and return it.      |
