...
<Banner type="info">
  ...
  here](https://github.com/payloadcms/payload/tree/3.x/packages/plugin-nested-docs).
...
The [Templates Directory](https://github.com/payloadcms/payload/tree/3.x/templates) also contains an official [Website Template](https://github.com/payloadcms/payload/tree/3.x/templates/website) which uses this plugin.
