...
#### Using Direct Upload Instructions for Large Files

S3, Azure, and GCS can upload large files without including their bytes in the document request. Enable `clientUploads`, ask Payload for upload instructions, then follow the returned HTTP request:
