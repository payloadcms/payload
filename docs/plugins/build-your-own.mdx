...
Building your own plugin is easy, and if you&apos;re already familiar with Payload then you&apos;ll have everything you need to get started.

<Banner type="success">
  You can either start from scratch or use the [Payload plugin template.](https://github.com/payloadcms/payload-plugin-template)
</Banner>
