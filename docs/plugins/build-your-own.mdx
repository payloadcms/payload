...
In the [Payload Plugin Template](https://github.com/payloadcms/payload/tree/3.x/templates/plugin), you will see a common file structure that is used across plugins:
