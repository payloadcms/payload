...
Simply write or read data into the `context` object which is available to every hook. This data will persist throughout the entire lifecycle. You can also find the context in every request object: `req.payloadContext`.
