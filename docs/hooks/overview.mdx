...
**Declaring a function with async does not make it “asynchronous.” The async keyword simply makes the function return a Promise automatically — which is why Payload then awaits it.**
