  ...
  auth: {
    useAPIKey: {
      access: {
        ...
        // Whether this collection's users can delete (revoke) OTHER owners' keys.
...
<Banner type="warning">
  **Breaking change:**
  ...
  existing keys into the new collection before starting Payload - it will refuse to start
  otherwise.
