...
<Banner type="success">
  **Tip:** Setting `pagination: false` is a performance optimization! This will
  reduce the overhead of pagination calculations and improve query speed.
</Banner>
...
<Banner type="warning">
  **Reminder:** By default, any query with `limit: 0` will automatically disable
  pagination for you.
</Banner>
