...
| `every_in`            | Every element of the value must be found within the provided comma-delimited list of values. |
| `every_not_in`        | Every element of the value must NOT be within the provided comma-delimited list of values. |
| `every_equals`        | Every element of the value must be exactly equal. |
| `every_not_equals`    | The query will return all documents where the Every element of the value is not equal. |
