...
When building queries, combine as many of these options together as possible as your requirements allow. This will ensure your queries are as efficient as they possibly can be.
