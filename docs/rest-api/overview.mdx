...
- [version](/docs/versions/drafts#reading-with-version) - `'published'`, `'latest'`, or `'draft'` on read operations
- [action](/docs/versions/drafts#writing-with-action) - `saveDraft`, `publish`, or `unpublish` on write operations
