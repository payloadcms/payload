...
| Service              | Package                                                                      |
| -------------------- | ---------------------------------------------------------------------------- |
| Vercel Blob          | https://github.com/payloadcms/payload/tree/3.x/packages/storage-vercel-blob |
| AWS S3               | https://github.com/payloadcms/payload/tree/3.x/packages/storage-s3          |
| Azure                | https://github.com/payloadcms/payload/tree/3.x/packages/storage-azure       |
...
Then go through each one of the breaking changes and make the adjustments. You can optionally reference the [blank template](https://github.com/payloadcms/payload/tree/3.x/templates/blank) for how things should end up.
