...
### Minimum supported Next.js version is now 16.3.0 ([#16537](https://github.com/payloadcms/payload/pull/16537))

Older versions of Next.js are no longer supported. Update Next.js to **16.3.0** or newer.
