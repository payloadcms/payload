...
- Register commands by import path to keep them out of the Payload config's module graph. Paths use the existing `PayloadComponent` syntax and support default or named exports. Direct `CLICommand` values are also accepted.
