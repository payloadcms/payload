...
| `DefaultNavClient`         | `@payloadcms/next/client`    | `@payloadcms/ui/internal` |
| `HierarchyTypeField`       | `@payloadcms/next/client`    | `@payloadcms/ui`          |
| `NavSidebarToggle`         | `@payloadcms/next/client`    | `@payloadcms/ui/internal` |
| `NavWrapper`               | `@payloadcms/next/client`    | `@payloadcms/ui/internal` |
| `QueryPresetsAccessCell`   | `@payloadcms/next/client`    | `@payloadcms/ui/internal` |
| `QueryPresetsColumnField`  | `@payloadcms/next/client`    | `@payloadcms/ui/internal` |
| `QueryPresetsColumnsCell`  | `@payloadcms/next/client`    | `@payloadcms/ui/internal` |
| `QueryPresetsGroupByCell`  | `@payloadcms/next/client`    | `@payloadcms/ui/internal` |
| `QueryPresetsGroupByField` | `@payloadcms/next/client`    | `@payloadcms/ui/internal` |
| `QueryPresetsWhereCell`    | `@payloadcms/next/client`    | `@payloadcms/ui/internal` |
| `QueryPresetsWhereField`   | `@payloadcms/next/client`    | `@payloadcms/ui/internal` |
...
The `/internal` targets above are implementation details used by Payload core and may change without a major version bump.
