...
MongoDB does not need a schema migration. You can optionally generate the same predefined migration with `@payloadcms/db-mongodb` to remove the old field and index.
