...
Access now runs where the upload is authorized. Signed URL and token generators check access before returning credentials. R2 checks access in its supporting endpoint.
