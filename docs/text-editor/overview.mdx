...
<Banner type="warning">
  ...
  editor was based on Slate and is still supported. You can read [its documentation](/docs/text-editor/slate), 
  or the optional [migration guide](/docs/text-editor/migration) to migrate from Slate to Lexical (recommended).
...
You can find more information about creating your own feature in our [building custom feature docs](/docs/text-editor/building-custom-features).
