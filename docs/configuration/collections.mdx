...
| `LivePreviewToggler`     | Replace the default Live Preview Toggler within the Edit View. [Live Preview](../live-preview/overview) must be enabled. [More details](../custom-components/edit-view#livepreviewtoggler).             |
