...
Payload Collections are defined through configs of their own. You can define as many Collections as your application needs. Each Collection will automatically scaffold a new collection / table in your [Database](../database/overview), based on the [Fields](../fields/overview) that you define.
