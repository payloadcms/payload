...
A Collection is a group of records, called Documents, that share a common schema. You can define as many Collections as your application needs. Each Collection corresponds to a collection or table in your [Database](../database/overview) based on the [Fields](../fields/overview) that you define.
