...
| `useAsThumbnail`             | Optional upload field path for dashboard document thumbnails, such as `hero.image`. Defaults to the first upload field. Missing or inaccessible images use a file icon.                                                                                                                                |
