...
| `afterListBulkActions`  | An array of components to inject _after_ the built-in List View's bulk actions. [More details](../custom-components/list-view#afterbulkactions).                                   |
...
| `beforeListBulkActions` | An array of components to inject _before_ the built-in List View's bulk actions. [More details](../custom-components/list-view#beforebulkactions).                                 |
