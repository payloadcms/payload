...
| `listHeaderActions` | An array of components to inject as action buttons in the List View header next to the title. [More details](../custom-components/list-view#listheaderactions).                    |
