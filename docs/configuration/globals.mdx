...
To do this, use the `admin` property in your Global Config:
...
| `preview`     | Function to generate a preview URL within the [Admin Panel](../admin/overview) for this global that can point to your app. [More](#preview).           |
