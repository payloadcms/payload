...
| `LivePreviewToggler`     | Replace the default Live Preview Toggler with a Custom Component. [Live Preview](../live-preview/overview) must be enabled. [More details](../custom-components/edit-view#livepreviewtoggler).             |
