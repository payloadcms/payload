...
<Banner type="warning">
  <strong>Tip:</strong>
  Be sure that `dotenv` can find your `.env` file. By default, it will look for a file named `.env` in the root of your project. If you need to specify a different file, you can pass the path to the config options.
</Banner>
