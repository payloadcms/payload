...
You can import config types in one two ways:

**Config**

This is the type used for an incoming Payload Config. Only the bare minimum properties are marked as required.
...
This is the type used after an incoming Payload Config is fully sanitized. Generally, this is only used internally by Payload.
