...
| **`typeSafeDepth`**      | Enable depth-aware result types for relationship and join fields in the Local API, disabled by default. [More details](../queries/depth#type-safe-relationship-types-with-depth).                                                                                                                                                                                                                                                                       |
