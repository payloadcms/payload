...
| **`generateInputTypes`** | By default, Payload generates a write-shaped input type (e.g. `PostInput`) alongside each read type. Opt out by setting `typescript.generateInputTypes: false`. [More details](../typescript/generating-types#input-and-output-types).                                                                                                                                                                                                                  |
