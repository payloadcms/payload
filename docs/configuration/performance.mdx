...
Here are some tips to ensure your Payload app runs as quickly and efficiently as possible.
...
- [Turbopack](#turbopack)
- [devBundleServerPackages](#devbundleserverpackages)
...
Use [block references]() to share the same block across multiple fields without bloating the config.
