...
Anywhere in your Payload app that you have access to the `req` object, you can access i18next's extensive internationalization features. This allows access to translated text using `req.i18n.t('namespace:key')`.
