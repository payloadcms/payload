...
<Banner type="warning">
  **Important:** This feature is currently in beta and may have some limitations
  or bugs. Please test thoroughly before using in production.
</Banner>

To enable this experimental feature, set `versions.drafts.localizeStatus` to `true` in your collection or global config:
