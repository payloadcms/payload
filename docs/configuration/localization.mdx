...
| **`duplicateSelectLocales`** | **Boolean.** Adds a new docment control option `Duplicate Selected Locales` allowing the user to select specific locales to duplicate. Defaults to `false`.                                 |
