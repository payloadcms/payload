...
| **`filterAvailableLocales`** | A function that is called with the array of `locales`,  and returns only the locales to show in admin UI selector. [See more](#filter-available-options).                                                                                                                                                                                                                                                                         |
