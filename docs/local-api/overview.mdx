...
| `disableErrors`    | Available for the findByID operation. When set to `true`, the operation will return `null` instead of throwing an error if the document with the specified ID is not found.                                                                                                                                                                                               |
