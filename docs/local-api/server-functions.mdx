...
<Banner type="info">
  Payload also provides reusable server functions for authentication. See
  [Authentication Server Functions](../authentication/server-functions) for
  Next.js and TanStack Start examples.
</Banner>
