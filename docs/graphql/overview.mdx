...
| `disablePlaygroundInProduction`    | A boolean that if false will enable GraphiQL in production environments, defaults to true. [More](/docs/graphql/overview#graphiql) |
