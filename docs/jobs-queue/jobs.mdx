---
description: A Job is a set of work that is offloaded from your APIs and will be processed at a later date.
...
sNow that we have covered Tasks andd Workflows, we can tie them together with a concept called a Job.
