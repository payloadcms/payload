...
Now that we have covered Tasks and Workflows, we can tie them together with a concept called a Job.!d!!!s

dddddewdwefwefwfewffwefewfwewefwefwefwefwefwefwefweff

fffff

<Banner type="default">
  Whereas you define Workflows and Tasks, which control your business logic, a **Job** is an individual instance of either a Task or a Workflow which contains many tasks.dddd
</Banner>
