...
![Blocks field in Payload admin panel](/images/fields/blocks.jpg)
...
#### Required, auto-generated data per block

In addition to the field data that you define on each block, Payload will store two additional required properties on each block:
...
This field features default admin options at this time. For more on default admin options, [click here](/docs/fields/overview#admin-options).
