...
In addition to the default [field admin config](/docs/fields/overview#admin), you can customize all of the options that `react-datepicker` provisions for via the `date` property.
