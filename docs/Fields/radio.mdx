...
In addition to the default [field admin config](/docs/fields/overview#admin), the Radio field type allows for the specification of the following `admin` properties:
