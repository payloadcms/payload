...
<Banner >
  The Textarea field is almost identical to the Text field but it features a slightly larger input better suited to edit longer text.
</Banner>
...
In addition to the default [field admin config](/docs/fields/overview#admin), the Textarea field type allows for the following `admin` properties:
