...
If you're using this block within the [Lexical editor](/docs/text-editor/overview), you can also customize how the block is rendered in the Lexical editor itself by specifying custom components.
