...
| **`custom`**               | Extension point for adding custom data (e.g. for plugins)                                                                                                                           |
| **`admin`**                | Admin-specific configuration. [More details](#block-admin-options).                                                                                                                       |

## Block Admin Options

To customize the appearance and behavior of a Block in the [Admin Panel](../admin/overview), you can use the `admin` option:
...
A Block config can have the following admin options:
...
| **`components.Label`** | React component to be rendered as the label on the block row. [Example](#row-label) |
| **`components.Block`** | React component to be rendered as the block in Lexical. [More info](#customizing-the-way-your-block-is-rendered-in-lexical) |
