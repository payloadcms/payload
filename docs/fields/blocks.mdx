...
| **`imageURL`** _(deprecated)_     | Use `images` instead. Thumbnail URL for the block selection drawer.                                                                                                                                                                                            |
| **`imageAltText`** _(deprecated)_ | Use `images` instead. Alt text for the block thumbnail.                                                                                                                                                                                                        |
