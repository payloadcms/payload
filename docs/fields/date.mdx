...
| **`expires`**      | Number of seconds after specified date before document expires. [More](https://mongoosejs.com/docs/api.html#schemadateoptions_SchemaDateOptions-expires)
