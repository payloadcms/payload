...
| **`editor`**           | Customize or override the rich text editor. [More details](/docs/text-editor/overview).                                                                               |
...
take a look at the [rich text editor documentation](/docs/text-editor/overview).
