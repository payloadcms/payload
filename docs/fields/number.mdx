...
Set this property to format the number value in its description and its collection table view. The options are provided by JavaScript's [Intl.NumberFormat](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat).
