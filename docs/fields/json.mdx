...
| **`jsonSchema`**    | Provide a JSON schema that will be used for visual warning diagnostics in the monaco editor. [JSON schemas](https://json-schema.org/learn/getting-started-step-by-step)                                                        |
