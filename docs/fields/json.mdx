...
| **`index`**        | Build an [index](/docs/database/indexes) for this field to produce faster queries. Set this field to `true` if your users will perform queries on this field's data often.                                                                                                                              |
...
export const CustomJSONFieldClient: React.FC<JSONFieldClientProps> = (
  props,
) => {
