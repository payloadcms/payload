...
To create a Tabs Field, set the `type` to `tabs` in your [Field Config](./overview):
...
| **`admin`**   | Admin-specific configuration. [More details](./overview#admin-config). |
