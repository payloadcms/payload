...
| **`interface`**   | Create a top level, reusable [Typescript interface](/docs/typescript/generating-types#custom-field-interfaces) & [GraphQL type](/docs/graphql/graphql-schema#custom-field-schemas). (`name` must be present) |
  ...
  fields: [
    {
      ...
      tabs: [
        ...
        },
        {
          ...
          interface: "TabTwo", // optional (`name` must be present)
          fields: [
            // required
            {
