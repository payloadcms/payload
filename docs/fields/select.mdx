...
You can import the existing Select component directly from Payload, then extend and customize it as needed. See the [Custom Select Field](/docs/admin/components#field-component) video to learn more.
