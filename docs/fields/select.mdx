...
| **`reduceOptions`**    | Dynamically filter which options are available based on the user, data, etc. [More details](#reduce-options)                                                                                                                                                                                            |
...
The result of `reduceOptions` will determine:
