...
| `disabledListColumn` | Set `disabledListColumn` to `true` to prevent fields from appearing in the list view column selector and in the list view filter options.                                                                                                 |
