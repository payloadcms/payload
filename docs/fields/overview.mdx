...
Collections automatically generate an ID field. To customize its type or behavior, see [Fields Generated by Payload](./default-fields#custom-id-fields).
