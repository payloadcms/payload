...
One common use case for the Text Field is to create a "slug" for a document. A slug is a unique, URL-friendly string that identifies a particular document, often used to construct the URL of a webpage.
