...
Just like inline blocks, the BlockCollapsible component will automatically render an edit button for custom blocks. This button displays a drawer with the block's fields so your editors can edit them. You can change this behavior and customize other aspects of the block's UI by passing props to the BlockCollapsible component.
