...
{/* IMAGE_PLACEHOLDER: Comparison showing a block vs inline block in the editor */}
...
{/* IMAGE_PLACEHOLDER: Screenshot of the CodeBlock in the editor with syntax highlighting */}
...
{/* IMAGE_PLACEHOLDER: Screenshot of the custom code block with language dropdown */}
