...
export const Code: React.FC<CodeFieldClientProps> = ({
  ...
  const languageField = useFormFields(
  ...
  const props: CodeFieldClient = useMemo<CodeFieldClient>(
    () => ({
      ...
      admin: {
        ...
        language:
          languageKeyToMonacoLanguageMap[language] || language,
      },
      label,
    }),
...
export const INSERT_MYNODE_COMMAND: LexicalCommand<void> =
  createCommand('INSERT_MYNODE_COMMAND')
