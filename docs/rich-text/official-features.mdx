...
When using TypeScript, you can also pass in additional type definitions that will be available in the editor. Here's an example of how to make `payload` available in the editor:
