  ...
  fields: [
    ...
    lexicalHTMLField({
      ...
      converters: (({ defaultConverters }) => ({
        ...
        WithDefaultNodes<SerializedBlockNode<MyTextBlock>>
      >,
    }),
  ],
}
...
type NodeTypes = WithDefaultNodes<
  SerializedBlockNode<MyTextBlock> | SerializedInlineBlockNode<MyInlineBlock>
>
...
const lexicalJSON = convertHTMLToLexical({
  editorConfig: editorConfigFactory.default({
...
const lexicalJSON = convertHTMLToLexical({
  editorConfig: editorConfigFactory.default({ config }),
  html: htmlWithImage,
  JSDOM,
})
