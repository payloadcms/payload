...
Export content from the Lexical editor into plain text using the [lexical editor config](/docs/rich-text/converters#getting-the-editor-config) following these steps:
