      ...
      hooks: {
        afterRead: [
          ({ siblingData, siblingFields }) => {
            const data: SerializedEditorState = siblingData['nameOfYourRichTextField']
            ...
            const markdown = convertLexicalToMarkdown({
              ...
              editorConfig: editorConfigFactory.fromField({
                field: siblingFields.find(
                  (field) => 'name' in field && field.name === 'nameOfYourRichTextField',
                ) as RichTextField,
              }),
            })
...
<LightDarkImage
  srcLight="https://payloadcms.com/images/docs/fields/mdx-example-light.png"
  srcDark="https://payloadcms.com/images/docs/fields/mdx-example-dark.png"
