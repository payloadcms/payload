...
Convert markdown content to the Lexical editor format using the [lexical editor config](/docs/rich-text/converters#getting-the-editor-config) with the following:
...
Export content from the Lexical editor into Markdown format using the [lexical editor config](/docs/rich-text/converters#getting-the-editor-config) following these steps:
