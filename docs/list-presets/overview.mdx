...
List Presets are subject to the same [Access Control](../access-control/overview) patterns as the rest of Payload. This means you can use the same access control functions you are already familiar with to control who can read, update, and delete each individual preset.
