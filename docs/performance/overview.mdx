...
If your validation functions are asynchronous or computationally heavy, [ensure they only run when necessary](../field/overview#validation-performance).

### Building lightweight custom components
