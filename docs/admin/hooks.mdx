...
<TableWithDrawers
  ...
  rows={[
    ...
    [
      ...
      {
        drawerTitle: 'useForm().addFieldRow',
        drawerSlug: 'addFieldRow',
        drawerContent: <UseFormHookAddFieldRow />
      }
    ],
    [
      {
      ...
      {
        drawerTitle: 'useForm().removeFieldRow',
        drawerSlug: 'removeFieldRow',
        drawerContent: <UseFormHookRemoveFieldRow />
      }
    ],
    [
      {
      ...
      {
        drawerTitle: 'useForm().replaceFieldRow',
        drawerSlug: 'replaceFieldRow',
        drawerContent: <UseFormHookReplaceFieldRow />
      }
    ],
  ]}
/>
