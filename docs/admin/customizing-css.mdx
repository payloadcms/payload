...
order: 50
desc: Customize the Payload Admin Panel further by adding your own CSS style sheet to the configuration, powerful theme and design options are waiting for you.
keywords: admin, css, documentation, Content Management System, cms, headless, javascript, node, react, nextjs
---
...
To customize the CSS within the Admin UI, determine scope and change you'd like to make, and then add your own CSS to the configuration as needed.
