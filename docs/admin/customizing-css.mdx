...
- [Breakpoints](https://github.com/payloadcms/payload/blob/3.x/packages/ui/src/scss/queries.scss)
- [Colors](https://github.com/payloadcms/payload/blob/3.x/packages/ui/src/scss/colors.scss)
...
- [Sizing](https://github.com/payloadcms/payload/blob/3.x/packages/ui/src/scss/app.scss)
  - Horizontal gutter
  - Transition speeds
  - Font sizes
  - Etc.

For an up-to-date, comprehensive list of all available variables, please refer to the [Source Code](https://github.com/payloadcms/payload/blob/3.x/packages/ui/src/scss).
