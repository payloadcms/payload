...
By default this is not included in the list of supported timezones but you can add it manually, this will ensure that any dates entered with this timezone are exactly matching the UTC value as well.
