...
Payload dynamically generates a beautiful, [fully type-safe](../typescript/overview) admin panel to manage your users and data. It is highly performant, even with 100+ fields, and fully secure behind your application's [Access Control](../access-control/overview). Within the Admin Panel you can manage content, [render your site](../live-preview/overview), preview drafts, [diff versions](../versions/overview), and so much more.
...
The `admin` directory contains all the _pages_ related to the interface itself, while the `api` and `graphql` directories contains all the _routes_ related to the [REST API](../rest-api/overview) and [GraphQL API](../graphql/overview), respectively. All [admin routes are configurable](#custom-admin-routes) to meet your application's requirements.
...
| `routes`          | Replace built-in Admin Panel routes with your own custom routes. [More](#custom-admin-routes).                                                                                                                                                                              |
