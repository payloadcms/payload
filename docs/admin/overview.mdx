...
Finally, the `custom.scss` file is where you can add or override styles to the Admin Panel. Customizing the look and feel through CSS alone is a powerful feature of the Admin Panel, [more on that here](./customizing-css).
...
<Banner type="success">
  <strong>Note:</strong>
  You can also swap out entire views out for your own. See [Views](./views) for more information.
</Banner>
