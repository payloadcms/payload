...
To easily swap out Collection Views with your own, or to [create entirely new ones](#adding-new-views), use the `admin.components.views` property on any [Collection Config](../collections/overview):
...
To easily swap out Global Views with your own or [create entirely new ones](#adding-new-views), use the `admin.components.views` property on any [Global Config](../globals/overview):
