...
| **`public`**       | When true, this path will be accessible to non logged in users allowing you to control access. Combine it with `exact: true` if you want nested paths to not be public. |
