...
You can add additional [React Context](https://react.dev/learn/scaling-up-with-reducer-and-context) to any Payload app through Custom Providers. As you add more and more Custom Components to your [Admin Panel](./overview), you may want to share state across all of them. To do this, simply add `admin.components.providers` to your Payload config:
