...
| **`list.BeforeList`**   | Array of components to inject _before_ the built-in List view
                                                         |
| **`list.BeforeListTable`**   | Array of components to inject _before_ the built-in List view's table
                                                         |
| **`list.AfterListTable`**   | Array of components to inject _after_ the built-in List view's table
                                                         |
| **`list.AfterList`**   | Array of components to inject _after_ the built-in List view
                                                         |
#### Examples
