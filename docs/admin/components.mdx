...
There are fields that support **`Label`** and **`Error`** that are swappable likewise. The main idea of these properties is to extend existing fields without reimplementing them. The only fields that **DON'T** support are [Array](/docs/fields/array), [Blocks](/docs/fields/blocks), [Collapsible](/docs/fields/collapsible), [Group](/docs/fields/group), [Rich Text](/docs/fields/rich-text), [Row](/docs/fields/row), [Tabs](/docs/fields/tabs), and [UI](/docs/fields/ui) Fields.

| Component   | Description                                        |
| ----------- | -------------------------------------------------- |
| **`Label`** | Override the default Label in the Field Component. |
| **`Error`** | Override the default Label in the Field Component. |

Also, there are fields that support BeforeInput and AfterInput. Supported by [Checkbox](/docs/fields/checkbox), [Email](/docs/fields/email), [Number](/docs/fields/number), [Point](/docs/fields/point), [Text](/docs/fields/text), and [Textarea](/docs/fields/textarea) fields.

| Property          | Description                                                                 |
| ----------------- | --------------------------------------------------------------------------- |
| **`BeforeInput`** | An array of elements that will be added before `input`/`textarea` elements. |
| **`AfterInput`**  | An array of elements that will be added after `input`/`textarea` elements.  |
