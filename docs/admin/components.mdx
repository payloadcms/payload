...
| **`BeforeNavLinks`**  | Injects into the built-in Nav, _before_ the links themselves. |
| **`AfterNavLinks`**   | Injects into the built-in Nav, _after_ the links themselves. [Demo](https://github.com/payloadcms/payload/tree/master/demo/client/components/AfterNavLinks) |
| **`BeforeDashboard`** | Injects into the built-in Dashboard, _before_ the default dashboard contents. |
| **`AfterNavLinks`**   | Injects into the built-in Nav, _after_ the default dashboard contents. [Demo](https://github.com/payloadcms/payload/tree/master/demo/client/components/AfterDashboard) |
