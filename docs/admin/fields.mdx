...
In addition to the above props, Server Components will also receive the following props:

| Property         | Description                                                                                                                                                                                                                      |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`clientField`** | The serialized Client Field Config. |
...
All Cell Components will receive all the the same props that [Field Components](#field) receive, plus the following props:
...
All Label Components receive the same props that the [Field Component](#field) receives. For details on how to build Custom Components themselves, see [Building Custom Components](./components#building-custom-components).
...
All Description Components receive the same props that the [Field Component](#field) receives. For details on how to build a Custom Components themselves, see [Building Custom Components](./components#building-custom-components).
...
All Description Components receive the same props that the [Field Component](#field) receives. For details on how to build Custom Components themselves, see [Building Custom Components](./components#building-custom-components).
...
All `beforeInput` and `afterInput` Components receive the same props that the [Field Component](#field) receives.
