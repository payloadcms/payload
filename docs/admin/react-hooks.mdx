...
| **`resetColumnsState`** | A method to reset columns back to their default state |
| **`setColumns`** | A method to set which columns are active. Accepts an array of column names as strings |
