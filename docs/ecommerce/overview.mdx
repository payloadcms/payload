...
<Banner type="info">
  ...
  here](https://github.com/payloadcms/payload/tree/3.x/packages/plugin-ecommerce).
...
The [Templates Directory](https://github.com/payloadcms/payload/tree/3.x/templates) also contains an official [E-commerce Template](https://github.com/payloadcms/payload/tree/3.x/templates/ecommerce), which uses this plugin.
