...
<Banner type="success">
  **Note:** All of these APIs share the exact same query language.
  [More details](../queries/overview).
</Banner>
...
<Banner type="info">
  For more information about the Local API, [click
  here](../local-api/overview).
</Banner>
...
<Banner type="info">
  For more information about the REST API, [click
  here](../rest-api/overview).
</Banner>
...
<Banner type="info">
  For more information about the GraphQL API, [click
  here](../graphql/overview).
</Banner>
...
<Banner type="warning">
  **Important:** Version numbers of all official Payload packages are
  always published in sync. You should make sure that you always use
  matching versions for all official Payload packages.
</Banner>
...
<Banner type="info">
  **Note:** Rich Text is entirely optional and you may not need it for
  your project.
</Banner>
