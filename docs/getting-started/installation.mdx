...
Then just follow the prompts! You'll get set up with a new folder and a functioning Payload app inside. You can now start to [configure your application](../configuration/overview).
