...
If you're building a website and your frontend is on Next.js or TanStack Start, then Payload is a no-brainer.
...
<Banner type="success">
  ...
  connection back and forth, just install Payload in your existing Next.js or
  TanStack Start repo and instantly get a full CMS.
</Banner>
