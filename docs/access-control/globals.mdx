...
Global Access Control is [Access Control](../overview) used to restrict access to [Global](../getting-started/concepts#globals) Documents, as well as what they can and cannot see within the [Admin Panel](../admin/overview) as it relates to that Global.
