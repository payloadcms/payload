...
If a Collection supports [`Authentication`](/docs/authentication/overview), the following additional options are available:
...
If a Collection supports [Versions](/docs/versioning/overview), the following additional options are available:
...
export const CollectionWithReadVersionsAccess: CollectionConfig = {
  // ...
  access: {
    // highlight-start
