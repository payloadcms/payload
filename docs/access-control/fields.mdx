...
| **`collection`**  | The collection config that owns the field, or `null` when the field belongs to a global.                                     |
| **`global`**      | The global config that owns the field, or `null` when the field belongs to a collection.                                     |
