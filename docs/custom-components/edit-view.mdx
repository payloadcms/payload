...
<Banner type="warning">
  **Note:** Collection and Globals share the same `admin.components.edit` key,
  with slightly different options (e.g., `Upload` is Collection-only). Use the
  same key, but be aware of which options apply to your entity.
</Banner>
...
To add `beforeDocumentControls` components, use the `components.edit.beforeDocumentControls` property in your [Collection Config](../configuration/collections) or [Global Config](../configuration/globals):
...
- **Globals:** `admin.components.edit.SaveDraftButton`
...
- **Globals:** `admin.components.edit.PublishButton`
...
To add an `UnpublishButton` component, use the `components.edit.UnpublishButton` property in your [Collection Config](../configuration/collections) or [Global Config](../configuration/globals):
...
- **Globals:** `admin.components.edit.PreviewButton`
...
To add a `Description` component, use the `components.Description` property in your [Collection Config](../configuration/collections) or [Global Config](../configuration/globals):
...
- **Globals:** `admin.components.edit.Status`
