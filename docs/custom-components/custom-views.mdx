...
| `default`     | The Default View is the primary view in which your document is edited. It is rendered within the "Edit" tab. [More details](../custom-components/edit-view).                                                    |
