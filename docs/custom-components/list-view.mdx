...
| `beforeBulkActions` | An array of custom components to inject before the list of bulk actions in the List View. [More details](#beforeActions). |
...
| `afterBulkActions`  | An array of custom components to inject after the list of bulk actions in the List View. [More details](#afterActions).   |
...
The `beforeBulkActions` property allows you to inject custom components before the list of bulk actions in the List View.

To add `beforeBulkActions` components, use the `components.beforeBulkActions` property in your [Collection Config](../configuration/collections):
...
export const MyCollection: CollectionConfig = {
  ...
  admin: {
    components: {
      // highlight-start
      beforeBulkActions: ['/path/to/MyBeforeBulkActionsComponent'],
      // highlight-end
    },
  },
}
...
Here's an example of a custom `beforeBulkActions` component:

#### Server Component

```tsx
import React from 'react'
import type { BeforeBulkActionsServerProps } from 'payload'

export function MyBeforeBulkActionsComponent(props: BeforeBulkActionsServerProps) {
  return <div>This is a custom beforeBulkActions component (Server)</div>
}
```
...
'use client'
import React from 'react'
import type { BeforeBulkActionsClientProps } from 'payload'

export function MyBeforeBulkActionsComponent(props: BeforeBulkActionsClientProps) {
  return <div>This is a custom beforeBulkActions component (Client)</div>
}
```
...
The `afterBulkActions` property allows you to inject custom components after the list of bulk actions in the List View.

To add `afterBulkActions` components, use the `components.afterBulkActions` property in your [Collection Config](../configuration/collections):
...
export const MyCollection: CollectionConfig = {
  ...
  admin: {
    components: {
      // highlight-start
      afterBulkActions: ['/path/to/MyAfterBulkActionsComponent'],
      // highlight-end
    },
  },
}
...
Here's an example of a custom `afterBulkActions` component:

#### Server Component

```tsx
import React from 'react'
import type { AfterBulkActionsServerProps } from 'payload'

export function MyAfterBulkActionsComponent(props: AfterBulkActionsServerProps) {
  return <div>This is a custom afterBulkActions component (Server)</div>
}
```
...
'use client'
import React from 'react'
import type { AfterBulkActionsClientProps } from 'payload'

export function MyAfterBulkActionsComponent(props: AfterBulkActionsClientProps) {
  return <div>This is a custom afterBulkActions component (Client)</div>
}
```
