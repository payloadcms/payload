...
export function MyCustomServerListView(ListViewServerProps) {
  return (
    <div>
...
export function MyCustomClientListView(ListViewClientProps) {
  return (
    <div>
      <p>This is a custom List View.</p>
    </div>
...
export function MyBeforeListComponent(BeforeListServerProps) {
  return (
    <div>
...
export function MyBeforeListComponent(BeforeListClientProps) {
  return (
    <div>
      <p>This is a custom component that appears before the list of documents.</p>
    </div>
...
export function MyBeforeListTableComponent(BeforeListTableServerProps) {
  return (
    <div>
...
export function MyBeforeListTableComponent(BeforeListTableClientProps) {
  return (
    <div>
      <p>This is a custom component that appears before the table of documents.</p>
    </div>
...
export function MyAfterListComponent(AfterListServerProps) {
  return (
    <div>
...
export function MyAfterListComponent(AfterListClientProps) {
  return (
    <div>
      <p>This is a custom component that appears after the list of documents.</p>
    </div>
...
export function MyAfterListTableComponent(AfterListTableServerProps) {
  return (
    <div>
...
export function MyAfterListTableComponent(AfterListTableClientProps) {
  return (
    <div>
      <p>This is a custom component that appears after the table of documents.</p>
    </div>
...
export function MyDescriptionComponent(ListDescriptionServerProps) {
  return (
    <div>
...
export function MyDescriptionComponent(ListDescriptionClientProps) {
  return (
    <div>
      <p>This is a custom description of the Collection.</p>
    </div>
