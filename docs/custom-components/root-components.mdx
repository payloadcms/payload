...
<Banner type="success">
  **Note:** You can also use set [Collection
  ...
  Components](../configuration/globals#custom-components) in their respective configs.
</Banner>
...
<Banner type="success">
  **Note:** You can also use add Actions to the [Edit View](./edit-view) and [List
  View](./list-view) in their respective configs.
</Banner>
