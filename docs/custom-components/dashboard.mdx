...
The Dashboard is the first page users see when they log into the Payload Admin Panel. By default, it displays a grid of collection cards. You can customize the dashboard by adding **widgets** - modular components that can display data, analytics, or any other content.
