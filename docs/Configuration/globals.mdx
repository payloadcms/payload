...
| `admin`          | Admin-specific configuration. See below for [more detail](/docs/globals#admin). |
...
Globals also fully support a smaller subset of Hooks. To learn more, go to the [Hooks](/docs/hooks/config) documentation.
