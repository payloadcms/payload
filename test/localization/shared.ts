...
export const publicationAccessGlobalSlug = 'publication-access-global'
export const publicationAccessSlug = 'publication-access'
export const publicationBeforeOperationGlobalSlug = 'publication-before-operation-global'
export const publicationBeforeOperationSlug = 'publication-before-operation'
export const publicationFieldAccessGlobalSlug = 'publication-field-access-global'
export const publicationFieldAccessSlug = 'publication-field-access'
export const publicationHookSlug = 'publication-hook'
