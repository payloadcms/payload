...
// This component should consume the search params from the URL and use them to fetch the count of the tickets with the specified status
// e.g. /dashboard?status=open
