...
describe('Remove token from auth responses', () => {
  ...
  it('should not be token in response from /login', async () => {
  ...
  it('should not be token in response from /me', async () => {
  ...
  it('should not be token in response from /refresh-token', async () => {
  ...
  it('should not be token in response from /reset-password', async () => {
