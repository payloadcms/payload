...
describe('JWT authentication read access', () => {
  beforeAll(async () => {
    ;({ payload, restClient } = await initPayloadInt(dirname, 'auth/jwt'))
  })
  ...
  it('should return a user with read access from JWT authentication', async () => {
  ...
  it('should return a user with read access from the refresh operation', async () => {
