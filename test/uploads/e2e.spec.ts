...
describe('Uploads', () => {
  ...
  test('should see upload previews in relation list if allowed in config', async () => {
    ...
    const imageWithoutPreview2Button = page.locator(`.pill-selector .pill-selector__column`, {
      hasText: exactText('Image Without Preview2'),
    })
    const imageWithPreview3Button = page.locator(`.pill-selector .pill-selector__column`, {
      hasText: exactText('Image With Preview3'),
    })
    const imageWithoutPreview3Button = page.locator(`.pill-selector .pill-selector__column`, {
