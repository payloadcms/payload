...
export const preserveCropSlug = 'preserve-crop'
...
export const mediaWithoutWriteAccessSlug = 'media-without-write-access'
...
export const mediaWithFieldsSlug = 'media-with-fields'
export const adminUploadFilePreviewSingleSlug = 'admin-upload-file-preview-single'
