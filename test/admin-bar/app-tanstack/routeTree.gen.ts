...
import { Route as AdminBarRouteImport } from './app/admin-bar'
...
const AdminBarRoute = AdminBarRouteImport.update({
  id: '/admin-bar',
  path: '/admin-bar',
...
export interface FileRoutesByFullPath {
  '/': typeof IndexRoute
  '/admin-bar': typeof AdminBarRoute
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/admin-bar' | '/admin/$' | '/api/$' | '/admin/'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/admin-bar' | '/admin/$' | '/api/$' | '/admin'
  id:
    | '__root__'
    | '/'
    | '/_payload'
...
export interface RootRouteChildren {
  ...
  AdminBarRoute: typeof AdminBarRoute
}
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    '/admin-bar': {
      ...
      path: '/admin-bar'
      fullPath: '/admin-bar'
      preLoaderRoute: typeof AdminBarRouteImport
