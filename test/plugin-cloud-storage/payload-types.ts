...
export interface Config {
  ...
  collectionsInput: {
    media: MediaInput;
    'media-with-composite-prefixes': MediaWithCompositePrefixInput;
    'media-with-custom-url': MediaWithCustomUrlInput;
    'media-with-generate-file-url': MediaWithGenerateFileUrlInput;
    'media-with-overwrite': MediaWithOverwriteInput;
    'media-with-prefix': MediaWithPrefixInput;
    'media-with-throwing-hook': MediaWithThrowingHookInput;
    'restricted-media': RestrictedMediaInput;
    'test-metadata': TestMetadatumInput;
    users: UserInput;
