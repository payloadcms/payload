...
describe('Joins Field', () => {
  ...
  describeDatabase('Constrained joins', { db: 'drizzle' }, () => {
    ...
    it('should filter has-many and single select fields that share option values', async () => {
    ...
    it('should filter nested has-many and single select fields that share option values', async () => {
      const { children, parent } = await createConstrainedJoinDocuments()
