...
describe('Field Error States', () => {
  ...
  test('Remove row should remove error states from parent fields', async () => {
    ...
    await page
      .locator(
        '#field-parentArray [id$="-parentArray-row-0"] .collapsible__content .array-field__add-row',
      )
      .click()
    ...
    const errorPill = await page.waitForSelector(
      '#field-parentArray [id$="-parentArray-row-0"] > .collapsible > .collapsible__toggle-wrap .array-field__row-error-pill',
