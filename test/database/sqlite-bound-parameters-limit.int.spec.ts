...
describe(
  ...
  () => {
    ...
    it('should count omitted columns with defaults toward the bound parameters limit when batch inserting', async () => {
      ...
      await payload.delete({ collection: 'draft-with-array', id: parent.id })
    })
