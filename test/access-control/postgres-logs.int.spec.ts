      ...
      it('should cache identical where queries across operations, without passing data (2 DB calls total)', async () => {
        ...
        expect(permissions).toEqual({
          fields: {
            ...
            createdBy: { read: { permission: true }, update: { permission: true } },
            updatedBy: { read: { permission: true }, update: { permission: true } },
          },
      ...
      it('should return correct permissions with mixed results', async () => {
        ...
        expect(permissions).toEqual({
          fields: {
            ...
            createdBy: { read: { permission: false }, update: { permission: true } },
            updatedBy: { read: { permission: false }, update: { permission: true } },
          },
