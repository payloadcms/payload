...
export const landingPagesSlug = 'landing-pages'
export const blogPostsSlug = 'blog-posts'
export const productsSlug = 'products'
export const documentationSlug = 'documentation'
export const caseStudiesSlug = 'case-studies'
export const newslettersSlug = 'newsletters'
export const marketingCampaignsSlug = 'marketing-campaigns'
export const helpArticlesSlug = 'help-articles'
export const portfolioItemsSlug = 'portfolio-items'
export const eventsSlug = 'events'
export const recipesSlug = 'recipes'
export const formsSlug = 'forms'
export const workflowsSlug = 'workflows'
export const surveysSlug = 'surveys'
export const complexContentSlug = 'complex-content'
export const syncHeavySlug = 'sync-heavy'
