...
export interface Config {
  ...
  collections: {
    ...
    'custom-views-three': CustomViewsThree;
  ...
  collectionsSelect: {
    ...
    'custom-views-three': CustomViewsThreeSelect<false> | CustomViewsThreeSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "custom-views-three".
 */
export interface CustomViewsThree {
  id: string;
  title?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'custom-views-three';
        value: string | CustomViewsThree;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "custom-views-three_select".
 */
export interface CustomViewsThreeSelect<T extends boolean = true> {
  title?: T;
  updatedAt?: T;
  createdAt?: T;
}
