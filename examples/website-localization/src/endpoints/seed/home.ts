      ...
      links: [
        {
          link: {
            type: 'custom',
            appearance: 'default',
            label: locale === 'en' ? 'All posts' : 'Tous les articles',
            url: '/posts',
          },
        },
        {
              ...
              children: [
                {
                  ...
                  mode: 'normal',
                  style: '',
                  text: locale === 'en' ? 'Payload Website Template' : 'Modèle de site Web Payload',
                  version: 1,
                },
              ],
              direction: 'ltr',
                  ...
                  children: [
                    {
                      ...
                      text:
                        locale === 'en'
                          ...
                          : 'Visitez le tableau de bord admin',
                      version: 1,
                    },
                  ],
                  direction: 'ltr',
                  ...
                  children: [
                    {
                      ...
                      mode: 'normal',
                      style: '',
                      text: locale === 'en' ? 'on our Github' : ' sur notre Github',
                      version: 1,
                    },
                  ],
                  direction: 'ltr',
                    ...
                    children: [
                      {
                        ...
                        mode: 'normal',
                        style: '',
                        text: locale === 'en' ? 'Admin Dashboard' : 'Tableau de bord admin',
                        version: 1,
                      },
                    ],
                    direction: 'ltr',
                    ...
                    children: [
                      {
                        ...
                        text:
                          locale === 'en'
                            ...
                            : 'Gérez les pages et les articles de ce site à partir du ',
                        version: 1,
                      },
                      {
                        type: 'link',
                    ...
                    children: [
                      {
                        ...
                        text:
                          locale === 'en'
                            ...
                            : 'À l’aide des versions, des brouillons et de l’aperçu, les rédacteurs peuvent examiner et partager leurs modifications avant de les publier.',
                        version: 1,
                      },
                    ],
                    direction: 'ltr',
                    ...
                    children: [
                      {
                        ...
                        mode: 'normal',
                        style: '',
                        text: locale === 'en' ? 'Page Builder' : 'Constructeur de page',
                        version: 1,
                      },
                    ],
                    direction: 'ltr',
                    ...
                    children: [
                      {
                        ...
                        text:
                          locale === 'en'
                            ...
                            : 'Le constructeur de page personnalisé vous permet de créer des mises en page uniques pour les pages, les articles et les projets pour tout type de contenu.',
                        version: 1,
                      },
                    ],
                    direction: 'ltr',
                    ...
                    children: [
                      {
                        ...
                        text:
                          locale === 'en'
                            ...
                            : 'Les rédacteurs ont un contrôle total sur les données SEO et le contenu du site directement à partir de la ',
                        version: 1,
                      },
                      {
                        type: 'link',
                    ...
                    children: [
                      {
                        ...
                        text:
                          locale === 'en'
                            ...
                            : 'Les utilisateurs découvriront ce site dans leur schéma de couleurs préféré et chaque bloc peut être inversé.',
                        version: 1,
                      },
                    ],
                    direction: 'ltr',
                ...
                children: [
                  {
                    ...
                    mode: 'normal',
                    style: '',
                    text: locale === 'en' ? 'Recent posts' : 'Articles récents',
                    version: 1,
                  },
                ],
                direction: 'ltr',
                ...
                children: [
                  {
                    ...
                    text:
                      locale === 'en'
                        ...
                        : 'Les articles ci-dessous sont affichés dans un bloc de construction de mise en page "Archive", qui est un moyen extrêmement puissant d’afficher des documents sur une page. Il peut être auto-rempli par collection ou par catégorie, ou les articles peuvent être sélectionnés individuellement. Les contrôles de pagination apparaîtront automatiquement si le nombre de résultats dépasse le nombre d’éléments par page.',
                    version: 1,
                  },
                ],
                direction: 'ltr',
                ...
                children: [
                  {
                    ...
                    text:
                      locale === 'en'
                        ...
                        : 'Ceci est un bloc de construction de mise en page personnalisé ',
                    version: 1,
                  },
                  {
                    type: 'link',
                    children: [
                      {
                        ...
                        text:
                          locale === 'en'
                            ...
                            : 'configuré dans le tableau de bord admin',
                        version: 1,
                      },
                    ],
                    direction: 'ltr',
