 ...
 * @param customAdminRoute - Optional custom admin route for specific test suites (e.g., admin-root)
 */
export function getNextRootDir(testSuite?: string, customAdminRoute?: string) {
