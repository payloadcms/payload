...
/**
 * Write databaseAdapter.js to the specified output directory
 * @param dbAdapter - The database adapter type to generate
 * @param outputDir - Directory to write databaseAdapter.js (defaults to cwd)
 */
export function generateDatabaseAdapter(
  dbAdapter: DatabaseAdapterType,
  ...
  fs.writeFileSync(
    path.resolve(outputDir, 'databaseAdapter.js'),
    `
  ...
  console.log('Wrote', dbAdapter, 'db adapter to', outputDir)
