...
import { translations } from '@payloadcms/plugin-form-builder/translations/languages/all'
import { enTranslations } from '@payloadcms/plugin-form-builder/translations/languages/en'
...
void translateObject({
  ...
  targetFolder: path.resolve(
    dirname,
    '../../../../packages/plugin-form-builder/src/translations/languages',
  ),
