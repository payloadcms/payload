...
| Background jobs                      | Jobs queue with tasks                                                      | [JOBS-QUEUE.md](reference/JOBS-QUEUE.md)                                                                                         |
| Custom API routes                    | Collection custom endpoints                                                | [ENDPOINTS.md](reference/ENDPOINTS.md)                                                                                           |
...
| Validate Payload JWT externally      | SHA-256 + slice(0,32) of `PAYLOAD_SECRET`                                  | [AUTHENTICATION.md](reference/AUTHENTICATION.md)                                                                                 |
