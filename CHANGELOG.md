...
* chore: type fix (cb9ca3e4c)
* Merge branch 'master' of github.com:payloadcms/payload (5a6447805)
* feat: exposes new replaceState form api (52ae6f06a)
* Merge pull request #2518 from payloadcms/fix/#2494-excess-versions (799699894)
* fix: #2494, reduces versions caused by reverting to published with autosave: true (e0c0b2fdf)
* Merge pull request #2515 from payloadcms/feat/abstract-query-engine (506bf646b)
* Merge pull request #2511 from payloadcms/docs/user-token (e6c94c4f3)
* fix: incorrect version defaults (3f9bbe90b)
* feat: support email configuration in payload config (#2485) (042e58ea2)
* chore: clarity to secret key usage (7fa27686b)
* Merge branch 'docs/user-token' of github.com:payloadcms/payload into docs/user-token (e3e2d513d)
* chore: cleans duplicative logic (086feafcb)
* fix: hides preview button until document is saved #2476 (#2477) (f9b8e2dbc)
* Merge pull request #2507 from payloadcms/fix/preview-null (5eafbefa9)
* chore: merge master (cfadaf781)
* Merge pull request #2513 from payloadcms/fix/sidebar-spacing-2478 (dab5481fc)
* chore: revises outdated tests (1a681dd97)
* chore: corrects typo in queries overview documentation (#2475) (2074f6333)
* chore: test coverage queries (959a5d78c)
* chore: adds tests to validate queries (995054d46)
...
* docs: export default typo (faef4d5f8)
* feat: replace deprecated express-graphql dependency (#2484) (cd548a6e2)
* chore: updates global versions test config (78316d4dd)
* fix: corrects sidebar spacing in collection and global edit views #2478 (a45ab8bd7)
* docs: adds info on payload secret encryption (cd861c22b)
* fix: use correct locale when querying relationships for list view (#2438) (15442a9cc)
* docs: add custom express middleware and logging example (#2509) (3c04d43ea)
* chore: adds translations for error:previewing (63e23bab8)
...
* chore: begins work to build queries from fields instead of mongoose schema (2d0441a72)
* fix: excess padding on textarea (#2488) (6ceb79189)
* Merge pull request #2289 from payloadcms/feat/form-builder-example (b9a5bb3b8)
* chore: updates form-builder-example nextjs README (1387ba9ae)
* Merge branch 'master' of https://github.com/payloadcms/payload into feat/form-builder-example (3dd70483c)
* Merge pull request #2455 from payloadcms/chore/date-docs (ec2933c49)
* Merge pull request #2448 from AlessioGr/patch-4 (7eec16ee6)
* Merge pull request #2464 from infonomic/docs/localization-warning (ff89b8f78)
* Update overview.mdx (588a7d0a5)
...
* chore: improves text-area error rendering (4d515a0d5)
* fix: properly awaits email send to catch potential errors #2444 (#2470) (11a6ce6d3)
* docs: fixed sentance error in warning (013c96f0d)
* docs: localization warning for existing data (5fa8f69e1)
* docs: typo in date field and double link in textarea field (fb8979370)
* chore: updates date field docs (67098f7a3)
* docs: explain lifecycle of validate & beforeValida (b76c25c9e)
* chore: adds max-width to confirmation message (c0ab499a7)
* Merge branch 'master' of https://github.com/payloadcms/payload into feat/form-builder-example (abf74f1a9)
* chore: style refinements (8e814b1ed)
* feat: updates form-builder example READMEs (b459277c7)
* feat: migrates form builder example nextjs to examples (28ecb0c5e)
* chore: migrates form builder example cms to examples (1356b4db4)
