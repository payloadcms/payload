...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LexicalNodes_C9C3FC1A".
 */
export type LexicalNodes_C9C3FC1A =
  | SerializedTextNode
  | SerializedTabNode
  | SerializedLineBreakNode
  | SerializedParagraphNode<LexicalNodes_C9C3FC1A>
  | SerializedHorizontalRuleNode
  | SerializedUploadNode<'media'>
  | SerializedQuoteNode<LexicalNodes_C9C3FC1A>
  | SerializedRelationshipNode<
      ...
      | 'payload-migrations'
    >
  | SerializedAutoLinkNode<LexicalNodes_C9C3FC1A, LexicalLinkFields>
  | SerializedLinkNode<LexicalNodes_C9C3FC1A, LexicalLinkFields>
  | SerializedListNode<LexicalNodes_C9C3FC1A>
  | SerializedListItemNode<LexicalNodes_C9C3FC1A>
  | SerializedHeadingNode<LexicalNodes_C9C3FC1A>;
...
export interface Post {
  ...
  content?: LexicalRichText<LexicalNodes_C9C3FC1A> | null;
  layout?: (HeroBlock | FeatureGridBlock | CallToActionBlock)[] | null;
  updatedAt: string;
  createdAt: string;
...
export interface CollectionQueryWidget {
  data?: {
    title?: string | null;
    relatedCollection: 'users' | 'posts' | 'media' | 'categories';
    where?:
      | {
          [k: string]: unknown;
        }
...
export interface ActivityWidget {
  data?: {
    excludedCollections?: ('users' | 'posts' | 'media' | 'categories')[] | null;
  };
  width: 'x-small' | 'small' | 'medium' | 'large' | 'x-large' | 'full';
}
/**
